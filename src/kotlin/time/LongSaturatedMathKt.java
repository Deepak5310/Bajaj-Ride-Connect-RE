...
public final class LongSaturatedMathKt {
    ...
    public static final long m3830saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM3747toLongimpl = Duration.m3747toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m3829checkInfiniteSumDefinedPjuGub4(j, j2, jM3747toLongimpl);
        }
        if ((1 | (jM3747toLongimpl - 1)) == Long.MAX_VALUE) {
            return m3831saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM3747toLongimpl;
        if (((j ^ j3) & (jM3747toLongimpl ^ j3)) < 0) {
    ...
    private static final long m3829checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m3733isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m3831saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM3704divUwyO8pc = Duration.m3704divUwyO8pc(j2, 2);
        long jM3747toLongimpl = Duration.m3747toLongimpl(jM3704divUwyO8pc, durationUnit);
        return (1 | (jM3747toLongimpl - 1)) == Long.MAX_VALUE ? jM3747toLongimpl : m3830saturatingAddNuflL3o(m3830saturatingAddNuflL3o(j, durationUnit, jM3704divUwyO8pc), durationUnit, Duration.m3736minusLRDsOJo(j2, jM3704divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m3803getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m3802getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m3754unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m3737plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m3754unaryMinusUwyO8pc(infinityOfSign(j3));
        }
