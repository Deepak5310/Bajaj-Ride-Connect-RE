...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m3841boximpl(m3835markNowz9LOYto());
    }
    ...
    public long m3835markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m3844constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m3834elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m3833differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m3832adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m3844constructorimpl(LongSaturatedMathKt.m3830saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
