...
public final class DurationKt {
    ...
    private static final long m3828timesmvk6XK0(int i, long j) {
        return Duration.m3739timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m3827timeskIfJnKk(double d, long j) {
        return Duration.m3738timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM3804getZEROUwyO8pc = Duration.INSTANCE.m3804getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM3737plusLRDsOJo = Duration.m3737plusLRDsOJo(jM3804getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM3804getZEROUwyO8pc = Duration.m3737plusLRDsOJo(jM3737plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM3804getZEROUwyO8pc = Duration.m3737plusLRDsOJo(jM3804getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM3804getZEROUwyO8pc = Duration.INSTANCE.m3802getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM3737plusLRDsOJo2 = Duration.m3737plusLRDsOJo(jM3804getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM3804getZEROUwyO8pc = Duration.m3737plusLRDsOJo(jM3737plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM3804getZEROUwyO8pc = Duration.m3737plusLRDsOJo(jM3804getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m3754unaryMinusUwyO8pc(jM3804getZEROUwyO8pc) : jM3804getZEROUwyO8pc;
    }
    ...
    private static final long parseOverLongIsoComponent(String str) {
        ...
        if (length - i > 16) {
            ...
            if (!(intRange instanceof Collection) || !((Collection) intRange).isEmpty()) {
                ...
                while (true) {
                    if (it2.hasNext()) {
                        char cCharAt = str.charAt(((IntIterator) it2).nextInt());
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m3701constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m3701constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m3701constructorimpl((j << 1) + ((long) i));
    }
