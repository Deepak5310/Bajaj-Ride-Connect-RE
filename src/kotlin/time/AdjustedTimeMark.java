...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo3692minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m3838minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo3691elapsedNowUwyO8pc() {
        return Duration.m3736minusLRDsOJo(this.mark.mo3691elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo3694plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m3737plusLRDsOJo(this.adjustment, duration), null);
    }
}
