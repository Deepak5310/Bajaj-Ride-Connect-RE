...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public static final List constructors_delegate$lambda$7(KClassImpl this$0) {
            ...
            while (it2.hasNext()) {
                arrayList.add(new KFunctionImpl(this$0, (ConstructorDescriptor) it2.next()));
            }
            return arrayList;
        }
        ...
        public static final List supertypes_delegate$lambda$18(final Data this$0, final KClassImpl this$1) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(this$1, "this$1");
            Collection<KotlinType> collectionMo3640getSupertypes = this$0.getDescriptor().getTypeConstructor().mo3640getSupertypes();
            Intrinsics.checkNotNullExpressionValue(collectionMo3640getSupertypes, "getSupertypes(...)");
            ArrayList arrayList = new ArrayList(collectionMo3640getSupertypes.size());
            for (final KotlinType kotlinType : collectionMo3640getSupertypes) {
            ...
            if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(this$0.getDescriptor())) {
                ...
                if ((arrayList3 instanceof Collection) && arrayList3.isEmpty()) {
                    ...
                    while (it2.hasNext()) {
                        ClassKind kind = DescriptorUtils.getClassDescriptorForType(((KTypeImpl) it2.next()).getType()).getKind();
        ...
        public static final Type supertypes_delegate$lambda$18$lambda$15$lambda$14(KotlinType kotlinType, Data this$0, KClassImpl this$1) {
            ...
            if (!(classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassDescriptor)) {
                throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo3639getDeclarationDescriptor);
            }
            Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo3639getDeclarationDescriptor);
            if (javaClass == null) {
                throw new KotlinReflectionInternalError("Unsupported superclass of " + this$0 + ": " + classifierDescriptorMo3639getDeclarationDescriptor);
            }
            ...
            throw new KotlinReflectionInternalError("No superclass of " + this$0 + " in Java reflection for " + classifierDescriptorMo3639getDeclarationDescriptor);
        }
    ...
    public String toString() {
        ...
        if (packageFqName.isRoot()) {
            ...
            str = packageFqName.asString() + ClassUtils.PACKAGE_SEPARATOR_CHAR;
        }
