...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    public static final Caller caller_delegate$lambda$4(KFunctionImpl this$0) {
        ...
        if (constructorFindMethodBySignature instanceof Constructor) {
            ...
            } else if (this$0.getDescriptor().getAnnotations().mo3634findAnnotation(UtilKt.getJVM_STATIC()) != null) {
    ...
    public static final Caller defaultCaller_delegate$lambda$10(KFunctionImpl this$0) {
        ...
        if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinFunction) {
            ...
            if (functionWithDefaultParametersForValueClassOverride != null) {
                ...
                Member memberMo3631getMember = this$0.getCaller().mo3631getMember();
                Intrinsics.checkNotNull(memberMo3631getMember);
                constructorFindDefaultConstructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(memberMo3631getMember.getModifiers()));
            }
        ...
        if (constructorFindDefaultConstructor instanceof Constructor) {
            ...
            if (this$0.getDescriptor().getAnnotations().mo3634findAnnotation(UtilKt.getJVM_STATIC()) != null) {
    ...
    private final FunctionDescriptor getFunctionWithDefaultParametersForValueClassOverride(FunctionDescriptor descriptor) {
        ...
        Member memberMo3631getMember = getCaller().mo3631getMember();
        Intrinsics.checkNotNull(memberMo3631getMember);
        if (!Modifier.isStatic(memberMo3631getMember.getModifiers())) {
            return null;
        }
        Iterator<CallableMemberDescriptor> it3 = DescriptorUtilsKt.overriddenTreeAsSequence(descriptor, false).iterator();
        loop0: while (true) {
            if (!it3.hasNext()) {
                next = null;
                break;
            ...
            if (!(list2 instanceof Collection) || !list2.isEmpty()) {
                ...
                while (it4.hasNext()) {
                    if (((ValueParameterDescriptor) it4.next()).declaresDefaultValue()) {
                        break loop0;
                    }
                }
            }
