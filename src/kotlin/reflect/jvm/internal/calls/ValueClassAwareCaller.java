...
public final class ValueClassAwareCaller<M extends Member> implements Caller<M> {
    ...
    public ValueClassAwareCaller(CallableMemberDescriptor descriptor, Caller<? extends M> oldCaller, boolean z) {
                        ...
                        while (true) {
                            if (it3.hasNext()) {
                                if (((ValueParameterDescriptor) it3.next()).declaresDefaultValue()) {
                                    ...
                                    oldCaller = new CallerImpl.Method.BoundStaticMultiFieldValueClass(((CallerImpl.Method) oldCaller).mo3631getMember(), arrayList.toArray(new Object[0]));
                                }
                            }
                        }
                    }
        ...
        this.member = (M) oldCaller.mo3631getMember();
        ...
        if (InlineClassesUtilsKt.isGetterOfUnderlyingPropertyOfValueClass(descriptor)) {
            ...
            List listMakeKotlinParameterTypes = ValueClassAwareCallerKt.makeKotlinParameterTypes(descriptor, this.caller.mo3631getMember(), new Function1() { // from class: kotlin.reflect.jvm.internal.calls.ValueClassAwareCaller$$Lambda$0
            ...
            if (this.isDefault) {
                ...
                while (it4.hasNext()) {
                    iData$lambda$5$typeSize += data$lambda$5$typeSize((KotlinType) it4.next());
                }
            ...
            Iterator it5 = listMakeKotlinParameterTypes.iterator();
            int iData$lambda$5$typeSize2 = 0;
            while (it5.hasNext()) {
                iData$lambda$5$typeSize2 += data$lambda$5$typeSize((KotlinType) it5.next());
            }
        ...
        if (!(argumentRange instanceof Collection) || !((Collection) argumentRange).isEmpty()) {
            ...
            while (it6.hasNext()) {
                List<Method> list5 = this.data.getUnboxParameters()[((IntIterator) it6).nextInt()];
    ...
    public static final class MultiFieldValueClassPrimaryConstructorCaller implements Caller {
        ...
        public MultiFieldValueClassPrimaryConstructorCaller(FunctionDescriptor descriptor, KDeclarationContainerImpl container, String constructorDesc, List<? extends ParameterDescriptor> originalParameters) {
            ...
            for (Object obj : list) {
                ...
                ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = ((ParameterDescriptor) obj).getType().getConstructor().mo3639getDeclarationDescriptor();
                ...
                if (list2 == null) {
                    ...
                    while (it3.hasNext()) {
                        arrayList3.add(((Method) it3.next()).getReturnType());
                    }
        ...
        @Override // kotlin.reflect.jvm.internal.calls.Caller
        /* JADX INFO: renamed from: getMember */
        public /* bridge */ /* synthetic */ Member mo3631getMember() {
        ...
        public Object call(Object[] args) throws IllegalAccessException, InvocationTargetException {
            ...
            for (Pair pair : listZip) {
                ...
                if (list == null) {
                    ...
                    while (it2.hasNext()) {
                        arrayList2.add(((Method) it2.next()).invoke(objComponent1, null));
                    }
