...
public final class ValueClassAwareCallerKt {
    ...
    private static final List<String> getMfvcUnboxMethods$getUnboxMethodNameSuffixes(SimpleType simpleType) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = simpleType.getConstructor().mo3639getDeclarationDescriptor();
        ...
        MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) classifierDescriptorMo3639getDeclarationDescriptor);
    ...
    public static final List<Method> getMfvcUnboxMethods(SimpleType type) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = type.getConstructor().mo3639getDeclarationDescriptor();
        Intrinsics.checkNotNull(classifierDescriptorMo3639getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
        ...
        while (it3.hasNext()) {
            arrayList3.add(javaClass.getDeclaredMethod((String) it3.next(), null));
        }
        return arrayList3;
    }
        ...
        if (!InlineClassesUtilsKt.isGetterOfUnderlyingPropertyOfValueClass(descriptor)) {
            ...
            if ((list2 instanceof Collection) && list2.isEmpty()) {
                ...
                if (!(list instanceof Collection)) {
                    it2 = list.iterator();
                    while (it2.hasNext()) {
                        type = ((ValueParameterDescriptor) it2.next()).getType();
            ...
            while (it3.hasNext()) {
                KotlinType type2 = ((ReceiverParameterDescriptor) it3.next()).getType();
    ...
    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo3639getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }
