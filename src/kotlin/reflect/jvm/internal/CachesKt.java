...
public final class CachesKt {
    ...
    public static final KType CACHE_FOR_BASE_CLASSIFIERS$lambda$2(Class it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return KClassifiers.createType(getOrCreateKotlinClass(it2), CollectionsKt.emptyList(), false, CollectionsKt.emptyList());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final KType CACHE_FOR_NULLABLE_BASE_CLASSIFIERS$lambda$3(Class it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return KClassifiers.createType(getOrCreateKotlinClass(it2), CollectionsKt.emptyList(), true, CollectionsKt.emptyList());
    }
