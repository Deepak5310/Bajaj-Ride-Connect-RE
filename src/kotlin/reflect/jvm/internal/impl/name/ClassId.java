...
public final class ClassId {
    ...
    public final FqName asSingleFqName() {
        ...
        return new FqName(this.packageFqName.asString() + ClassUtils.PACKAGE_SEPARATOR_CHAR + this.relativeClassName.asString());
    }
    ...
    public static final class Companion {
        ...
        public final ClassId fromString(String string, boolean z) {
            ...
            int iLastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) str2, RemoteSettings.FORWARD_SLASH_STRING, iIndexOf$default, false, 4, (Object) null);
            if (iLastIndexOf$default == -1) {
                ...
                String strReplace$default2 = StringsKt.replace$default(strSubstring, '/', ClassUtils.PACKAGE_SEPARATOR_CHAR, false, 4, (Object) null);
