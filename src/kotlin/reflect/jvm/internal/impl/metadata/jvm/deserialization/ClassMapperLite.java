...
public final class ClassMapperLite {
    ...
    private static final String f743kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        List listListOf = CollectionsKt.listOf((Object[]) new String[]{"Boolean", "Z", "Char", WeatherCriteria.UNIT_CELSIUS, "Byte", "B", "Short", ExifInterface.LATITUDE_SOUTH, "Int", "I", "Float", WeatherCriteria.UNIT_FARENHEIT, "Long", "J", "Double", "D"});
        int progressionLastElement = ProgressionUtilKt.getProgressionLastElement(0, listListOf.size() - 1, 2);
        if (progressionLastElement >= 0) {
            int i = 0;
            while (true) {
                StringBuilder sb = new StringBuilder();
                String str = f743kotlin;
                sb.append(str);
                sb.append('/');
        ...
        linkedHashMap.put(f743kotlin + "/Unit", ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f743kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f743kotlin + '/' + str, "L" + str2 + ';');
    }
