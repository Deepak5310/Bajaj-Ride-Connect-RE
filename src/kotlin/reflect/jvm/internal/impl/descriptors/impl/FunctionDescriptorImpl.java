...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public void setOverriddenDescriptors(Collection<? extends CallableMemberDescriptor> collection) {
        ...
        while (it2.hasNext()) {
            if (((FunctionDescriptor) it2.next()).isHiddenForResolutionEverywhereBesideSupercalls()) {
            ...
            if (copyConfiguration.substitution.isEmpty()) {
                ...
                functionDescriptorImplCreateSubstitutedCopy.lazyOverriddenFunctionsTask = new Function0<Collection<FunctionDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.1
                    ...
                    public Collection<FunctionDescriptor> invoke() {
                        ...
                        Iterator<? extends FunctionDescriptor> it2 = FunctionDescriptorImpl.this.getOverriddenDescriptors().iterator();
                        while (it2.hasNext()) {
                            smartList.add(it2.next().substitute(typeSubstitutorSubstituteTypeParameters));
                        }
                        return smartList;
                    }
                };
