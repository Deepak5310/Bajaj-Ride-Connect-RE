...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo3639getDeclarationDescriptor() {
                return this.this$0;
            }
            ...
            public Collection<KotlinType> mo3640getSupertypes() {
                Collection<KotlinType> collectionMo3640getSupertypes = mo3639getDeclarationDescriptor().getUnderlyingType().getConstructor().mo3640getSupertypes();
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo3639getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo3639getDeclarationDescriptor().getName().asString() + ']';
            }
    ...
    public static final Boolean isInner$lambda$2(AbstractTypeAliasDescriptor this$0, UnwrappedType unwrappedType) {
        ...
        if (KotlinTypeKt.isError(unwrappedType)) {
            ...
            if (!(classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeParameterDescriptor) || Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo3639getDeclarationDescriptor).getContainingDeclaration(), this$0)) {
                z = false;
            } else {
                z = true;
            }
