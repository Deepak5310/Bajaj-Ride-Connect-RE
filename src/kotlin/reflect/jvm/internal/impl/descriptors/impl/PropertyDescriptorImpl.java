...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    protected PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        Iterator<ReceiverParameterDescriptor> it2 = this.contextReceiverParameters.iterator();
        while (it2.hasNext()) {
            ReceiverParameterDescriptor receiverParameterDescriptorSubstituteContextParameterDescriptor = substituteContextParameterDescriptor(typeSubstitutorSubstituteTypeParameters, propertyDescriptorImplCreateSubstitutedCopy, it2.next());
        ...
        if (copyConfiguration.copyOverrides) {
            ...
            Iterator<? extends PropertyDescriptor> it3 = getOverriddenDescriptors().iterator();
            while (it3.hasNext()) {
                smartSetCreate.add(it3.next().substitute(typeSubstitutorSubstituteTypeParameters));
            }
