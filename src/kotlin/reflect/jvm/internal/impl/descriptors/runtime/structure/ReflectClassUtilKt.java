    ...
    public static final String getDesc(Class<?> cls) {
        ...
        if (!cls.isPrimitive()) {
            if (cls.isArray()) {
                ...
                return StringsKt.replace$default(name, ClassUtils.PACKAGE_SEPARATOR_CHAR, '/', false, 4, (Object) null);
            }
            StringBuilder sb = new StringBuilder("L");
            String name2 = cls.getName();
            Intrinsics.checkNotNullExpressionValue(name2, "getName(...)");
            sb.append(StringsKt.replace$default(name2, ClassUtils.PACKAGE_SEPARATOR_CHAR, '/', false, 4, (Object) null));
            sb.append(';');
            return sb.toString();
        }
            ...
            switch (name3.hashCode()) {
                ...
                case 3052374:
                    if (name3.equals("char")) {
                        return WeatherCriteria.UNIT_CELSIUS;
                    }
                    break;
                case 3327612:
                ...
                case 97526364:
                    if (name3.equals(TypedValues.Custom.S_FLOAT)) {
                        return WeatherCriteria.UNIT_FARENHEIT;
                    }
                    break;
                case 109413500:
