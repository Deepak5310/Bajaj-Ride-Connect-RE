...
public final class CompositeAnnotations implements Annotations {
    ...
    public boolean hasAnnotation(FqName fqName) {
        ...
        Iterator it2 = CollectionsKt.asSequence(this.delegates).iterator();
        while (it2.hasNext()) {
    ...
    public static final AnnotationDescriptor findAnnotation$lambda$2(FqName fqName, Annotations it2) {
        Intrinsics.checkNotNullParameter(fqName, "$fqName");
        Intrinsics.checkNotNullParameter(it2, "it");
        return it2.mo3634findAnnotation(fqName);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.Annotations
    /* JADX INFO: renamed from: findAnnotation */
    public AnnotationDescriptor mo3634findAnnotation(final FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Sequence iterator$lambda$4(Annotations it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
