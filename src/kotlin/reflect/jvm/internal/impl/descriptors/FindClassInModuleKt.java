...
public final class FindClassInModuleKt {
    ...
    public static final int findNonGenericClassAcrossDependencies$lambda$1(ClassId it2) {
    ...
    public static final ClassifierDescriptor findClassifierAcrossModuleDependencies(ModuleDescriptor moduleDescriptor, ClassId classId) {
        ...
        if (resolutionAnchorIfAny == null) {
            ...
            contributedClassifier = memberScope.mo3641getContributedClassifier((Name) objFirst, NoLookupLocation.FROM_DESERIALIZATION);
            ...
            for (Name name : listPathSegments.subList(1, listPathSegments.size())) {
                ...
                ClassifierDescriptor contributedClassifier2 = unsubstitutedInnerClassesScope.mo3641getContributedClassifier(name, NoLookupLocation.FROM_DESERIALIZATION);
            ...
            ClassDescriptor contributedClassifier3 = memberScope2.mo3641getContributedClassifier((Name) objFirst2, NoLookupLocation.FROM_DESERIALIZATION);
            ...
            for (Name name2 : listPathSegments2.subList(1, listPathSegments2.size())) {
                if (contributedClassifier3 instanceof ClassDescriptor) {
                    ...
                    ClassifierDescriptor contributedClassifier4 = unsubstitutedInnerClassesScope2.mo3641getContributedClassifier(name2, NoLookupLocation.FROM_DESERIALIZATION);
            ...
            contributedClassifier = memberScope3.mo3641getContributedClassifier((Name) objFirst3, NoLookupLocation.FROM_DESERIALIZATION);
            if (contributedClassifier == null) {
                return null;
            }
            for (Name name3 : listPathSegments3.subList(1, listPathSegments3.size())) {
                ...
                ClassifierDescriptor contributedClassifier5 = unsubstitutedInnerClassesScope3.mo3641getContributedClassifier(name3, NoLookupLocation.FROM_DESERIALIZATION);
