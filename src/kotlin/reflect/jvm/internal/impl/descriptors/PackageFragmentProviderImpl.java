...
public final class PackageFragmentProviderImpl implements PackageFragmentProviderOptimized {
    ...
    public boolean isEmpty(FqName fqName) {
        ...
        while (it2.hasNext()) {
            if (Intrinsics.areEqual(((PackageFragmentDescriptor) it2.next()).getFqName(), fqName)) {
                return false;
            }
        }
        return true;
    ...
    public static final FqName getSubPackagesOf$lambda$3(PackageFragmentDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return it2.getFqName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean getSubPackagesOf$lambda$4(FqName fqName, FqName it2) {
        Intrinsics.checkNotNullParameter(fqName, "$fqName");
        Intrinsics.checkNotNullParameter(it2, "it");
        return !it2.isRoot() && Intrinsics.areEqual(it2.parent(), fqName);
    }
}
