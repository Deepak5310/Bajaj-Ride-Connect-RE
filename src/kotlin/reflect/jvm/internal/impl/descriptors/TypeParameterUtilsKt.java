...
public final class TypeParameterUtilsKt {
    public static final List<TypeParameterDescriptor> computeConstructorTypeParameters(ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        ...
        Iterator<DeclarationDescriptor> it2 = DescriptorUtilsKt.getParents(classifierDescriptorWithTypeParameters2).iterator();
        do {
            listEmptyList = null;
            if (!it2.hasNext()) {
                next = null;
    ...
    public static final boolean computeConstructorTypeParameters$lambda$0(DeclarationDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return it2 instanceof CallableDescriptor;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean computeConstructorTypeParameters$lambda$1(DeclarationDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return !(it2 instanceof ConstructorDescriptor);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Sequence computeConstructorTypeParameters$lambda$2(DeclarationDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
    ...
    public static final PossiblyInnerType buildPossiblyInnerType(KotlinType kotlinType) {
        ...
        return buildPossiblyInnerType(kotlinType, classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo3639getDeclarationDescriptor : null, 0);
    }
