...
public final class InlineClassManglingRulesKt {
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType, boolean z) {
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo3639getDeclarationDescriptor : null;
