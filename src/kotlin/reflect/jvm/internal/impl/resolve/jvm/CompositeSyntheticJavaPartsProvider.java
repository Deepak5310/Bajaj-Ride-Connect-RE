...
public final class CompositeSyntheticJavaPartsProvider implements SyntheticJavaPartsProvider {
    ...
    public List<Name> getMethodNames(ClassDescriptor thisDescriptor, LazyJavaResolverContext c) {
        ...
        while (it2.hasNext()) {
            CollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it2.next()).getMethodNames(thisDescriptor, c));
        }
        return arrayList;
    }
    ...
    public void generateMethods(ClassDescriptor thisDescriptor, Name name, Collection<SimpleFunctionDescriptor> result, LazyJavaResolverContext c) {
        ...
        while (it2.hasNext()) {
            ((SyntheticJavaPartsProvider) it2.next()).generateMethods(thisDescriptor, name, result, c);
        }
    }
    ...
    public List<Name> getStaticFunctionNames(ClassDescriptor thisDescriptor, LazyJavaResolverContext c) {
        ...
        Iterator<T> it2 = list.iterator();
        while (it2.hasNext()) {
            CollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it2.next()).getStaticFunctionNames(thisDescriptor, c));
        }
        return arrayList;
    }
    ...
    public void generateStaticFunctions(ClassDescriptor thisDescriptor, Name name, Collection<SimpleFunctionDescriptor> result, LazyJavaResolverContext c) {
        ...
        Iterator<T> it2 = this.inner.iterator();
        while (it2.hasNext()) {
            ((SyntheticJavaPartsProvider) it2.next()).generateStaticFunctions(thisDescriptor, name, result, c);
        }
    }
    ...
    public void generateConstructors(ClassDescriptor thisDescriptor, List<ClassConstructorDescriptor> result, LazyJavaResolverContext c) {
        ...
        Iterator<T> it2 = this.inner.iterator();
        while (it2.hasNext()) {
            ((SyntheticJavaPartsProvider) it2.next()).generateConstructors(thisDescriptor, result, c);
        }
    }
    ...
    public List<Name> getNestedClassNames(ClassDescriptor thisDescriptor, LazyJavaResolverContext c) {
        ...
        Iterator<T> it2 = list.iterator();
        while (it2.hasNext()) {
            CollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it2.next()).getNestedClassNames(thisDescriptor, c));
        }
        return arrayList;
    }
    ...
    public void generateNestedClass(ClassDescriptor thisDescriptor, Name name, List<ClassDescriptor> result, LazyJavaResolverContext c) {
        ...
        Iterator<T> it2 = this.inner.iterator();
        while (it2.hasNext()) {
            ((SyntheticJavaPartsProvider) it2.next()).generateNestedClass(thisDescriptor, name, result, c);
        }
    }
    ...
    public PropertyDescriptorImpl modifyField(ClassDescriptor thisDescriptor, PropertyDescriptorImpl propertyDescriptor, LazyJavaResolverContext c) {
        ...
        Iterator<T> it2 = this.inner.iterator();
        while (it2.hasNext()) {
            propertyDescriptor = ((SyntheticJavaPartsProvider) it2.next()).modifyField(thisDescriptor, propertyDescriptor, c);
        }
