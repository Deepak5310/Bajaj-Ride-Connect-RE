        ...
        while (true) {
            ...
            if (!linkedList2.isEmpty()) {
                ...
                if (collectionExtractMembersOverridableInBothWays.size() == 1 && smartSetCreate2.isEmpty()) {
                    ...
                    CallableDescriptor callableDescriptorInvoke = descriptorByHandle.invoke(animatorVar);
                    for (R.anim animVar : collectionExtractMembersOverridableInBothWays) {
                        Intrinsics.checkNotNull(animVar);
                        if (!OverridingUtil.isMoreSpecific(callableDescriptorInvoke, descriptorByHandle.invoke(animVar))) {
