...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    private final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo3640getSupertypes = this.containingClass.getTypeConstructor().mo3640getSupertypes();
        ...
        while (it2.hasNext()) {
            CollectionsKt.addAll(arrayList2, ResolutionScope.DefaultImpls.getContributedDescriptors$default(((KotlinType) it2.next()).getMemberScope(), null, null, 3, null));
        }
