...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo3641getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor classifierDescriptorMo3641getContributedClassifier = memberScope.mo3641getContributedClassifier(name, location);
            if (classifierDescriptorMo3641getContributedClassifier != null) {
                if (!(classifierDescriptorMo3641getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((MemberDescriptor) classifierDescriptorMo3641getContributedClassifier).isExpect()) {
                    return classifierDescriptorMo3641getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = classifierDescriptorMo3641getContributedClassifier;
                }
            }
        }
    ...
    public void mo3645recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo3645recordLookup(name, location);
        }
    }
