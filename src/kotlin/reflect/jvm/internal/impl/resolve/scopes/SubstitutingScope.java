...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo3645recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    private final <D extends DeclarationDescriptor> Collection<D> substitute(Collection<? extends D> collection) {
        ...
        while (it2.hasNext()) {
            linkedHashSetNewLinkedHashSetWithExpectedSize.add(substitute((DeclarationDescriptor) it2.next()));
        }
    ...
    public ClassifierDescriptor mo3641getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo3641getContributedClassifier(name, location);
