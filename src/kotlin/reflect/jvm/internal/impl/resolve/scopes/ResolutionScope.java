...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo3641getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo3645recordLookup(Name name, LookupLocation lookupLocation);
