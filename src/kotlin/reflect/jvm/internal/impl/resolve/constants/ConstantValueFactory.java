...
public final class ConstantValueFactory {
    ...
    private final ArrayValue createArrayValue(List<?> list, ModuleDescriptor moduleDescriptor, final PrimitiveType primitiveType) {
        ...
        while (it2.hasNext()) {
            ConstantValue constantValueCreateConstantValue$default = createConstantValue$default(this, it2.next(), null, 2, null);
    ...
    public static final KotlinType createArrayValue$lambda$0(PrimitiveType componentType, ModuleDescriptor it2) {
        Intrinsics.checkNotNullParameter(componentType, "$componentType");
        Intrinsics.checkNotNullParameter(it2, "it");
        SimpleType primitiveArrayKotlinType = it2.getBuiltIns().getPrimitiveArrayKotlinType(componentType);
        Intrinsics.checkNotNullExpressionValue(primitiveArrayKotlinType, "getPrimitiveArrayKotlinType(...)");
