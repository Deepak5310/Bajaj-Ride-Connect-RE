...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo3639getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo3639getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        if (classifierDescriptorMo3639getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo3639getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        return (classifierDescriptorMo3639getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo3639getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
