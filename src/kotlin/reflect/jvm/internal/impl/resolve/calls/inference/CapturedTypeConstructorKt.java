...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
            ...
            public TypeProjection mo3644get(KotlinType key) {
                Intrinsics.checkNotNullParameter(key, "key");
                TypeProjection typeProjectionMo3644get = super.mo3644get(key);
                if (typeProjectionMo3644get == null) {
                    return null;
                }
                ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = key.getConstructor().mo3639getDeclarationDescriptor();
                return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo3644get, classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo3639getDeclarationDescriptor : null);
            }
        };
    }
