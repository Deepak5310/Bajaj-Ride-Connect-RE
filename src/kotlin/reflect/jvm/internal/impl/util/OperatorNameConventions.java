...
public final class OperatorNameConventions {
    ...
    static {
        ...
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(nameIdentifier22, "++"), TuplesKt.to(nameIdentifier23, "--"), TuplesKt.to(nameIdentifier28, "+"), TuplesKt.to(nameIdentifier27, "-"), TuplesKt.to(nameIdentifier26, "!"), TuplesKt.to(nameIdentifier29, "*"), TuplesKt.to(nameIdentifier24, "+"), TuplesKt.to(nameIdentifier25, "-"), TuplesKt.to(nameIdentifier30, RemoteSettings.FORWARD_SLASH_STRING), TuplesKt.to(nameIdentifier32, "%"), TuplesKt.to(nameIdentifier33, ".."), TuplesKt.to(nameIdentifier34, "..<"));
    }
}
