...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        if (classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(classifierDescriptorMo3639getDeclarationDescriptor);
                return;
            }
            for (KotlinType kotlinType3 : ((TypeParameterDescriptor) classifierDescriptorMo3639getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNull(kotlinType3);
                extractTypeParametersFromUpperBounds(kotlinType3, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor2 = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo3639getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo3639getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo3639getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo3639getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean containsTypeAliasParameters$lambda$14(UnwrappedType it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = it2.getConstructor().mo3639getDeclarationDescriptor();
        if (classifierDescriptorMo3639getDeclarationDescriptor != null) {
            return isTypeAliasParameter(classifierDescriptorMo3639getDeclarationDescriptor);
        }
        return false;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean requiresTypeAliasExpansion$lambda$17(UnwrappedType it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = it2.getConstructor().mo3639getDeclarationDescriptor();
        if (classifierDescriptorMo3639getDeclarationDescriptor != null) {
            return (classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeAliasDescriptor) || (classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeParameterDescriptor);
        }
        return false;
    }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo3639getDeclarationDescriptor();
            ClassDescriptor classDescriptor = classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo3639getDeclarationDescriptor : null;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean shouldBeUpdated$lambda$24(UnwrappedType it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return (it2 instanceof StubTypeForBuilderInference) || (it2.getConstructor() instanceof TypeVariableTypeConstructorMarker) || KotlinTypeKt.isError(it2);
    }
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrappedTypeUnwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo3639getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo3639getDeclarationDescriptor() != null) {
            ...
            if (!simpleTypeReplace$default.getConstructor().getParameters().isEmpty() && simpleTypeReplace$default.getConstructor().mo3639getDeclarationDescriptor() != null) {
