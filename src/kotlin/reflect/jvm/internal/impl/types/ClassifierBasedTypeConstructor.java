...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo3639getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = mo3639getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo3639getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo3639getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = mo3639getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor2 = typeConstructor.mo3639getDeclarationDescriptor();
        if (classifierDescriptorMo3639getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo3639getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo3639getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo3639getDeclarationDescriptor2);
        }
        return false;
    }
