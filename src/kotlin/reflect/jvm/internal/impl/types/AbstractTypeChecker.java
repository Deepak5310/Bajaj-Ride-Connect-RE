...
public final class AbstractTypeChecker {
    ...
    private static final boolean checkSubtypeForIntegerLiteralType$lambda$7$isIntegerLiteralTypeInIntersectionComponents(TypeSystemContext typeSystemContext, SimpleTypeMarker simpleTypeMarker) {
        ...
        if (typeConstructorMarkerTypeConstructor instanceof IntersectionTypeConstructorMarker) {
            ...
            if (!(collectionSupertypes instanceof Collection) || !collectionSupertypes.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    SimpleTypeMarker simpleTypeMarkerAsSimpleType = typeSystemContext.asSimpleType((KotlinTypeMarker) it2.next());
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarkerPop)) {
                ...
                if (lowerIfFlexible == null) {
                    ...
                    Iterator<KotlinTypeMarker> it2 = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(simpleTypeMarkerPop)).iterator();
                    while (it2.hasNext()) {
                        SimpleTypeMarker simpleTypeMarkerMo3643transformType = lowerIfFlexible.mo3643transformType(typeCheckerState, it2.next());
                        if (typeSystemContext.isNothingConstructor(typeSystemContext.typeConstructor(simpleTypeMarkerMo3643transformType))) {
                            typeCheckerState.clear();
                            return true;
                        }
                        supertypesDeque.add(simpleTypeMarkerMo3643transformType);
                    }
                }
            }
        }
    ...
    public static final Unit isSubtypeOfForSingleClassifierType$lambda$21$lambda$20(Collection supertypesWithSameConstructor, final TypeCheckerState state, final TypeSystemContext this_with, final SimpleTypeMarker superType, TypeCheckerState.ForkPointContext runForkingPoint) {
        ...
        while (it2.hasNext()) {
            final SimpleTypeMarker simpleTypeMarker = (SimpleTypeMarker) it2.next();
            ...
            if (!typeSystemContext.isError(simpleTypeMarker4)) {
                ...
                if (typeSystemContext.isIntersection(typeConstructorMarkerTypeConstructor)) {
                    ...
                    if ((collectionSupertypes instanceof Collection) && collectionSupertypes.isEmpty()) {
                        ...
                        Iterator<T> it2 = collectionSupertypes.iterator();
                        while (it2.hasNext()) {
                            if (!isSubtypeOf$default(INSTANCE, typeCheckerState, simpleTypeMarker3, (KotlinTypeMarker) it2.next(), false, 8, null)) {
                            }
                        }
                        z = true;
                    }
                ...
                if (!(simpleTypeMarker instanceof CapturedTypeMarker)) {
                    if (typeSystemContext.isIntersection(typeConstructorMarkerTypeConstructor2)) {
                        ...
                        if ((collectionSupertypes2 instanceof Collection) && collectionSupertypes2.isEmpty()) {
                            ...
                            Iterator<T> it3 = collectionSupertypes2.iterator();
                            while (it3.hasNext()) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarkerPop)) {
                ...
                if (lowerIfFlexibleSubstitutionSupertypePolicy != null) {
                    ...
                    Iterator<KotlinTypeMarker> it2 = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(simpleTypeMarkerPop)).iterator();
                    while (it2.hasNext()) {
                        supertypesDeque.add(lowerIfFlexibleSubstitutionSupertypePolicy.mo3643transformType(typeCheckerState, it2.next()));
                    }
                }
            }
        }
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarkerPop)) {
                ...
                if (lowerIfFlexible != null) {
                    ...
                    Iterator<KotlinTypeMarker> it2 = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(simpleTypeMarkerPop)).iterator();
                    while (it2.hasNext()) {
                        supertypesDeque.add(lowerIfFlexible.mo3643transformType(state, it2.next()));
                    }
                }
            }
        }
