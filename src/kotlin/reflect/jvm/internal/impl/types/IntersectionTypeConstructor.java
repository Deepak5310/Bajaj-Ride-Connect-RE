...
public final class IntersectionTypeConstructor implements TypeConstructor, IntersectionTypeConstructorMarker {
    ...
    public static final String makeDebugNameForIntersectionType$lambda$1(KotlinType it2) {
    ...
    public IntersectionTypeConstructor refine(KotlinTypeRefiner kotlinTypeRefiner) {
        Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
        Collection<KotlinType> collectionMo3640getSupertypes = mo3640getSupertypes();
