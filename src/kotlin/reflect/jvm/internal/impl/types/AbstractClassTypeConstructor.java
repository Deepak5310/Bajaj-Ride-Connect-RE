...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    public abstract ClassDescriptor mo3639getDeclarationDescriptor();
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo3639getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    protected boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo3639getDeclarationDescriptor(), classifierDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo3639getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo3632getCompanionObjectDescriptor = classDescriptor.mo3632getCompanionObjectDescriptor();
        if (z && classDescriptorMo3632getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo3632getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    protected KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo3639getDeclarationDescriptor())) {
            return null;
        }
