...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public List<UnwrappedType> mo3640getSupertypes() {
    ...
    public static final List refine$lambda$6$lambda$5(NewCapturedTypeConstructor this$0, KotlinTypeRefiner kotlinTypeRefiner) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "$kotlinTypeRefiner");
        List<UnwrappedType> listMo3640getSupertypes = this$0.mo3640getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo3640getSupertypes, 10));
        Iterator<T> it2 = listMo3640getSupertypes.iterator();
        while (it2.hasNext()) {
