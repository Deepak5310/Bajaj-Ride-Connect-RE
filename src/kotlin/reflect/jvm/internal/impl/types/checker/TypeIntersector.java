    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo3640getSupertypes = simpleType.getConstructor().mo3640getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo3640getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo3640getSupertypes;
