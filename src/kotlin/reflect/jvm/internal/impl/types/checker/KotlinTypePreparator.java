    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo3640getSupertypes = capturedTypeConstructorImpl.mo3640getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo3640getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo3640getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo3640getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo3640getSupertypes2, 10));
            Iterator<T> it3 = collectionMo3640getSupertypes2.iterator();
            while (it3.hasNext()) {
        ...
        Collection<KotlinType> collectionMo3640getSupertypes3 = intersectionTypeConstructor.mo3640getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo3640getSupertypes3, 10));
        Iterator<T> it4 = collectionMo3640getSupertypes3.iterator();
        while (it4.hasNext()) {
            arrayList3.add(TypeUtilsKt.makeNullable((KotlinType) it4.next()));
            z = true;
        }
