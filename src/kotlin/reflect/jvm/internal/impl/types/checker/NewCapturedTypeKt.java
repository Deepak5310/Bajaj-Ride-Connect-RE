                ...
                if (((TypeProjection) it2.next()).getProjectionKind() != Variance.INVARIANT) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (typeProjection.getProjectionKind() != Variance.INVARIANT) {
                            ...
                            while (it3.hasNext()) {
                                arrayList3.add(KotlinTypePreparator.Default.INSTANCE.prepareType((KotlinTypeMarker) typeSubstitutorBuildSubstitutor.safeSubstitute((KotlinType) it3.next(), Variance.INVARIANT).unwrap()));
                            }
