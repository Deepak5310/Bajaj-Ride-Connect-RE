...
public final class ClassDeserializer {
    ...
    private final ClassDescriptor createClass(ClassKey classKey) {
        ...
        Iterator<ClassDescriptorFactory> it2 = this.components.getFictitiousClassDescriptorFactories().iterator();
        while (it2.hasNext()) {
            ClassDescriptor classDescriptorCreateClass = it2.next().createClass(classId);
        ...
        if (outerClassId != null) {
            ...
            Iterator<T> it3 = PackageFragmentProviderKt.packageFragments(this.components.getPackageFragmentProvider(), classId.getPackageFqName()).iterator();
            do {
                if (!it3.hasNext()) {
                    next = null;
                    break;
