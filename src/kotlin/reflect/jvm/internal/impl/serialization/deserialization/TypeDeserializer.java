...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo3639getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo3639getDeclarationDescriptor, list);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ProtoBuf.Type typeConstructor$notFoundClass$lambda$8(TypeDeserializer this$0, ProtoBuf.Type it2) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(it2, "it");
        return ProtoTypeTableUtilKt.outerType(it2, this$0.c.getTypeTable());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final int typeConstructor$notFoundClass$lambda$9(ProtoBuf.Type it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        FqName fqNameSafe = classifierDescriptorMo3639getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo3639getDeclarationDescriptor) : null;
