...
public final class SpecialBuiltinMembers {
    ...
    public static final boolean getOverriddenBuiltinWithDifferentJvmName$lambda$0(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return ClassicBuiltinSpecialProperties.INSTANCE.hasBuiltinSpecialPropertyFqName(DescriptorUtilsKt.getPropertyIfAccessor(it2));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean getOverriddenBuiltinWithDifferentJvmName$lambda$1(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean getOverriddenSpecialBuiltin$lambda$3(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
