...
public final class ClassicBuiltinSpecialProperties {
    ...
    public static final boolean getBuiltinSpecialPropertyGetterName$lambda$1(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return INSTANCE.hasBuiltinSpecialPropertyFqName(it2);
    }
