...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final LazyJavaClassMemberScope scopeHolder$lambda$3(LazyJavaClassDescriptor this$0, KotlinTypeRefiner it2) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            Iterator<JavaClassifierType> it2 = permittedTypes.iterator();
            while (it2.hasNext()) {
                ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType(it2.next(), attributes$default).getConstructor().mo3639getDeclarationDescriptor();
    ...
    final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (kotlinTypeEnhanceSuperType.getConstructor().mo3639getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo3639getDeclarationDescriptor = mo3639getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo3639getDeclarationDescriptor, arrayList5);
            }
        ...
        private final KotlinType getPurelyImplementedSupertype() {
            ...
            if (size2 == size) {
                ...
                while (it2.hasNext()) {
                    arrayList2.add(new TypeProjectionImpl(Variance.INVARIANT, ((TypeParameterDescriptor) it2.next()).getDefaultType()));
                }
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo3634findAnnotation = annotations.mo3634findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (annotationDescriptorMo3634findAnnotation == null) {
                return null;
            }
            Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo3634findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo3639getDeclarationDescriptor() {
