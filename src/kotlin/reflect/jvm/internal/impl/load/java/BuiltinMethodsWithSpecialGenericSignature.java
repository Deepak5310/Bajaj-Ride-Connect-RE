...
public final class BuiltinMethodsWithSpecialGenericSignature extends SpecialGenericSignatures {
    ...
    public static final boolean getOverriddenBuiltinFunctionWithErasedValueParametersInJava$lambda$0(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return INSTANCE.getHasErasedValueParametersInJava(it2);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean getSpecialSignatureInfo$lambda$3(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return (it2 instanceof FunctionDescriptor) && INSTANCE.getHasErasedValueParametersInJava(it2);
    }
}
