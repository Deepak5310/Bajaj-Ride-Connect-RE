...
public final class JvmPackageScope implements MemberScope {
    ...
    public static final MemberScope[] kotlinScopes_delegate$lambda$1(JvmPackageScope this$0) {
        ...
        while (it2.hasNext()) {
            MemberScope memberScopeCreateKotlinPackagePartScope = this$0.c.getComponents().getDeserializedDescriptorResolver().createKotlinPackagePartScope(this$0.packageFragment, (KotlinJvmBinaryClass) it2.next());
    ...
    public ClassifierDescriptor mo3641getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo3641getContributedClassifier = this.javaScope.mo3641getContributedClassifier(name, location);
        if (classDescriptorMo3641getContributedClassifier != null) {
            return classDescriptorMo3641getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo3641getContributedClassifier(name, location);
