...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    protected void mo3642reportSupertypeLoopError(KotlinType type) {
    ...
    private final List<KotlinType> computeNotEnhancedBounds() {
        ...
        while (it2.hasNext()) {
            arrayList.add(this.c.getTypeResolver().transformJavaType((JavaClassifierType) it2.next(), JavaTypeAttributesKt.toAttributes$default(TypeUsage.COMMON, false, false, this, 3, null)));
        }
        return arrayList;
    }
