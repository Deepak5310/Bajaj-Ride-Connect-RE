...
public abstract class AbstractSignatureParts<TAnnotation> {
    ...
    private final NullabilityQualifierWithMigrationStatus getBoundsNullability(TypeParameterMarker typeParameterMarker) {
        ...
        if (!z2 || !list2.isEmpty()) {
            ...
            while (it3.hasNext()) {
                if (!typeSystem.isError((KotlinTypeMarker) it3.next())) {
                    if (!z2 || !list2.isEmpty()) {
                        Iterator<T> it4 = list2.iterator();
                        while (true) {
                            if (it4.hasNext()) {
                                if (getNullabilityQualifier((KotlinTypeMarker) it4.next()) != null) {
                            ...
                            while (true) {
                                ...
                                if (!typeSystem.isNullableType((KotlinTypeMarker) it2.next())) {
                    ...
                    if (!z2 || !list2.isEmpty()) {
                        ...
                        while (it5.hasNext()) {
                            if (getEnhancedForWarnings((KotlinTypeMarker) it5.next()) != null) {
                                ArrayList arrayList2 = new ArrayList();
                                Iterator<T> it6 = list2.iterator();
                                while (it6.hasNext()) {
                                    KotlinTypeMarker enhancedForWarnings = getEnhancedForWarnings((KotlinTypeMarker) it6.next());
    ...
    public final Function1<Integer, JavaTypeQualifiers> computeIndexedQualifiers(KotlinTypeMarker kotlinTypeMarker, Iterable<? extends KotlinTypeMarker> overrides, final TypeEnhancementInfo typeEnhancementInfo, boolean z) {
        ...
        while (it2.hasNext()) {
            arrayList.add(toIndexed(it2.next()));
        }
        ...
        if (getForceOnlyHeadTypeConstructor()) {
            ...
            if (isCovariant() && (!(overrides instanceof Collection) || !((Collection) overrides).isEmpty())) {
                Iterator<? extends KotlinTypeMarker> it3 = overrides.iterator();
                while (true) {
                    if (it3.hasNext()) {
                        if (!isEqual(kotlinTypeMarker, it3.next())) {
                            size = 1;
                        }
                    }
                }
        ...
        while (i < size) {
            ...
            while (it4.hasNext()) {
                TypeAndDefaultQualifiers typeAndDefaultQualifiers = (TypeAndDefaultQualifiers) CollectionsKt.getOrNull((List) it4.next(), i);
    ...
    private final <T> void flattenTree(T t, List<T> list, Function1<? super T, ? extends Iterable<? extends T>> function1) {
        ...
        if (iterableInvoke != null) {
            Iterator<? extends T> it2 = iterableInvoke.iterator();
            while (it2.hasNext()) {
                flattenTree(it2.next(), list, function1);
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Iterable toIndexed$lambda$23$lambda$22(AbstractSignatureParts this$0, TypeSystemContext this_with, TypeAndDefaultQualifiers it2) {
        TypeConstructorMarker typeConstructorMarkerTypeConstructor;
        ...
        if (this$0.getSkipRawTypeArguments() && (type = it2.getType()) != null && this_with.isRawType(type)) {
            return null;
        }
        KotlinTypeMarker type2 = it2.getType();
        if (type2 != null && (typeConstructorMarkerTypeConstructor = this_with.typeConstructor(type2)) != null && (parameters = this_with.getParameters(typeConstructorMarkerTypeConstructor)) != null) {
            ...
            List<TypeArgumentMarker> arguments = this_with.getArguments(it2.getType());
            ...
            while (it3.hasNext() && it4.hasNext()) {
                ...
                if (this_with.isStarProjection(typeArgumentMarker)) {
                    typeAndDefaultQualifiers = new TypeAndDefaultQualifiers(null, it2.getDefaultQualifiers(), typeParameterMarker);
                } else {
                    KotlinTypeMarker type3 = this_with.getType(typeArgumentMarker);
                    typeAndDefaultQualifiers = new TypeAndDefaultQualifiers(type3, this$0.extractAndMergeDefaultQualifiers(type3, it2.getDefaultQualifiers()), typeParameterMarker);
                }
