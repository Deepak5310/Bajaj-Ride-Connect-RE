...
public final class TypeEnhancementUtilsKt {
    ...
    public static final JavaTypeQualifiers computeQualifiersForOverride(JavaTypeQualifiers javaTypeQualifiers, Collection<JavaTypeQualifiers> superQualifiers, boolean z, boolean z2, boolean z3) {
        ...
        while (it2.hasNext()) {
            NullabilityQualifier nullabilityForErrors = getNullabilityForErrors((JavaTypeQualifiers) it2.next());
        ...
        while (it4.hasNext()) {
            MutabilityQualifier mutability = ((JavaTypeQualifiers) it4.next()).getMutability();
            if (mutability != null) {
        ...
        if (nullabilityQualifier != NullabilityQualifier.NOT_NULL) {
            ...
            if (!javaTypeQualifiers.getDefinitelyNotNull()) {
                if (!collection.isEmpty()) {
                    ...
                    while (true) {
                        if (it5.hasNext()) {
                            if (((JavaTypeQualifiers) it5.next()).getDefinitelyNotNull()) {
                            }
                        }
                    }
                }
