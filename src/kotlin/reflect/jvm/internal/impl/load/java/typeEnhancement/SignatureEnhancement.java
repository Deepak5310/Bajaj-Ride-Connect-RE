...
public final class SignatureEnhancement {
    ...
    private final <D extends CallableMemberDescriptor> D enhanceSignature(D d, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        if (kotlinTypeEnhanceValueParameter == null && kotlinTypeEnhance$default == null) {
            ...
            if (!(arrayList4 instanceof Collection) || !arrayList4.isEmpty()) {
                ...
                } while (!(((KotlinType) it3.next()) != null));
            } else {
                z2 = false;
                break;
            }
    ...
    public static final KotlinType enhanceSignature$lambda$2(CallableMemberDescriptor it2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final KotlinType enhanceSignature$lambda$8$lambda$7(ValueParameterDescriptor valueParameterDescriptor, CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        KotlinType type = it2.getValueParameters().get(valueParameterDescriptor.getIndex()).getType();
        Intrinsics.checkNotNullExpressionValue(type, "getType(...)");
        return type;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final KotlinType enhanceSignature$lambda$9(CallableMemberDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean enhanceTypeParameterBounds$lambda$14$lambda$13(UnwrappedType it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
    ...
    public static final Boolean containsFunctionN$lambda$15(UnwrappedType unwrappedType) {
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = unwrappedType.getConstructor().mo3639getDeclarationDescriptor();
        boolean z = false;
        if (classifierDescriptorMo3639getDeclarationDescriptor == null) {
            return false;
        }
        if (Intrinsics.areEqual(classifierDescriptorMo3639getDeclarationDescriptor.getName(), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME().shortName()) && Intrinsics.areEqual(DescriptorUtilsKt.fqNameOrNull(classifierDescriptorMo3639getDeclarationDescriptor), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME())) {
            z = true;
        }
