...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = getConstructor().mo3639getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo3639getDeclarationDescriptor()).toString());
        }
    ...
    private static final List<String> render$renderArguments(DescriptorRenderer descriptorRenderer, KotlinType kotlinType) {
        ...
        while (it2.hasNext()) {
            arrayList.add(descriptorRenderer.renderTypeProjection((TypeProjection) it2.next()));
        }
        return arrayList;
    }
    ...
    public static final CharSequence render$lambda$2(String it2) {
