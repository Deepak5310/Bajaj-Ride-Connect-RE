            ...
            if (z) {
                ...
                if (bool.booleanValue() && (container instanceof ProtoContainer.Package)) {
                    ...
                    if (facadeClassName != null) {
                        ...
                        return KotlinClassFinderKt.findKotlinClass(kotlinClassFinder, companion.topLevel(new FqName(StringsKt.replace$default(internalName, '/', ClassUtils.PACKAGE_SEPARATOR_CHAR, false, 4, (Object) null))), jvmMetadataVersion);
                    }
                }
            }
