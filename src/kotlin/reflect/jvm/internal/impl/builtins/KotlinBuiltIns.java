...
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo3641getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (classifierDescriptorMo3639getDeclarationDescriptor == null || !UnsignedTypes.INSTANCE.isShortNameOfUnsignedArray(classifierDescriptorMo3639getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo3639getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = UnsignedTypes.INSTANCE.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        return (classifierDescriptorMo3639getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo3639getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo3639getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        return (classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo3639getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo3639getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    private static boolean isNotNullConstructedFromGivenClass(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(RCTMGLShapeSourceManager.METHOD_GET_CLUSTER_CHILDREN);
        }
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(107);
        }
    ...
    public static boolean isBoolean(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(PanasonicMakernoteDirectory.TAG_LANDMARK);
        }
    ...
    public static boolean isUShortArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(NikonType2MakernoteDirectory.TAG_ADAPTER);
        }
    ...
    public static boolean isULongArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(NikonType2MakernoteDirectory.TAG_LENS);
        }
    ...
    public static boolean isUnsignedArrayType(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(NikonType2MakernoteDirectory.TAG_MANUAL_FOCUS_DISTANCE);
        }
    ...
    private static boolean isConstructedFromGivenClassAndNotNullable(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(NikonType2MakernoteDirectory.TAG_FLASH_USED);
        }
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(136);
        }
    ...
    public static boolean isNothingOrNullableNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(NikonType2MakernoteDirectory.TAG_LENS_STOPS);
        }
