...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public Collection<SimpleFunctionDescriptor> getFunctions(final Name name, ClassDescriptor classDescriptor) {
        ...
        if (Intrinsics.areEqual(name, CloneableClassScope.Companion.getCLONE_NAME()) && (classDescriptor instanceof DeserializedClassDescriptor) && KotlinBuiltIns.isArrayOrPrimitiveArray(classDescriptor)) {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    if (Intrinsics.areEqual(NameResolverUtilKt.getName(deserializedClassDescriptor.getC().getNameResolver(), ((ProtoBuf.Function) it2.next()).getName()), CloneableClassScope.Companion.getCLONE_NAME())) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Collection getFunctions$lambda$5(Name name, MemberScope it2) {
        Intrinsics.checkNotNullParameter(name, "$name");
    ...
    public static final Iterable getJdkMethodStatus$lambda$16(JvmBuiltInsCustomizer this$0, ClassDescriptor classDescriptor) {
        ...
        while (it2.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = ((KotlinType) it2.next()).getConstructor().mo3639getDeclarationDescriptor();
            LazyJavaClassDescriptor lazyJavaClassDescriptor = null;
            ClassifierDescriptor original = classifierDescriptorMo3639getDeclarationDescriptor != null ? classifierDescriptorMo3639getDeclarationDescriptor.getOriginal() : null;
    ...
    public boolean isFunctionAvailable(ClassDescriptor classDescriptor, SimpleFunctionDescriptor functionDescriptor) {
        ...
        if (!(contributedFunctions instanceof Collection) || !contributedFunctions.isEmpty()) {
            ...
            while (it2.hasNext()) {
                if (Intrinsics.areEqual(MethodSignatureMappingKt.computeJvmDescriptor$default((SimpleFunctionDescriptor) it2.next(), false, false, 3, null), strComputeJvmDescriptor$default)) {
                    return true;
                }
            }
        }
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo3639getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo3639getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo3639getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
