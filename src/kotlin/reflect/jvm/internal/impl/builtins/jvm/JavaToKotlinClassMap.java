...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        NUMBERED_FUNCTION_PREFIX = FunctionTypeKind.Function.INSTANCE.getPackageFqName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + FunctionTypeKind.Function.INSTANCE.getClassNamePrefix();
        NUMBERED_K_FUNCTION_PREFIX = FunctionTypeKind.KFunction.INSTANCE.getPackageFqName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + FunctionTypeKind.KFunction.INSTANCE.getClassNamePrefix();
        NUMBERED_SUSPEND_FUNCTION_PREFIX = FunctionTypeKind.SuspendFunction.INSTANCE.getPackageFqName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + FunctionTypeKind.SuspendFunction.INSTANCE.getClassNamePrefix();
        NUMBERED_K_SUSPEND_FUNCTION_PREFIX = FunctionTypeKind.KSuspendFunction.INSTANCE.getPackageFqName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + FunctionTypeKind.KSuspendFunction.INSTANCE.getClassNamePrefix();
        ...
        Iterator<PlatformMutabilityMapping> it2 = listListOf.iterator();
        while (it2.hasNext()) {
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName((kSuspendFunction.getPackageFqName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + kSuspendFunction.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }
