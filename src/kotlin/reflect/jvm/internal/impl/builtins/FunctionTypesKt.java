...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo3639getDeclarationDescriptor != null) {
            return getFunctionTypeKind(classifierDescriptorMo3639getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = kotlinType.getConstructor().mo3639getDeclarationDescriptor();
        return classifierDescriptorMo3639getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo3639getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo3634findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo3634findAnnotation = kotlinType.getAnnotations().mo3634findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo3634findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo3634findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo3634findAnnotation = kotlinType.getAnnotations().mo3634findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo3634findAnnotation == null) {
            return null;
        }
