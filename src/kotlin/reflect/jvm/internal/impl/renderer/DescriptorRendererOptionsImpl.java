...
public final class DescriptorRendererOptionsImpl implements DescriptorRendererOptions {
    ...
    public static final KotlinType typeNormalizer_delegate$lambda$2(KotlinType it2) {
    ...
    public final DescriptorRendererOptionsImpl copy() {
        ...
        Iterator it2 = ArrayIteratorKt.iterator(getClass().getDeclaredFields());
        while (it2.hasNext()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final String defaultParameterValueRenderer_delegate$lambda$3(ValueParameterDescriptor it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return "...";
    }
