...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = typeConstructor.mo3639getDeclarationDescriptor();
        if ((classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeParameterDescriptor) || (classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassDescriptor) || (classifierDescriptorMo3639getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(classifierDescriptorMo3639getDeclarationDescriptor);
        }
        if (classifierDescriptorMo3639getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo3639getDeclarationDescriptor.getClass()).toString());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Object renderTypeConstructor$lambda$6(KotlinType it2) {
        Intrinsics.checkNotNullParameter(it2, "it");
        return it2 instanceof StubTypeForBuilderInference ? ((StubTypeForBuilderInference) it2).getOriginalTypeVariable() : it2;
    }
    ...
    private final void appendTypeProjections(StringBuilder sb, List<? extends TypeProjection> list) {
        CollectionsKt.joinTo(list, sb, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : ", ", (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$2
            private final DescriptorRendererImpl arg$0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final CharSequence appendTypeProjections$lambda$8(DescriptorRendererImpl this$0, TypeProjection it2) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(it2, "it");
        ...
        if (it2.getProjectionKind() != Variance.INVARIANT) {
            strRenderType = it2.getProjectionKind() + ' ' + strRenderType;
        }
    ...
    private final void renderFunctionType(StringBuilder sb, KotlinType kotlinType) {
        ...
        if (!contextReceiverTypesFromFunctionType.isEmpty()) {
            sb.append("context(");
            Iterator<KotlinType> it2 = contextReceiverTypesFromFunctionType.subList(0, CollectionsKt.getLastIndex(contextReceiverTypesFromFunctionType)).iterator();
            while (it2.hasNext()) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor = annotationClass.mo3633getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    private final String renderConstant(ConstantValue<?> constantValue) {
        ...
        while (it2.hasNext()) {
            String strRenderConstant = renderConstant((ConstantValue) it2.next());
    ...
    private final void renderAdditionalModifiers(FunctionDescriptor functionDescriptor, StringBuilder sb) {
        ...
        if (!collection2.isEmpty()) {
            ...
            while (it3.hasNext()) {
                if (((FunctionDescriptor) it3.next()).isInfix()) {
                    if (!getAlwaysRenderModifiers()) {
                        z2 = false;
                        break;
                    }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo3633getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor.getValueParameters();
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        ...
        sb.append(StringUtils.SPACE);
        CollectionsKt.joinTo(arrayList, sb, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : ", ", (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : null);
    }
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo3635getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo3635getCompileTimeInitializer = variableDescriptor.mo3635getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo3635getCompileTimeInitializer)) == null) {
            return;
        }
        sb.append(" = ");
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor = classDescriptor.mo3633getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(StringUtils.SPACE);
            renderAnnotations$default(this, sb, classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo3633getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo3640getSupertypes = classDescriptor.getTypeConstructor().mo3640getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo3640getSupertypes, "getSupertypes(...)");
        if (collectionMo3640getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo3640getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo3640getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(collectionMo3640getSupertypes, sb, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : ", ", (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$4
            private final DescriptorRendererImpl arg$0;
