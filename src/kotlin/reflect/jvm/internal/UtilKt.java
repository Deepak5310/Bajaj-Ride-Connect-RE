...
public final class UtilKt {
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i) {
        ...
        sb.append(StringsKt.replace$default(str2, ClassUtils.PACKAGE_SEPARATOR_CHAR, '$', false, 4, (Object) null));
        if (i > 0) {
            sb.append(";");
        }
    ...
    private static final List<Annotation> unwrapRepeatableAnnotations(List<? extends Annotation> list) throws IllegalAccessException, InvocationTargetException {
        ...
        while (it2.hasNext()) {
            if (Intrinsics.areEqual(JvmClassMappingKt.getJavaClass(JvmClassMappingKt.getAnnotationClass((Annotation) it2.next())).getSimpleName(), "Container")) {
                ArrayList arrayList = new ArrayList();
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo3639getDeclarationDescriptor();
    ...
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo3639getDeclarationDescriptor = type2.getConstructor().mo3639getDeclarationDescriptor();
                ClassDescriptor classDescriptor = classifierDescriptorMo3639getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo3639getDeclarationDescriptor : null;
                if (classDescriptor == null) {
            ...
            case 1:
                ...
                while (i < size4) {
                    ...
                    sArr[i] = ((Boolean) obj3).booleanValue();
                    i++;
                }
                return sArr;
            case 2:
                ...
                while (i < size5) {
                    ...
                    sArr[i] = ((Character) obj4).charValue();
                    i++;
                }
                return sArr;
            case 3:
            ...
            case 8:
                ...
                while (i < size11) {
                    ...
                    sArr[i] = ((Double) obj10).doubleValue();
                    i++;
                }
                return sArr;
        }
