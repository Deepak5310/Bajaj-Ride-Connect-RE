...
public abstract class KDeclarationContainerImpl implements ClassBasedDeclarationContainer {
            ...
            for (Object obj : functions) {
                ...
                if (constructorDescriptor.isPrimary()) {
                    ...
                    if (InlineClassesUtilsKt.isMultiFieldValueClass(containingDeclaration)) {
                        ...
                        sb.append(StringsKt.removeSuffix(strAsString2, (CharSequence) ExifInterface.GPS_MEASUREMENT_INTERRUPTED));
    ...
    private final Method lookupMethod(Class<?> cls, String str, Class<?>[] clsArr, Class<?> cls2, boolean z) {
        ...
        Iterator it2 = ArrayIteratorKt.iterator(cls.getInterfaces());
        while (it2.hasNext()) {
