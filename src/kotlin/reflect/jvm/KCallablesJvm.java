...
public final class KCallablesJvm {
    public static final boolean isAccessible(KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KMutableProperty) {
            ...
            Member memberMo3631getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo3631getMember();
            AccessibleObject accessibleObject = memberMo3631getMember instanceof AccessibleObject ? (AccessibleObject) memberMo3631getMember : null;
