...
public final class KCallables {
    ...
    /* JADX INFO: compiled from: KCallables.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    static final class C02801<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
    ...
    public static final <R> Object callSuspendBy(KCallable<? extends R> kCallable, Map<KParameter, ? extends Object> map, Continuation<? super R> continuation) throws Throwable {
        ...
        Object objCallDefaultMethod$kotlin_reflection = c02801.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02801.label;
        if (i == 0) {
            ...
            c02801.L$0 = kCallable;
            c02801.L$1 = map;
            c02801.L$2 = kCallableImplAsKCallableImpl;
            c02801.label = 1;
            C02801 c02802 = c02801;
            objCallDefaultMethod$kotlin_reflection = kCallableImplAsKCallableImpl.callDefaultMethod$kotlin_reflection(map, c02802);
            if (objCallDefaultMethod$kotlin_reflection == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(c02802);
            }
            ...
            kCallable = (KCallable) c02801.L$0;
            ResultKt.throwOnFailure(objCallDefaultMethod$kotlin_reflection);
        }
        KFunction kFunction = (KFunction) kCallable;
