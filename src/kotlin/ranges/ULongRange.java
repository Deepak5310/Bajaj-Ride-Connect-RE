...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public static /* synthetic */ void m3595getEndExclusivesVKNKU$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m3596containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m2490boximpl(m3597getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m2490boximpl(m3598getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m2490boximpl(m3599getStartsVKNKU());
    }
    ...
    public long m3599getStartsVKNKU() {
        return getFirst();
    }

    /* JADX INFO: renamed from: getEndInclusive-s-VKNKU, reason: not valid java name */
    public long m3598getEndInclusivesVKNKU() {
        return getLast();
    }

    /* JADX INFO: renamed from: getEndExclusive-s-VKNKU, reason: not valid java name */
    public long m3597getEndExclusivesVKNKU() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return ULong.m2496constructorimpl(getLast() + ULong.m2496constructorimpl(((long) 1) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m3596containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m2496constructorimpl(getFirst() ^ ULong.m2496constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m2496constructorimpl(getLast() ^ ULong.m2496constructorimpl(getLast() >>> 32)));
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m2542toStringimpl(getFirst())) + ".." + ((Object) ULong.m2542toStringimpl(getLast()));
    }
