...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m3530getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM2496constructorimpl = ((int) ULong.m2496constructorimpl(j ^ ULong.m2496constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM2496constructorimpl2 = (iM2496constructorimpl + ((int) ULong.m2496constructorimpl(j2 ^ ULong.m2496constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM2496constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m2542toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m2542toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m3593fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
