...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m2490boximpl(ULong.m2496constructorimpl(getMostSignificantBits())), ULong.m2490boximpl(ULong.m2496constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m3864fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid uuid, Uuid uuid2) {
        ...
        return j != uuid2.mostSignificantBits ? Long.compare(ULong.m2496constructorimpl(j) ^ Long.MIN_VALUE, ULong.m2496constructorimpl(uuid2.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m2496constructorimpl(uuid.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m2496constructorimpl(uuid2.leastSignificantBits) ^ Long.MIN_VALUE);
    }
}
