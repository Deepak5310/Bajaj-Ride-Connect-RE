...
public class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    public static final String replaceIndentByMargin(String str, String newIndent, String marginPrefix) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(length), (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : "\n", (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : null)).toString();
    ...
    public static final String replaceIndent(String str, String newIndent) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList4, new StringBuilder(length), (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : "\n", (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function2) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(i), (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : "\n", (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
}
