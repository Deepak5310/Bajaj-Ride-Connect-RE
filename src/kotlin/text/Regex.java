...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C03091(input, limit, null));
    }
    ...
    @DebugMetadata(c = "kotlin.text.Regex$splitToSequence$1", f = "Regex.kt", i = {1, 1, 1}, l = {275, 283, OlympusImageProcessingMakernoteDirectory.TagWbGLevel}, m = "invokeSuspend", n = {"$this$sequence", "matcher", "splitCount"}, s = {"L$0", "L$1", "I$0"})
    static final class C03091 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03091(CharSequence charSequence, int i, Continuation<? super C03091> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03091 c03091 = Regex.this.new C03091(this.$input, this.$limit, continuation);
            c03091.L$0 = obj;
            return c03091;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C03091) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
