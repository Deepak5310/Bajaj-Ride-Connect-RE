...
public final class UStringsKt {
    ...
    public static final String m3688toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m3690toStringolVBNx4(short s, int i) {
    ...
    public static final String m3689toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m3687toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m2417constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m2331boximpl(UByte.m2337constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m2417constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m2597boximpl(UShort.m2603constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM2417constructorimpl = UInt.m2417constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM2417constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM2417constructorimpl2 = UInt.m2417constructorimpl(i3 * iM2417constructorimpl);
            int iM2417constructorimpl3 = UInt.m2417constructorimpl(UInt.m2417constructorimpl(iDigitOf) + iM2417constructorimpl2);
            if (Integer.compare(iM2417constructorimpl3 ^ Integer.MIN_VALUE, iM2417constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM2417constructorimpl3;
        }
        return UInt.m2411boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM2496constructorimpl = ULong.m2496constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM2496constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM2496constructorimpl2 = ULong.m2496constructorimpl(j * jM2496constructorimpl);
            long jM2496constructorimpl3 = ULong.m2496constructorimpl(ULong.m2496constructorimpl(((long) UInt.m2417constructorimpl(iDigitOf)) & 4294967295L) + jM2496constructorimpl2);
            if (Long.compare(jM2496constructorimpl3 ^ Long.MIN_VALUE, jM2496constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM2496constructorimpl3;
        }
        return ULong.m2490boximpl(j);
    }
}
