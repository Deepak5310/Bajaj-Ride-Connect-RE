...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM3541m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3541m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM3541m);
            List<Path> list = CollectionsKt.toList(directoryStreamM3541m);
    ...
    static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i, Object obj) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM3541m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3541m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM3541m);
            Object objInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamM3541m));
    ...
    private static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM3541m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3541m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM3541m);
            T tInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamM3541m));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
    ...
    static /* synthetic */ void forEachDirectoryEntry$default(Path path, String glob, Function1 action, int i, Object obj) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM3541m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3541m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM3541m);
            Iterator it2 = directoryStreamM3541m.iterator();
            while (it2.hasNext()) {
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m4124m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        PathsKt.fileAttributeViewNotAvailable(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m$1());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        return (A) NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m4123m((Object) attributes);
    }
