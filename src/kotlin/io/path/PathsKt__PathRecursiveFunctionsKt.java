...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function4 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path3), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path4));
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            ...
            throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3550m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3567m$1();
        ...
        PathsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPreVisitDirectory(new Function2<Path, BasicFileAttributes, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.1
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path5, BasicFileAttributes basicFileAttributes) {
                        return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path5), NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m4123m((Object) basicFileAttributes));
                    }
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path8, IOException iOException) {
                        return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path8), iOException);
                    }
            ...
            /* synthetic */ class AnonymousClass2 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path), NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m4123m((Object) basicFileAttributes));
                }
            ...
            /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function2<Path, Exception, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, Exception exc) {
                    return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m((Object) path), exc);
                }
    ...
    public static final FileVisitResult copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(ArrayList<Path> arrayList, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function3, Path path, Path path2, Path path3, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function4, Path path4, BasicFileAttributes basicFileAttributes) {
        try {
            if (!arrayList.isEmpty()) {
                ...
                checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(path4, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m(CollectionsKt.last((List) arrayList)));
            }
    ...
    public static final void deleteRecursively(Path path) throws FileSystemException {
        ...
        while (it2.hasNext()) {
            ExceptionsKt.addSuppressed(fileSystemExceptionM, (Exception) it2.next());
        }
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) {
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    DirectoryStream directoryStreamM3541m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3541m((Object) directoryStream);
                    if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2(directoryStreamM3541m)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM3553m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3553m((Object) directoryStreamM3541m);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM3553m, fileName, null, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (secureDirectoryStreamNewDirectoryStream != null) {
            ...
            try {
                SecureDirectoryStream secureDirectoryStreamM3553m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3553m((Object) secureDirectoryStream2);
                Iterator it2 = secureDirectoryStreamM3553m.iterator();
                while (it2.hasNext()) {
                    Path fileName = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m(it2.next()).getFileName();
                    Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                    handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM3553m, fileName, exceptionsCollector.getPath(), exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3556m((Object) secureDirectoryStream.getFileAttributeView(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (directoryStreamNewDirectoryStream != null) {
            DirectoryStream directoryStream = directoryStreamNewDirectoryStream;
            try {
                Iterator it2 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3541m((Object) directoryStream).iterator();
                while (it2.hasNext()) {
                    Path pathM3551m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m3551m(it2.next());
                    Intrinsics.checkNotNull(pathM3551m);
                    insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(pathM3551m, path, exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
                CloseableKt.closeFinally(directoryStream, null);
            } catch (Throwable th) {
