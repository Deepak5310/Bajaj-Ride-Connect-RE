...
public class a {
    ...
    public Task<List<q>> b() {
        return Tasks.call(NotifeeCoreDatabase.b, new Callable() { // from class: app.notifee.core.database.a$$ExternalSyntheticLambda6
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.d();
            }
    ...
    public Task<List<q>> a(final Boolean bool) {
        return Tasks.call(NotifeeCoreDatabase.b, new Callable() { // from class: app.notifee.core.database.a$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
    ...
    public void a(final String str) {
        NotifeeCoreDatabase.b.execute(new Runnable() { // from class: app.notifee.core.database.a$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.c(str);
            }
