...
public class Notifee {
    ...
    public void cancelAllNotifications(int i, final MethodCallResult<Void> methodCallResult) {
        c.a(i).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda3
    ...
    public void cancelAllNotificationsWithIds(int i, List<String> list, String str, final MethodCallResult<Void> methodCallResult) {
        c.a(i, list, str).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda5
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void createChannel(Bundle bundle, final MethodCallResult<Void> methodCallResult) {
        a.a(new n.o.t.i.f.e.e.c(bundle)).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda12
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void createChannelGroup(Bundle bundle, final MethodCallResult<Void> methodCallResult) {
        a.a(new n.o.t.i.f.e.e.b(bundle)).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda15
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void createChannelGroups(List<Bundle> list, final MethodCallResult<Void> methodCallResult) {
        ...
        while (it2.hasNext()) {
            arrayList.add(new n.o.t.i.f.e.e.b(it2.next()));
        }
        a.a(arrayList).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda14
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void createChannels(List<Bundle> list, final MethodCallResult<Void> methodCallResult) {
        ...
        Iterator<Bundle> it2 = list.iterator();
        while (it2.hasNext()) {
            arrayList.add(new n.o.t.i.f.e.e.c(it2.next()));
        }
        a.b(arrayList).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda16
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void createTriggerNotification(Bundle bundle, Bundle bundle2, final MethodCallResult<Void> methodCallResult) {
        c.a(new NotificationModel(bundle), bundle2).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda7
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void displayNotification(Bundle bundle, final MethodCallResult<Void> methodCallResult) {
        c.b(new NotificationModel(bundle), (Bundle) null).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda11
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void getChannel(String str, final MethodCallResult<Bundle> methodCallResult) {
        a.a(str).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda9
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void getChannelGroups(final MethodCallResult<List<Bundle>> methodCallResult) {
        a.a().addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void getChannels(final MethodCallResult<List<Bundle>> methodCallResult) {
        a.b().addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda10
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void getDisplayedNotifications(final MethodCallResult<List<Bundle>> methodCallResult) {
        c.a().addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda8
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void isChannelBlocked(String str, final MethodCallResult<Boolean> methodCallResult) {
        a.c(str).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda13
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void isChannelCreated(String str, final MethodCallResult<Boolean> methodCallResult) {
        a.d(str).addOnCompleteListener(new OnCompleteListener() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda6
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
    ...
    public void openNotificationSettings(String str, Activity activity, MethodCallResult<Void> methodCallResult) {
        ...
        intent.setFlags(268435456);
        activity.runOnUiThread(new Runnable() { // from class: app.notifee.core.Notifee$$ExternalSyntheticLambda4
