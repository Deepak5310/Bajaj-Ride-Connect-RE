...
public class a {
    ...
    public a(Bundle bundle) {
        ...
        EnumC0016a enumC0016a = EnumC0016a.SET_EXACT;
        this.e = enumC0016a;
        this.f = null;
        this.g = null;
        this.a = bundle;
        ...
        if (!this.a.containsKey("alarmManager")) {
            if (this.a.containsKey("allowWhileIdle")) {
                this.d = Boolean.TRUE;
                this.e = EnumC0016a.SET_EXACT_AND_ALLOW_WHILE_IDLE;
                return;
            }
            return;
        }
        ...
        if (iA2 == 0) {
            this.e = EnumC0016a.SET;
            return;
        }
        if (iA2 == 1) {
            this.e = EnumC0016a.SET_AND_ALLOW_WHILE_IDLE;
            return;
        }
        if (iA2 == 3) {
            this.e = EnumC0016a.SET_EXACT_AND_ALLOW_WHILE_IDLE;
            ...
            this.e = EnumC0016a.SET_ALARM_CLOCK;
        }
    }
