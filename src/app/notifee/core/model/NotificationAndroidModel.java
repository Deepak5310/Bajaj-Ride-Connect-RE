...
public class NotificationAndroidModel {
    ...
    public ArrayList<NotificationAndroidActionModel> getActions() {
        ...
        while (it2.hasNext()) {
            arrayList2.add(NotificationAndroidActionModel.fromBundle((Bundle) it2.next()));
        }
        return arrayList2;
    }
    ...
    public String getCategory() {
        return this.mNotificationAndroidBundle.getString(SavingTrackHelper.POINT_COL_CATEGORY);
    }
    ...
    public Integer getDefaults(Boolean bool) {
        ...
        if (this.mNotificationAndroidBundle.containsKey(RemoteConfigComponent.DEFAULTS_FILE_NAME)) {
            numValueOf = null;
            for (Integer num : (ArrayList) Objects.requireNonNull(this.mNotificationAndroidBundle.getIntegerArrayList(RemoteConfigComponent.DEFAULTS_FILE_NAME))) {
    ...
    public a getProgress() {
        ...
        return new a(l.a(bundle.get("max")), l.a(bundle.get("current")), bundle.getBoolean("indeterminate", false));
    }
