...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM2319constructorimpl = Result.m2319constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM2319constructorimpl = Result.m2319constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m2325isFailureimpl(objM2319constructorimpl) ? null : objM2319constructorimpl);
