...
public final class TimeoutKt {
    ...
    public static final <T> Object m3877withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m3869toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m3878withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m3869toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM3870timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM3870timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m3870timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM3870timeoutMessageLRDsOJo == null) {
                strM3870timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM3870timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM3870timeoutMessageLRDsOJo, job);
    }
}
