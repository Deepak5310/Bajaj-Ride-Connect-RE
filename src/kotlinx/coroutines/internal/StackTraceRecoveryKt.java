...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM2319constructorimpl2;
        ...
        try {
            ...
            objM2319constructorimpl = Result.m2319constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m2322exceptionOrNullimpl(objM2319constructorimpl) == null) {
            obj2 = objM2319constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM2319constructorimpl2 = Result.m2319constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM2319constructorimpl2 = Result.m2319constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m2322exceptionOrNullimpl(objM2319constructorimpl2) == null) {
            obj = objM2319constructorimpl2;
        }
