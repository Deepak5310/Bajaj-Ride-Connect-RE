...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM2319constructorimpl = Result.m2319constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM2319constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM2319constructorimpl = Result.m2319constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM2319constructorimpl = Result.m2319constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m2325isFailureimpl(objM2319constructorimpl) ? null : objM2319constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM2319constructorimpl = Result.m2319constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM2319constructorimpl = Result.m2319constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m2325isFailureimpl(objM2319constructorimpl)) {
            objM2319constructorimpl = numValueOf;
        }
        return ((Number) objM2319constructorimpl).intValue();
    }
