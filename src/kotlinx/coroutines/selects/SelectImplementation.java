...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C03701 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03701(SelectImplementation<R> selectImplementation, Continuation<? super C03701> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C03701 c03701;
        if (continuation instanceof C03701) {
            c03701 = (C03701) continuation;
            if ((c03701.label & Integer.MIN_VALUE) != 0) {
                c03701.label -= Integer.MIN_VALUE;
            } else {
                c03701 = new C03701(this, continuation);
            }
        } else {
            c03701 = new C03701(this, continuation);
        }
        Object objInvokeBlock = c03701.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c03701.label;
        try {
            if (i == 0) {
                ...
                c03701.label = 1;
                objInvokeBlock = clauseData.invokeBlock(objProcessResult, c03701);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c03701 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c03701);
            }
            throw th;
        }
    }
