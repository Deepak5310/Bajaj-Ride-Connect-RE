...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", f = "Merge.kt", i = {}, l = {NikonType2MakernoteDirectory.TAG_UNKNOWN_50, NikonType2MakernoteDirectory.TAG_UNKNOWN_50}, m = "invokeSuspend", n = {}, s = {})
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", f = "Merge.kt", i = {}, l = {Mp4VideoDirectory.TAG_COLOR_TABLE, Mp4VideoDirectory.TAG_COLOR_TABLE}, m = "invokeSuspend", n = {}, s = {})
    static final class C03561<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03561(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C03561> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        @Override // kotlin.jvm.functions.Function3
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C03561 c03561 = new C03561(this.$transform, continuation);
            c03561.L$0 = flowCollector;
            c03561.L$1 = t;
            return c03561.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
            ...
            L48:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__MergeKt.C03561.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C03561(function2, null));
    }
