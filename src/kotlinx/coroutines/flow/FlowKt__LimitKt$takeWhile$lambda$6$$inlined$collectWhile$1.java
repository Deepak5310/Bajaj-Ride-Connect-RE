...
public final class FlowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$1", f = "Limit.kt", i = {0, 0, 1}, l = {131, NikonType2MakernoteDirectory.TAG_LENS}, m = "emit", n = {"this", "value", "this"}, s = {"L$0", "L$1", "L$0"})
