...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.CallbackFlowBuilder", f = "Builders.kt", i = {0}, l = {ExifDirectoryBase.TAG_SUB_IFD_OFFSET}, m = "collectTo", n = {AccountsQueryParameters.SCOPE}, s = {"L$0"})
