...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", f = "Builders.kt", i = {0}, l = {PanasonicMakernoteDirectory.TAG_LANDMARK}, m = "collect", n = {"$this$asFlow_u24lambda_u243"}, s = {"L$0"})
