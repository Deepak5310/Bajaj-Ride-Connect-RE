...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    static final class C03581<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {179}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C03593<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C03593(Continuation<? super C03593> continuation) {
            super(continuation);
        }
    ...
    static final class C03601<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C03611<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C03631<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C03651<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C03671<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C03691<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        if (continuation instanceof C03651) {
            c03651 = (C03651) continuation;
            if ((c03651.label & Integer.MIN_VALUE) != 0) {
                c03651.label -= Integer.MIN_VALUE;
            } else {
                c03651 = new C03651(continuation);
            }
        } else {
            c03651 = new C03651(continuation);
        }
        Object obj = c03651.result;
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c03662 = new C03662<>(objectRef2, function3);
            c03651.L$0 = objectRef2;
            c03651.label = 1;
            if (flow.collect(c03662, c03651) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c03651.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    static final class C03662<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C03662(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        C03601 c03601;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C03601) {
            c03601 = (C03601) continuation;
            if ((c03601.label & Integer.MIN_VALUE) != 0) {
                c03601.label -= Integer.MIN_VALUE;
            } else {
                c03601 = new C03601(continuation);
            }
        } else {
            c03601 = new C03601(continuation);
        }
        ...
        if (i == 0) {
            ...
            c03601.L$0 = objectRef2;
            c03601.label = 1;
            if (flow.collect(anonymousClass2, c03601) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c03601.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C03671) {
            ...
            if ((c03671.label & Integer.MIN_VALUE) != 0) {
                ...
                c03671 = new C03671(continuation);
            }
        } else {
            c03671 = new C03671(continuation);
        }
        ...
        if (i == 0) {
            ...
            c03671.L$0 = objectRef2;
            c03671.label = 1;
            if (flow.collect(flowCollector, c03671) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c03671.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C03691) {
            c03691 = (C03691) continuation;
            if ((c03691.label & Integer.MIN_VALUE) != 0) {
                c03691.label -= Integer.MIN_VALUE;
            } else {
                c03691 = new C03691(continuation);
            }
        } else {
            c03691 = new C03691(continuation);
        }
        ...
        if (i == 0) {
            ...
            try {
                c03691.L$0 = objectRef2;
                c03691.L$1 = flowCollector2;
                c03691.label = 1;
                if (flow.collect(flowCollector2, c03691) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c03691.L$1;
            objectRef = (Ref.ObjectRef) c03691.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<T> flowCollector;
        if (continuation instanceof C03581) {
            c03581 = (C03581) continuation;
            if ((c03581.label & Integer.MIN_VALUE) != 0) {
                c03581.label -= Integer.MIN_VALUE;
            } else {
                c03581 = new C03581(continuation);
            }
        } else {
            c03581 = new C03581(continuation);
        }
        ...
        if (i == 0) {
            ...
            try {
                c03581.L$0 = objectRef2;
                c03581.L$1 = flowCollector2;
                c03581.label = 1;
                if (flow.collect(flowCollector2, c03581) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c03581.L$1;
            objectRef = (Ref.ObjectRef) c03581.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C03593) {
            c03593 = (C03593) continuation;
            if ((c03593.label & Integer.MIN_VALUE) != 0) {
                c03593.label -= Integer.MIN_VALUE;
            } else {
                c03593 = new C03593(continuation);
            }
        } else {
            c03593 = new C03593(continuation);
        }
        Object obj = c03593.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c03593.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c03593.L$0 = objectRef2;
                c03593.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c03593.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c03593) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c03593.L$1;
            objectRef = (Ref.ObjectRef) c03593.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        C03611 c03611;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C03611) {
            c03611 = (C03611) continuation;
            if ((c03611.label & Integer.MIN_VALUE) != 0) {
                c03611.label -= Integer.MIN_VALUE;
            } else {
                c03611 = new C03611(continuation);
            }
        } else {
            c03611 = new C03611(continuation);
        }
        ...
        if (i == 0) {
            ...
            c03611.L$0 = objectRef2;
            c03611.label = 1;
            if (flow.collect(flowCollector, c03611) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c03611.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c03631.L$0 = objectRef2;
            c03631.label = 1;
            if (flow.collect(flowCollector, c03631) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c03631.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
