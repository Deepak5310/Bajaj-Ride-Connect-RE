...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2", f = "Combine.kt", i = {}, l = {PanasonicMakernoteDirectory.TAG_CLEAR_RETOUCH}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            static final class C01311 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ CompletableJob $collectJob;
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C01311(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, CompletableJob completableJob, Continuation<? super C01311> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C01311(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, this.$collectJob, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
                    return ((C01311) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Object invokeSuspend(Object obj) throws Throwable {
                    Object objMo3887receiveCatchingJP2dKIU;
                    ?? r1;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    int i = this.label;
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        objMo3887receiveCatchingJP2dKIU = this.$second.mo3887receiveCatchingJP2dKIU(this);
                        if (objMo3887receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i == 1) {
                            ResultKt.throwOnFailure(obj);
                            objMo3887receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                        } else if (i == 2) {
                    ...
                    if (objMo3887receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM3899exceptionOrNullimpl = ChannelResult.m3899exceptionOrNullimpl(objMo3887receiveCatchingJP2dKIU);
                        if (thM3899exceptionOrNullimpl == null) {
                            throw new AbortFlowException(completableJob);
                        }
                        throw thM3899exceptionOrNullimpl;
                    }
                    Object obj2 = this.$this_unsafeFlow;
                    Function3 function3 = this.$transform;
                    Object obj3 = this.$value;
                    if (objMo3887receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo3887receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = obj2;
                    this.label = 2;
                    obj = function3.invoke(obj3, objMo3887receiveCatchingJP2dKIU, this);
                    r1 = obj2;
            ...
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    C01311 c01311 = new C01311(this.$second, this.$this_unsafeFlow, this.$transform, t1, this.$collectJob, null);
                    combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                    if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c01311, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
