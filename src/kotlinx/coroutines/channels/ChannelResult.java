...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m3895boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m3896constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3897equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3898equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m3902hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m3897equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m3902hashCodeimpl(this.holder);
    }
    ...
    public static final boolean m3905isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m3904isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* JADX INFO: renamed from: isClosed-impl, reason: not valid java name */
    public static final boolean m3903isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m3900getOrNullimpl(Object obj) {
    ...
    public static final T m3901getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m3899exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m3910successJP2dKIU(E value) {
            return ChannelResult.m3896constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m3909failurePtdJZtk() {
            return ChannelResult.m3896constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m3908closedJP2dKIU(Throwable cause) {
            return ChannelResult.m3896constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m3906toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3906toStringimpl(Object obj) {
        if (obj instanceof Closed) {
