...
public interface SendChannel<E> {
    ...
    Object mo3880trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m3905isSuccessimpl(objMo3880trySendJP2dKIU)) {
                return true;
            }
            Throwable thM3899exceptionOrNullimpl = ChannelResult.m3899exceptionOrNullimpl(objMo3880trySendJP2dKIU);
