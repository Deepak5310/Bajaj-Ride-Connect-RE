...
public interface ReceiveChannel<E> {
    ...
    Object mo3887receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo3888tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo3888tryReceivePtdJZtk = receiveChannel.mo3888tryReceivePtdJZtk();
            if (ChannelResult.m3905isSuccessimpl(objMo3888tryReceivePtdJZtk)) {
                return (E) ChannelResult.m3901getOrThrowimpl(objMo3888tryReceivePtdJZtk);
            }
            Throwable thM3899exceptionOrNullimpl = ChannelResult.m3899exceptionOrNullimpl(objMo3888tryReceivePtdJZtk);
            if (thM3899exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM3899exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo3887receiveCatchingJP2dKIU = receiveChannel.mo3887receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m3900getOrNullimpl(objMo3887receiveCatchingJP2dKIU);
        }
