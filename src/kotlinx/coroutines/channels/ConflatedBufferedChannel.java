...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM3914trySendImplMj0NB7M = conflatedBufferedChannel.m3914trySendImplMj0NB7M(e, true);
        if (objM3914trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m3899exceptionOrNullimpl(objM3914trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM3914trySendImplMj0NB7M = conflatedBufferedChannel.m3914trySendImplMj0NB7M(e, true);
        if (!(objM3914trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo3880trySendJP2dKIU(E element) {
        return m3914trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m3914trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m3913trySendDropLatestMj0NB7M(element, isSendOp) : m3889trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m3913trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo3880trySendJP2dKIU = super.mo3880trySendJP2dKIU(element);
        if (ChannelResult.m3905isSuccessimpl(objMo3880trySendJP2dKIU) || ChannelResult.m3903isClosedimpl(objMo3880trySendJP2dKIU)) {
            return objMo3880trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo3880trySendJP2dKIU = mo3880trySendJP2dKIU(element);
        if (!(objMo3880trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo3880trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m3899exceptionOrNullimpl(objMo3880trySendJP2dKIU);
