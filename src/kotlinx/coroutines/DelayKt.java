...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo3947scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m3868delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m3869toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m3869toDelayMillisLRDsOJo(long j) {
        boolean zM3735isPositiveimpl = Duration.m3735isPositiveimpl(j);
        if (zM3735isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m3719getInWholeMillisecondsimpl(Duration.m3737plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM3735isPositiveimpl) {
