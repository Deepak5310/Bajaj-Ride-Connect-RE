...
public final class MutexKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.sync.MutexKt", f = "Mutex.kt", i = {0, 0, 0}, l = {PanasonicMakernoteDirectory.TAG_INTELLIGENT_D_RANGE}, m = "withLock", n = {"$this$withLock", "owner", "action"}, s = {"L$0", "L$1", "L$2"})
