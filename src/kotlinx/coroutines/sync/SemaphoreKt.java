...
public final class SemaphoreKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {PanasonicMakernoteDirectory.TAG_LENS_TYPE}, m = "withPermit", n = {"$this$withPermit", "action"}, s = {"L$0", "L$1"})
