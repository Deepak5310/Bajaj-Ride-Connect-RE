...
public class NumberPickerView extends View {
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (getOneRecycleSize() <= 1) {
            ...
            value = this.mCurrDrawFirstItemIndex + ((this.mShownCount - 1) / 2);
        } else {
            value = 0;
        }
        ...
        correctPositionByDefaultValue(value, z);
        updateFontAttr();
        updateNotWrapYLimit();
        updateDividerAttr();
        this.mHasInit = true;
    ...
    private void updateDividerAttr() {
        ...
        this.dividerY0 = (i2 * i4) / i;
        this.dividerY1 = (i3 * i4) / i;
        ...
        if (this.mDividerMarginL + this.mDividerMarginR != 0 && getPaddingLeft() + this.mDividerMarginL >= (this.mViewWidth - getPaddingRight()) - this.mDividerMarginR) {
            ...
            float f = i6;
            int i8 = (int) (i7 - ((i7 * f) / (i7 + i5)));
            this.mDividerMarginL = i8;
            this.mDividerMarginR = (int) (i5 - ((f * i5) / (i8 + i5)));
        }
    }
    ...
    private void drawContent(Canvas canvas) {
        ...
        while (i < this.mShownCount + 1) {
            ...
            if (i == i2 / 2) {
                int i3 = this.mItemHeight;
                f = (this.mCurrDrawFirstItemY + i3) / i3;
            ...
            if (indexByRawIndex >= 0 && indexByRawIndex < getOneRecycleSize()) {
                ...
                canvas.drawText(charSequenceEllipsize.toString(), this.mPaintText.getTextAlign() == Paint.Align.RIGHT ? this.mViewWidth - (this.mItemPaddingHorizontal * 2) : this.mItemPaddingHorizontal * 2, f3 + (this.mItemHeight / 2) + evaluateSize2, this.mPaintText);
