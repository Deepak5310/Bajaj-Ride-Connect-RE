...
final class DefaultMethodSupport {
    ...
    static Object invoke(Method method, Class<?> cls, Object obj, @Nullable Object[] objArr) throws Throwable {
        ...
        if (declaredConstructor == null) {
            declaredConstructor = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m$2().getDeclaredConstructor(Class.class, Integer.TYPE);
            declaredConstructor.setAccessible(true);
            lookupConstructor = declaredConstructor;
        }
        return NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m((Object) declaredConstructor.newInstance(cls, -1)).unreflectSpecial(method, cls).bindTo(obj).invokeWithArguments(objArr);
    }
