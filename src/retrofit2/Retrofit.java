...
public final class Retrofit {
    ...
    Retrofit(okhttp3.Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, int i, List<CallAdapter.Factory> list2, int i2, @Nullable Executor executor, boolean z) {
