    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (this.mRunning) {
                ...
                float f2 = i;
                float interpolation = INTERPOLATOR.getInterpolation((((jCurrentAnimationTimeMillis - j4) % 1000) / 10.0f) / 100.0f) * f2;
                this.mClipRect.set(f2 - interpolation, 0.0f, f2 + interpolation, iHeight);
