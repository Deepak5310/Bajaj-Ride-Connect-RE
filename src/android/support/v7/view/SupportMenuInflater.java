...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (typedArrayObtainStyledAttributes.getInt(R.styleable.MenuItem_android_menuCategory, this.groupCategory) & androidx.core.internal.view.SupportMenu.CATEGORY_MASK) | (typedArrayObtainStyledAttributes.getInt(R.styleable.MenuItem_android_orderInCategory, this.groupOrder) & 65535);
