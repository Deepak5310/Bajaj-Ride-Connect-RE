...
public class ActionMenuItem implements SupportMenuItem {
    ...
    public SupportMenuItem m1setActionView(View view) {
    ...
    /* JADX INFO: renamed from: setActionView, reason: merged with bridge method [inline-methods] */
    public SupportMenuItem m0setActionView(int i) {
        throw new UnsupportedOperationException();
    }
    ...
    public SupportMenuItem m3setShowAsActionFlags(int i) {
        setShowAsAction(i);
        return this;
    }
    ...
    public SupportMenuItem m2setContentDescription(CharSequence charSequence) {
