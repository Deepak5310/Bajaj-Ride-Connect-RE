...
public class MenuBuilder implements SupportMenu {
    ...
    /* JADX WARN: Type inference failed for: r9v1, types: [android.support.v7.view.menu.MenuItemImpl, android.view.MenuItem, java.lang.Object] */
    protected MenuItem addInternal(int i, int i2, int i3, CharSequence charSequence) {
        int ordering = getOrdering(i3);
        ?? CreateNewMenuItem = createNewMenuItem(i, i2, i3, ordering, charSequence, this.mDefaultShowAsAction);
        ContextMenu.ContextMenuInfo contextMenuInfo = this.mCurrentMenuInfo;
        if (contextMenuInfo != null) {
            CreateNewMenuItem.setMenuInfo(contextMenuInfo);
        }
        ArrayList<MenuItemImpl> arrayList = this.mItems;
        arrayList.add(findInsertIndex(arrayList, ordering), (MenuItemImpl) CreateNewMenuItem);
        onItemsChanged(true);
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [android.support.v7.view.menu.MenuItemImpl, android.view.MenuItem] */
    ...
    public boolean performShortcut(int i, KeyEvent keyEvent, int i2) {
        SupportMenuItem supportMenuItemFindItemWithShortcutForKey = findItemWithShortcutForKey(i, keyEvent);
        boolean zPerformItemAction = supportMenuItemFindItemWithShortcutForKey != null ? performItemAction(supportMenuItemFindItemWithShortcutForKey, i2) : false;
        if ((i2 & 2) != 0) {
            close(true);
        }
