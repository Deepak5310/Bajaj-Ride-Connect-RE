...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX INFO: renamed from: android.support.v7.app.AppCompatDelegateImplV9$3, reason: invalid class name */
    ...
    public ActionMode startSupportActionMode(ActionMode.Callback callback) {
        ...
        if (supportActionBar != null) {
            ...
            if (actionModeStartActionMode != null && this.mAppCompatCallback != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        viewPropertyAnimatorCompatAlpha.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.app.AppCompatDelegateImplV9.6
                            public void onAnimationStart(View view) {
                                AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r4v3, types: [android.view.Window$Callback] */
    ...
    /* JADX WARN: Type inference failed for: r5v2, types: [android.support.v7.view.menu.MenuBuilder] */
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            ...
            PanelFeatureState panelFeatureStateFindMenuPanel = appCompatDelegateImplV9.findMenuPanel(supportMenu);
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            if (menuBuilder != 0 || !AppCompatDelegateImplV9.this.mHasActionBar || (windowCallback = AppCompatDelegateImplV9.this.getWindowCallback()) == null || AppCompatDelegateImplV9.this.isDestroyed()) {
                return true;
            }
