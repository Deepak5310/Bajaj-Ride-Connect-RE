...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (dispatchNestedScroll(iScrollHorizontallyBy, iScrollVerticallyBy, i3, i4, this.mScrollOffset, 0)) {
            ...
            int i6 = iArr[0];
            this.mLastTouchX = i5 - i6;
            int i7 = this.mLastTouchY;
            int i8 = iArr[1];
            this.mLastTouchY = i7 - i8;
            if (motionEvent != null) {
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? NikonType2MakernoteDirectory.TAG_ADAPTER : 33;
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (!RecyclerView.this.dispatchNestedScroll(iScrollHorizontallyBy, iScrollVerticallyBy, i, i2, null, 1) && (i != 0 || i2 != 0)) {
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Code duplicated, block: B:106:0x0225 A[ADDED_TO_REGION] */
        ...
        /* JADX WARN: Code duplicated, block: B:73:0x017c A[PHI: r1 r4
          0x017c: PHI (r1v12 android.support.v7.widget.RecyclerView$ViewHolder) = (r1v11 android.support.v7.widget.RecyclerView$ViewHolder), (r1v31 android.support.v7.widget.RecyclerView$ViewHolder) binds: [B:28:0x005d, B:59:0x00fc] A[DONT_GENERATE, DONT_INLINE]
          0x017c: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:59:0x00fc] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static abstract class LayoutManager {
        ...
        /* JADX WARN: Code duplicated, block: B:24:0x006f A[PHI: r2
