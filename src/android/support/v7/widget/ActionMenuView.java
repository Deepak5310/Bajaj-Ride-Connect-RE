...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (true) {
            ...
            while (i26 < childCount) {
                ...
                if ((j2 & j3) == 0) {
                    ...
                    if (z4 && layoutParams3.preventEdgeOffset && i10 == 1) {
        ...
        int i32 = iMax2;
        boolean z6 = !z2 && i31 == 1;
        if (i10 <= 0 || j == 0 || (i10 >= i31 - 1 && !z6 && i32 <= 1)) {
            i6 = 0;
            z = z5;
        } else {
            ...
            int i34 = fBitCount > 0.0f ? (int) ((i10 * i12) / fBitCount) : i6;
            z = z5;
        ...
        if (z) {
            ...
            while (i36 < childCount) {
                ...
                if (layoutParams5.expanded) {
                    i7 = childMeasureSpec;
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i12) + layoutParams5.extraPixels, 1073741824), i7);
                } else {
                    i7 = childMeasureSpec;
                }
                i36++;
