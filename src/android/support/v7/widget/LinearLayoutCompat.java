...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.mOrientation == 1 && (i = this.mGravity & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) != 48) {
            if (i == 16) {
                ...
                if (virtualChildAt.getVisibility() == 8) {
                    ...
                    if (mode != i13 || layoutParams.width != 0 || layoutParams.weight <= 0.0f) {
                        ...
                        if (z2 && (baseline2 = view.getBaseline()) != -1) {
                            ...
                            int i17 = (((i12 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) >> 4) & (-2)) >> 1;
                    ...
                    if (z2) {
                        ...
                        int i110 = (((i12 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) >> 4) & (-2)) >> 1;
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (z9) {
                        ...
                        if (z11 && (baseline = virtualChildAt3.getBaseline()) != i5) {
                            ...
                            int i37 = (((i6 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) >> 4) & (-2)) >> 1;
                    ...
                    if (z11) {
                        ...
                        int i38 = (((i6 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) >> 4) & (-2)) >> 1;
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        int i11 = i10 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
        ...
        while (childrenSkipCount < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() != 8) {
                    ...
                    int absoluteGravity = android.support.v4.view.GravityCompat.getAbsoluteGravity(i13, android.support.v4.view.ViewCompat.getLayoutDirection(this)) & 7;
    ...
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int absoluteGravity = android.support.v4.view.GravityCompat.getAbsoluteGravity(8388615 & i10, android.support.v4.view.ViewCompat.getLayoutDirection(this));
        boolean z3 = true;
        if (absoluteGravity == 1) {
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() != 8) {
                    ...
                    if (z2) {
                        ...
                        i8 = i7 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
                        i11 = i11;
                        if (i8 != 16) {
                            if (i8 != 48) {
