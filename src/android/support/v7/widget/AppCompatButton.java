...
public class AppCompatButton extends Button implements TintableBackgroundView, AutoSizeableTextView {
    ...
    public AppCompatButton(Context context, AttributeSet attributeSet, int i) {
        ...
        AppCompatTextHelper appCompatTextHelperCreate = AppCompatTextHelper.create(this);
        this.mTextHelper = appCompatTextHelperCreate;
        appCompatTextHelperCreate.loadFromAttributes(attributeSet, i);
        appCompatTextHelperCreate.applyCompoundDrawablesTints();
    }
