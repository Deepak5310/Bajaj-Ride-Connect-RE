...
public class Toolbar extends ViewGroup {
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
            layoutParamsGenerateDefaultLayoutParams.gravity = (this.mButtonGravity & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) | 8388611;
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        ActionMenuView actionMenuView = this.mMenuView;
        SupportMenu supportMenuPeekMenu = actionMenuView != null ? actionMenuView.peekMenu() : null;
        if (savedState.expandedMenuItemId != 0 && this.mExpandedMenuPresenter != null && supportMenuPeekMenu != null && (menuItemFindItem = supportMenuPeekMenu.findItem(savedState.expandedMenuItemId)) != null) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (!zShouldLayout || zShouldLayout2) {
                ...
                i5 = this.mGravity & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
                i6 = paddingLeft;
                if (i5 == 48) {
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
    }

    private void addCustomViewsWithGravity(List<View> list, int i) {
        boolean z = ViewCompat.getLayoutDirection(this) == 1;
        int childCount = getChildCount();
        int absoluteGravity = android.support.v4.view.GravityCompat.getAbsoluteGravity(i, ViewCompat.getLayoutDirection(this));
        list.clear();
        if (!z) {
    ...
    private int getChildHorizontalGravity(int i) {
        ...
        int absoluteGravity = android.support.v4.view.GravityCompat.getAbsoluteGravity(i, layoutDirection) & 7;
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar2) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = (Toolbar.this.mButtonGravity & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) | 8388611;
                layoutParamsGenerateDefaultLayoutParams.mViewType = 2;
