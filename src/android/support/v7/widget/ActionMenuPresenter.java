    ...
    public boolean flagActionItems() {
        ...
        while (i9 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = r1.getItemView(menuItemImpl2, r1.mScrapActionButtonView, viewGroup);
                if (r1.mScrapActionButtonView == null) {
                    r1.mScrapActionButtonView = itemView;
                }
                ...
                boolean z4 = z3;
                if (z3) {
                    View itemView2 = r1.getItemView(menuItemImpl2, r1.mScrapActionButtonView, viewGroup);
                    if (r1.mScrapActionButtonView == null) {
                        r1.mScrapActionButtonView = itemView2;
                    }
                    if (r1.mStrictWidthLimit) {
