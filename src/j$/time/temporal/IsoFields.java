...
public abstract class IsoFields {
    ...
    private static abstract class Field implements TemporalField {
        ...
        static {
            ...
            QUARTER_DAYS = new int[]{0, 90, NikonType2MakernoteDirectory.TAG_UNKNOWN_48, 273, 0, 91, 182, 274};
        }
    ...
    private enum Unit implements TemporalUnit {
        ...
        public Temporal addTo(Temporal temporal, long j) {
            ...
            if (i == 1) {
                ...
                return temporal.with(temporalField, Math.addExact(temporal.get(temporalField), j));
            }
            if (i == 2) {
