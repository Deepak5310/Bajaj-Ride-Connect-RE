...
public final class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime, Serializable {
    ...
    public static LocalDateTime ofEpochSecond(long j, int i, ZoneOffset zoneOffset) {
        ...
        return new LocalDateTime(LocalDate.ofEpochDay(Math.floorDiv(totalSeconds, (long) DateTimeConstants.SECONDS_PER_DAY)), LocalTime.ofNanoOfDay((((long) DesugarLocalTime$$ExternalSyntheticBackport0.m(totalSeconds, DateTimeConstants.SECONDS_PER_DAY)) * 1000000000) + j2));
    }
            ...
            if (temporalUnit.isTimeBased()) {
                ...
                switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        jMultiplyExact = Math.multiplyExact(jMultiplyExact, DateUtils.MILLIS_PER_DAY);
                        j /= 1000000;
                        break;
                    case 4:
                        jMultiplyExact = Math.multiplyExact(jMultiplyExact, (long) DateTimeConstants.SECONDS_PER_DAY);
                        j /= 1000000000;
                        break;
                    case 5:
                        jMultiplyExact = Math.multiplyExact(jMultiplyExact, (long) DateTimeConstants.MINUTES_PER_DAY);
                        j /= 60000000000L;
                        break;
                    case 6:
