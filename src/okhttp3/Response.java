...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = LoginActivity.REQUEST_KEY, imports = {}))
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = AccountsQueryParameters.CODE, imports = {}))
    ...
    public final CacheControl m4080deprecated_cacheControl() {
        return cacheControl();
    }
