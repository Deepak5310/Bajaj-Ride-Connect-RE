...
public final class CipherSuite {
    ...
    static {
        ...
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", RCTMGLShapeSourceManager.METHOD_GET_CLUSTER_CHILDREN);
        ...
        TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", NikonType2MakernoteDirectory.TAG_LENS);
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", NikonType2MakernoteDirectory.TAG_FLASH_USED);
        ...
        TLS_PSK_WITH_3DES_EDE_CBC_SHA = companion.init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", NikonType2MakernoteDirectory.TAG_LENS_STOPS);
        ...
        TLS_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_RSA_WITH_AES_128_GCM_SHA256", NikonType2MakernoteDirectory.TAG_SCENE_ASSIST);
        ...
        TLS_DH_anon_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DH_anon_WITH_AES_128_GCM_SHA256", NikonType2MakernoteDirectory.TAG_DELETED_IMAGE_COUNT);
        TLS_DH_anon_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", NikonType2MakernoteDirectory.TAG_EXPOSURE_SEQUENCE_NUMBER);
