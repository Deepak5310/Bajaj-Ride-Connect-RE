...
public class Peripheral extends BluetoothGattCallback {
    ...
    private void sendConnectionEvent(BluetoothDevice bluetoothDevice, String str, int i) {
        ...
        sendEvent(str, writableMapCreateMap);
        Log.d(BleManager.LOG_TAG, "Peripheral event (" + str + "):" + bluetoothDevice.getAddress());
    }

    private static List<Callback> drainCallbacks(LinkedList<Callback> linkedList) {
        ArrayList arrayList = new ArrayList(linkedList);
        linkedList.clear();
        return arrayList;
    }

    private static void invokeDrained(LinkedList<Callback> linkedList, Object... objArr) {
        Iterator<Callback> it2 = drainCallbacks(linkedList).iterator();
        while (it2.hasNext()) {
            it2.next().invoke(objArr);
        }
    }
    ...
    public /* synthetic */ void lambda$connect$0(Callback callback, ReadableMap readableMap, Activity activity) {
        if (!this.connected) {
            ...
            if (!z && readableMap.hasKey("phy") && Build.VERSION.SDK_INT >= 26) {
    ...
    public /* synthetic */ void lambda$disconnect$1(boolean z, Callback callback) {
        invokeDrained(this.connectCallbacks, "Disconnect called before connect callback invoked");
        this.connected = false;
        clearBuffers();
    ...
    public WritableMap asWritableMap(BluetoothGatt bluetoothGatt) {
        ...
        if (this.connected && bluetoothGatt != null) {
            ...
            while (it2.hasNext()) {
                ...
                WritableMap writableMapCreateMap = Arguments.createMap();
                writableMapCreateMap.putString("uuid", UUIDHelper.uuidToString(next.getUuid()));
                for (BluetoothGattCharacteristic bluetoothGattCharacteristic : next.getCharacteristics()) {
                    ...
                    for (BluetoothGattDescriptor bluetoothGattDescriptor : bluetoothGattCharacteristic.getDescriptors()) {
                        ...
                        writableMapCreateMap3.putString("uuid", UUIDHelper.uuidToString(bluetoothGattDescriptor.getUuid()));
    ...
    public void onServicesDiscovered(final BluetoothGatt bluetoothGatt, int i) {
        ...
        this.mainHandler.post(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onServicesDiscovered$2(bluetoothGatt);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$onServicesDiscovered$2(BluetoothGatt bluetoothGatt) {
        ...
        while (it2.hasNext()) {
            it2.next().invoke(null, asWritableMap(bluetoothGatt));
        }
    ...
    public /* synthetic */ void lambda$onConnectionStateChange$3(BluetoothGatt bluetoothGatt, int i, int i2) {
        ...
        if (i2 == 2 && i == 0) {
            ...
            invokeDrained(this.connectCallbacks, new Object[0]);
            return;
        }
        if (i2 == 0 || i != 0) {
            ...
            invokeDrained(this.writeCallbacks, "Device disconnected");
            invokeDrained(this.retrieveServicesCallbacks, "Device disconnected");
            invokeDrained(this.readRSSICallbacks, "Device disconnected");
            invokeDrained(this.registerNotifyCallbacks, "Device disconnected");
            invokeDrained(this.requestMTUCallbacks, "Device disconnected");
            invokeDrained(this.readCallbacks, "Device disconnected");
            invokeDrained(this.readDescriptorCallbacks, "Device disconnected");
            invokeDrained(this.writeDescriptorCallbacks, "Device disconnected");
            invokeDrained(this.connectCallbacks, "Connection error");
    ...
    public void onCharacteristicChanged(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, byte[] bArr) {
        ...
        try {
            ...
            while (bArr != null) {
                ...
                sendEvent("BleManagerDidUpdateValueForCharacteristic", writableMapCreateMap);
                bArr = bArr2;
            }
        } catch (Exception e) {
    ...
    public void onCharacteristicWrite(BluetoothGatt bluetoothGatt, final BluetoothGattCharacteristic bluetoothGattCharacteristic, final int i) {
        ...
        this.mainHandler.post(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onDescriptorRead(BluetoothGatt bluetoothGatt, final BluetoothGattDescriptor bluetoothGattDescriptor, final int i) {
        ...
        this.mainHandler.post(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void registerNotify(final UUID uuid, final UUID uuid2, final Integer num, final Callback callback) {
        if (enqueue(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void readDescriptor(final UUID uuid, final UUID uuid2, final UUID uuid3, final Callback callback) {
        enqueue(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void writeDescriptor(final UUID uuid, final UUID uuid2, final UUID uuid3, final byte[] bArr, final Callback callback) {
        enqueue(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void refreshCache(final Callback callback) {
        enqueue(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$refreshCache$15(Callback callback) {
        try {
            try {
                Boolean bool = (Boolean) this.gatt.getClass().getMethod("refresh", null).invoke(this.gatt, null);
                bool.booleanValue();
    ...
    public boolean doWrite(final BluetoothGattCharacteristic bluetoothGattCharacteristic, byte[] bArr, final Callback callback) {
        ...
        return enqueue(new Runnable() { // from class: it.innove.Peripheral.3
            ...
            public void run() {
                ...
                for (Callback callback2 : Peripheral.this.writeCallbacks) {
    ...
    public void requestMTU(final int i, final Callback callback) {
        enqueue(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onMtuChanged(BluetoothGatt bluetoothGatt, final int i, final int i2) {
        ...
        this.mainHandler.post(new Runnable() { // from class: it.innove.Peripheral$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
