...
public class Validate {
    ...
    public static void isInstanceOf(Class<?> cls, Object obj) {
        if (cls.isInstance(obj)) {
            ...
            throw new IllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, cls.getName(), obj == null ? BuildConfig.TRAVIS : obj.getClass().getName()));
        }
    }
    ...
    public static void isAssignableFrom(Class<?> cls, Class<?> cls2) {
        if (cls.isAssignableFrom(cls2)) {
            ...
            throw new IllegalArgumentException(String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, cls2 == null ? BuildConfig.TRAVIS : cls2.getName(), cls.getName()));
        }
    }
