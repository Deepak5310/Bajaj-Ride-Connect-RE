...
public class Observable<T> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <R> Observable<R> flatMap(Func1<? super T, ? extends Observable<? extends R>> func1, Func1<? super Throwable, ? extends Observable<? extends R>> func2, Func0<? extends Observable<? extends R>> func0) {
        return merge(mapNotification(func1, func2, func0));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final <R> Observable<R> flatMap(Func1<? super T, ? extends Observable<? extends R>> func1, Func1<? super Throwable, ? extends Observable<? extends R>> func2, Func0<? extends Observable<? extends R>> func0, int i) {
        return merge(mapNotification(func1, func2, func0), i);
    }
    ...
    public final void forEach(Action1<? super T> action1, Action1<Throwable> action2) {
        subscribe(action1, action2);
    }

    public final void forEach(Action1<? super T> action1, Action1<Throwable> action2, Action0 action0) {
        subscribe(action1, action2, action0);
    }

    public final <K, R> Observable<GroupedObservable<K, R>> groupBy(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends R> func2) {
        return lift(new OperatorGroupBy(func1, func2));
    }

    public final <K, R> Observable<GroupedObservable<K, R>> groupBy(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends R> func2, Func1<Action1<K>, Map<K, Object>> func3) {
        if (func3 == null) {
            throw new NullPointerException("evictingMapFactory cannot be null");
        }
        return lift(new OperatorGroupBy(func1, func2, func3));
    }
    ...
    public final <T2, D1, D2, R> Observable<R> groupJoin(Observable<T2> observable, Func1<? super T, ? extends Observable<D1>> func1, Func1<? super T2, ? extends Observable<D2>> func2, Func2<? super T, ? super Observable<T2>, ? extends R> func3) {
        return unsafeCreate(new OnSubscribeGroupJoin(this, observable, func1, func2, func3));
    }
    ...
    public final <TRight, TLeftDuration, TRightDuration, R> Observable<R> join(Observable<TRight> observable, Func1<T, Observable<TLeftDuration>> func1, Func1<TRight, Observable<TRightDuration>> func2, Func2<T, TRight, R> func3) {
        return unsafeCreate(new OnSubscribeJoin(this, observable, func1, func2, func3));
    }
    ...
    private <R> Observable<R> mapNotification(Func1<? super T, ? extends R> func1, Func1<? super Throwable, ? extends R> func2, Func0<? extends R> func0) {
        return lift(new OperatorMapNotification(func1, func2, func0));
    }
    ...
    public final Subscription subscribe(Action1<? super T> action1, Action1<Throwable> action2) {
        if (action1 == null) {
            throw new IllegalArgumentException("onNext can not be null");
        }
        if (action2 == null) {
        ...
        return subscribe((Subscriber) new ActionSubscriber(action1, action2, Actions.empty()));
    }

    public final Subscription subscribe(Action1<? super T> action1, Action1<Throwable> action2, Action0 action0) {
        if (action1 == null) {
            throw new IllegalArgumentException("onNext can not be null");
        }
        if (action2 == null) {
        ...
        return subscribe((Subscriber) new ActionSubscriber(action1, action2, action0));
    }
    ...
    public final <K, V> Observable<Map<K, V>> toMap(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends V> func2) {
        return unsafeCreate(new OnSubscribeToMap(this, func1, func2));
    }

    public final <K, V> Observable<Map<K, V>> toMap(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends V> func2, Func0<? extends Map<K, V>> func0) {
        return unsafeCreate(new OnSubscribeToMap(this, func1, func2, func0));
    }
    ...
    public final <K, V> Observable<Map<K, Collection<V>>> toMultimap(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends V> func2) {
        return unsafeCreate(new OnSubscribeToMultimap(this, func1, func2));
    }

    public final <K, V> Observable<Map<K, Collection<V>>> toMultimap(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends V> func2, Func0<? extends Map<K, Collection<V>>> func0) {
        return unsafeCreate(new OnSubscribeToMultimap(this, func1, func2, func0));
    }

    public final <K, V> Observable<Map<K, Collection<V>>> toMultimap(Func1<? super T, ? extends K> func1, Func1<? super T, ? extends V> func2, Func0<? extends Map<K, Collection<V>>> func0, Func1<? super K, ? extends Collection<V>> func3) {
        return unsafeCreate(new OnSubscribeToMultimap(this, func1, func2, func0, func3));
    }
