...
public final class OperatorPublish<T> extends ConnectableObservable<T> {
            ...
            public void call(Subscriber<? super T> subscriber) {
                while (true) {
                    ...
                    if (publishSubscriber == null || publishSubscriber.isUnsubscribed()) {
                        ...
                        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, publishSubscriber, publishSubscriber2)) {
    ...
    static final class PublishSubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        void init() {
            add(Subscriptions.create(new Action0() { // from class: rx.internal.operators.OperatorPublish.PublishSubscriber.1
                ...
                public void call() {
                    ...
                    PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(PublishSubscriber.this.current, PublishSubscriber.this, null);
                }
            }));
        }
        ...
        boolean add(InnerProducer<T> innerProducer) {
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.producers, innerProducerArr, innerProducerArr2));
            return true;
        }
