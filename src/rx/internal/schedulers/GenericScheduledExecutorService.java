...
public final class GenericScheduledExecutorService implements SchedulerLifecycle {
    ...
    public void start() {
        ...
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.executor, NONE, scheduledExecutorServiceArr)) {
    ...
    public void shutdown() {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.executor, scheduledExecutorServiceArr, scheduledExecutorServiceArr2));
