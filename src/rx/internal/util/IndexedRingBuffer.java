...
public final class IndexedRingBuffer<E> implements Subscription {
    ...
    static final class ElementSection<E> {
        ...
        ElementSection<E> getNext() {
            ...
            return PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.next, null, elementSection) ? elementSection : this.next.get();
        }
    }
    ...
    static class IndexSection {
        ...
        IndexSection getNext() {
            ...
            return PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this._next, null, indexSection) ? indexSection : this._next.get();
        }
    }
}
