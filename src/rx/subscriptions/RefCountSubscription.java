...
public final class RefCountSubscription implements Subscription {
    ...
    public Subscription get() {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, state, state.addChild()));
    ...
    public void unsubscribe() {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, state, stateUnsubscribe));
    ...
    void unsubscribeAChild() {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, state, stateRemoveChild));
