...
public final class ZonalDateTime implements ChronoDisplay, UniversalTime {
    ...
    public int compareByMoment(ZonalDateTime zonalDateTime) {
        int iCompareTo = this.moment.compareTo(zonalDateTime.moment);
        return iCompareTo == 0 ? this.timestamp.compareTo(zonalDateTime.timestamp) : iCompareTo;
    }

    public int compareByLocalTimestamp(ZonalDateTime zonalDateTime) {
        int iCompareTo = this.timestamp.compareTo(zonalDateTime.timestamp);
        return iCompareTo == 0 ? this.moment.compareTo(zonalDateTime.moment) : iCompareTo;
    }
    ...
    public static ZonalDateTime parse(String str, TemporalFormatter<Moment> temporalFormatter) {
        ...
        try {
            ...
            Moment moment = temporalFormatter.parse(str, rawValues);
