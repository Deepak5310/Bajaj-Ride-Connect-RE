            ...
            public long toMJD(HistoricDate historicDate) {
                if (historicDate.compareTo(AncientJulianLeapYears.AD8) < 0) {
                    ...
                    for (int i6 = 1; i6 < historicDate.getMonth(); i6++) {
                        maximumDayOfMonth += (long) getMaximumDayOfMonth(prolepticYear, i6);
                    }
                    return (maximumDayOfMonth + ((long) historicDate.getDayOfMonth())) - 1;
                }
            ...
            public HistoricDate fromMJD(long j) {
                ...
                while (i5 >= -44) {
                    ...
                    if (j2 <= j) {
                        int i6 = 1;
                        while (i6 <= 12) {
                            long maximumDayOfMonth = ((long) getMaximumDayOfMonth(i5, i6)) + j2;
