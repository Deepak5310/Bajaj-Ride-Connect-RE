    ...
    public int print(ChronoDisplay chronoDisplay, Appendable appendable, AttributeQuery attributeQuery, Set<ElementPosition> set, boolean z) throws IOException {
        ...
        if ((appendable instanceof CharSequence) && set != null) {
            ...
            if (chronoPrinter instanceof ChronoFormatter) {
                ...
                chronoPrinter.print((V) obj, sb, attributeQuery, (ChronoFunction<ChronoDisplay, R>) NO_RESULT);
            }
            set.add(new ElementPosition(this.element, length, sb.length() + length));
        } else {
            this.printer.print((V) obj, sb, attributeQuery, (ChronoFunction<ChronoDisplay, R>) NO_RESULT);
        }
