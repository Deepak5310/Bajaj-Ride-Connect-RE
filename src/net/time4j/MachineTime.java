...
public final class MachineTime<U> implements TimeSpan<U>, Comparable<MachineTime<U>>, Serializable {
    ...
    public boolean contains(Object obj) {
        ...
        return ((this.scale == TimeScale.POSIX && TimeUnit.NANOSECONDS.equals(obj)) || (this.scale == TimeScale.UTC && SI.NANOSECONDS.equals(obj))) && this.nanos != 0;
    }
    ...
    public MachineTime<U> plus(MachineTime<U> machineTime) {
        ...
        return isEmpty() ? machineTime : new MachineTime<>(MathUtils.safeAdd(this.seconds, machineTime.seconds), this.nanos + machineTime.nanos, this.scale);
    }
    ...
    public int hashCode() {
        long j = this.seconds;
        return ((((CanonMakernoteDirectory.TAG_TONE_CURVE_TABLE + ((int) (j ^ (j >>> 32)))) * 23) + this.nanos) * 23) + this.scale.hashCode();
    }
    ...
    /* JADX INFO: renamed from: net.time4j.MachineTime$1, reason: invalid class name */
