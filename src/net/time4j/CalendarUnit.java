...
public enum CalendarUnit implements IsoDateUnit {
    ...
    /* JADX INFO: renamed from: net.time4j.CalendarUnit$9, reason: invalid class name */
        ...
        public long between(T t, T t2) {
            ...
            switch (AnonymousClass9.$SwitchMap$net$time4j$CalendarUnit[this.unit.ordinal()]) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    jDayDelta = monthDelta(plainDate, plainDate2) / 1200;
                    break;
                case 5:
            ...
            if (jDayDelta <= 0 || !plainTime.isAfter(plainTime2)) {
                return (jDayDelta >= 0 || !plainTime.isBefore(plainTime2)) ? jDayDelta : jDayDelta + 1;
            }
            return jDayDelta - 1;
        }
