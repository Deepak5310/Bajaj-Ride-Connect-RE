...
public enum PersianAlgorithm {
    ...
    BIRASHK { // from class: net.time4j.calendar.PersianAlgorithm.3
        ...
        long transform(PersianCalendar persianCalendar, ZonalOffset zonalOffset) {
            ...
            int iFloorModulo = MathUtils.floorModulo(year, 2820);
            long jFloorDivide = (((long) (MathUtils.floorDivide(year, 2820) * 1029983)) - 492998) + ((long) ((iFloorModulo + 473) * 365)) + ((long) MathUtils.floorDivide(((iFloorModulo + 474) * 31) - 5, 128));
            int value = persianCalendar.getMonth().getValue();
            return jFloorDivide + ((long) (value <= 7 ? (value - 1) * 31 : ((value - 1) * 30) + 6)) + ((long) persianCalendar.getDayOfMonth());
        }
    },
