...
public class CommonElements {
    ...
    private static class CWRule<D extends ChronoEntity<D>> implements ElementRule<D, Integer> {
        ...
        private Weekday getWeekdayStart(D d, int i) {
            ...
            if (i == -1) {
                long jLongValue = ((Long) d.get(EpochDays.UTC)).longValue() - ((long) i2);
                return CommonElements.getDayOfWeek((jLongValue - ((long) d.with(EpochDays.UTC, jLongValue).getInt(((CalendarWeekElement) this.owner).dayElement))) + 1);
            }
            if (i == 0) {
        ...
        private int getLengthOfYM(D d, int i) {
            int i2 = d.getInt(((CalendarWeekElement) this.owner).dayElement);
            if (i == -1) {
                return CommonElements.getMax(((CalendarWeekElement) this.owner).dayElement, d.with(EpochDays.UTC, ((Long) d.get(EpochDays.UTC)).longValue() - ((long) i2)));
            }
            if (i == 0) {
                return CommonElements.getMax(((CalendarWeekElement) this.owner).dayElement, d);
            }
            if (i == 1) {
                return CommonElements.getMax(((CalendarWeekElement) this.owner).dayElement, d.with(EpochDays.UTC, ((((Long) d.get(EpochDays.UTC)).longValue() + ((long) CommonElements.getMax(((CalendarWeekElement) this.owner).dayElement, d))) + 1) - ((long) i2)));
            }
            throw new AssertionError("Unexpected: " + i);
        }
        ...
        private D setCalendarWeek(D d, int i) {
            ...
            return i == calendarWeek ? d : (D) d.with(EpochDays.UTC, ((Long) d.get(EpochDays.UTC)).longValue() + ((long) ((i - calendarWeek) * 7)));
        }
    }
    ...
    private static class BWRule<D extends ChronoEntity<D>> implements ElementRule<D, Integer> {
        ...
        private ChronoElement<?> getChild(D d, boolean z) {
            ...
            int i = d.getInt(((CalendarWeekElement) this.owner).dayElement);
            if (z) {
                if (((Integer) d.getMaximum(((CalendarWeekElement) this.owner).dayElement)).intValue() < ((long) i) + (((Long) d.with(dayOfWeekElementOf, d.getMaximum(dayOfWeekElementOf)).get(EpochDays.UTC)).longValue() - jLongValue)) {
                    return ((CalendarWeekElement) this.owner).dayElement;
                }
            } else if (week <= 1) {
                if (((Integer) d.getMinimum(((CalendarWeekElement) this.owner).dayElement)).intValue() > ((long) i) - (jLongValue - ((Long) d.with(dayOfWeekElementOf, d.getMinimum(dayOfWeekElementOf)).get(EpochDays.UTC)).longValue())) {
                    return ((CalendarWeekElement) this.owner).dayElement;
                }
            }
        ...
        private D setWeek(D d, int i) {
            ...
            return (D) d.with(EpochDays.UTC, ((Long) d.get(EpochDays.UTC)).longValue() + ((long) ((i - week) * 7)));
        }
    }
    ...
    private static class DRule<T extends ChronoEntity<T>> implements ElementRule<T, Weekday> {
        ...
        public Weekday getMinimum(T t) {
            ...
            if ((jLongValue + 1) - ((long) CommonElements.getDayOfWeek(jLongValue).getValue(((DayOfWeekElement) this.element).model)) < minimumSinceUTC) {
        ...
        public Weekday getMaximum(T t) {
            ...
            long jLongValue = ((Long) t.get(EpochDays.UTC)).longValue();
            if ((jLongValue + 7) - ((long) CommonElements.getDayOfWeek(jLongValue).getValue(((DayOfWeekElement) this.element).model)) > maximumSinceUTC) {
        ...
        public T withValue2(T t, Weekday weekday, boolean z) {
            ...
            return (T) t.with(EpochDays.UTC, (jLongValue + ((long) weekday.getValue(((DayOfWeekElement) this.element).model))) - ((long) value));
        }
    }
