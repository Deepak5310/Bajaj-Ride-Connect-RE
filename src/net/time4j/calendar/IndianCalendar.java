...
public final class IndianCalendar extends Calendrical<Unit, IndianCalendar> implements LocalizedPatternSupport {
    ...
    private static class Transformer implements EraYearMonthDaySystem<IndianCalendar> {
        ...
        /* JADX WARN: Code duplicated, block: B:21:0x0047 A[PHI: r12
        ...
        public IndianCalendar transform(long j) {
            ...
            int dayOfMonth = plainDateOf.getDayOfMonth();
            boolean zIsLeapYear = GregorianMath.isLeapYear(year);
            int i3 = zIsLeapYear ? 21 : 22;
                                            ...
                                            if (month == 7) {
                                                ...
                                                if (month == 6) {
                                                    ...
                                                    if (month == 5) {
                                                        ...
                                                        i6 = 1;
                                                        if (month == 4) {
                                                            i2 = dayOfMonth + (zIsLeapYear ? 11 : 10);
                                                        } else if (month != 3 || dayOfMonth < i3) {
                                                            if (month == 3) {
                                                                i4 = year2 - 79;
                                                                i2 = dayOfMonth + (zIsLeapYear ? 10 : 9);
        ...
        public long transform(IndianCalendar indianCalendar) {
            ...
            return jLongValue + ((long) (i2 + (indianCalendar.idom - 1)));
        }
    ...
    private static class IndianUnitRule implements UnitRule<IndianCalendar> {
        ...
        public long between(IndianCalendar indianCalendar, IndianCalendar indianCalendar2) {
            ...
            if (jYmValue <= 0 || indianCalendar2.idom >= indianCalendar.idom) {
                return (jYmValue >= 0 || indianCalendar2.idom <= indianCalendar.idom) ? jYmValue : jYmValue + 1;
            }
            return jYmValue - 1;
        }
    ...
    /* JADX INFO: renamed from: net.time4j.calendar.IndianCalendar$2, reason: invalid class name */
