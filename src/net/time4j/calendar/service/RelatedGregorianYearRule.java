...
public final class RelatedGregorianYearRule<T extends ChronoEntity<T>> implements ElementRule<T, Integer> {
    ...
    public boolean isValid2(T t, Integer num) {
        return getValue((ChronoEntity) t).equals(num);
    }
    ...
    public T withValue2(T t, Integer num, boolean z) {
        if (isValid2((ChronoEntity) t, num)) {
            return t;
        }
    ...
    private static Integer toGregorianYear(long j) {
        ...
        if (iFloorModulo == 146096) {
            ...
            int i4 = i2 % 1461;
            if (i4 == 1460) {
                j2 = (jFloorDivide * 400) + ((long) (i * 100)) + ((long) ((i3 + 1) * 4));
            } else {
                j2 = (jFloorDivide * 400) + ((long) (i * 100)) + ((long) (i3 * 4)) + ((long) (i4 / 365));
