...
public enum AstronomicalSeason {
    ...
    private static final int[] A = {485, 203, 199, 182, NikonType2MakernoteDirectory.TAG_SCENE_ASSIST, 136, 77, 74, 70, 58, 52, 50, 45, 44, 29, 18, 17, 16, 14, 12, 12, 12, 9, 8};
    ...
    /* JADX INFO: renamed from: net.time4j.calendar.astro.AstronomicalSeason$1, reason: invalid class name */
    ...
    private double jdMean(int i) {
        ...
        double d6 = ((double) (i - 2000)) / 1000.0d;
