...
public final class HistoricCalendar extends CalendarVariant<HistoricCalendar> implements LocalizedPatternSupport {
    ...
    private static class Transformer implements CalendarSystem<HistoricCalendar> {
        ...
        public long getMinimumSinceUTC() {
            return this.history.convert((HistoricDate) PlainDate.of(Constants.MAX_URL_LENGTH, 1, 1).getMinimum(this.history.date())).getDaysSinceEpochUTC();
        }

        @Override // net.time4j.engine.CalendarSystem
        public long getMaximumSinceUTC() {
            return this.history.convert((HistoricDate) PlainDate.of(Constants.MAX_URL_LENGTH, 1, 1).getMaximum(this.history.date())).getDaysSinceEpochUTC();
        }
    ...
    private static class Merger implements ChronoMerger<HistoricCalendar> {
        ...
        public HistoricCalendar createFrom2(ChronoEntity<?> chronoEntity, AttributeQuery attributeQuery, boolean z, boolean z2) {
            ...
            if (chronoEntity.contains(HistoricCalendar.ERA)) {
                ...
                chronoEntity.with((ChronoElement<Object>) HistoricCalendar.ERA, (Object) null);
                chronoEntity.with((ChronoElement<HistoricEra>) history.era(), historicEra);
            }
            if (chronoEntity.contains(HistoricCalendar.RELATED_STANDARD_YEAR)) {
                ...
                chronoEntity.with(HistoricCalendar.RELATED_STANDARD_YEAR, (Object) null);
            ...
            if (chronoEntity.contains(HistoricCalendar.DAY_OF_YEAR)) {
                ...
                chronoEntity.with(HistoricCalendar.DAY_OF_YEAR, (Object) null);
                ...
                if (chronoEntity.contains(HistoricCalendar.MONTH_OF_YEAR)) {
                    ...
                    chronoEntity.with(HistoricCalendar.MONTH_OF_YEAR, (Object) null);
                ...
                if (chronoEntity.contains(HistoricCalendar.DAY_OF_MONTH)) {
                    ...
                    chronoEntity.with(HistoricCalendar.DAY_OF_MONTH, (Object) null);
