...
public final class JapaneseCalendar extends Calendrical<Unit, JapaneseCalendar> implements LocalizedPatternSupport {
    ...
    @FormattableElement(format = WeatherCriteria.UNIT_FARENHEIT)
    ...
    /* JADX WARN: Bottom block not found for handler: all -> 0x01e7 */
    /* JADX WARN: Code duplicated, block: B:10:0x004a  */
    /* JADX WARN: Code duplicated, block: B:13:0x0050 A[Catch: all -> 0x01e7, IOException -> 0x01ea, TryCatch #0 {IOException -> 0x01ea, blocks: (B:4:0x0019, B:5:0x0021, B:7:0x0035, B:13:0x0050, B:17:0x0059, B:18:0x0061, B:19:0x0068), top: B:38:0x0019, outer: #3 }] */
    ...
    /* JADX WARN: Code duplicated, block: B:7:0x0035 A[Catch: all -> 0x01e7, IOException -> 0x01ea, TryCatch #0 {IOException -> 0x01ea, blocks: (B:4:0x0019, B:5:0x0021, B:7:0x0035, B:13:0x0050, B:17:0x0059, B:18:0x0061, B:19:0x0068), top: B:38:0x0019, outer: #3 }] */
    ...
    static {
        ...
        Nengo.Element element2 = Nengo.Element.SINGLETON;
        ERA = element2;
        YearOfNengoElement yearOfNengoElement2 = new YearOfNengoElement();
        YEAR_OF_ERA = yearOfNengoElement2;
        StdIntegerDateElement stdIntegerDateElement5 = new StdIntegerDateElement("KOKI_YEAR", JapaneseCalendar.class, 1361, 1000000659, (char) 0, null, null);
        KOKI_YEAR = stdIntegerDateElement5;
        MonthPrimitiveElement monthPrimitiveElement2 = new MonthPrimitiveElement();
        MONTH_OF_YEAR = monthPrimitiveElement2;
        StdIntegerDateElement stdIntegerDateElement6 = new StdIntegerDateElement("MONTH_AS_ORDINAL", JapaneseCalendar.class, 1, 12, (char) 0, null, null);
        MONTH_AS_ORDINAL = stdIntegerDateElement6;
        StdIntegerDateElement stdIntegerDateElement7 = new StdIntegerDateElement("DAY_OF_MONTH", JapaneseCalendar.class, 1, 31, 'd');
        DAY_OF_MONTH = stdIntegerDateElement7;
        StdIntegerDateElement stdIntegerDateElement8 = new StdIntegerDateElement("DAY_OF_YEAR", JapaneseCalendar.class, 1, 365, 'D');
        DAY_OF_YEAR = stdIntegerDateElement8;
        StdWeekdayElement stdWeekdayElement2 = new StdWeekdayElement(JapaneseCalendar.class, getDefaultWeekmodel());
        DAY_OF_WEEK = stdWeekdayElement2;
        WeekdayInMonthElement<JapaneseCalendar> weekdayInMonthElement2 = new WeekdayInMonthElement<>(JapaneseCalendar.class, stdIntegerDateElement7, stdWeekdayElement2);
        WIM_ELEMENT = weekdayInMonthElement2;
        WEEKDAY_IN_MONTH = weekdayInMonthElement2;
        Transformer transformer2 = new Transformer();
        CALSYS = transformer2;
        ENGINE = TimeAxis.Builder.setUp(Unit.class, JapaneseCalendar.class, new Merger(), transformer2).appendElement(element2, new NengoRule(), Unit.ERAS).appendElement(yearOfNengoElement2, new IntegerRule(0), Unit.YEARS).appendElement(monthPrimitiveElement2, MonthPrimitiveElement.SINGLETON_JP, Unit.MONTHS).appendElement(stdIntegerDateElement6, new IntegerRule(1), Unit.MONTHS).appendElement(stdIntegerDateElement7, new IntegerRule(2), Unit.DAYS).appendElement(stdIntegerDateElement8, new IntegerRule(3), Unit.DAYS).appendElement(stdWeekdayElement2, new WeekdayRule(getDefaultWeekmodel(), new ChronoFunction<JapaneseCalendar, CalendarSystem<JapaneseCalendar>>() { // from class: net.time4j.calendar.JapaneseCalendar.1
            @Override // net.time4j.engine.ChronoFunction
            public CalendarSystem<JapaneseCalendar> apply(JapaneseCalendar japaneseCalendar) {
                return JapaneseCalendar.CALSYS;
            }
        }), Unit.DAYS).appendElement((ChronoElement) weekdayInMonthElement2, WeekdayInMonthElement.getRule(weekdayInMonthElement2)).appendElement(stdIntegerDateElement5, new IntegerRule(5), Unit.YEARS).appendElement((ChronoElement) CommonElements.RELATED_GREGORIAN_YEAR, (ElementRule) new IntegerRule(4)).appendUnit(Unit.ERAS, new JapaneseUnitRule(Unit.ERAS), Unit.ERAS.getLength()).appendUnit(Unit.YEARS, new JapaneseUnitRule(Unit.YEARS), Unit.YEARS.getLength()).appendUnit(Unit.MONTHS, new JapaneseUnitRule(Unit.MONTHS), Unit.MONTHS.getLength()).appendUnit(Unit.WEEKS, new JapaneseUnitRule(Unit.WEEKS), Unit.WEEKS.getLength(), Collections.singleton(Unit.DAYS)).appendUnit(Unit.DAYS, new JapaneseUnitRule(Unit.DAYS), Unit.DAYS.getLength(), Collections.singleton(Unit.WEEKS)).build();
        return;
        if (inputStreamLoad != null) {
            try {
                inputStreamLoad.close();
    ...
    private static class JapaneseUnitRule implements UnitRule<JapaneseCalendar> {
        ...
        /* JADX WARN: Code duplicated, block: B:34:0x0087 A[PHI: r2
        ...
        /* JADX WARN: Code duplicated, block: B:46:0x00b9 A[PHI: r4
        ...
        public long between(JapaneseCalendar japaneseCalendar, JapaneseCalendar japaneseCalendar2) {
            ...
            while (true) {
                ...
                if (i5 >= 1873) {
                    ...
                    if (monthIndex4 > (JapaneseCalendar.LEAP_INDICATORS[i5 + (-701)] != 0 ? 13 : 12)) {
                        i5++;
                        monthIndex4 = 1;
                    }
                }
