...
public enum FrenchRepublicanAlgorithm {
    ...
    ROMME { // from class: net.time4j.calendar.frenchrev.FrenchRepublicanAlgorithm.2
        ...
        long transform(FrenchRepublicanCalendar frenchRepublicanCalendar) {
            ...
            return ((((FrenchRepublicanAlgorithm.EPOCH - 1) + ((long) (year * 365))) + ((long) MathUtils.floorDivide(year, 4))) - ((long) MathUtils.floorDivide(year, 100))) + ((long) MathUtils.floorDivide(year, 400)) + ((long) frenchRepublicanCalendar.getDayOfYear());
        }
    };
