...
public final class HinduCalendar extends CalendarVariant<HinduCalendar> implements LocalizedPatternSupport {
    ...
    public static final StdCalendarElement<Integer, HinduCalendar> YEAR_OF_ERA = new StdIntegerDateElement("YEAR_OF_ERA", HinduCalendar.class, 0, NavigationConstants.UI_HANDLER_PROGRESS, 'y');
    ...
    private static class IntegerRule implements IntElementRule<HinduCalendar> {
        ...
        private int getMax(HinduCalendar hinduCalendar) {
            int i = this.index;
            if (i == 0) {
                return hinduCalendar.getEra().yearOfEra(HinduEra.KALI_YUGA, hinduCalendar.variant.isUsingElapsedYears() ? HinduCalendar.MAX_YEAR : NavigationConstants.UI_HANDLER_PROGRESS);
            }
            if (i == 1) {
    ...
    private static class MonthElement extends DisplayElement<HinduMonth> implements AdjustableTextElement<HinduMonth>, ElementRule<HinduCalendar, HinduMonth> {
        ...
        /* JADX WARN: Code duplicated, block: B:18:0x00e0  */
        /* JADX WARN: Code duplicated, block: B:20:0x00e4 A[DONT_INVERT] */
        ...
        /* JADX WARN: Code duplicated, block: B:52:0x01bc A[LOOP:2: B:42:0x019a->B:52:0x01bc, LOOP_END] */
        /* JADX WARN: Code duplicated, block: B:54:0x01c1  */
        /* JADX WARN: Code duplicated, block: B:56:0x01c6 A[DONT_INVERT] */
        ...
        /* JADX WARN: Code duplicated, block: B:74:0x01b3 A[EDGE_INSN: B:74:0x01b3->B:51:0x01b3 BREAK  A[LOOP:2: B:42:0x019a->B:52:0x01bc], SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:75:0x01b1 A[SYNTHETIC] */
        @Override // net.time4j.format.TextElement
        public HinduMonth parse(CharSequence charSequence, ParsePosition parsePosition, AttributeQuery attributeQuery) {
            ...
            if (index2 < length2) {
                ...
                if (zIsSolar) {
                    ...
                    char cCharValue2 = ((Character) attributeQuery.get(HinduPrimitive.ADHIKA_INDICATOR, Character.valueOf(textForms.get("leap-indicator").charAt(0)))).charValue();
                    String str4 = CalendarText.getInstance("hindu", locale).getTextForms().get("adhika");
                    if (!zBooleanValue2) {
                        i = -1;
                        str = "R";
                        str2 = "hindu";
                        index2 = HinduCalendar.parseLeadingLeapInfo(charSequence, index2, length2, zBooleanValue, str4, cCharValue2, locale);
                        if (index2 != -1) {
                            z = zBooleanValue2;
                            c = cCharValue2;
                            str3 = str4;
                        ...
                        if (iIntValue == 0) {
                            ...
                            cCharValue = ((Character) attributeQuery.get(Attributes.ZERO_DIGIT, Character.valueOf(numberSystem.getDigits().charAt(0)))).charValue();
                            if (zIsSolar && numberSystem.isDecimal()) {
                                while (index2 < length2 && charSequence.charAt(index2) == cCharValue) {
                                    index2++;
                                }
                            }
                            i2 = 12;
                            i3 = 0;
                            while (i2 >= 1 && i3 == 0) {
                                numeral = DualFormatHelper.toNumeral(numberSystem, cCharValue, i2);
                        ...
                        if (z || (trailingLeapInfo = HinduCalendar.parseTrailingLeapInfo(charSequence, index, length2, zBooleanValue, str3, c, locale)) == -1) {
                            z3 = z2;
                        } else {
    ...
    private static class DayOfMonthElement extends DisplayElement<HinduDay> implements AdjustableTextElement<HinduDay>, ElementRule<HinduCalendar, HinduDay> {
        ...
        /* JADX WARN: Code duplicated, block: B:47:0x0136 A[LOOP:2: B:37:0x0114->B:47:0x0136, LOOP_END] */
        ...
        /* JADX WARN: Code duplicated, block: B:65:0x012d A[EDGE_INSN: B:65:0x012d->B:46:0x012d BREAK  A[LOOP:2: B:37:0x0114->B:47:0x0136], SYNTHETIC] */
        ...
        public HinduDay parse(CharSequence charSequence, ParsePosition parsePosition, AttributeQuery attributeQuery) {
            ...
            if (index < length2) {
                ...
                if (zIsSolar) {
                    ...
                    if (zBooleanValue2 || (index = HinduCalendar.parseLeadingLeapInfo(charSequence, index, length2, zBooleanValue, str, cCharValue2, locale)) == -1) {
                        z = zBooleanValue2;
                        c = cCharValue2;
                    } else {
                        z = zBooleanValue2;
                    ...
                    cCharValue = ((Character) attributeQuery.get(Attributes.ZERO_DIGIT, Character.valueOf(numberSystem.getDigits().charAt(0)))).charValue();
                    if (zIsSolar && numberSystem.isDecimal()) {
                        while (index < length2 && charSequence.charAt(index) == cCharValue) {
                            index++;
                        }
                    }
                    if (zIsSolar) {
                    ...
                    i3 = 0;
                    while (i >= 1 && i3 == 0) {
                        numeral = DualFormatHelper.toNumeral(numberSystem, cCharValue, i);
                        length = numeral.length();
                        NumberSystem numberSystem2 = numberSystem;
                        i4 = 0;
                        while (true) {
                    ...
                    if (z || (trailingLeapInfo = HinduCalendar.parseTrailingLeapInfo(charSequence, i2, length2, zBooleanValue, str, c, locale)) == -1) {
                        z3 = z2;
                    } else {
                        i2 = trailingLeapInfo;
                        z3 = true;
            ...
            try {
                ...
                if (chronoEntity.contains(HinduCalendar.MONTH_OF_YEAR) && chronoEntity.contains(HinduCalendar.DAY_OF_MONTH)) {
                    ...
                    if (i2 != Integer.MIN_VALUE) {
                        if (i2 >= 1) {
                            long j = (calendarSystem.create(calendarSystem.create(iYearOfEra, HinduMonth.of(IndianMonth.AGRAHAYANA), HinduDay.valueOf(1)).utcDays).withNewYear().utcDays + ((long) i2)) - 1;
