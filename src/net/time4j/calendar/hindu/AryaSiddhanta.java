...
public enum AryaSiddhanta {
    ...
    private static class OldCS extends HinduCS {
        ...
        HinduCalendar create(int i, HinduMonth hinduMonth, HinduDay hinduDay) {
            double value;
            if (isSolar()) {
                value = (((((double) i) * ARYA_SOLAR_YEAR) + (((double) (hinduMonth.getRasi() - 1)) * ARYA_SOLAR_MONTH)) + ((double) hinduDay.getValue())) - 1.25d;
            } else {
                double d = ((double) ((i * 12) - 1)) * ARYA_SOLAR_MONTH;
                ...
                value = ((dFloor + (((double) value2) * ARYA_LUNAR_MONTH)) + (((double) (hinduDay.getValue() - 1)) * 0.9843527269193898d)) - 0.25d;
            }
