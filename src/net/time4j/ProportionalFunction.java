...
final class ProportionalFunction implements ChronoFunction<ChronoEntity<?>, BigDecimal> {
    ...
    public BigDecimal apply(ChronoEntity<?> chronoEntity) {
        ...
        return zzah$$ExternalSyntheticBackportWithForwarding0.m(new BigDecimal(jLongValue - jLongValue2).setScale(15).divide(new BigDecimal((jLongValue3 - jLongValue2) + 1), RoundingMode.HALF_UP));
    }
}
