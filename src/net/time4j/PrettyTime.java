...
public final class PrettyTime {
    ...
    public String print(Duration<?> duration, TextWidth textWidth, boolean z, int i) {
        ...
        for (int i5 = 8; i4 < i5; i5 = 8) {
            if (i3 >= i || ((this.weekToDays && i4 == 2) || ((!z || i3 <= 0) && jArr[i4] <= j))) {
                ...
                arrayList.add(format(jArr[i4], i4 == 7 ? ClockUnit.NANOS : STD_UNITS[i4], zIsNegative, textWidth));
                i3++;
            }
            i4++;
            i2 = i2;
        ...
        int i7 = i2;
        if (i6 == 1) {
            return arrayList.get(i7).toString();
        }
    ...
    public String printRelative(UnixTime unixTime, Timezone timezone, TimeUnit timeUnit) {
        ...
        if (timeUnit.compareTo(TimeUnit.SECONDS) <= 0) {
            long jUntil = momentFrom.until(momentFrom2, TimeUnit.SECONDS);
    ...
    /* JADX INFO: renamed from: net.time4j.PrettyTime$1, reason: invalid class name */
