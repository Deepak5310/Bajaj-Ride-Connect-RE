...
public final class PropertyBundle {
    ...
    public static PropertyBundle load(String str, Locale locale) throws Throwable {
        ...
        Iterator<Locale> it2 = getCandidateLocales(locale).iterator();
        while (it2.hasNext()) {
            try {
                PropertyBundle propertyBundleNewBundle = newBundle(str, it2.next());
    ...
    private static class CacheKey {
        ...
        public String toString() {
            return this.baseName + RemoteSettings.FORWARD_SLASH_STRING + this.locale;
        }
    }
