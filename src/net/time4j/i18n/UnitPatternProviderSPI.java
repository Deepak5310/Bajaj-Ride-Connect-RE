...
public final class UnitPatternProviderSPI implements RelativeTimeProvider {
    ...
    private String getPattern(Locale locale, String str, String str2, String str3, PluralCategory pluralCategory) throws Throwable {
        boolean z = true;
    ...
    /* JADX INFO: renamed from: net.time4j.i18n.UnitPatternProviderSPI$1, reason: invalid class name */
