...
public class WeekdataProviderSPI implements WeekdataProvider {
    ...
    public WeekdataProviderSPI() {
        ...
        if (inputStreamLoad != null) {
            ...
            try {
                try {
                    BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStreamLoad, CharEncoding.US_ASCII));
                    while (true) {
                        ...
                        if (line != null) {
                            if (!line.startsWith("#")) {
                                ...
                                if (strTrim.equals("minDays-4")) {
                                    ...
                                    if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.SUNDAY)) {
                                        weekday = Weekday.SUNDAY;
                                    } else if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.SATURDAY)) {
                                        weekday = Weekday.SATURDAY;
                                    } else if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.FRIDAY)) {
                                        weekday = Weekday.FRIDAY;
                                    } else if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.THURSDAY)) {
                                        weekday = Weekday.THURSDAY;
                                    } else if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.WEDNESDAY)) {
                                        weekday = Weekday.WEDNESDAY;
                                    } else if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.TUESDAY)) {
                                        weekday = Weekday.TUESDAY;
                                    } else if (strSubstring.equals(LocalePreferences.FirstDayOfWeek.MONDAY)) {
                                        weekday = Weekday.MONDAY;
                                    }
