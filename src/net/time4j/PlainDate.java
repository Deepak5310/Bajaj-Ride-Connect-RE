...
public final class PlainDate extends Calendrical<IsoDateUnit, PlainDate> implements GregorianDate, Normalizer<CalendarUnit>, LocalizedPatternSupport {
    ...
    private static final int[] DAY_OF_YEAR_PER_MONTH = {31, 59, 90, 120, 151, NikonType2MakernoteDirectory.TAG_UNKNOWN_48, Mp4VideoDirectory.TAG_OPCOLOR, 243, 273, 304, 334, 365};
    ...
    static {
        ...
        IntegerDateElement integerDateElementCreate = IntegerDateElement.create("YEAR", 14, -999999999, 999999999, 'u');
    ...
    public TimeSpan<CalendarUnit> normalize2(TimeSpan<? extends CalendarUnit> timeSpan) {
        return (Duration) until(plus(timeSpan), (TimeMetric) Duration.inYearsMonthsDays());
    }
    ...
    static PlainDate from(UnixTime unixTime, ZonalOffset zonalOffset) {
        ...
        long packedDate = GregorianMath.toPackedDate(EpochDays.MODIFIED_JULIAN_DATE.transform(MathUtils.floorDivide(posixTime, DateTimeConstants.SECONDS_PER_DAY), EpochDays.UNIX));
    ...
    private PlainTimestamp atStartOfDay(TransitionHistory transitionHistory) {
        ...
        if (conflictTransition != null && conflictTransition.isGap()) {
            ...
            PlainDate plainDateOf = of(MathUtils.floorDivide(posixTime, DateTimeConstants.SECONDS_PER_DAY), EpochDays.UNIX);
    ...
    public PlainDate withDayOfWeek(Weekday weekday) {
        ...
        return dayOfWeek == weekday ? this : TRANSFORMER.transform(MathUtils.safeAdd(getDaysSinceUTC(), weekday.getValue() - dayOfWeek.getValue()));
    }
    ...
    private static class Merger implements ChronoMerger<PlainDate> {
        private static final int DEFAULT_PIVOT_YEAR = GregorianMath.readYear(GregorianMath.toPackedDate(EpochDays.MODIFIED_JULIAN_DATE.transform(MathUtils.floorDivide(System.currentTimeMillis(), DateTimeConstants.MILLIS_PER_DAY), EpochDays.UNIX))) + 20;
            ...
            if (i2 != Integer.MIN_VALUE) {
                ...
                if (i4 != Integer.MIN_VALUE && chronoEntity.contains(PlainDate.QUARTER_OF_YEAR)) {
                    ...
                    if (quarter == Quarter.Q1) {
                        ...
                        i5 += NikonType2MakernoteDirectory.TAG_AF_INFO_2;
                    }
                    if (z) {
    ...
    /* JADX INFO: renamed from: net.time4j.PlainDate$1, reason: invalid class name */
    ...
    private static class IntegerElementRule implements IntElementRule<PlainDate> {
        ...
        private int getMaximumOfWIM(PlainDate plainDate) {
            ...
            byte b = plainDate.dayOfMonth;
            int i = 0;
            while (true) {
                int i2 = i + 1;
                if ((i2 * 7) + b > lengthOfMonth) {
                    return (((b + (i * 7)) - 1) / 7) + 1;
                }
                i = i2;
            }
    ...
    private static class EnumElementRule<V extends Enum<V>> implements ElementRule<PlainDate, V> {
        ...
        public boolean isValid2(PlainDate plainDate, V v) {
            ...
            try {
                withValue(plainDate, (Enum) v, false);
                return true;
