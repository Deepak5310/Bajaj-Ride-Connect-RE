...
final class SPX implements Externalizable {
    ...
    private Object readWeekmodel(DataInput dataInput, byte b) throws IOException {
        ...
        if ((b & Ascii.SI) == 1) {
            ...
            weekdayValueOf3 = Weekday.valueOf(b3 & Ascii.SI);
        }
    ...
    private void writeDayPeriod(ObjectOutput objectOutput) throws IOException {
        ...
        int i = element.isFixed() ? 113 : PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
        if (locale == null) {
            i |= 2;
        }
