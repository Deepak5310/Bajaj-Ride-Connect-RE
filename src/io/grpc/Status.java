...
public final class Status {
    ...
    private Status(Code code, @Nullable String str, @Nullable Throwable th) {
        this.code = (Code) Preconditions.checkNotNull(code, AccountsQueryParameters.CODE);
    ...
    public String toString() {
        MoreObjects.ToStringHelper toStringHelperAdd = MoreObjects.toStringHelper(this).add(AccountsQueryParameters.CODE, this.code.name()).add(SavingTrackHelper.POINT_COL_DESCRIPTION, this.description);
