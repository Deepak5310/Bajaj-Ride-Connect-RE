...
public class Platform {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [io.grpc.okhttp.internal.Platform$1] */
    ...
    private static Platform findPlatform() {
        ...
        if (androidSecurityProvider != null) {
            ...
            return new Android(optionalMethod, optionalMethod2, method3, r4, optionalMethod3, optionalMethod4, androidSecurityProvider, tlsExtensionType);
        }
        try {
            Provider provider = SSLContext.getDefault().getProvider();
            try {
                try {
                    SSLContext sSLContext = SSLContext.getInstance(Region.REGION_TIMOR_LESTE, provider);
