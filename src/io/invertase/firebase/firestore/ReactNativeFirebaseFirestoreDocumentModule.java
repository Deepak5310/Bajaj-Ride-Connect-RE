...
public class ReactNativeFirebaseFirestoreDocumentModule extends ReactNativeFirebaseModule {
    ...
    public void documentOnSnapshot(final String str, final String str2, String str3, final int i, ReadableMap readableMap) {
        ...
        EventListener<DocumentSnapshot> eventListener = new EventListener() { // from class: io.invertase.firebase.firestore.ReactNativeFirebaseFirestoreDocumentModule$$ExternalSyntheticLambda15
            ...
            public final void onEvent(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
                this.f$0.lambda$documentOnSnapshot$0(i, str, str2, (DocumentSnapshot) obj, firebaseFirestoreException);
            }
        };
    ...
    public void documentGet(final String str, final String str2, String str3, ReadableMap readableMap, final Promise promise) {
        ...
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.firestore.ReactNativeFirebaseFirestoreDocumentModule$$ExternalSyntheticLambda5
            ...
            public final Object call() {
                return ReactNativeFirebaseFirestoreSerialize.snapshotToWritableMap(str, str2, (DocumentSnapshot) Tasks.await(documentForFirestore.get(source)));
            }
    ...
    static /* synthetic */ Task lambda$documentSet$5(ReadableMap readableMap, DocumentReference documentReference, Task task) throws Exception {
        ...
        if (readableMap.hasKey("mergeFields")) {
            ...
            Iterator<Object> it2 = ((ReadableArray) Objects.requireNonNull(readableMap.getArray("mergeFields"))).toArrayList().iterator();
            while (it2.hasNext()) {
    ...
    static /* synthetic */ Task lambda$documentBatch$11(FirebaseFirestore firebaseFirestore, Task task) throws Exception {
        ...
        for (Map map : (List) task.getResult()) {
            ...
            String str2 = (String) map.get(ReactNativeBlobUtilConst.RNFB_RESPONSE_PATH);
            ...
            switch (str3) {
                case "UPDATE":
                    writeBatchBatch = writeBatchBatch.update(documentForFirestore, (Map<String, Object>) Objects.requireNonNull(map2));
                    break;
                case "SET":
                    Map map3 = (Map) map.get("options");
                    if (((Map) Objects.requireNonNull(map3)).containsKey("merge") && ((Boolean) map3.get("merge")).booleanValue()) {
                        writeBatchBatch = writeBatchBatch.set(documentForFirestore, Objects.requireNonNull(map2), SetOptions.merge());
                        break;
                    } else {
                        if (map3.containsKey("mergeFields")) {
                            ArrayList arrayList = new ArrayList();
                            Iterator it2 = ((List) Objects.requireNonNull((List) map3.get("mergeFields"))).iterator();
                            while (it2.hasNext()) {
                                arrayList.add((String) it2.next());
                            }
                            writeBatchBatch = writeBatchBatch.set(documentForFirestore, Objects.requireNonNull(map2), SetOptions.mergeFields(arrayList));
                        } else {
                            writeBatchBatch = writeBatchBatch.set(documentForFirestore, Objects.requireNonNull(map2));
                        }
                        break;
                    }
                    break;
    ...
    private void sendOnSnapshotEvent(final String str, final String str2, final int i, final DocumentSnapshot documentSnapshot) {
        Tasks.call(getExecutor(), new Callable() { // from class: io.invertase.firebase.firestore.ReactNativeFirebaseFirestoreDocumentModule$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return ReactNativeFirebaseFirestoreSerialize.snapshotToWritableMap(str, str2, documentSnapshot);
            }
            ...
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                this.f$0.lambda$sendOnSnapshotEvent$14(str, str2, i, task);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$sendOnSnapshotEvent$14(String str, String str2, int i, Task task) {
        if (task.isSuccessful()) {
            ...
            ReactNativeFirebaseEventEmitter.getSharedInstance().sendEvent(new ReactNativeFirebaseFirestoreEvent("firestore_document_sync_event", writableMapCreateMap, str, str2, i));
            return;
        }
