...
public class ReactNativeFirebaseFirestoreSerialize {
    ...
    public static WritableMap snapshotToWritableMap(String str, String str2, String str3, QuerySnapshot querySnapshot, @Nullable MetadataChanges metadataChanges) {
        WritableMap writableMapCreateMap = Arguments.createMap();
        writableMapCreateMap.putString("source", str3);
        WritableArray writableArrayCreateArray = Arguments.createArray();
        ...
        if (metadataChanges == null || metadataChanges == MetadataChanges.EXCLUDE) {
            ...
            writableMapCreateMap.putArray(KEY_CHANGES, documentChangesToWritableArray(str, str2, documentChanges, null));
        } else {
            writableMapCreateMap.putBoolean("excludesMetadataChanges", false);
            writableMapCreateMap.putArray(KEY_CHANGES, documentChangesToWritableArray(str, str2, querySnapshot.getDocumentChanges(MetadataChanges.INCLUDE), documentChanges));
        }
        SnapshotMetadata metadata = querySnapshot.getMetadata();
        Iterator<DocumentSnapshot> it2 = querySnapshot.getDocuments().iterator();
        while (it2.hasNext()) {
            writableArrayCreateArray2.pushMap(snapshotToWritableMap(str, str2, it2.next()));
        }
    ...
    private static WritableArray documentChangesToWritableArray(String str, String str2, List<DocumentChange> list, @Nullable List<DocumentChange> list2) {
        ...
        for (DocumentChange documentChange : list) {
            ...
            writableArrayCreateArray.pushMap(documentChangeToWritableMap(str, str2, documentChange, z));
        }
    ...
    private static WritableMap documentChangeToWritableMap(String str, String str2, DocumentChange documentChange, boolean z) {
        ...
        if (i == 1) {
            ...
            writableMapCreateMap.putString("type", CHANGE_REMOVED);
        }
        writableMapCreateMap.putMap(KEY_DOC_CHANGE_DOCUMENT, snapshotToWritableMap(str, str2, documentChange.getDocument()));
    ...
    /* JADX INFO: renamed from: io.invertase.firebase.firestore.ReactNativeFirebaseFirestoreSerialize$1, reason: invalid class name */
    ...
    private static WritableArray buildTypeMap(Object obj) {
        ...
        if (obj instanceof Timestamp) {
            ...
            writableArrayCreateArray2.pushDouble(timestamp.getSeconds());
            writableArrayCreateArray2.pushInt(timestamp.getNanoseconds());
    ...
    public static List<Object> parseDocumentBatches(FirebaseFirestore firebaseFirestore, ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            if (map2.hasKey(KEY_OPTIONS)) {
                map.put(KEY_OPTIONS, RCTConvertFirebase.toHashMap(map2.getMap(KEY_OPTIONS)));
            }
            arrayList.add(map);
        }
        return arrayList;
