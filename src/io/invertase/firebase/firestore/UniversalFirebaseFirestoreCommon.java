...
public class UniversalFirebaseFirestoreCommon {
    ...
    static FirebaseFirestore getFirestoreForApp(String str, String str2) {
        String strCreateFirestoreKey = createFirestoreKey(str, str2);
        WeakReference<FirebaseFirestore> weakReference = instanceCache.get(strCreateFirestoreKey);
        if (weakReference != null) {
            return weakReference.get();
        }
        FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance(FirebaseApp.getInstance(str), str2);
        setFirestoreSettings(firebaseFirestore, strCreateFirestoreKey);
