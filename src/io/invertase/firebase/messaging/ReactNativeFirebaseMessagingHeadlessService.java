...
public class ReactNativeFirebaseMessagingHeadlessService extends HeadlessJsTaskService {
    ...
    protected HeadlessJsTaskConfig getTaskConfig(Intent intent) {
        ...
        return new HeadlessJsTaskConfig(TASK_KEY, ReactNativeFirebaseMessagingSerializer.remoteMessageToWritableMap((RemoteMessage) intent.getParcelableExtra(StackTraceHelper.MESSAGE_KEY)), ReactNativeFirebaseJSON.getSharedInstance().getLongValue(TIMEOUT_JSON_KEY, 60000L), true);
    }
}
