...
public class SharedUtils {
    ...
    public static WritableMap getExceptionMap(Exception exc) {
        ...
        writableMapCreateMap.putString("nativeErrorCode", EnvironmentCompat.MEDIA_UNKNOWN);
        writableMapCreateMap.putString(StackTraceHelper.MESSAGE_KEY, message);
    ...
    private static WritableArray listToWritableArray(List<Object> list) {
        ...
        while (it2.hasNext()) {
            arrayPushValue(it2.next(), writableArrayCreateArray);
        }
        return writableArrayCreateArray;
    }
