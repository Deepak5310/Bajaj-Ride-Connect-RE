    ...
    static /* synthetic */ void lambda$checkForUnsentReports$0(Promise promise, Task task) {
        ...
        if (task.isSuccessful()) {
            if (task.getResult() != null) {
                ...
                rejectPromiseWithCodeAndMessage(promise, EnvironmentCompat.MEDIA_UNKNOWN, "Unknown result of check for unsent reports");
                return;
            }
        }
        ...
        rejectPromiseWithCodeAndMessage(promise, EnvironmentCompat.MEDIA_UNKNOWN, message);
    }
