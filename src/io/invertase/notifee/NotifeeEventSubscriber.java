...
public class NotifeeEventSubscriber implements EventListener {
    ...
    public void onBlockStateEvent(final BlockStateEvent blockStateEvent) {
        ...
        if (NotifeeReactUtils.isAppInForeground()) {
            ...
            NotifeeReactUtils.startHeadlessTask(NOTIFICATION_EVENT_KEY, writableMapCreateMap, 0L, new NotifeeReactUtils.GenericCallback() { // from class: io.invertase.notifee.NotifeeEventSubscriber$$ExternalSyntheticLambda0
    ...
    public void onForegroundServiceEvent(final ForegroundServiceEvent foregroundServiceEvent) {
        ...
        NotifeeReactUtils.startHeadlessTask(FOREGROUND_NOTIFICATION_TASK_KEY, writableMapCreateMap, 0L, new NotifeeReactUtils.GenericCallback() { // from class: io.invertase.notifee.NotifeeEventSubscriber$$ExternalSyntheticLambda1
            @Override // io.invertase.notifee.NotifeeReactUtils.GenericCallback
            public final void call() {
