...
public final class PdfDocumentKt implements Closeable {
    ...
    static final class C02342 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Integer>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02342(continuation);
        }
    ...
    public final Object getPageCount(Continuation<? super Integer> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02342(null), continuation);
    }
    ...
    static final class C02332 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super int[]>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02332(continuation);
        }
    ...
    public final Object getPageCharCounts(Continuation<? super int[]> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02332(null), continuation);
    }
    ...
    static final class C02362 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PdfPageKt>, Object> {
        final /* synthetic */ int $pageIndex;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02362(int i, Continuation<? super C02362> continuation) {
            super(2, continuation);
            this.$pageIndex = i;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02362(this.$pageIndex, continuation);
        }
    ...
    public final Object openPage(int i, Continuation<? super PdfPageKt> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02362(i, null), continuation);
    }
    ...
    static final class C02372 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends PdfPageKt>>, Object> {
        final /* synthetic */ int $fromIndex;
        final /* synthetic */ int $toIndex;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02372(int i, int i2, Continuation<? super C02372> continuation) {
            super(2, continuation);
            this.$fromIndex = i;
            this.$toIndex = i2;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02372(this.$fromIndex, this.$toIndex, continuation);
        }
    ...
    public final Object openPages(int i, int i2, Continuation<? super List<PdfPageKt>> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02372(i, i2, null), continuation);
    }

    /* JADX INFO: renamed from: io.legere.pdfiumandroid.suspend.PdfDocumentKt$getDocumentMeta$2, reason: invalid class name */
    /* JADX INFO: compiled from: PdfDocumentKt.kt */
    ...
    static final class C02352 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends PdfDocument.Bookmark>>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02352(continuation);
        }
    ...
    public final Object getTableOfContents(Continuation<? super List<PdfDocument.Bookmark>> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02352(null), continuation);
    }
    ...
    static final class C02382 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PdfTextPageKt>, Object> {
        final /* synthetic */ PdfPageKt $page;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02382(PdfPageKt pdfPageKt, Continuation<? super C02382> continuation) {
            super(2, continuation);
            this.$page = pdfPageKt;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02382(this.$page, continuation);
        }
    ...
    public final Object openTextPage(PdfPageKt pdfPageKt, Continuation<? super PdfTextPageKt> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02382(pdfPageKt, null), continuation);
    }
    ...
    static final class C02392 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends PdfTextPageKt>>, Object> {
        final /* synthetic */ int $fromIndex;
        final /* synthetic */ int $toIndex;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02392(int i, int i2, Continuation<? super C02392> continuation) {
            super(2, continuation);
            this.$fromIndex = i;
            this.$toIndex = i2;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02392(this.$fromIndex, this.$toIndex, continuation);
        }
    ...
    public final Object openTextPages(int i, int i2, Continuation<? super List<PdfTextPageKt>> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02392(i, i2, null), continuation);
    }
    ...
    static final class C02402 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
        final /* synthetic */ PdfWriteCallback $callback;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02402(PdfWriteCallback pdfWriteCallback, Continuation<? super C02402> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PdfDocumentKt.this.new C02402(this.$callback, continuation);
        }
    ...
    public final Object saveAsCopy(PdfWriteCallback pdfWriteCallback, Continuation<? super Boolean> continuation) {
        return BuildersKt.withContext(this.dispatcher, new C02402(pdfWriteCallback, null), continuation);
    }
