...
public abstract class SingleShareIntent extends ShareIntent {
    ...
    public void open(ReadableMap readableMap) throws ActivityNotFoundException {
        ...
        if (getPackage() != null || getDefaultWebLink() != null || getPlayStoreLink() != null) {
            ...
            if (getDefaultWebLink() != null) {
                playStoreLink = getDefaultWebLink().replace("{url}", urlEncode(readableMap.getString(ImagesContract.URL))).replace("{message}", urlEncode(readableMap.getString(StackTraceHelper.MESSAGE_KEY)));
    ...
    protected void openIntentChooser(ReadableMap readableMap) throws ActivityNotFoundException {
        ...
        writableMapCreateMap2.putString(StackTraceHelper.MESSAGE_KEY, getIntent().getPackage());
