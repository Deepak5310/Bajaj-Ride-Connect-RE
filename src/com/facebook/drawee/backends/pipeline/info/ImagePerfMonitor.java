...
public class ImagePerfMonitor implements ImagePerfNotifier {
    ...
    public void setEnabled(boolean z) {
        ...
        ImagePerfControllerListener2 imagePerfControllerListener3 = this.mImagePerfControllerListener2;
        if (imagePerfControllerListener3 != null) {
            this.mPipelineDraweeController.removeControllerListener2(imagePerfControllerListener3);
        }
    ...
    public void notifyStatusUpdated(ImagePerfState imagePerfState, ImageLoadStatus imageLoadStatus) {
        ...
        Iterator<ImagePerfDataListener> it2 = this.mImagePerfDataListeners.iterator();
        while (it2.hasNext()) {
            it2.next().onImageLoadStatusUpdated(imagePerfDataSnapshot, imageLoadStatus);
        }
    }
    ...
    public void notifyListenersOfVisibilityStateUpdate(ImagePerfState imagePerfState, VisibilityState visibilityState) {
        ...
        Iterator<ImagePerfDataListener> it2 = this.mImagePerfDataListeners.iterator();
        while (it2.hasNext()) {
            it2.next().onImageVisibilityUpdated(imagePerfDataSnapshot, visibilityState);
        }
    }
