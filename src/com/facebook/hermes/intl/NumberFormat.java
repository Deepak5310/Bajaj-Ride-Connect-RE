...
public class NumberFormat {
    private static String[] s_sanctionedSimpleUnitIdentifiers = {"acre", "bit", "byte", LocalePreferences.TemperatureUnit.CELSIUS, "centimeter", WeatherCriteria.UNIT_TYPE_DAY, "degree", "fahrenheit", "fluid-ounce", "foot", "gallon", "gigabit", "gigabyte", "gram", "hectare", WeatherCriteria.UNIT_TYPE_HOUR, "inch", "kilobit", "kilobyte", "kilogram", "kilometer", "liter", "megabit", "megabyte", "meter", "mile", "mile-scandinavian", "milliliter", "millimeter", "millisecond", "minute", "month", "ounce", "percent", "petabyte", "pound", "second", "stone", "terabit", "terabyte", "week", "yard", "year"};
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        ...
        Object objGetOption2 = OptionHelpers.GetOption(map, "currencyDisplay", OptionHelpers.OptionType.STRING, new String[]{"symbol", "narrowSymbol", AccountsQueryParameters.CODE, "name"}, "symbol");
        Object objGetOption3 = OptionHelpers.GetOption(map, "currencySign", OptionHelpers.OptionType.STRING, new String[]{PlaceTypes.ACCOUNTING, Constants.COLLATION_STANDARD}, Constants.COLLATION_STANDARD);
    ...
    public List<Map<String, String>> formatToParts(double d) throws JSRangeErrorException {
        ...
        for (char cFirst = toParts.first(); cFirst != 65535; cFirst = toParts.next()) {
            ...
            if (toParts.getIndex() + 1 == toParts.getRunLimit()) {
                ...
                if (it2.hasNext()) {
                    strFieldToString = this.mPlatformNumberFormatter.fieldToString(it2.next(), d);
                } else {
