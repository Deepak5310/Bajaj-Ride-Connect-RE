...
public final class ImagePipeline {
    ...
    public static final boolean clearMemoryCaches$lambda$2(CacheKey it2) {
    ...
    public static final Void isInDiskCache$lambda$4(SimpleDataSource simpleDataSource, Task task) {
        boolean z;
        if (task.isCancelled() || task.isFaulted()) {
            z = false;
        } else {
