...
public final class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        private final void doDecode(EncodedImage encodedImage, int status, int lastScheduledScanNumber) throws Throwable {
            ...
            boolean zAreEqual = Intrinsics.areEqual(encodedImage.getImageFormat(), DefaultImageFormats.GIF);
            String str2 = DecodeProducer.PRODUCER_NAME;
            if (zAreEqual && DecodeProducer.INSTANCE.isTooBig(encodedImage, this.imageDecodeOptions)) {
            ...
            String str3 = (imageFormat == null || (name = imageFormat.getName()) == null) ? EnvironmentCompat.MEDIA_UNKNOWN : name;
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            this.producerListener.onProducerFinishWithSuccess(this.producerContext, DecodeProducer.PRODUCER_NAME, getExtraMap(closeableImageInternalDecode, queuedTime, quality, zIsLast, str3, str4, str, strValueOf));
                            ...
                            e = e;
                            str2 = DecodeProducer.PRODUCER_NAME;
                            closeableImage = closeableImageInternalDecode;
                            Intrinsics.checkNotNullExpressionValue(quality, "quality");
                            try {
                                this.producerListener.onProducerFinishWithFailure(this.producerContext, str2, e, getExtraMap(closeableImage, queuedTime, quality, zIsLast, str3, str4, str, strValueOf));
                                handleError(e);
                                EncodedImage.closeSafely(encodedImage);
                            } catch (Throwable th) {
                                th = th;
