...
public final class TiffUtil {
    ...
    public static final int readOrientationFromTIFF(InputStream stream, int length) throws IOException {
        ...
        return tiffUtil.getOrientationFromTiffEntry(stream, tiffUtil.moveToTiffEntryWithTag(stream, tiffHeader2 - firstIfdOffset, tiffHeader.getIsLittleEndian(), 274), tiffHeader.getIsLittleEndian());
    }
