...
public final class DevInternalSettings implements DeveloperSettings, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (this.listener != null) {
            if (Intrinsics.areEqual(PREFS_FPS_DEBUG_KEY, key) || Intrinsics.areEqual(PREFS_JS_DEV_MODE_DEBUG_KEY, key) || Intrinsics.areEqual(PREFS_START_SAMPLING_PROFILER_ON_INIT, key) || Intrinsics.areEqual(PREFS_JS_MINIFY_DEBUG_KEY, key)) {
