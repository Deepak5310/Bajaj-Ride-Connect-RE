...
public final class LogBoxModule extends NativeLogBoxSpec {
    ...
    public LogBoxModule(ReactApplicationContext reactApplicationContext, DevSupportManager devSupportManager) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.LogBoxModule$$ExternalSyntheticLambda1
            ...
            public final void run() {
                LogBoxModule._init_$lambda$0(this.f$0);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void _init_$lambda$0(LogBoxModule this$0) {
    ...
    public void show() {
        if (this.surfaceDelegate.isContentViewReady()) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.LogBoxModule$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    LogBoxModule.show$lambda$1(this.f$0);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void show$lambda$1(LogBoxModule this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.surfaceDelegate.show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void hide$lambda$2(LogBoxModule this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void hide() {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.LogBoxModule$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                LogBoxModule.hide$lambda$2(this.f$0);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invalidate$lambda$3(LogBoxModule this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void invalidate() {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.LogBoxModule$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                LogBoxModule.invalidate$lambda$3(this.f$0);
            }
        });
    }
}
