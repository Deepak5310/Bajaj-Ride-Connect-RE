...
public abstract class DefaultReactNativeHost extends ReactNativeHost {
    ...
    public final ReactHost toReactHost$ReactAndroid_release(Context context) {
        ...
        Boolean boolIsHermesEnabled = isHermesEnabled();
        return DefaultReactHost.getDefaultReactHost$default(context, packages, jSMainModuleName, str, boolIsHermesEnabled != null ? boolIsHermesEnabled.booleanValue() : true, getUseDeveloperSupport(), null, 64, null);
    }
}
