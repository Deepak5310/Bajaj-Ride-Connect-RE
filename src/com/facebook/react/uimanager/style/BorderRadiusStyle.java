...
public final /* data */ class BorderRadiusStyle {
    ...
    public final ComputedBorderRadius resolve(int layoutDirection, Context context, float width, float height) {
        ...
        if (layoutDirection == 0) {
            ...
            float fResolve = lengthPercentage != null ? lengthPercentage.resolve(width, height) : 0.0f;
            ...
            float fResolve2 = lengthPercentage2 != null ? lengthPercentage2.resolve(width, height) : 0.0f;
            ...
            float fResolve3 = lengthPercentage3 != null ? lengthPercentage3.resolve(width, height) : 0.0f;
            ...
            computedBorderRadius = new ComputedBorderRadius(fResolve, fResolve2, fResolve3, lengthPercentage4 != null ? lengthPercentage4.resolve(width, height) : 0.0f);
            ...
            if (I18nUtil.INSTANCE.getInstance().doLeftAndRightSwapInRTL(context)) {
                ...
                float fResolve4 = lengthPercentage5 != null ? lengthPercentage5.resolve(width, height) : 0.0f;
                ...
                float fResolve5 = lengthPercentage6 != null ? lengthPercentage6.resolve(width, height) : 0.0f;
                ...
                float fResolve6 = lengthPercentage7 != null ? lengthPercentage7.resolve(width, height) : 0.0f;
                ...
                computedBorderRadius = new ComputedBorderRadius(fResolve4, fResolve5, fResolve6, lengthPercentage8 != null ? lengthPercentage8.resolve(width, height) : 0.0f);
            } else {
                ...
                float fResolve7 = lengthPercentage9 != null ? lengthPercentage9.resolve(width, height) : 0.0f;
                LengthPercentage lengthPercentage10 = this.startStart;
                ...
                float fResolve8 = lengthPercentage10 != null ? lengthPercentage10.resolve(width, height) : 0.0f;
                ...
                float fResolve9 = lengthPercentage11 != null ? lengthPercentage11.resolve(width, height) : 0.0f;
                ...
                computedBorderRadius = new ComputedBorderRadius(fResolve7, fResolve8, fResolve9, lengthPercentage12 != null ? lengthPercentage12.resolve(width, height) : 0.0f);
            }
        } else {
