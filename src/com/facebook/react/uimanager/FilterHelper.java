...
public final class FilterHelper {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (key.hashCode()) {
                case -2114203985:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createSaturateEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case -1267206133:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createOpacityEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case -1183703082:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createInvertEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case -905411385:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createGrayscaleEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case -566947070:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createContrastEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case 3027047:
                    if (!key.equals("blur")) {
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createBlurEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case 109324790:
                    if (!key.equals("sepia")) {
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createSepiaEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case 648162385:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createBrightnessEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                case 650888307:
                    ...
                    renderEffectCreateSaturateEffect = INSTANCE.createHueRotateEffect(fDoubleValue, renderEffectCreateSaturateEffect);
                    break;
                    break;
                default:
                    throw new IllegalArgumentException("Invalid filter name: " + key);
    ...
    public final RenderEffect createBlurEffect(float sigma, RenderEffect chainedEffects) {
        ...
        if (chainedEffects == null) {
            return RenderEffect.createBlurEffect(pixelFromDIP, pixelFromDIP, Shader.TileMode.DECAL);
        }
        return RenderEffect.createBlurEffect(pixelFromDIP, pixelFromDIP, chainedEffects, Shader.TileMode.DECAL);
    }
