...
final class ReactInstance {
    ...
    void initializeEagerTurboModules() {
        Iterator<String> it2 = this.mTurboModuleManager.getEagerInitModuleNames().iterator();
        while (it2.hasNext()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    class ReactJsExceptionHandlerImpl implements ReactJsExceptionHandler {
        private final MessageQueueThread mNativemodulesmessagequeuethread;

        ReactJsExceptionHandlerImpl(MessageQueueThread messageQueueThread) {
            this.mNativemodulesmessagequeuethread = messageQueueThread;
        }

        @Override // com.facebook.react.interfaces.exceptionmanager.ReactJsExceptionHandler
        public void reportJsException(ReactJsExceptionHandler.ParsedError parsedError) {
            final JavaOnlyMap javaOnlyMapConvertParsedError = StackTraceHelper.convertParsedError(parsedError);
            this.mNativemodulesmessagequeuethread.runOnQueue(new Runnable() { // from class: com.facebook.react.runtime.ReactInstance$ReactJsExceptionHandlerImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$reportJsException$0(javaOnlyMapConvertParsedError);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$reportJsException$0(JavaOnlyMap javaOnlyMap) {
            ((NativeExceptionsManagerSpec) Assertions.assertNotNull(ReactInstance.this.mTurboModuleManager.getModule(NativeExceptionsManagerSpec.NAME))).reportException(javaOnlyMap);
        }
    }
