...
public class ReactDrawableHelper {
    ...
    private static int getAttrId(Context context, String str) {
        ...
        return "selectableItemBackgroundBorderless".equals(str) ? R.attr.selectableItemBackgroundBorderless : context.getResources().getIdentifier(str, "attr", SystemMediaRouteProvider.PACKAGE_NAME);
    }
