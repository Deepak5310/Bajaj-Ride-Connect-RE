...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public void setSelectionHandleColor(ReactEditText reactEditText, Integer num) {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (num != null) {
                zzb$$ExternalSyntheticApiModelOutline0.m1443m();
                BlendModeColorFilter blendModeColorFilterM = zzb$$ExternalSyntheticApiModelOutline0.m(num.intValue(), BlendMode.SRC_IN);
        ...
        while (true) {
            ...
            try {
                Field declaredField = reactEditText.getClass().getDeclaredField(strArr[i]);
    ...
    public void setCursorColor(ReactEditText reactEditText, Integer num) {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (textCursorDrawable != null) {
                if (num != null) {
                    zzb$$ExternalSyntheticApiModelOutline0.m1443m();
                    textCursorDrawable.setColorFilter(zzb$$ExternalSyntheticApiModelOutline0.m(num.intValue(), BlendMode.SRC_IN));
                } else {
    ...
    public void addEventEmitters(final ThemedReactContext themedReactContext, final ReactEditText reactEditText) {
        ...
        reactEditText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.facebook.react.views.textinput.ReactTextInputManager$$ExternalSyntheticLambda3
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view, boolean z) {
                ReactTextInputManager.lambda$addEventEmitters$0(themedReactContext, reactEditText, view, z);
            }
        });
        reactEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.facebook.react.views.textinput.ReactTextInputManager$$ExternalSyntheticLambda4
