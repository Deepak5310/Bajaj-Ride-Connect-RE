...
public class ReactEditText extends AppCompatEditText {
    ...
    public ReactEditText(Context context) {
        ...
        this.mDefaultGravityVertical = getGravity() & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
    ...
    public boolean requestFocusInternal() {
        ...
        boolean zRequestFocus = super.requestFocus(NikonType2MakernoteDirectory.TAG_ADAPTER, null);
