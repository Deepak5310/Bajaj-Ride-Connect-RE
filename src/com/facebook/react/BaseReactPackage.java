    ...
    Iterable<ModuleHolder> getNativeModuleIterator(final ReactApplicationContext reactApplicationContext) {
        ...
        return new Iterable() { // from class: com.facebook.react.BaseReactPackage$$ExternalSyntheticLambda0
            ...
            public final Iterator iterator() {
                return this.f$0.lambda$getNativeModuleIterator$0(it2, reactApplicationContext);
            }
        };
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Iterator lambda$getNativeModuleIterator$0(final Iterator it2, final ReactApplicationContext reactApplicationContext) {
        return new Iterator<ModuleHolder>() { // from class: com.facebook.react.BaseReactPackage.1
            ...
            private void findNext() {
                while (it2.hasNext()) {
                    Map.Entry<String, ReactModuleInfo> entry = (Map.Entry) it2.next();
