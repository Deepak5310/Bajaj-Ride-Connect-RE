...
public class DebugServerException extends RuntimeException {
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString(StackTraceHelper.MESSAGE_KEY), shortenFileName(jSONObject.getString("filename")), jSONObject.getInt("lineNumber"), jSONObject.getInt("column"));
