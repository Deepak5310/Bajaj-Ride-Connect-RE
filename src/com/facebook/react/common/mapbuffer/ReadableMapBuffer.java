...
public final class ReadableMapBuffer implements MapBuffer {
    ...
    private final void readHeader() {
        ...
        this.count = m1142readUnsignedShortBwKQO78(this.buffer.position()) & UShort.MAX_VALUE;
    }
    ...
    private final int getBucketIndexForKey(int intKey) {
        ...
        if (intKey <= kEY_RANGE$ReactAndroid_release.getLast() && first <= intKey) {
            short sM2603constructorimpl = UShort.m2603constructorimpl((short) intKey);
            int count = getCount() - 1;
            int i = 0;
            while (i <= count) {
                int i2 = (i + count) >>> 1;
                int iM1142readUnsignedShortBwKQO78 = m1142readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i2)) & UShort.MAX_VALUE;
                int i3 = 65535 & sM2603constructorimpl;
                if (Intrinsics.compare(iM1142readUnsignedShortBwKQO78, i3) < 0) {
                    i = i2 + 1;
                } else {
                    if (Intrinsics.compare(iM1142readUnsignedShortBwKQO78, i3) <= 0) {
                        return i2;
    ...
    private final MapBuffer.DataType readDataType(int bucketIndex) {
        return MapBuffer.DataType.values()[m1142readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(bucketIndex) + 2) & UShort.MAX_VALUE];
    }
    ...
    public final short m1142readUnsignedShortBwKQO78(int bufferPosition) {
        return UShort.m2603constructorimpl(this.buffer.getShort(bufferPosition));
    }
    ...
    public String toString() {
        ...
        CollectionsKt.joinTo(this, sb, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 2) != 0 ? ", " : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 4) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 8) != 0 ? "" : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 16) != 0 ? -1 : 0, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 32) != 0 ? "..." : null, (PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION & 64) != 0 ? null : new Function1<MapBuffer.Entry, CharSequence>() { // from class: com.facebook.react.common.mapbuffer.ReadableMapBuffer.toString.1
    ...
    private final class MapBufferEntry implements MapBuffer.Entry {
        ...
        public int getKey() {
            return ReadableMapBuffer.this.m1142readUnsignedShortBwKQO78(this.bucketOffset) & UShort.MAX_VALUE;
        }

        @Override // com.facebook.react.common.mapbuffer.MapBuffer.Entry
        public MapBuffer.DataType getType() {
            return MapBuffer.DataType.values()[ReadableMapBuffer.this.m1142readUnsignedShortBwKQO78(this.bucketOffset + 2) & UShort.MAX_VALUE];
        }
