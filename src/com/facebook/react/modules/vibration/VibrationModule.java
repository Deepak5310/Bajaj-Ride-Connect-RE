...
public final class VibrationModule extends NativeVibrationSpec {
    ...
    private final Vibrator getVibrator() {
        if (Build.VERSION.SDK_INT >= 31) {
            VibratorManager vibratorManagerM484m = a$$ExternalSyntheticApiModelOutline0.m484m(getReactApplicationContext().getSystemService("vibrator_manager"));
            if (vibratorManagerM484m != null) {
                return vibratorManagerM484m.getDefaultVibrator();
            }
            return null;
        }
