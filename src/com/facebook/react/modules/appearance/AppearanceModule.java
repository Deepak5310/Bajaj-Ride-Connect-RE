...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0006\n\u0002\b\u0005\b\u0007\u0018\u0000 \u00182\u00020\u0001:\u0002\u0018\u0019B\u001b\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\bH\u0016J\u0010\u0010\f\u001a\u00020\b2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\u000e\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\bJ\b\u0010\u0010\u001a\u00020\bH\u0016J\u000e\u0010\u0011\u001a\u00020\n2\u0006\u0010\u0012\u001a\u00020\u000eJ\u0010\u0010\u0013\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\u0015H\u0016J\u0010\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0017\u001a\u00020\bH\u0016R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0004\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001a"}, d2 = {"Lcom/facebook/react/modules/appearance/AppearanceModule;", "Lcom/facebook/fbreact/specs/NativeAppearanceSpec;", "reactContext", "Lcom/facebook/react/bridge/ReactApplicationContext;", "overrideColorScheme", "Lcom/facebook/react/modules/appearance/AppearanceModule$OverrideColorScheme;", "(Lcom/facebook/react/bridge/ReactApplicationContext;Lcom/facebook/react/modules/appearance/AppearanceModule$OverrideColorScheme;)V", "colorScheme", "", "addListener", "", "eventName", "colorSchemeForCurrentConfiguration", "context", "Landroid/content/Context;", "emitAppearanceChanged", "getColorScheme", "onConfigurationChanged", "currentContext", "removeListeners", "count", "", "setColorScheme", "style", "Companion", "OverrideColorScheme", "ReactAndroid_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class AppearanceModule extends NativeAppearanceSpec {
    ...
    public AppearanceModule(ReactApplicationContext reactContext, OverrideColorScheme overrideColorScheme) {
        ...
        this.colorScheme = colorSchemeForCurrentConfiguration(reactContext);
    }
    ...
    private final String colorSchemeForCurrentConfiguration(Context context) {
        ...
        if ((context.getResources().getConfiguration().uiMode & 48) == 32) {
            return WeatherCriteria.THEME_DARK;
        }
        return WeatherCriteria.THEME_LIGHT;
    }
    ...
    public String getColorScheme() {
        ...
        String strColorSchemeForCurrentConfiguration = colorSchemeForCurrentConfiguration(contextWrapper);
    ...
    public void setColorScheme(String style) {
        ...
        if (iHashCode == -1626174665) {
            ...
            if (style.equals(WeatherCriteria.THEME_DARK)) {
                AppCompatDelegate.setDefaultNightMode(2);
            }
        } else if (iHashCode == 102970646 && style.equals(WeatherCriteria.THEME_LIGHT)) {
            AppCompatDelegate.setDefaultNightMode(1);
        }
    }
    ...
    public final void onConfigurationChanged(Context currentContext) {
        ...
        if (Intrinsics.areEqual(this.colorScheme, strColorSchemeForCurrentConfiguration)) {
            return;
        }
        this.colorScheme = strColorSchemeForCurrentConfiguration;
