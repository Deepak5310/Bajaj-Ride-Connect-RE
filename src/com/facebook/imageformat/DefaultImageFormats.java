...
public final class DefaultImageFormats {
    ...
    static {
        ...
        JPEG = imageFormat;
        ImageFormat imageFormat2 = new ImageFormat(Region.REGION_PAPUA_NEW_GUINEA, "png");
        PNG = imageFormat2;
