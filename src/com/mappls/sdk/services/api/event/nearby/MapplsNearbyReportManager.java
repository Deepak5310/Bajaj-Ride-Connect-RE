...
public class MapplsNearbyReportManager {
    ...
    public ApiResponse<NearbyReportResponse> executeCall() throws IOException {
        Response<NearbyReportResponse> responseExecute = this.mapplsNearbyReport.execute();
    ...
    public void call(final OnResponseCallback<NearbyReportResponse> onResponseCallback) {
        this.mapplsNearbyReport.enqueue(new Callback<NearbyReportResponse>() { // from class: com.mappls.sdk.services.api.event.nearby.MapplsNearbyReportManager.1
