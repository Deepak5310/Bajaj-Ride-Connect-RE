...
public class MapplsRouteSummaryManager {
    ...
    public ApiResponse<RouteReportSummaryResponse> executeCall() throws IOException {
        Response<RouteReportSummaryResponse> responseExecute = this.mapplsRouteSummary.execute();
    ...
    public void call(final OnResponseCallback<RouteReportSummaryResponse> onResponseCallback) {
        this.mapplsRouteSummary.enqueue(new Callback<RouteReportSummaryResponse>() { // from class: com.mappls.sdk.services.api.event.route.MapplsRouteSummaryManager.1
