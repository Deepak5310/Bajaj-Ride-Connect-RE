...
public class MapplsFuelCostManager {
    ...
    public ApiResponse<FuelCostResponse> executeCall() throws IOException {
        Response<FuelCostResponse> responseExecute = this.mapplsFuelCost.execute();
    ...
    public void call(final OnResponseCallback<FuelCostResponse> onResponseCallback) {
        this.mapplsFuelCost.enqueue(new Callback<FuelCostResponse>() { // from class: com.mappls.sdk.services.api.fuleCost.MapplsFuelCostManager.1
