...
public class MapplsTripOptimisationManager {
    ...
    public ApiResponse<TripOptimisationResponse> executeCall() throws IOException {
        Response<TripOptimisationResponse> responseExecute = this.mapplsTripOptimisation.execute();
    ...
    public void call(final OnResponseCallback<TripOptimisationResponse> onResponseCallback) {
        this.mapplsTripOptimisation.enqueue(new Callback<TripOptimisationResponse>() { // from class: com.mappls.sdk.services.api.tripoptimisation.MapplsTripOptimisationManager.1
