...
public class MapplsCostEstimationManager {
    ...
    public ApiResponse<CostEstimationResponse> executeCall() throws IOException {
        Response<CostEstimationResponse> responseExecute = this.mapplsCostEstimation.execute();
    ...
    public void call(final OnResponseCallback<CostEstimationResponse> onResponseCallback) {
        this.mapplsCostEstimation.enqueue(new Callback<CostEstimationResponse>() { // from class: com.mappls.sdk.services.api.costestimation.MapplsCostEstimationManager.1
