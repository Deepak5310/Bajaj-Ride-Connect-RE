...
public class MapplsTextSearchManager {
    ...
    public ApiResponse<AutoSuggestAtlasResponse> executeCall() throws IOException {
        Response<AutoSuggestAtlasResponse> responseExecute = this.mapplsTextSearch.execute();
    ...
    public void call(final OnResponseCallback<AutoSuggestAtlasResponse> onResponseCallback) {
        this.mapplsTextSearch.enqueue(new Callback<AutoSuggestAtlasResponse>() { // from class: com.mappls.sdk.services.api.textsearch.MapplsTextSearchManager.1
