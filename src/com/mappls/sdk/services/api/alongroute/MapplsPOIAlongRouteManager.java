...
public class MapplsPOIAlongRouteManager {
    ...
    public ApiResponse<POIAlongRouteResponse> executeCall() throws IOException {
        Response<POIAlongRouteResponse> responseExecute = this.mapplsPOIAlongRoute.execute();
    ...
    public void call(final OnResponseCallback<POIAlongRouteResponse> onResponseCallback) {
        this.mapplsPOIAlongRoute.enqueue(new Callback<POIAlongRouteResponse>() { // from class: com.mappls.sdk.services.api.alongroute.MapplsPOIAlongRouteManager.1
