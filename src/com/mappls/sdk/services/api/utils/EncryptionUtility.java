...
public class EncryptionUtility {
    ...
    public static String encryptData(String str) throws InvalidKeyException, InvalidAlgorithmParameterException {
    ...
    public static String decryptData(String str) throws InvalidKeyException, InvalidAlgorithmParameterException {
        SecretKeySpec secretKeySpec = new SecretKeySpec(Base64.decode(getKey(), 2), new String(Base64.decode(getKeyAlgorithm(), 2)));
        try {
            Cipher cipher = Cipher.getInstance(new String(Base64.decode(getAlgorithm(), 2)));
