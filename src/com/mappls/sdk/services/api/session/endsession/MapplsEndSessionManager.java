...
public class MapplsEndSessionManager {
    ...
    public ApiResponse<Void> executeCall() throws IOException {
        Response<Void> responseExecute = this.mapplsEndSession.execute();
    ...
    public void call(final OnResponseCallback<Void> onResponseCallback) {
        this.mapplsEndSession.enqueue(new Callback<Void>() { // from class: com.mappls.sdk.services.api.session.endsession.MapplsEndSessionManager.1
