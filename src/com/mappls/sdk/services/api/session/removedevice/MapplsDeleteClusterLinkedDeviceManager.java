...
public class MapplsDeleteClusterLinkedDeviceManager {
    ...
    public ApiResponse<Void> executeCall() throws IOException {
        Response<Void> responseExecute = this.mapplsDeleteClusterLinkedDevice.execute();
    ...
    public void call(final OnResponseCallback<Void> onResponseCallback) {
        this.mapplsDeleteClusterLinkedDevice.enqueue(new Callback<Void>() { // from class: com.mappls.sdk.services.api.session.removedevice.MapplsDeleteClusterLinkedDeviceManager.1
