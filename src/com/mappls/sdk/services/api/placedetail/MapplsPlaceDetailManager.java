...
public class MapplsPlaceDetailManager {
    ...
    public ApiResponse<PlaceDetailResponse> executeCall() throws IOException {
        Response<PlaceDetailResponse> responseExecute = this.mapplsPlaceDetail.execute();
    ...
    public void call(final OnResponseCallback<PlaceDetailResponse> onResponseCallback) {
