...
public class MapplsFeedbackManager {
    ...
    public ApiResponse<Void> executeCall() throws IOException {
        Response<Void> responseExecute = this.mapplsFeedback.execute();
    ...
    public void call(final OnResponseCallback<Void> onResponseCallback) {
        this.mapplsFeedback.enqueue(new Callback<Void>() { // from class: com.mappls.sdk.services.api.feedback.MapplsFeedbackManager.1
