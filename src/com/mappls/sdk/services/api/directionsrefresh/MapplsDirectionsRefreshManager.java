...
public class MapplsDirectionsRefreshManager {
    ...
    public ApiResponse<DirectionsRoute> executeCall() throws IOException {
        Response<DirectionsRoute> responseExecute = this.mapplsDirectionsRefresh.execute();
    ...
    public void call(final OnResponseCallback<DirectionsRoute> onResponseCallback) {
        this.mapplsDirectionsRefresh.enqueue(new Callback<DirectionsRoute>() { // from class: com.mappls.sdk.services.api.directionsrefresh.MapplsDirectionsRefreshManager.1
