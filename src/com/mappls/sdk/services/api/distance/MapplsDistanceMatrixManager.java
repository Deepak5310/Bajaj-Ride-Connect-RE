...
public class MapplsDistanceMatrixManager {
    ...
    public ApiResponse<DistanceResponse> executeCall() throws IOException {
        Response<DistanceResponse> responseExecute = this.mapplsDistanceMatrix.execute();
    ...
    public void call(final OnResponseCallback<DistanceResponse> onResponseCallback) {
        this.mapplsDistanceMatrix.enqueue(new Callback<DistanceResponse>() { // from class: com.mappls.sdk.services.api.distance.MapplsDistanceMatrixManager.1
