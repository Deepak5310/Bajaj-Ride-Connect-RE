...
public class MapplsDirectionManager {
    ...
    public ApiResponse<DirectionsResponse> executeCall() throws IOException {
        Response<DirectionsResponse> responseExecute = this.mapplsDirections.execute();
    ...
    public void call(final OnResponseCallback<DirectionsResponse> onResponseCallback) {
        this.mapplsDirections.enqueue(new Callback<DirectionsResponse>() { // from class: com.mappls.sdk.services.api.directions.MapplsDirectionManager.1
