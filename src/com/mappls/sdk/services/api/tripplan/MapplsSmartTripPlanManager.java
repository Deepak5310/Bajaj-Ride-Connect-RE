...
public class MapplsSmartTripPlanManager {
    private MapplsSmartTripPlan mapplsSmartTripPlanner;

    private MapplsSmartTripPlanManager(MapplsSmartTripPlan mapplsSmartTripPlan) {
        this.mapplsSmartTripPlanner = mapplsSmartTripPlan;
    }

    public static MapplsSmartTripPlanManager newInstance(MapplsSmartTripPlan mapplsSmartTripPlan) {
        return new MapplsSmartTripPlanManager(mapplsSmartTripPlan);
    }

    public ApiResponse<SmartTripPlanResponse> executeCall() throws IOException {
        Response<SmartTripPlanResponse> responseExecute = this.mapplsSmartTripPlanner.execute();
    ...
    public void call(final OnResponseCallback<SmartTripPlanResponse> onResponseCallback) {
        this.mapplsSmartTripPlanner.enqueue(new Callback<SmartTripPlanResponse>() { // from class: com.mappls.sdk.services.api.tripplan.MapplsSmartTripPlanManager.1
            @Override // retrofit2.Callback
            public void onResponse(Call<SmartTripPlanResponse> call, Response<SmartTripPlanResponse> response) {
            ...
            @Override // retrofit2.Callback
            public void onFailure(Call<SmartTripPlanResponse> call, Throwable th) {
                if (call.isCanceled()) {
    ...
    public void cancel() {
        this.mapplsSmartTripPlanner.cancel();
    }

    public boolean isExecuted() {
        return this.mapplsSmartTripPlanner.executed();
    }
}
