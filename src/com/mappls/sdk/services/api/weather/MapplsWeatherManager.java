...
public class MapplsWeatherManager {
    ...
    public ApiResponse<WeatherResponse> executeCall() throws IOException {
        Response<WeatherResponse> responseExecute = this.mapplsWeatherCondition.execute();
    ...
    public void call(final OnResponseCallback<WeatherResponse> onResponseCallback) {
        this.mapplsWeatherCondition.enqueue(new Callback<WeatherResponse>() { // from class: com.mappls.sdk.services.api.weather.MapplsWeatherManager.1
