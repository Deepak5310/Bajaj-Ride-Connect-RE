...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    private static class b {
        ...
        static {
            ...
            a = map;
            map.put("layout/mappls_category_result_fragment_0", Integer.valueOf(R.layout.mappls_category_result_fragment));
            map.put("layout/mappls_category_search_fragment_0", Integer.valueOf(R.layout.mappls_category_search_fragment));
            map.put("layout/mappls_category_search_item_fragment_0", Integer.valueOf(R.layout.mappls_category_search_item_fragment));
        }
    }
