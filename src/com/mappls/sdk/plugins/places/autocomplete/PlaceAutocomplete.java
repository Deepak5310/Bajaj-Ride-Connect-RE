...
public final class PlaceAutocomplete {
    ...
    public static MapplsFavoritePlace getFavoritePlace(Intent intent) {
        return (MapplsFavoritePlace) new Gson().fromJson(intent.getStringExtra(PlaceConstants.RETURNING_FAVORITE_DATA), MapplsFavoritePlace.class);
    }
    ...
    public static SuggestedSearchAtlas getSuggestedSearch(Intent intent) {
        return (SuggestedSearchAtlas) new Gson().fromJson(intent.getStringExtra(PlaceConstants.RETURNING_SUGGESTED_DATA), SuggestedSearchAtlas.class);
    }
