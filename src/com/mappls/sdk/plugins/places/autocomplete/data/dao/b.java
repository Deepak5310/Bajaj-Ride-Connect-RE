...
final class b extends EntityInsertionAdapter<com.mappls.sdk.plugins.places.autocomplete.data.entity.a> {
    b(SearchHistoryDatabase searchHistoryDatabase) {
        super(searchHistoryDatabase);
    }

    @Override // androidx.room.EntityInsertionAdapter
    protected final void bind(SupportSQLiteStatement supportSQLiteStatement, com.mappls.sdk.plugins.places.autocomplete.data.entity.a aVar) {
        ...
        String strA = com.mappls.sdk.plugins.places.autocomplete.data.converter.a.a(aVar2.b());
        if (strA == null) {
            supportSQLiteStatement.bindNull(2);
        } else {
            supportSQLiteStatement.bindString(2, strA);
        }
        if (aVar2.f() == null) {
