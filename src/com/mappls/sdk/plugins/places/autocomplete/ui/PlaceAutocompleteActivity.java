...
public class PlaceAutocompleteActivity extends AppCompatActivity implements PlaceSelectionListener, SuggestedSearchSelectionListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            PlaceAutocompleteFragment placeAutocompleteFragmentNewInstance = placeOptions != null ? PlaceAutocompleteFragment.newInstance(placeOptions) : PlaceAutocompleteFragment.newInstance();
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, placeAutocompleteFragmentNewInstance, PlaceAutocompleteFragment.TAG).commit();
            placeAutocompleteFragmentNewInstance.setOnPlaceSelectedListener(this);
            placeAutocompleteFragmentNewInstance.setSuggestedSearchSelectionListener(this);
        }
    }
