...
public abstract class c {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                a[m.AspectFill.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                a[m.Center.ordinal()] = 3;
    ...
    private static class b {
        ...
        private static RectF b = new RectF(0.0f, 0.0f, 32.0f, 32.0f);
    ...
    /* JADX INFO: renamed from: com.mappls.sdk.plugin.directions.view.c$c, reason: collision with other inner class name */
    ...
    private static class l {
        ...
        private static com.mappls.sdk.plugin.directions.view.d f725n = new com.mappls.sdk.plugin.directions.view.d();
    }
    ...
    public static void a(Canvas canvas, RectF rectF, m mVar, int i2, PointF pointF) {
        ...
        float f2 = pointF.x;
        float f3 = f2 / 2.0f;
        float fMin = Math.min(f2 / 32.0f, pointF.y / 32.0f);
    ...
    public static void b(Canvas canvas, RectF rectF, m mVar, int i2, PointF pointF) {
        Stack stack = new Stack();
        stack.push(new Matrix());
        Paint paint = C0110c.a;
        float f2 = pointF.x;
        float f3 = f2 / 2.0f;
        float fMin = Math.min(f2 / 32.0f, pointF.y / 32.0f);
        float f4 = pointF.y / 2.0f;
        canvas.save();
        RectF rectF2 = C0110c.c;
        a(mVar, C0110c.b, rectF, rectF2);
        canvas.translate(rectF2.left, rectF2.top);
        canvas.scale(rectF2.width() / 32.0f, rectF2.height() / 32.0f);
        C0110c.d.set(0.0f, 0.0f, pointF.x, pointF.y);
        canvas.save();
        canvas.translate(f3, f4);
        ((Matrix) stack.peek()).postTranslate(f3, f4);
        canvas.scale(fMin, fMin);
        ((Matrix) stack.peek()).postScale(fMin, fMin);
        C0110c.e.set(-0.99f, 5.6f, -0.99f, 16.0f);
        Path path = C0110c.f;
        path.reset();
        ...
        canvas.drawPath(path, paint);
        canvas.restore();
        C0110c.g.set(-9.05f, -10.03f, 6.95f, 1.48f);
        Path path2 = C0110c.h;
        path2.reset();
    ...
    public static void d(Canvas canvas, RectF rectF, m mVar, int i2, PointF pointF) {
        ...
        float f2 = pointF.y;
        float f3 = f2 / 2.0f;
        float fMin = Math.min(pointF.x / 32.0f, f2 / 32.0f);
    ...
    public static void d(Canvas canvas, RectF rectF, m mVar, int i2, int i3, PointF pointF) {
        ...
        stack.push(new Matrix());
        Paint paint = h.a;
        float fMin = Math.min(pointF.x / 32.0f, pointF.y / 32.0f);
        canvas.save();
        RectF rectF2 = h.c;
        a(mVar, h.b, rectF, rectF2);
        canvas.translate(rectF2.left, rectF2.top);
    ...
    public static void a(Canvas canvas, RectF rectF, m mVar, int i2, int i3, PointF pointF, float f2, float f3) {
        ...
        float fCos = (pointF.y - (((f3 * 2.0f) + 4.0f) * fMin)) + 1.0f + (((((float) Math.cos(d2)) * fMin) * 20.0f) / 4.0f);
        float fSin = (pointF.x / 2.0f) + ((((0.75f * fMin) * ((float) Math.sin(d2))) * 16.0f) / 2.0f);
        canvas.save();
        RectF rectF2 = l.c;
        ...
        Path path2 = l.h;
        path2.reset();
        float fMin2 = Math.min(Math.min(rectF3.width(), rectF3.height()) / 2.0f, 1.0f);
        float[] fArr = l.i;
        fArr[1] = fMin2;
        fArr[0] = fMin2;
        fArr[3] = fMin2;
        ...
        paint.setStrokeJoin(Paint.Join.ROUND);
        paint.setStrokeMiter(10.0f);
        paint.setPathEffect(l.f725n.a((f2 / 360.0f) * 2.0f * 3.1415927f * f3, 1000.0f, 0.0f));
        canvas.save();
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(i2);
        canvas.drawPath(path4, paint);
