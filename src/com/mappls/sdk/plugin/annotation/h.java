...
class h implements c<SymbolLayer> {
    ...
    h() {
        ...
        this.a = String.format("mappls-android-symbol-layer-%s", Long.valueOf(jIncrementAndGet));
        this.b = String.format("mappls-android-symbol-source-%s", Long.valueOf(jIncrementAndGet));
    }
