...
public class SymbolOptions extends g<Symbol> {
    ...
    static SymbolOptions fromFeature(Feature feature, Style style) {
        ...
        if (feature.hasProperty(PROPERTY_ICON_OFFSET)) {
            symbolOptions.iconOffset = b.a(feature.getProperty(PROPERTY_ICON_OFFSET).getAsJsonArray());
        }
        ...
        if (feature.hasProperty(PROPERTY_TEXT_FONT)) {
            symbolOptions.textFont = b.b(feature.getProperty(PROPERTY_TEXT_FONT).getAsJsonArray());
        }
        ...
        if (feature.hasProperty(PROPERTY_TEXT_OFFSET)) {
            symbolOptions.textOffset = b.a(feature.getProperty(PROPERTY_TEXT_OFFSET).getAsJsonArray());
        }
    ...
    Symbol build(long j, AnnotationManager<?, Symbol, ?, ?, ?, ?> annotationManager) {
        ...
        if (str2 == null) {
            ...
            long jIncrementAndGet = IMAGE_ID_GENERATOR.incrementAndGet();
            annotationManager.style.addImage(ICON_IMAGE_NAME + jIncrementAndGet, this.icon);
            str = ICON_IMAGE_NAME + jIncrementAndGet;
        } else {
        ...
        jsonObject.add(PROPERTY_TEXT_FONT, b.a(this.textFont));
    ...
    public SymbolOptions data(JsonElement jsonElement) {
