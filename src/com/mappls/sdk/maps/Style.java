...
public class Style {
    ...
    public String getMapplsStyle() {
        validateState("getMapplsStyle");
        return this.nativeMap.getMapplsStyle();
    }
    ...
    void onDidFinishLoadingStyle() {
        ...
        Iterator it2 = this.builder.sources.iterator();
        while (it2.hasNext()) {
        ...
        for (Builder.LayerWrapper layerWrapper : this.builder.layers) {
            if (layerWrapper instanceof Builder.LayerAtWrapper) {
                ...
                addLayerBelow(layerWrapper.layer, MapplsConstants.LAYER_ID_ANNOTATIONS);
            }
        }
    ...
    public static class Builder {
        ...
        private String mapplsStyle = getDefaultStyle();
        ...
        public Builder fromMapplsStyle(String str) {
