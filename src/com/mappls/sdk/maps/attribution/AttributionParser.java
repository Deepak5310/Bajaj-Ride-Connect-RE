...
public class AttributionParser {
    ...
    private final boolean withMapplsAttribution;
    ...
    private void parseAttributions() {
        this.attributions.add(new Attribution("@OpenStreetMap", ""));
    }

    private void parseUrlSpan(SpannableStringBuilder spannableStringBuilder, URLSpan uRLSpan) {
        this.attributions.add(new Attribution("Open Street Map", ""));
    }

    private boolean isUrlValid(String str) {
        return isValidForImproveThisMap(str) && isValidForMappls(str);
    }
    ...
    private boolean isValidForMappls(String str) {
        return this.withMapplsAttribution || !str.equals("https://about.mappls.com/");
    }
    ...
    public static class Options {
        ...
        private boolean withMapplsAttribution = true;
        ...
        public AttributionParser build() {
            ...
            AttributionParser attributionParser = new AttributionParser(this.context, parseAttribution(strArr), this.withImproveMap, this.withCopyrightSign, this.withMapplsAttribution);
