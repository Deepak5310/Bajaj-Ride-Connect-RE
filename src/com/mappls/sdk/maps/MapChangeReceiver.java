...
class MapChangeReceiver implements NativeMapView.StateCallback {
    ...
    @Override // com.mappls.sdk.maps.NativeMapView.StateCallback
    ...
    @Override // com.mappls.sdk.maps.NativeMapView.StyleCallback
    ...
    public void onDidFinishLoadingMap() {
        try {
            ...
            while (it2.hasNext()) {
                it2.next().onDidFinishLoadingMap();
            }
        } catch (Throwable th) {
    ...
    public void onDidFailLoadingMap(String str) {
        try {
            ...
            while (it2.hasNext()) {
                it2.next().onDidFailLoadingMap(str);
            }
        } catch (Throwable th) {
    ...
    public boolean onCanRemoveUnusedStyleImage(String str) {
        ...
        try {
            if (!this.onCanRemoveUnusedStyleImageListenerList.isEmpty()) {
                Iterator<MapView.OnCanRemoveUnusedStyleImageListener> it2 = this.onCanRemoveUnusedStyleImageListenerList.iterator();
                while (it2.hasNext()) {
                    zOnCanRemoveUnusedStyleImage &= it2.next().onCanRemoveUnusedStyleImage(str);
                }
            }
