...
public class DownloadMapImageTask extends AsyncTask<Map.Entry<String, ImageEntry>, Void, List<Map.Entry<String, Bitmap>>> {
    ...
    public DownloadMapImageTask(Context context, MapplsMap mapplsMap, @Nullable OnAllImagesLoaded onAllImagesLoaded) {
    ...
    public void onPostExecute(List<Map.Entry<String, Bitmap>> list) {
        ...
        if (mapplsMap != null && list != null && list.size() > 0 && (style = mapplsMap.getStyle()) != null) {
