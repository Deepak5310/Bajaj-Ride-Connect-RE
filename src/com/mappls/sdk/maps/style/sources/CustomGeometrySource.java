...
public class CustomGeometrySource extends Source {
    ...
    public List<Feature> querySourceFeatures(Expression expression) {
        checkThread();
        Feature[] featureArrQuerySourceFeatures = querySourceFeatures(expression != null ? expression.toArray() : null);
    ...
    private void startThreads() {
        ...
        try {
            ...
            this.executor = new ThreadPoolExecutor(4, 4, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(), new ThreadFactory() { // from class: com.mappls.sdk.maps.style.sources.CustomGeometrySource.1
