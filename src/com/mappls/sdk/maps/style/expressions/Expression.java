...
public class Expression {
    ...
    public static Expression distance(GeoJson geoJson) {
        ...
        return new Expression(DirectionsCriteria.ANNOTATION_DISTANCE, new ExpressionMap(map));
    }
    ...
    public static Expression floor(Expression expression) {
        return new Expression(PlaceTypes.FLOOR, expression);
    }
    ...
    public static Expression format(FormatEntry... formatEntryArr) {
        ...
        for (FormatEntry formatEntry : formatEntryArr) {
            ...
            i += 2;
            expressionArr[i2] = new ExpressionMap(map);
        }
    ...
    public static class ExpressionLiteral extends Expression implements ValueExpression {
        ...
        @Override // com.mappls.sdk.maps.style.expressions.Expression.ValueExpression
