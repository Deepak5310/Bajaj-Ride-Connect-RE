...
abstract class MapplsAnimator<K> extends ValueAnimator implements ValueAnimator.AnimatorUpdateListener {
    ...
    MapplsAnimator(K[] kArr, AnimationsValueChangeListener<K> animationsValueChangeListener, int i) {
        this.minUpdateInterval = 1.0E9d / ((double) i);
    ...
    public MapplsAnimator(AnimationsValueChangeListener<K> animationsValueChangeListener, K k, K k2, double d, long j) {
        this.updateListener = animationsValueChangeListener;
        this.target = k;
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            MapplsAnimator.this.postUpdates();
        }
    }
