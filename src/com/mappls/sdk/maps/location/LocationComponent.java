...
public final class LocationComponent {
    ...
    private MapplsMap.OnCameraIdleListener onCameraIdleListener;
    private OnCameraMoveInvalidateListener onCameraMoveInvalidateListener;
    private MapplsMap.OnCameraMoveListener onCameraMoveListener;
    ...
    private MapplsMap.OnMapClickListener onMapClickListener;
    private MapplsMap.OnMapLongClickListener onMapLongClickListener;
    ...
    public LocationComponent(MapplsMap mapplsMap, Transform transform, List<MapplsMap.OnDeveloperAnimationListener> list) {
        ...
        this.onCameraMoveListener = new MapplsMap.OnCameraMoveListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.1
            @Override // com.mappls.sdk.maps.MapplsMap.OnCameraMoveListener
            public void onCameraMove() {
                LocationComponent.this.updateLayerOffsets(false);
            }
        };
        this.onCameraIdleListener = new MapplsMap.OnCameraIdleListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.2
            @Override // com.mappls.sdk.maps.MapplsMap.OnCameraIdleListener
            public void onCameraIdle() {
                LocationComponent.this.updateLayerOffsets(false);
            }
        };
        this.onMapClickListener = new MapplsMap.OnMapClickListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.3
        ...
        this.onMapLongClickListener = new MapplsMap.OnMapLongClickListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.4
        ...
        this.onLocationStaleListener = new OnLocationStaleListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.5
        ...
        this.onCameraMoveInvalidateListener = new OnCameraMoveInvalidateListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.6
        ...
        this.compassListener = new CompassListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.7
        ...
        this.cameraTrackingChangedListener = new OnCameraTrackingChangedListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.8
            ...
            public void onCameraTrackingChanged(int i) {
                ...
                Iterator it2 = LocationComponent.this.onCameraTrackingChangedListeners.iterator();
                while (it2.hasNext()) {
                    ((OnCameraTrackingChangedListener) it2.next()).onCameraTrackingChanged(i);
                }
            }
        };
        this.renderModeChangedListener = new OnRenderModeChangedListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.9
            ...
            public void onRenderModeChanged(int i) {
                ...
                while (it2.hasNext()) {
                    ((OnRenderModeChangedListener) it2.next()).onRenderModeChanged(i);
                }
            }
        };
    ...
    LocationComponent() {
        ...
        this.developerAnimationListener = new MapplsMap.OnDeveloperAnimationListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.10
            @Override // com.mappls.sdk.maps.MapplsMap.OnDeveloperAnimationListener
            public void onDeveloperAnimationStarted() {
                if (LocationComponent.this.isComponentInitialized && LocationComponent.this.isEnabled) {
                    LocationComponent.this.setCameraMode(8);
    ...
    LocationComponent(MapplsMap mapplsMap, Transform transform, List<MapplsMap.OnDeveloperAnimationListener> list, LocationEngineCallback<LocationEngineResult> locationEngineCallback, LocationEngineCallback<LocationEngineResult> locationEngineCallback2, LocationLayerController locationLayerController, LocationCameraController locationCameraController, LocationAnimatorCoordinator locationAnimatorCoordinator, StaleStateManager staleStateManager, CompassEngine compassEngine, InternalLocationEngineProvider internalLocationEngineProvider, boolean z) {
        ...
        this.onLocationStaleListener = new OnLocationStaleListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.5
            ...
            public void onStaleStateChange(boolean z2) {
                ...
                Iterator it2 = LocationComponent.this.onLocationStaleListeners.iterator();
                while (it2.hasNext()) {
                    ((OnLocationStaleListener) it2.next()).onStaleStateChange(z2);
                }
            }
        };
        this.onCameraMoveInvalidateListener = new OnCameraMoveInvalidateListener() { // from class: com.mappls.sdk.maps.location.LocationComponent.6
    ...
    public void activateLocationComponent(LocationComponentActivationOptions locationComponentActivationOptions) {
        ...
        if (locationComponentOptions == null) {
            ...
            if (iStyleRes == 0) {
                iStyleRes = R.style.mappls_maps_LocationComponent;
            }
    ...
    private class CameraTransitionListener implements OnLocationCameraTransitionListener {
        ...
        private void reset(int i) {
            LocationComponent.this.locationAnimatorCoordinator.resetAllCameraAnimations(LocationComponent.this.mapplsMap.getCameraPosition(), i == 36);
        }
    }
    ...
    public void zoomWhileTracking(double d, long j, MapplsMap.CancelableCallback cancelableCallback) {
        checkActivationState();
        ...
        if (getCameraMode() == 8) {
            ...
            this.locationAnimatorCoordinator.feedNewZoomLevel(d, this.mapplsMap.getCameraPosition(), j, cancelableCallback);
        }
    }
    ...
    public void tiltWhileTracking(double d, long j, MapplsMap.CancelableCallback cancelableCallback) {
        checkActivationState();
        if (!this.isLayerReady) {
            notifyUnsuccessfulCameraOperation(cancelableCallback, null);
            return;
        ...
        if (getCameraMode() == 8) {
            ...
            this.locationAnimatorCoordinator.feedNewTilt(d, this.mapplsMap.getCameraPosition(), j, cancelableCallback);
        }
    }
    ...
    public void forceLocationUpdate(Location location, boolean z) {
        checkActivationState();
    ...
    public void resetCompassEngine(Context context) {
    ...
    private void initialize(Context context, Style style, boolean z, LocationComponentOptions locationComponentOptions) {
        ...
        this.locationLayerController = new LocationLayerController(this.mapplsMap, style, new LayerSourceProvider(), new LayerFeatureProvider(), new LayerBitmapProvider(context), locationComponentOptions, this.renderModeChangedListener, z);
        this.locationCameraController = new LocationCameraController(context, this.mapplsMap, this.transform, this.cameraTrackingChangedListener, locationComponentOptions, this.onCameraMoveInvalidateListener);
        LocationAnimatorCoordinator locationAnimatorCoordinator = new LocationAnimatorCoordinator(this.mapplsMap.getProjection(), MapplsAnimatorSetProvider.getInstance(), MapplsAnimatorProvider.getInstance());
        this.locationAnimatorCoordinator = locationAnimatorCoordinator;
    ...
    private void updateMapWithOptions(LocationComponentOptions locationComponentOptions) {
        ...
        if (iArrPadding != null) {
            this.mapplsMap.setPadding(iArrPadding[0], iArrPadding[1], iArrPadding[2], iArrPadding[3]);
        }
    }
    ...
    public void updateCompassHeading(float f) {
        this.locationAnimatorCoordinator.feedNewCompassBearing(f, this.mapplsMap.getCameraPosition());
    }
    ...
    private void updateAccuracyRadius(Location location, boolean z) {
        ...
        if (location == null) {
            ...
            fCalculateZoomLevelRadius = Utils.calculateZoomLevelRadius(this.mapplsMap, location);
        }
    ...
    public void updateAnimatorListenerHolders() {
        ...
        this.locationAnimatorCoordinator.resetAllCameraAnimations(this.mapplsMap.getCameraPosition(), this.locationCameraController.getCameraMode() == 36);
    ...
    public void setManualStaleState(boolean z) {
        ...
        if (staleStateManager != null) {
            staleStateManager.showStaleState(z);
        }
    }
    ...
    private void notifyUnsuccessfulCameraOperation(MapplsMap.CancelableCallback cancelableCallback, String str) {
        if (str != null) {
            Logger.e(TAG, str);
        }
    ...
    public void setTransitioning(boolean z) {
        ...
        if (locationCameraController != null) {
            locationCameraController.setTransitioning(z);
        }
    }
}
