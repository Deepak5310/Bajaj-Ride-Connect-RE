...
public class LocationComponentOptions implements Parcelable {
    ...
    public static final Parcelable.Creator<LocationComponentOptions> CREATOR = new Parcelable.Creator<LocationComponentOptions>() { // from class: com.mappls.sdk.maps.location.LocationComponentOptions.1
    ...
    public static LocationComponentOptions createFromAttributes(Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, R.styleable.mappls_maps_LocationComponent);
        ...
        builderPadding.foregroundDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_foregroundDrawable, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_foregroundTintColor)) {
            builderPadding.foregroundTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_foregroundTintColor, -1)));
        }
        builderPadding.backgroundDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_backgroundDrawable, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_backgroundTintColor)) {
            builderPadding.backgroundTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_backgroundTintColor, -1)));
        }
        builderPadding.foregroundDrawableStale(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_foregroundDrawableStale, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_foregroundStaleTintColor)) {
            builderPadding.foregroundStaleTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_foregroundStaleTintColor, -1)));
        }
        builderPadding.backgroundDrawableStale(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_backgroundDrawableStale, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_backgroundStaleTintColor)) {
            builderPadding.backgroundStaleTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_backgroundStaleTintColor, -1)));
        }
        builderPadding.bearingDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_bearingDrawable, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_bearingTintColor)) {
            builderPadding.bearingTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_bearingTintColor, -1)));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_enableStaleState)) {
            builderPadding.enableStaleState(typedArrayObtainStyledAttributes.getBoolean(R.styleable.mappls_maps_LocationComponent_mappls_maps_enableStaleState, true));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_staleStateTimeout)) {
            builderPadding.staleStateTimeout(typedArrayObtainStyledAttributes.getInteger(R.styleable.mappls_maps_LocationComponent_mappls_maps_staleStateTimeout, HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT));
        }
        builderPadding.gpsDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_gpsDrawable, -1));
        builderPadding.gpsStaleDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.mappls_maps_LocationComponent_mappls_maps_gpsStaleDrawable, -1));
        float dimension = typedArrayObtainStyledAttributes.getDimension(R.styleable.mappls_maps_LocationComponent_mappls_maps_elevation, 0.0f);
        builderPadding.accuracyColor(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_accuracyColor, -1));
        builderPadding.accuracyAlpha(typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_accuracyAlpha, 0.15f));
        builderPadding.elevation(dimension);
        builderPadding.trackingGesturesManagement(typedArrayObtainStyledAttributes.getBoolean(R.styleable.mappls_maps_LocationComponent_mappls_maps_trackingGesturesManagement, false));
        builderPadding.trackingInitialMoveThreshold(typedArrayObtainStyledAttributes.getDimension(R.styleable.mappls_maps_LocationComponent_mappls_maps_trackingInitialMoveThreshold, context.getResources().getDimension(R.dimen.mappls_maps_locationComponentTrackingInitialMoveThreshold)));
        builderPadding.trackingMultiFingerMoveThreshold(typedArrayObtainStyledAttributes.getDimension(R.styleable.mappls_maps_LocationComponent_mappls_maps_trackingMultiFingerMoveThreshold, context.getResources().getDimension(R.dimen.mappls_maps_locationComponentTrackingMultiFingerMoveThreshold)));
        builderPadding.padding(new int[]{typedArrayObtainStyledAttributes.getInt(R.styleable.mappls_maps_LocationComponent_mappls_maps_iconPaddingLeft, 0), typedArrayObtainStyledAttributes.getInt(R.styleable.mappls_maps_LocationComponent_mappls_maps_iconPaddingTop, 0), typedArrayObtainStyledAttributes.getInt(R.styleable.mappls_maps_LocationComponent_mappls_maps_iconPaddingRight, 0), typedArrayObtainStyledAttributes.getInt(R.styleable.mappls_maps_LocationComponent_mappls_maps_iconPaddingBottom, 0)});
        builderPadding.layerAbove(typedArrayObtainStyledAttributes.getString(R.styleable.mappls_maps_LocationComponent_mappls_maps_layer_above));
        builderPadding.layerBelow(typedArrayObtainStyledAttributes.getString(R.styleable.mappls_maps_LocationComponent_mappls_maps_layer_below));
        float f = typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_minZoomIconScale, MIN_ZOOM_ICON_SCALE_DEFAULT);
        float f2 = typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_maxZoomIconScale, 1.0f);
        builderPadding.minZoomIconScale(f);
        builderPadding.maxZoomIconScale(f2);
        builderPadding.trackingAnimationDurationMultiplier(typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_trackingAnimationDurationMultiplier, TRACKING_ANIMATION_DURATION_MULTIPLIER_DEFAULT));
        builderPadding.compassAnimationEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.mappls_maps_LocationComponent_mappls_maps_compassAnimationEnabled, true));
        builderPadding.accuracyAnimationEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.mappls_maps_LocationComponent_mappls_maps_accuracyAnimationEnabled, true));
        builderPadding.pulseEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleEnabled, false));
        builderPadding.pulseFadeEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleFadeEnabled, true));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleColor)) {
            builderPadding.pulseColor(typedArrayObtainStyledAttributes.getColor(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleColor, -1));
        }
        builderPadding.pulseSingleDuration = typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleDuration, 2300.0f);
        builderPadding.pulseMaxRadius = typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleRadius, 35.0f);
        builderPadding.pulseAlpha = typedArrayObtainStyledAttributes.getFloat(R.styleable.mappls_maps_LocationComponent_mappls_maps_pulsingLocationCircleAlpha, 1.0f);
    ...
    public int hashCode() {
        ...
        String str2 = this.foregroundStaleName;
        int iHashCode2 = (((((iHashCode + (str2 != null ? str2.hashCode() : 0)) * 31) + this.gpsDrawable) * 31) + this.gpsStaleDrawable) * 31;
        String str3 = this.gpsName;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.gpsStaleDrawable);
    ...
    protected LocationComponentOptions(Parcel parcel) {
        ...
        this.gpsStaleDrawable = parcel.readInt();
    ...
    public static class Builder {
        ...
        private String gpsName;
        private Integer gpsStaleDrawable;
        private String layerAbove;
        private String layerBelow;
        private Float maxZoomIconScale;
        private Float minZoomIconScale;
        ...
        public LocationComponentOptions build() {
            ...
            if (locationComponentOptionsAutoBuild.pulseEnabled() == null) {
                if (locationComponentOptionsAutoBuild.pulseFadeEnabled() == null) {
                    str = "";
                } else {
        ...
        private Builder(LocationComponentOptions locationComponentOptions) {
            ...
            this.gpsStaleDrawable = Integer.valueOf(locationComponentOptions.gpsStaleDrawable());
        ...
        public Builder gpsStaleDrawable(int i) {
            this.gpsStaleDrawable = Integer.valueOf(i);
            return this;
        }
