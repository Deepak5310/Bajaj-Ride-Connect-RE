...
public class LatLngSpan implements Parcelable {
    public static final Parcelable.Creator<LatLngSpan> CREATOR = new Parcelable.Creator<LatLngSpan>() { // from class: com.mappls.sdk.maps.geometry.LatLngSpan.1
    ...
    public int hashCode() {
        long jDoubleToLongBits = Double.doubleToLongBits(this.mLatitudeSpan);
        int i = (int) (jDoubleToLongBits ^ (jDoubleToLongBits >>> 32));
        long jDoubleToLongBits2 = Double.doubleToLongBits(this.mLongitudeSpan);
