...
public final class CompassView extends ImageView implements Runnable {
    ...
    private MapplsMap.OnCompassAnimationListener compassAnimationListener;
    ...
    public void injectCompassAnimationListener(MapplsMap.OnCompassAnimationListener onCompassAnimationListener) {
    ...
    public void run() {
        if (isHidden()) {
            ...
            duration.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: com.mappls.sdk.maps.widgets.CompassView.1
