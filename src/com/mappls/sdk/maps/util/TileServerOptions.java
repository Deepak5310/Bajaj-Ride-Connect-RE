...
public class TileServerOptions implements Parcelable {
    public static final Parcelable.Creator<TileServerOptions> CREATOR = new Parcelable.Creator<TileServerOptions>() { // from class: com.mappls.sdk.maps.util.TileServerOptions.1
    ...
    /* JADX INFO: renamed from: com.mappls.sdk.maps.util.TileServerOptions$2, reason: invalid class name */
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$mappls$sdk$maps$WellKnownTileServer;

        static {
            int[] iArr = new int[WellKnownTileServer.values().length];
            $SwitchMap$com$mappls$sdk$maps$WellKnownTileServer = iArr;
            try {
                iArr[WellKnownTileServer.MAPPLS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$mappls$sdk$maps$WellKnownTileServer[WellKnownTileServer.MapTiler.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$mappls$sdk$maps$WellKnownTileServer[WellKnownTileServer.MapLibre.ordinal()] = 3;
    ...
    public static TileServerOptions get(WellKnownTileServer wellKnownTileServer) {
        int i = AnonymousClass2.$SwitchMap$com$mappls$sdk$maps$WellKnownTileServer[wellKnownTileServer.ordinal()];
        if (i == 1) {
