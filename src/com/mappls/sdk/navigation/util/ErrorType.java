...
public class ErrorType {
    ...
    public static AuthenticationError NO_ROUTE_FOUND = new AuthenticationError(5, "No Route Found");
    public static AuthenticationError DUPLICATE_SESSION_ERROR = new AuthenticationError(700, "Session already active on Another device");
