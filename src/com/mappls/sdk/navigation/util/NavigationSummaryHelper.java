...
public final class NavigationSummaryHelper {
    ...
    public final int getTotalTimeTaken() {
        long jCurrentTimeMillis = this.navigationEndTime;
        if (jCurrentTimeMillis <= 0) {
            jCurrentTimeMillis = System.currentTimeMillis();
        }
        return (int) ((jCurrentTimeMillis - this.navigationStartTime) / ((long) 1000));
    }
    ...
    public final void navigationStarted(NavLocation location) {
    ...
    public final int onNewLocation(NavLocation location, boolean z) {
    ...
    public final void setLastLocation(NavLocation navLocation) {
        this.lastLocation = navLocation;
    }

    public final void setLastTollableLocation(NavLocation navLocation) {
