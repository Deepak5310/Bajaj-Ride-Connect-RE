...
public class MapplsNavigationHelper extends e {
    private static MapplsNavigationHelper L = new MapplsNavigationHelper();
    Session K;

    private MapplsNavigationHelper() {
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void addCongestionInfoChangedListener(CongestionInfoChangedListener congestionInfoChangedListener) {
        super.addCongestionInfoChangedListener(congestionInfoChangedListener);
    }
    ...
    public void deleteSession(String str, IStopSession iStopSession) {
        NavigationContext.getNavigationContext().m.a(str, iStopSession);
    }
    ...
    public void extendNotification(NotificationCompat.Builder builder) {
        if (this.K != null) {
            Intent data = new Intent("android.intent.action.VIEW").setComponent(new ComponentName(this.b, (Class<?>) getInstance().getNavigationCarAppServiceClass())).setData(NavigationConstants.createDeepLinkUri("com.mappls.app.navigation.car.OpenRootScreen"));
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ CongestionInfoLoadedListener getCongestionInfoLoadedListener() {
        return super.getCongestionInfoLoadedListener();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ ManeuverInfo getManeuverInfo(Context context, int i) {
        return super.getManeuverInfo(context, i);
    }

    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ int getMinimumVehicleSpeed() {
        return super.getMinimumVehicleSpeed();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ INotificationManagerCallback getNotificationManagerCallback() {
        return super.getNotificationManagerCallback();
    }

    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ int getOdometerSpeed() {
        return super.getOdometerSpeed();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ String getOfflineBaseUrl() {
        return super.getOfflineBaseUrl();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void initVoiceCommandPlayer() {
        super.initVoiceCommandPlayer();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ boolean isCongestionDelayEventEnabled() {
        return super.isCongestionDelayEventEnabled();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ boolean isHideExitFromNotification() {
        return super.isHideExitFromNotification();
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void removeCongestionInfoChangedListener(CongestionInfoChangedListener congestionInfoChangedListener) {
        super.removeCongestionInfoChangedListener(congestionInfoChangedListener);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setAccuracyNavigation(int i) {
        super.setAccuracyNavigation(i);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setCongestionDelayEventEnabled(boolean z) {
        super.setCongestionDelayEventEnabled(z);
    }

    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setCongestionDelayVisualPromptBefore(int i) {
        super.setCongestionDelayVisualPromptBefore(i);
    }

    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setCongestionInfoLoadedListener(CongestionInfoLoadedListener congestionInfoLoadedListener) {
        super.setCongestionInfoLoadedListener(congestionInfoLoadedListener);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setHideExitFromNotification(boolean z) {
        super.setHideExitFromNotification(z);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setMinimumVehicleSpeed(int i) {
        super.setMinimumVehicleSpeed(i);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setNotificationChannelId(String str) {
        super.setNotificationChannelId(str);
    }

    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setNotificationManagerCallback(INotificationManagerCallback iNotificationManagerCallback) {
        super.setNotificationManagerCallback(iNotificationManagerCallback);
    }

    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setOdometerSpeed(int i) {
        super.setOdometerSpeed(i);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setOfflineBaseUrl(String str) {
        super.setOfflineBaseUrl(str);
    }
    ...
    @Override // com.mappls.sdk.navigation.e
    public /* bridge */ /* synthetic */ void setRouteSettingOptions(u uVar) {
        super.setRouteSettingOptions(uVar);
    }
