...
public final class NearbyResultFragment extends Fragment {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final NearbyResultFragment newInstance(MapplsNearbyResponse mapplsNearbyResponse) {
            ...
            return newInstance(mapplsNearbyResponse, nearbyUIOptionBuild);
        }

        @JvmStatic
        public final NearbyResultFragment newInstance(MapplsNearbyResponse mapplsNearbyResponse, NearbyUIOption nearbyUIOption) {
            Intrinsics.checkNotNullParameter(mapplsNearbyResponse, "mapplsNearbyResponse");
            ...
            Iterator<T> it2 = mapplsNearbyResponse.getSelectedCategory().iterator();
            while (it2.hasNext()) {
                arrayList.add((CategoryCode) it2.next());
            }
        ...
        @JvmStatic
        public final NearbyResultFragment newInstance(MapplsNearbyResponse mapplsNearbyResponse, NearbyUIOption nearbyUIOption, NearbyOption nearbyOption) {
            Intrinsics.checkNotNullParameter(mapplsNearbyResponse, "mapplsNearbyResponse");
            Intrinsics.checkNotNullParameter(nearbyUIOption, "nearbyUIOption");
    ...
    public static final class b implements e {
        ...
        public final void a(NearbyAtlasResult nearbyResult) {
    ...
    @JvmStatic
    public static final NearbyResultFragment newInstance(MapplsNearbyResponse mapplsNearbyResponse) {
        return Companion.newInstance(mapplsNearbyResponse);
    }

    @JvmStatic
    public static final NearbyResultFragment newInstance(MapplsNearbyResponse mapplsNearbyResponse, NearbyUIOption nearbyUIOption) {
        return Companion.newInstance(mapplsNearbyResponse, nearbyUIOption);
    }

    @JvmStatic
    public static final NearbyResultFragment newInstance(MapplsNearbyResponse mapplsNearbyResponse, NearbyUIOption nearbyUIOption, NearbyOption nearbyOption) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ViewDataBinding viewDataBindingInflate = DataBindingUtil.inflate(inflater, R.layout.mappls_nearby_result_fragment, viewGroup, false);
        Intrinsics.checkNotNullExpressionValue(viewDataBindingInflate, "inflate(inflater, R.layo…agment, container, false)");
        MapplsNearbyResultFragmentBinding mapplsNearbyResultFragmentBinding = (MapplsNearbyResultFragmentBinding) viewDataBindingInflate;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.mViewModel = (com.mappls.sdk.nearby.plugin.viewmodel.b) new ViewModelProvider(fragmentActivityRequireActivity).get(com.mappls.sdk.nearby.plugin.viewmodel.b.class);
        ...
        if (arguments != null) {
            ...
            bVar.a((NearbyAtlasResponse) new Gson().fromJson(arguments.getString("com.mappls.sdk.nearby.plugin.NEARBY_ATLAS_RESPONSE_KEY"), NearbyAtlasResponse.class));
        ...
        if (bundle != null) {
            ...
            bVar7.a((NearbyAtlasResponse) new Gson().fromJson(bundle.getString("com.mappls.sdk.nearby.plugin.NEARBY_ATLAS_RESPONSE_KEY"), NearbyAtlasResponse.class));
        ...
        NearbyResultViewOption nearbyResultViewOptionCreateFromNearbyOption = NearbyResultViewOption.createFromNearbyOption(bVar15.d());
        Intrinsics.checkNotNullExpressionValue(nearbyResultViewOptionCreateFromNearbyOption, "createFromNearbyOption(mViewModel.nearbyUIOption)");
        NearbyResultView nearbyResultView = new NearbyResultView(contextRequireContext, nearbyResultViewOptionCreateFromNearbyOption);
    ...
    public final void setOnNearbyResultCallback(INearbyResultCallback callback) {
