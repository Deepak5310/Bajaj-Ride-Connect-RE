...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    private static class b {
        ...
        static {
            ...
            a = map;
            map.put("layout/mappls_nearby_activity_0", Integer.valueOf(R.layout.mappls_nearby_activity));
            map.put("layout/mappls_nearby_base_fragment_0", Integer.valueOf(R.layout.mappls_nearby_base_fragment));
            map.put("layout/mappls_nearby_category_adapter_0", Integer.valueOf(R.layout.mappls_nearby_category_adapter));
            map.put("layout/mappls_nearby_fragment_0", Integer.valueOf(R.layout.mappls_nearby_fragment));
            map.put("layout/mappls_nearby_fragment_map_0", Integer.valueOf(R.layout.mappls_nearby_fragment_map));
            map.put("layout/mappls_nearby_fragment_result_list_0", Integer.valueOf(R.layout.mappls_nearby_fragment_result_list));
            map.put("layout/mappls_nearby_result_category_adapter_0", Integer.valueOf(R.layout.mappls_nearby_result_category_adapter));
            map.put("layout/mappls_nearby_result_fragment_0", Integer.valueOf(R.layout.mappls_nearby_result_fragment));
            map.put("layout/mappls_nearby_result_list_adapter_0", Integer.valueOf(R.layout.mappls_nearby_result_list_adapter));
            map.put("layout-land/mappls_nearby_result_view_0", Integer.valueOf(R.layout.mappls_nearby_result_view));
            map.put("layout/mappls_nearby_result_view_0", Integer.valueOf(R.layout.mappls_nearby_result_view));
            map.put("layout-land/mappls_nearby_view_0", Integer.valueOf(R.layout.mappls_nearby_view));
            map.put("layout/mappls_nearby_view_0", Integer.valueOf(R.layout.mappls_nearby_view));
        }
    }
