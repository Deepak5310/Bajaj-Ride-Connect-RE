...
public class MapplsLMSConfig {
    ...
    static final String REFERRER_PREFS_NAME = "com.mappls.android.metrics.ReferralInfo";
    ...
    MapplsLMSConfig(Bundle bundle, Context context) {
        long jFloatValue;
        ...
        this.mFlushInterval = bundle.getInt("com.mappls.android.MapplsAnalyticsConfig.FlushInterval", DateTimeConstants.MILLIS_PER_MINUTE);
        ...
        boolean zContainsKey = bundle.containsKey("com.mappls.android.MapplsAnalyticsConfig.UseIpAddressForGeolocation");
        ...
        if (string2 != null) {
            setFcmEventsEndpoint(zContainsKey ? getEndPointWithIpTrackingParam(string2, getUseIpAddressForGeolocation()) : string2);
        } else {
        ...
        if (string3 != null) {
            setPeopleEndpoint(zContainsKey ? getEndPointWithIpTrackingParam(string3, getUseIpAddressForGeolocation()) : string3);
        } else {
        ...
        if (string4 != null) {
            setGroupsEndpoint(zContainsKey ? getEndPointWithIpTrackingParam(string4, getUseIpAddressForGeolocation()) : string4);
        } else {
    ...
    /* JADX WARN: Code duplicated, block: B:9:0x0027 A[PHI: r1
      0x0027: PHI (r1v3 java.lang.StringBuilder) = (r1v1 java.lang.StringBuilder), (r1v4 java.lang.StringBuilder) binds: [B:13:0x003b, B:7:0x0024] A[DONT_GENERATE, DONT_INLINE]] */
    private String getEndPointWithIpTrackingParam(String str, boolean z) {
        StringBuilder sb;
        if (!ADD_ADDITIONAL_DATA_IN_PACKET) {
            return str;
        }
        String str2 = "1";
        if (str.contains("?ip=")) {
    ...
    static MapplsLMSConfig readConfig(Context context) {
