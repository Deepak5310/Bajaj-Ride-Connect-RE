...
public class AutomaticEvents {
    ...
    public static final String APP_EXCEPTION = "$ae_exception";
    public static final String APP_EXCEPTION_REASON = "$ae_exception_reason";
    public static final String APP_UPDATED = "$ae_updated";
    public static final String FCM_TOKEN = "fcm";
    public static final String FCM_TOKEN_DELETE = "fcm-delete";
    public static final String FIRST_OPEN = "first-time-app-launch";
