...
import com.mappls.android.util.NetworkUtility;
...
public class MapplsLMSManager {
    ...
    private JSONObject getMetaDataField(String str, String str2) throws JSONException {
        ...
        jSONObject.put("me_version", "1.0.4");
        Context context = this.context;
        if (context != null) {
            jSONObject.put("app_name", context.getApplicationInfo().loadLabel(this.context.getPackageManager()).toString());
            try {
    ...
    public void add(String str, String str2, String str3, JSONObject jSONObject) {
        try {
            ...
            commonFields.put(ImagesContract.URL, jSONObject);
    ...
    JSONObject getCommonFields(String str, String str2) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        if (this.latitude != 0.0d && this.longitude != 0.0d) {
            jSONObject.put("map_center", this.latitude + "," + this.longitude);
        }
        if (this.currentLocation != null) {
            jSONObject.put(FirebaseAnalytics.Param.LOCATION, this.currentLocation.getLatitude() + "," + this.currentLocation.getLongitude());
        }
        ...
        if (str6 != null) {
            jSONObject.put(AccountsQueryParameters.CLIENT_ID, str6);
        }
        Context context = this.context;
        if (context != null) {
            try {
    ...
    public void handledExceptions(String str, String str2, String str3, Throwable th) {
        try {
            ...
            commonFields.put(ImagesContract.URL, jSONObject.toString());
    ...
    public void setBaseUrl(String str) {
        ...
        NetworkUtility.listenCellInfoChange(this.context);
    }
