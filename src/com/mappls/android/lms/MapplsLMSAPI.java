...
public class MapplsLMSAPI {
    ...
    class GroupImpl implements Group {
        ...
        public void deleteGroup() {
            try {
                MapplsLMSAPI.this.recordGroupMessage(stdGroupMessage("$delete", JSONObject.NULL));
        ...
        public void remove(String str, Object obj) {
            ...
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(str, obj);
                MapplsLMSAPI.this.recordGroupMessage(stdGroupMessage("$remove", jSONObject));
            } catch (JSONException e) {
        ...
        public void set(JSONObject jSONObject) {
            ...
            try {
                ...
                MapplsLMSAPI.this.recordGroupMessage(stdGroupMessage("$set", jSONObject2));
            } catch (JSONException e) {
    ...
    class PeopleImpl implements People {
        ...
        public void deleteUser() {
            try {
                MapplsLMSAPI.this.recordPeopleMessage(stdPeopleMessage("$delete", JSONObject.NULL));
            } catch (JSONException unused) {
        ...
        public void increment(Map<String, ? extends Number> map) {
            ...
            try {
                MapplsLMSAPI.this.recordPeopleMessage(stdPeopleMessage("$add", new JSONObject(map)));
            } catch (JSONException e) {
        ...
        public void remove(String str, Object obj) {
            ...
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(str, obj);
                MapplsLMSAPI.this.recordPeopleMessage(stdPeopleMessage("$remove", jSONObject));
            } catch (JSONException e) {
                MPLog.e(MapplsLMSAPI.LOGTAG, "Exception appending a property", e);
            }
        }
        ...
        public void set(JSONObject jSONObject) {
            ...
            try {
                JSONObject jSONObject2 = new JSONObject(MapplsLMSAPI.this.mDeviceInfo);
                Iterator<String> itKeys = jSONObject.keys();
                while (itKeys.hasNext()) {
                    String next = itKeys.next();
                    jSONObject2.put(next, jSONObject.get(next));
                }
                MapplsLMSAPI.this.recordPeopleMessage(stdPeopleMessage("$set", jSONObject2));
            } catch (JSONException e) {
        ...
        public void trackCharge(double d, JSONObject jSONObject) {
            ...
            Date date = new Date();
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(MapplsLMSAPI.ENGAGE_DATE_FORMAT_STRING, Locale.US);
    ...
    MapplsLMSAPI(Context context, Future<SharedPreferences> future, String str, MapplsLMSConfig mapplsLMSConfig, boolean z, JSONObject jSONObject, String str2, boolean z2) {
        ...
        HashMap map = new HashMap();
        map.put("android_lib_version", "1.0.0");
        ...
        boolean zExists = MapplsLMSDbAdapter.getInstance(this.mContext).getDatabaseFile().exists();
    ...
    MapplsLMSAPI(Context context, Future<SharedPreferences> future, String str, boolean z, JSONObject jSONObject, String str2, boolean z2) {
        this(context, future, str, MapplsLMSConfig.getInstance(context), z, jSONObject, str2, z2);
    }

    MapplsLMSAPI(Context context, Future<SharedPreferences> future, String str, boolean z, JSONObject jSONObject, boolean z2) {
    ...
    static void allInstances(InstanceProcessor instanceProcessor) {
        ...
        synchronized (map) {
            Iterator<Map<Context, MapplsLMSAPI>> it2 = map.values().iterator();
            while (it2.hasNext()) {
                Iterator<MapplsLMSAPI> it3 = it2.next().values().iterator();
                while (it3.hasNext()) {
    ...
    private static void checkIntentForInboundAppLink(Context context) {
        ...
        if (context instanceof Activity) {
            try {
                ...
                string = sb.toString();
                MPLog.d(APP_LINKS_LOGTAG, string);
            } catch (IllegalAccessException e2) {
                string = "Unable to detect inbound App Links: " + e2.getMessage();
            ...
            string = "Context is not an instance of Activity. To detect inbound App Links, pass an instance of an Activity to getInstance.";
        }
        MPLog.d(APP_LINKS_LOGTAG, string);
    }
    ...
    public static MapplsLMSAPI getInstance(Context context, String str, boolean z, JSONObject jSONObject, String str2, boolean z2) {
        ...
        synchronized (map) {
            ...
            if (sReferrerPrefs == null) {
                sReferrerPrefs = sPrefsLoader.loadPreferences(context, "com.mappls.android.metrics.ReferralInfo", null);
            }
    ...
    private static void registerAppLinksListeners(Context context, MapplsLMSAPI mapplsLMSAPI) {
        ...
        try {
            ...
            cls.getMethod("registerReceiver", BroadcastReceiver.class, IntentFilter.class).invoke(cls.getMethod("getInstance", Context.class).invoke(null, context), new BroadcastReceiver() { // from class: com.mappls.android.lms.MapplsLMSAPI.4
                ...
                public void onReceive(Context context2, Intent intent) {
                    ...
                    MapplsLMSAPI.this.track("$" + intent.getStringExtra("event_name"), jSONObject);
                }
    ...
    private void sendHttpEvent(String str, String str2, String str3, JSONObject jSONObject, boolean z) throws JSONException {
        ...
        jSONObject2.put(SdkRemoteClientConnector.APP_ID_AUTH, str6);
        if (MapplsLMSConfig.ADD_ADDITIONAL_DATA_IN_PACKET) {
            jSONObject2.put("distinct_id", str3);
            if (str5 == null) {
                str5 = "1.0.0";
            }
            jSONObject2.put("$lib_version", str5);
        ...
        this.mMessages.eventsMessage(new LMSMessages.EventDescription(str, jSONObject2, str2));
        if (z) {
            ...
            this.mMessages.peopleMessage(new LMSMessages.PeopleDescription(jSONObject3, str2));
        }
        this.mMessages.postToServer(new LMSMessages.MapplsAnalyticsDescription(str2));
    }
    ...
    void registerMapplsAnalyticsActivityLifecycleCallbacks() {
        ...
        application.registerActivityLifecycleCallbacks(mapplsLMSActivityLifecycleCallbacks);
    }
    ...
    protected void track(String str, JSONObject jSONObject, boolean z) {
        ...
        if (!z || this.mTrackAutomaticEvents.booleanValue()) {
            ...
            try {
                ...
                jSONObject2.put(SdkRemoteClientConnector.APP_ID_AUTH, this.mToken);
                if (l != null) {
