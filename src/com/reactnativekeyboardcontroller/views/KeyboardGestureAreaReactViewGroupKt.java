...
public final class KeyboardGestureAreaReactViewGroupKt {
    private static final Map<String, Interpolator> interpolators = MapsKt.mapOf(TuplesKt.to(Property.RASTER_RESAMPLING_LINEAR, new LinearInterpolator()), TuplesKt.to("ios", new IosInterpolator()));
