    ...
    public void processChunk(String str, byte[] bArr) {
        ...
        if (str.equals(WebpDirectory.CHUNK_VP8X) && bArr.length == 10) {
            ...
            try {
                ...
                int int25 = byteArrayReader.getInt24(7);
                webpDirectory.setInt(2, int24 + 1);
                webpDirectory.setInt(1, int25 + 1);
        ...
        if (str.equals(WebpDirectory.CHUNK_VP8L) && bArr.length > 4) {
            ...
            try {
                ...
                short uInt9 = byteArrayReader2.getUInt8(2);
                int uInt10 = ((byteArrayReader2.getUInt8(4) & 15) << 10) | (byteArrayReader2.getUInt8(3) << 2) | ((uInt9 & 192) >> 6);
                webpDirectory.setInt(2, (uInt8 | ((uInt9 & 63) << 8)) + 1);
                webpDirectory.setInt(1, uInt10 + 1);
                this._metadata.addDirectory(webpDirectory);
                return;
        ...
        try {
            if (byteArrayReader3.getUInt8(3) == 157 && byteArrayReader3.getUInt8(4) == 1 && byteArrayReader3.getUInt8(5) == 42) {
                ...
                int uInt17 = byteArrayReader3.getUInt16(8);
                webpDirectory.setInt(2, uInt16);
                webpDirectory.setInt(1, uInt17);
                this._metadata.addDirectory(webpDirectory);
            }
