        ...
        try {
            if (str.equals(AviDirectory.CHUNK_STREAM_HEADER)) {
                ...
                if (str2.equals("vids")) {
                    ...
                    double dPow = d / Math.pow(60.0d, 0.0d);
                    numValueOf2.getClass();
                    this._directory.setString(3, String.format("%1$02d:%2$02d:%3$02d", numValueOf, numValueOf2, Integer.valueOf((int) Math.round(dPow - ((double) (i2 * 60))))));
                ...
                this._directory.setDouble(2, float33 / float32);
                return;
            }
            if (str.equals(AviDirectory.CHUNK_MAIN_HEADER)) {
                ...
                int int33 = byteArrayReader2.getInt32(24);
                int int34 = byteArrayReader2.getInt32(32);
                int int35 = byteArrayReader2.getInt32(36);
                this._directory.setInt(6, int34);
                this._directory.setInt(7, int35);
                this._directory.setInt(8, int33);
                return;
            }
