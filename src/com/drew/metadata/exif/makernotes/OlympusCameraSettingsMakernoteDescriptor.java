...
public class OlympusCameraSettingsMakernoteDescriptor extends TagDescriptor<OlympusCameraSettingsMakernoteDirectory> {
    ...
    public String getAfPointSelectedDescription() {
        ...
        if (iDoubleValue + iDoubleValue2 + iDoubleValue3 + iDoubleValue4 == 0) {
            return "n/a";
        }
        return String.format("(%d%%,%d%%) (%d%%,%d%%)", Integer.valueOf(iDoubleValue), Integer.valueOf(iDoubleValue2), Integer.valueOf(iDoubleValue3), Integer.valueOf(iDoubleValue4));
    }
