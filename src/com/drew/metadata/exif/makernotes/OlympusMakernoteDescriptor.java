...
public class OlympusMakernoteDescriptor extends TagDescriptor<OlympusMakernoteDirectory> {
    ...
    public String getApexFilmSpeedDescription() {
        ...
        double dPow = Math.pow((longObject.longValue() / 8.0d) - 1.0d, 2.0d) * 3.125d;
    ...
    public String getApexShutterSpeedTimeDescription() {
        ...
        double dPow = Math.pow((49 - longObject.longValue()) / 8.0d, 2.0d);
        DecimalFormat decimalFormat = new DecimalFormat("0.###");
        decimalFormat.setRoundingMode(RoundingMode.HALF_UP);
    ...
    public String getApexApertureDescription() {
        ...
        return getFStopDescription(Math.pow((longObject.longValue() / 16.0d) - 0.5d, 2.0d));
    }
    ...
    public String getFocalLengthDescription() {
        ...
        return getFocalLengthDescription(longObject.longValue() / 256.0d);
    }
    ...
    public String getDateDescription() {
        ...
        if (!DateUtil.isValidDate(iLongValue3, iLongValue2, iLongValue)) {
            return "Invalid date";
        }
        return String.format("%04d-%02d-%02d", Integer.valueOf(iLongValue3), Integer.valueOf(iLongValue2 + 1), Integer.valueOf(iLongValue));
    }
    ...
    public String getTimeDescription() {
        ...
        if (!DateUtil.isValidTime(iLongValue, iLongValue2, iLongValue3)) {
            return "Invalid time";
        }
        return String.format("%02d:%02d:%02d", Integer.valueOf(iLongValue), Integer.valueOf(iLongValue2), Integer.valueOf(iLongValue3));
    }
