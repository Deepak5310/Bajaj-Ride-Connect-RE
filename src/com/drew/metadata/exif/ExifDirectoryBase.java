...
public abstract class ExifDirectoryBase extends Directory {
    ...
    public static final int TAG_OFFSET_TIME = 36880;
    public static final int TAG_OFFSET_TIME_DIGITIZED = 36882;
    public static final int TAG_OFFSET_TIME_ORIGINAL = 36881;
    ...
    protected static void addExifTagNames(HashMap<Integer, String> map) {
        ...
        map.put(Integer.valueOf(TAG_OFFSET_TIME), "Offset Time");
        map.put(Integer.valueOf(TAG_OFFSET_TIME_ORIGINAL), "Offset Time Original");
        map.put(Integer.valueOf(TAG_OFFSET_TIME_DIGITIZED), "Offset Time Digitized");
