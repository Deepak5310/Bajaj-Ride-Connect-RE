...
public class ExifTiffHandler extends DirectoryTiffHandler {
    ...
    private static void processPrintIM(PrintIMDirectory printIMDirectory, int i, RandomAccessReader randomAccessReader, int i2) throws IOException {
        ...
        int i3 = i + 14;
        int uInt17 = randomAccessReader.getUInt16(i3);
        if (i2 < (uInt17 * 6) + 16) {
    ...
    private static void processKodakMakernote(KodakMakernoteDirectory kodakMakernoteDirectory, int i, RandomAccessReader randomAccessReader) {
        try {
            ...
            kodakMakernoteDirectory.setInt(98, randomAccessReader.getUInt16(i + RCTMGLShapeSourceManager.METHOD_GET_CLUSTER_CHILDREN));
    ...
    private static void processReconyxHyperFireMakernote(ReconyxHyperFireMakernoteDirectory reconyxHyperFireMakernoteDirectory, int i, RandomAccessReader randomAccessReader) throws IOException {
        ...
        int uInt17 = randomAccessReader.getUInt16(i + 4);
        int uInt18 = randomAccessReader.getUInt16(i + 6);
        ...
        if (numValueOf != null) {
            reconyxHyperFireMakernoteDirectory.setString(2, String.format("%d.%d.%d.%s", Integer.valueOf(uInt16), Integer.valueOf(uInt17), Integer.valueOf(uInt18), numValueOf));
        } else {
            reconyxHyperFireMakernoteDirectory.setString(2, String.format("%d.%d.%d", Integer.valueOf(uInt16), Integer.valueOf(uInt17), Integer.valueOf(uInt18)));
        ...
        int uInt19 = randomAccessReader.getUInt16(i + 22);
        int uInt110 = randomAccessReader.getUInt16(i + 24);
        int uInt111 = randomAccessReader.getUInt16(i + 26);
        int uInt112 = randomAccessReader.getUInt16(i + 28);
        int uInt113 = randomAccessReader.getUInt16(i + 30);
        int uInt114 = randomAccessReader.getUInt16(i + 32);
        if (uInt19 >= 0 && uInt19 < 60 && uInt110 >= 0 && uInt110 < 60 && uInt111 >= 0 && uInt111 < 24 && uInt112 >= 1 && uInt112 < 13 && uInt113 >= 1 && uInt113 < 32 && uInt114 >= 1 && uInt114 <= 9999) {
            reconyxHyperFireMakernoteDirectory.setString(22, String.format("%4d:%2d:%2d %2d:%2d:%2d", Integer.valueOf(uInt114), Integer.valueOf(uInt112), Integer.valueOf(uInt113), Integer.valueOf(uInt111), Integer.valueOf(uInt110), Integer.valueOf(uInt19)));
        } else {
            reconyxHyperFireMakernoteDirectory.addError("Error processing Reconyx HyperFire makernote data: Date/Time Original " + uInt114 + "-" + uInt112 + "-" + uInt113 + StringUtils.SPACE + uInt111 + ":" + uInt110 + ":" + uInt19 + " is not a valid date/time.");
        }
