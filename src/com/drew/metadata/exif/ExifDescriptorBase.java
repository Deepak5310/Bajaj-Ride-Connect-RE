...
public abstract class ExifDescriptorBase<T extends Directory> extends TagDescriptor<T> {
    ...
    private static String formatCFAPattern(int[] iArr) {
        ...
        for (int i4 = 2; i4 < i3; i4++) {
            ...
            if (i5 <= 6) {
                ...
                sb.append(Constants.BluetoothState.UNKNOWN);
            }
            if ((i4 - 2) % iArr[1] == 0) {
                sb.append(",");
            } else if (i4 != i2 + 1) {
    ...
    public String getSensitivityTypeRangeDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_SENSITIVITY_TYPE, Constants.BluetoothState.UNKNOWN, "Standard Output Sensitivity", "Recommended Exposure Index", "ISO Speed", "Standard Output Sensitivity and Recommended Exposure Index", "Standard Output Sensitivity and ISO Speed", "Recommended Exposure Index and ISO Speed", "Standard Output Sensitivity, Recommended Exposure Index and ISO Speed");
    }
    ...
    public String getTemperatureDescription() {
        ...
        return new DecimalFormat(IdManager.DEFAULT_VERSION_NAME).format(rational.doubleValue()) + " °C";
    }
    ...
    public String getHumidityDescription() {
        ...
        return new DecimalFormat(IdManager.DEFAULT_VERSION_NAME).format(rational.doubleValue()) + " %";
    }
    ...
    public String getPressureDescription() {
        ...
        return new DecimalFormat(IdManager.DEFAULT_VERSION_NAME).format(rational.doubleValue()) + " hPa";
    }
    ...
    public String get35mmFilmEquivFocalLengthDescription() {
        ...
        return integer.intValue() == 0 ? Constants.BluetoothState.UNKNOWN : getFocalLengthDescription(integer.intValue());
    }
    ...
    public String getSubjectDistanceRangeDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_SUBJECT_DISTANCE_RANGE, Constants.BluetoothState.UNKNOWN, "Macro", "Close view", "Distant view");
    }
