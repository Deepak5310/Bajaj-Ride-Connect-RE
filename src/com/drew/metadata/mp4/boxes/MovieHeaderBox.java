...
public class MovieHeaderBox extends FullBox {
    ...
    public void addMetadata(Mp4Directory mp4Directory) {
        ...
        int i = this.rate;
        mp4Directory.setDouble(261, ((double) (((-65536) & i) >> 16)) + (((double) (i & 65535)) / Math.pow(2.0d, 4.0d)));
        int i2 = this.volume;
        mp4Directory.setDouble(262, ((double) ((65280 & i2) >> 8)) + (((double) (i2 & 255)) / Math.pow(2.0d, 2.0d)));
