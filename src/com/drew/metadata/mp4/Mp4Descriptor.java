...
public class Mp4Descriptor<T extends Directory> extends TagDescriptor<Mp4Directory> {
    ...
    private String getDurationDescription() {
        ...
        double dPow = dDoubleValue / Math.pow(60.0d, 1.0d);
        numValueOf.getClass();
        int i = (int) (dPow - ((double) (iPow * 60)));
        Integer numValueOf2 = Integer.valueOf(i);
        double dPow2 = dDoubleValue / Math.pow(60.0d, 0.0d);
        numValueOf2.getClass();
        return String.format("%1$02d:%2$02d:%3$02d", numValueOf, numValueOf2, Integer.valueOf((int) Math.ceil(dPow2 - ((double) (i * 60)))));
    }
}
