...
public class Mp4Dictionary {
    ...
    static {
        ...
        _videoCompressionTypes.put("png ", Region.REGION_PAPUA_NEW_GUINEA);
    ...
    public static String lookup(int i, String str) {
        if (_dictionary.containsKey(Integer.valueOf(i)) && _dictionary.get(Integer.valueOf(i)).containsKey(str)) {
            return _dictionary.get(Integer.valueOf(i)).get(str);
        }
        return de.patwoz.rn.bluetoothstatemanager.Constants.BluetoothState.UNKNOWN;
    }
