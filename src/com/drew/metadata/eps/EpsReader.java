...
public class EpsReader {
    ...
    public void extract(InputStream inputStream, Metadata metadata) throws Throwable {
        ...
        int int33 = randomAccessStreamReader.getInt32(4);
        int int34 = randomAccessStreamReader.getInt32(8);
        int int35 = randomAccessStreamReader.getInt32(12);
        int int36 = randomAccessStreamReader.getInt32(16);
        int int37 = randomAccessStreamReader.getInt32(20);
        int int38 = randomAccessStreamReader.getInt32(24);
        if (int38 != 0) {
            epsDirectory.setInt(32, int38);
            epsDirectory.setInt(33, int37);
            try {
                new TiffReader().processTiff(new ByteArrayReader(randomAccessStreamReader.getBytes(int37, int38)), new PhotoshopTiffHandler(metadata, null), 0);
            } catch (TiffProcessingException e) {
                epsDirectory.addError("Unable to process TIFF data: " + e.getMessage());
            }
        } else if (int36 != 0) {
            epsDirectory.setInt(34, int36);
            epsDirectory.setInt(35, int35);
        }
        extract(epsDirectory, metadata, new SequentialByteArrayReader(randomAccessStreamReader.getBytes(int33, int34)));
    }
