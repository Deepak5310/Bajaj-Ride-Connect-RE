            ...
            try {
                ...
                if (uInt16 != 1) {
                    if (uInt16 == 2 || uInt16 == 3) {
                        ...
                        duckyDirectory.setStringValue(uInt16, sequentialReader.getStringValue(uInt17 - 4, Charsets.UTF_16BE));
                    } else {
                        duckyDirectory.setByteArray(uInt16, sequentialReader.getBytes(uInt17));
                    }
                } else {
                    if (uInt17 != 4) {
