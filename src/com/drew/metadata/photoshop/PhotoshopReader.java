...
public class PhotoshopReader implements JpegSegmentMetadataReader {
    ...
    public void extract(SequentialReader sequentialReader, int i, Metadata metadata, Directory directory) {
        int i2;
            ...
            try {
                ...
                if (string.equals("8BIM")) {
                    if (uInt16 == 1028) {
                        ...
                        HashMap<Integer, String> map = PhotoshopDirectory._tagNameMap;
                        int i9 = i4 + Constants.MAX_URL_LENGTH;
                        map.put(Integer.valueOf(i9), "Path Info " + i8);
