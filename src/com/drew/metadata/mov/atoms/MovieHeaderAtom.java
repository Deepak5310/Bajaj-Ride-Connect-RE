...
public class MovieHeaderAtom extends FullAtom {
    ...
    public void addMetadata(QuickTimeDirectory quickTimeDirectory) {
        ...
        quickTimeDirectory.setDouble(261, ((double) (((-65536) & i) >> 16)) + (((double) (i & 65535)) / Math.pow(2.0d, 4.0d)));
        int i2 = this.preferredVolume;
        quickTimeDirectory.setDouble(262, ((double) ((65280 & i2) >> 8)) + (((double) (i2 & 255)) / Math.pow(2.0d, 2.0d)));
