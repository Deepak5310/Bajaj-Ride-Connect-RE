...
public class PngMetadataReader {
    ...
    public static Metadata readMetadata(InputStream inputStream) throws IOException, PngProcessingException {
        Iterable<PngChunk> iterableExtract = new PngChunkReader().extract(new StreamReader(inputStream), _desiredChunkTypes);
        Metadata metadata = new Metadata();
        Iterator<PngChunk> it2 = iterableExtract.iterator();
        while (it2.hasNext()) {
            try {
                processChunk(metadata, it2.next());
            } catch (Exception e) {
    ...
    private static void processChunk(Metadata metadata, PngChunk pngChunk) throws IOException, PngProcessingException {
        ...
        if (type.equals(PngChunkType.iCCP)) {
            ...
            if (sequentialByteArrayReader.getInt8() == 0) {
                try {
                    ...
                    pngDirectory6.addError(String.format("Exception decompressing PNG iCCP chunk : %s", e.getMessage()));
        ...
        if (type.equals(PngChunkType.zTXt)) {
            ...
            if (int8 == 0) {
                try {
                    ...
                    pngDirectory9.addError(String.format("Exception decompressing PNG zTXt chunk with keyword \"%s\": %s", string2, e2.getMessage()));
        ...
        if (type.equals(PngChunkType.iTXt)) {
            ...
            byte int9 = sequentialByteArrayReader4.getInt8();
            byte int10 = sequentialByteArrayReader4.getInt8();
            ...
            if (int9 == 0) {
                ...
                try {
                    ...
                    pngDirectory13.addError(String.format("Exception decompressing PNG iTXt chunk with keyword \"%s\": %s", string3, e3.getMessage()));
        ...
        if (type.equals(PngChunkType.tIME)) {
            ...
            short uInt9 = sequentialByteArrayReader5.getUInt8();
            short uInt10 = sequentialByteArrayReader5.getUInt8();
            short uInt11 = sequentialByteArrayReader5.getUInt8();
            short uInt12 = sequentialByteArrayReader5.getUInt8();
            PngDirectory pngDirectory16 = new PngDirectory(PngChunkType.tIME);
            if (DateUtil.isValidDate(uInt16, uInt8 - 1, uInt9) && DateUtil.isValidTime(uInt10, uInt11, uInt12)) {
                pngDirectory16.setString(14, String.format("%04d:%02d:%02d %02d:%02d:%02d", Integer.valueOf(uInt16), Integer.valueOf(uInt8), Integer.valueOf(uInt9), Integer.valueOf(uInt10), Integer.valueOf(uInt11), Integer.valueOf(uInt12)));
            } else {
                pngDirectory16.addError(String.format("PNG tIME data describes an invalid date/time: year=%d month=%d day=%d hour=%d minute=%d second=%d", Integer.valueOf(uInt16), Integer.valueOf(uInt8), Integer.valueOf(uInt9), Integer.valueOf(uInt10), Integer.valueOf(uInt11), Integer.valueOf(uInt12)));
            }
        ...
        if (type.equals(PngChunkType.pHYs)) {
            ...
            int int33 = sequentialByteArrayReader6.getInt32();
            byte int11 = sequentialByteArrayReader6.getInt8();
            PngDirectory pngDirectory17 = new PngDirectory(PngChunkType.pHYs);
            pngDirectory17.setInt(16, int32);
            pngDirectory17.setInt(17, int33);
            pngDirectory17.setInt(18, int11);
