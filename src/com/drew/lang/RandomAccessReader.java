...
public abstract class RandomAccessReader {
    ...
    public int getInt24(int i) throws IOException {
        ...
        validateIndex(i, 3);
        if (this._isMotorolaByteOrder) {
            i2 = ((getByte(i) << Ascii.DLE) & 16711680) | (65280 & (getByte(i + 1) << 8));
            b = getByte(i + 2);
        } else {
            i2 = ((getByte(i + 2) << Ascii.DLE) & 16711680) | (65280 & (getByte(i + 1) << 8));
            b = getByte(i);
        }
        return (b & 255) | i2;
    }
    ...
    public int getInt32(int i) throws IOException {
        ...
        validateIndex(i, 4);
        if (this._isMotorolaByteOrder) {
            i2 = ((getByte(i) << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK) | (16711680 & (getByte(i + 1) << Ascii.DLE)) | (65280 & (getByte(i + 2) << 8));
            b = getByte(i + 3);
        } else {
            i2 = ((getByte(i + 3) << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK) | (16711680 & (getByte(i + 2) << Ascii.DLE)) | (65280 & (getByte(i + 1) << 8));
            b = getByte(i);
        }
        return (b & 255) | i2;
    }
    ...
    public long getInt64(int i) throws IOException {
        ...
        validateIndex(i, 8);
        if (this._isMotorolaByteOrder) {
            j = ((((long) getByte(i)) << 56) & (-72057594037927936L)) | ((((long) getByte(i + 1)) << 48) & 71776119061217280L) | ((((long) getByte(i + 2)) << 40) & 280375465082880L) | ((((long) getByte(i + 3)) << 32) & 1095216660480L) | ((((long) getByte(i + 4)) << 24) & 4278190080L) | ((((long) getByte(i + 5)) << 16) & 16711680) | ((((long) getByte(i + 6)) << 8) & 65280);
            b = getByte(i + 7);
        } else {
            j = ((((long) getByte(i + 7)) << 56) & (-72057594037927936L)) | ((((long) getByte(i + 6)) << 48) & 71776119061217280L) | ((((long) getByte(i + 5)) << 40) & 280375465082880L) | ((((long) getByte(i + 4)) << 32) & 1095216660480L) | ((((long) getByte(i + 3)) << 24) & 4278190080L) | ((((long) getByte(i + 2)) << 16) & 16711680) | ((((long) getByte(i + 1)) << 8) & 65280);
            b = getByte(i);
        }
        return j | (((long) b) & 255);
    }
