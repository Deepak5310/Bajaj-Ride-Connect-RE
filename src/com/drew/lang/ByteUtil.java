...
public class ByteUtil {
    ...
    public static long getLong64(byte[] bArr, int i, boolean z) {
        ...
        return (((long) (bArr[i + 7] & 255)) << 56) | ((long) ((bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16))) | (((long) (bArr[i + 3] & 255)) << 24) | (((long) (bArr[i + 4] & 255)) << 32) | (((long) (bArr[i + 5] & 255)) << 40) | (((long) (bArr[i + 6] & 255)) << 48);
    }
}
