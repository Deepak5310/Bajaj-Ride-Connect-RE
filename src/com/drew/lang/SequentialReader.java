...
public abstract class SequentialReader {
    ...
    public int getInt32() throws IOException {
        ...
        int i2;
        if (this._isMotorolaByteOrder) {
            i = ((getByte() << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK) | ((getByte() << Ascii.DLE) & 16711680) | ((getByte() << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
            i2 = getByte() & 255;
        } else {
            i = (getByte() & 255) | (65280 & (getByte() << 8)) | (16711680 & (getByte() << Ascii.DLE));
    ...
    public float getS15Fixed16() throws IOException {
        if (this._isMotorolaByteOrder) {
            return (float) (((double) (((getByte() & 255) << 8) | (getByte() & 255))) + (((double) (((getByte() & 255) << 8) | (getByte() & 255))) / 65536.0d));
        }
        return (float) (((double) ((getByte() & 255) | ((getByte() & 255) << 8))) + (((double) ((getByte() & 255) | ((getByte() & 255) << 8))) / 65536.0d));
    }
