...
public class MapManager extends ViewGroupManager<MapView> {
    ...
    public void setMapPadding(MapView mapView, ReadableMap readableMap) {
        ...
        mapView.applyBaseMapPadding(i4, i2, i3, i);
        mapView.map.setPadding(i4, i2, i3, i);
    }
    ...
    @ReactProp(defaultInt = NavigationConstants.UI_HANDLER_LOCATION_SERVICE, name = "userLocationUpdateInterval")
    public void setUserLocationUpdateInterval(MapView mapView, int i) {
        mapView.setUserLocationUpdateInterval(i);
    }

    @ReactProp(defaultInt = NavigationConstants.UI_HANDLER_LOCATION_SERVICE, name = "userLocationFastestInterval")
    ...
    public void setAccessibilityLabel(MapView mapView, String str) {
