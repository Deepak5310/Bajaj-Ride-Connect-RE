    ...
    class AIRMapGSUrlTileProvider extends MapTileProvider {
        ...
        class AIRMapWMSTileProvider extends UrlTileProvider {
            ...
            private double[] getBoundingBox(int i, int i2, int i3) {
                ...
                return new double[]{MapWMSTile.mapBound[0] + (((double) i) * dPow), MapWMSTile.mapBound[1] - (((double) (i2 + 1)) * dPow), MapWMSTile.mapBound[0] + (((double) (i + 1)) * dPow), MapWMSTile.mapBound[1] - (((double) i2) * dPow)};
            }
