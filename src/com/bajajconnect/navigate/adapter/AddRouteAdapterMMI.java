...
public class AddRouteAdapterMMI extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        if (i < this.eLocations.size()) {
            ...
            viewHolder.textViewTo.setText(this.eLocations.get(i).placeName);
        } else {
            viewHolder.imageViewRemove.setVisibility(8);
            viewHolder.imageViewAdd.setVisibility(8);
        }
        viewHolder.imageViewRemove.setOnClickListener(new View.OnClickListener() { // from class: com.bajajconnect.navigate.adapter.AddRouteAdapterMMI.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AddRouteAdapterMMI.this.addRouteListener.onRemoveRoute(viewHolder.getAdapterPosition());
            }
        });
        viewHolder.imageViewAdd.setOnClickListener(new View.OnClickListener() { // from class: com.bajajconnect.navigate.adapter.AddRouteAdapterMMI.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AddRouteAdapterMMI.this.addRouteListener.onAddRoute();
            }
        });
        viewHolder.textViewTo.setOnClickListener(new View.OnClickListener() { // from class: com.bajajconnect.navigate.adapter.AddRouteAdapterMMI.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AddRouteAdapterMMI.this.addRouteListener.onClickRouteText(viewHolder.getAdapterPosition());
            }
        });
    }

    public void updateList(List<ELocation> list) {
    ...
    public int getItemCount() {
        List<ELocation> list = this.eLocations;
        if (list == null) {
