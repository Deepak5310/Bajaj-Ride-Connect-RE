...
public final class ScreenWindowTraits {
    ...
    public final void setStyle$react_native_screens_release(Screen screen, final Activity activity, ReactContext context) {
        ...
        if (screenFindScreenForTrait == null || (statusBarStyle = screenFindScreenForTrait.getStatusBarStyle()) == null) {
            statusBarStyle = WeatherCriteria.THEME_LIGHT;
        }
    ...
    public static final void setStyle$lambda$0(Activity activity, String style) {
        ...
        new WindowInsetsControllerCompat(activity.getWindow(), decorView).setAppearanceLightStatusBars(Intrinsics.areEqual(style, WeatherCriteria.THEME_DARK));
    }
    ...
    public final void setTranslucent$react_native_screens_release(Screen screen, Activity activity, ReactContext context) {
        ...
        UiThreadUtil.runOnUiThread(new ScreenWindowTraits$setTranslucent$1(activity, (screenFindScreenForTrait == null || (isStatusBarTranslucent = screenFindScreenForTrait.getIsStatusBarTranslucent()) == null) ? false : isStatusBarTranslucent.booleanValue(), context.getExceptionHandler()));
    }
