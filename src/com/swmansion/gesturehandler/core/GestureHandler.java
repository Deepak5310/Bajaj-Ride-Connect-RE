...
public class GestureHandler<ConcreteGestureHandlerT extends GestureHandler<ConcreteGestureHandlerT>> {
    ...
    /* JADX INFO: renamed from: setMouseButton, reason: collision with other method in class */
    protected final void m2191setMouseButton(int i) {
        this.mouseButton = i;
    }
    ...
    public final boolean isWithinBounds(View view, float posX, float posY) {
        ...
        if (fArr != null) {
            ...
            f2 = companion.hitSlopSet(f4) ? 0.0f - f4 : 0.0f;
