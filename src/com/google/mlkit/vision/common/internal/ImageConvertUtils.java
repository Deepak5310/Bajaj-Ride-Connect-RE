    ...
    public ByteBuffer convertToNv21Buffer(InputImage inputImage, boolean z) throws MlKitException {
        ...
        for (int i4 = 0; i4 < height; i4++) {
            ...
            while (i5 < width) {
                ...
                int i8 = (i6 >> 8) & 255;
                int i9 = i6 & 255;
                int i10 = (((((i7 * (-38)) - (i8 * 74)) + (i9 * PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION)) + 128) >> 8) + 128;
                int i11 = (((((i7 * PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION) - (i8 * 94)) - (i9 * 18)) + 128) >> 8) + 128;
                int i12 = i3 + 1;
