...
public class LocalModel {
    ...
    public String toString() {
        zzv zzvVarZza = zzw.zza(this);
        zzvVarZza.zza("absoluteFilePath", this.zza);
        zzvVarZza.zza("assetFilePath", this.zzb);
        zzvVarZza.zza(ReactNativeBlobUtilConst.DATA_ENCODE_URI, this.zzc);
        zzvVarZza.zzb("isManifestFile", this.zzd);
