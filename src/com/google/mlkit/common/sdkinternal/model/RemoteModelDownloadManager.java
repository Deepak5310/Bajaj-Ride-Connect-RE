...
public class RemoteModelDownloadManager {
    ...
    public Task<Void> ensureModelDownloaded() {
        ...
        try {
            ...
            if (!modelExistsLocally() && (downloadingModelStatusCode == null || downloadingModelStatusCode.intValue() != 8)) {
                ...
                zzllVar.zze(zzlcVarZzg, remoteModel, zzid.NO_ERROR, false, remoteModel.getModelType(), zzij.DOWNLOADING);
    ...
    /* JADX WARN: Code duplicated, block: B:18:0x0042 A[Catch: all -> 0x0078, TRY_ENTER, TRY_LEAVE, TryCatch #1 {, blocks: (B:3:0x0001, B:7:0x000d, B:18:0x0042, B:34:0x006d, B:38:0x0075, B:9:0x0026, B:11:0x002c, B:21:0x0047, B:23:0x004e, B:25:0x0055, B:27:0x005b, B:29:0x0063), top: B:47:0x0001, inners: #2 }] */
    /* JADX WARN: Code duplicated, block: B:21:0x0047 A[Catch: all -> 0x003b, TRY_ENTER, TryCatch #2 {all -> 0x003b, blocks: (B:9:0x0026, B:11:0x002c, B:21:0x0047, B:23:0x004e, B:25:0x0055, B:27:0x005b, B:29:0x0063), top: B:48:0x0026, outer: #1 }] */
    ...
    public boolean isModelDownloadedAndValid() throws MlKitException {
        ...
        gmsLogger.d("ModelDownloadManager", "Download Status code: ".concat(String.valueOf(strValueOf)));
