...
abstract class TempFileCreator {
    ...
    static final class JavaNioCreator extends TempFileCreator {
        ...
        public static PermissionSupplier userPermissions() {
            try {
                final ImmutableList immutableListOf = ImmutableList.of(AclEntry.newBuilder().setType(AclEntryType.ALLOW).setPrincipal(FileSystems.getDefault().getUserPrincipalLookupService().lookupPrincipalByName(getUsername())).setPermissions((Set<AclEntryPermission>) EnumSet.allOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m())).setFlags(AclEntryFlag.DIRECTORY_INHERIT, AclEntryFlag.FILE_INHERIT).build());
        ...
        private static String getUsername() {
            ...
            try {
                ...
                Method method2 = cls.getMethod(LogEvent.LEVEL_INFO, null);
