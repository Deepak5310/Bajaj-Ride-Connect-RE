...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    protected final void afterDone() {
        ...
        if (isCancelled() && (immutableCollection != null)) {
            ...
            while (it2.hasNext()) {
                it2.next().cancel(zWasInterrupted);
            }
        }
    }
    ...
    final void init() {
            ...
            while (it2.hasNext()) {
                ...
                next.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m1473lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(next, i);
                    }
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1474lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
            }
        };
        UnmodifiableIterator<? extends ListenableFuture<? extends InputT>> it3 = this.futures.iterator();
        while (it3.hasNext()) {
            it3.next().addListener(runnable, MoreExecutors.directExecutor());
        }
    }

    /* JADX INFO: renamed from: lambda$init$0$com-google-common-util-concurrent-AggregateFuture, reason: not valid java name */
    /* synthetic */ void m1473lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(ListenableFuture listenableFuture, int i) {
        try {
            ...
            m1474lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    public void m1474lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion) {
    ...
    private void processCompleted(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion) {
        if (futuresIfNeedToCollectAtCompletion != null) {
            UnmodifiableIterator<? extends Future<? extends InputT>> it2 = futuresIfNeedToCollectAtCompletion.iterator();
            int i = 0;
            while (it2.hasNext()) {
