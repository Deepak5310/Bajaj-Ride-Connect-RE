...
public final class Graphs {
    ...
    public static <N> Graph<N> transitiveClosure(Graph<N> graph) {
        ...
        if (graph.isDirected()) {
            for (N n2 : graph.nodes()) {
                ...
                while (it2.hasNext()) {
                    standardMutableGraphBuild.putEdge(n2, it2.next());
                }
            }
        } else {
            ...
            for (N n3 : graph.nodes()) {
                if (!hashSet.contains(n3)) {
                    ...
                    for (Object obj : setReachableNodes) {
                        int i2 = i + 1;
                        Iterator it3 = Iterables.limit(setReachableNodes, i).iterator();
                        while (it3.hasNext()) {
                            standardMutableGraphBuild.putEdge(obj, it3.next());
                        }
                        i = i2;
                    }
                }
    ...
    public static <N> MutableGraph<N> inducedSubgraph(Graph<N> graph, Iterable<? extends N> iterable) {
        ...
        while (it2.hasNext()) {
            standardMutableGraph.addNode(it2.next());
        }
    ...
    public static <N, E> MutableNetwork<N, E> inducedSubgraph(Network<N, E> network, Iterable<? extends N> iterable) {
        ...
        Iterator<? extends N> it2 = iterable.iterator();
        while (it2.hasNext()) {
            standardMutableNetwork.addNode(it2.next());
        }
    ...
    public static <N, V> MutableValueGraph<N, V> copyOf(ValueGraph<N, V> valueGraph) {
        ...
        while (it2.hasNext()) {
            standardMutableValueGraph.addNode(it2.next());
        }
