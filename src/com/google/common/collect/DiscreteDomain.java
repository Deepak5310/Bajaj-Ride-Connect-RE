...
public abstract class DiscreteDomain<C extends Comparable> {
    ...
    private static final class IntegerDomain extends DiscreteDomain<Integer> implements Serializable {
        ...
        public Integer offset(Integer origin, long distance) {
            CollectPreconditions.checkNonnegative(distance, DirectionsCriteria.ANNOTATION_DISTANCE);
    ...
    C offset(C c, long j) {
        CollectPreconditions.checkNonnegative(j, DirectionsCriteria.ANNOTATION_DISTANCE);
        C c2 = c;
