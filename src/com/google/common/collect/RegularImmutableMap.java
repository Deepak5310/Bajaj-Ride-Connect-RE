...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    private static Object createHashTable(Object[] alternatingKeysAndValues, int n2, int tableSize, int keyOffset) {
        ...
        if (tableSize <= 128) {
            ...
            return i3 == n2 ? bArr : new Object[]{bArr, Integer.valueOf(i3), duplicateKey};
        }
        if (tableSize <= 32768) {
            ...
            return i10 == n2 ? sArr : new Object[]{sArr, Integer.valueOf(i10), duplicateKey};
        }
        ...
        return i18 == n2 ? iArr : new Object[]{iArr, Integer.valueOf(i18), duplicateKey};
    }
