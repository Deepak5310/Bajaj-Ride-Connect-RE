    ...
    private class SubRangeMap implements RangeMap<K, V> {
        ...
        class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                ...
                final Iterator<V> it2 = TreeRangeMap.this.entriesByLowerBound.tailMap((Cut) MoreObjects.firstNonNull((Cut) TreeRangeMap.this.entriesByLowerBound.floorKey(SubRangeMap.this.subRange.lowerBound), SubRangeMap.this.subRange.lowerBound), true).values().iterator();
