...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> putAll(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
            ...
            Iterator<? extends Map.Entry<? extends K, ? extends V>> it2 = entries.iterator();
            while (it2.hasNext()) {
                put(it2.next());
            }
            return this;
    ...
    static class SerializedForm<K, V> implements Serializable {
        ...
        SerializedForm(ImmutableMap<K, V> map) {
            ...
            UnmodifiableIterator<Map.Entry<K, V>> it2 = map.entrySet().iterator();
            int i = 0;
            while (it2.hasNext()) {
        ...
        final Object readResolve() {
            ...
            while (it2.hasNext()) {
                builderMakeBuilder.put(it2.next(), it3.next());
            }
