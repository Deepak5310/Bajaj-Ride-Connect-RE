...
public final class BigIntegerMath {
    ...
    public static BigInteger binomial(int n2, int k) {
        MathPreconditions.checkNonNegative("n", n2);
        ...
        if (k < LongMath.biggestBinomials.length && n2 <= LongMath.biggestBinomials[k]) {
            return BigInteger.valueOf(LongMath.binomial(n2, k));
        }
