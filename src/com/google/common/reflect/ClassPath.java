...
public final class ClassPath {
    ...
    public static ClassPath from(ClassLoader classloader) throws IOException {
        ...
        UnmodifiableIterator<LocationInfo> it3 = immutableSetLocationsFrom.iterator();
        while (it3.hasNext()) {
    ...
    static String getClassName(String filename) {
        return filename.substring(0, filename.length() - 6).replace('/', ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
