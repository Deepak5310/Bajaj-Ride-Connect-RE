...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        int i = absoluteGravity & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
        if (i == 48) {
        ...
        int i3 = absoluteGravity2 & PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
        if (i3 == 48) {
