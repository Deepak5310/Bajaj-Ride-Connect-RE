...
final class zzha {
    static /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzen {
    ...
    static /* synthetic */ void zzb(byte b, byte b2, char[] cArr, int i) throws zzen {
        if (b < -62 || zze(b2)) {
            throw zzen.zzc();
        }
    ...
    static /* synthetic */ void zzc(byte b, byte b2, byte b3, char[] cArr, int i) throws zzen {
        if (!zze(b2)) {
            if (b != -32) {
                if (b != -19) {
                    if (!zze(b3)) {
