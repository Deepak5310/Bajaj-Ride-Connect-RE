...
public final class zzbf implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    zzapVar2 = (zzap) SafeParcelReader.createParcelable(parcel, header, zzap.CREATOR);
                    break;
                default:
        ...
        return new zzaq(strCreateString, strCreateString2, strCreateString3, strCreateString4, strCreateString5, zzapVar, zzapVar2);
    }
