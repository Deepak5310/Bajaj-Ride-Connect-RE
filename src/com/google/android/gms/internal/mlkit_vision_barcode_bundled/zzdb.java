...
public abstract class zzdb implements Iterable, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzd()), zzd() <= 50 ? zzgn.zza(this) : zzgn.zza(zzk(0, 47)).concat("..."));
    }
    ...
    private static zzdb zzc(Iterator it2, int i) {
        if (i <= 0) {
        ...
        int i2 = i >>> 1;
        zzdb zzdbVarZzc = zzc(it2, i2);
        zzdb zzdbVarZzc2 = zzc(it2, i - i2);
