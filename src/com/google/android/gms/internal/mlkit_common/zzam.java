...
public abstract class zzam extends zzai implements List, RandomAccess {
    ...
    static zzam zzh(Object[] objArr) {
        return zzi(objArr, objArr.length);
    }

    static zzam zzi(Object[] objArr, int i) {
        return i == 0 ? zzar.zza : new zzar(objArr, i);
    }
    ...
    public final boolean equals(@CheckForNull Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (it2.hasNext()) {
                    if (it3.hasNext() && zzx.zza(it2.next(), it3.next())) {
                    }
                }
                if (!it3.hasNext()) {
                    return true;
    ...
    public zzam subList(int i, int i2) {
        ...
        return i3 == 0 ? zzar.zza : new zzal(this, i, i3);
    }
