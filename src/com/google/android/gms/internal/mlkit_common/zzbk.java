...
final class zzbk implements ObjectEncoderContext {
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_common.zzbj
            @Override // com.google.firebase.encoders.Encoder
            public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
                zzbk.zzg((Map.Entry) obj, objectEncoderContext);
            }
        };
    }

    zzbk(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private final zzbk zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zzbk zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    final ObjectEncoderContext zzc(FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof Collection) {
            ...
            while (it2.hasNext()) {
                zzc(fieldDescriptor, it2.next(), false);
            }
            return this;
        }
        if (obj instanceof Map) {
            ...
            while (it3.hasNext()) {
                zzk(zzd, fieldDescriptor, (Map.Entry) it3.next(), false);
            }
            return this;
        }
        ...
        if (obj instanceof zzbg) {
            zzd(fieldDescriptor, ((zzbg) obj).zza(), true);
            return this;
        }
    ...
    final zzbk zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzbi zzbiVarZzj = zzj(fieldDescriptor);
        zzbh zzbhVar = zzbh.DEFAULT;
        int iOrdinal = zzbiVarZzj.zzb().ordinal();
        if (iOrdinal == 0) {
            zzn(zzbiVarZzj.zza() << 3);
            zzn(i);
        } else if (iOrdinal == 1) {
            zzn(zzbiVarZzj.zza() << 3);
            zzn((i + i) ^ (i >> 31));
        } else if (iOrdinal == 2) {
            zzn((zzbiVarZzj.zza() << 3) | 5);
            this.zze.write(zzm(4).putInt(i).array());
        }
        return this;
    }

    final zzbk zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzbi zzbiVarZzj = zzj(fieldDescriptor);
        ...
        if (iOrdinal == 0) {
            ...
            zzn((zzbiVarZzj.zza() << 3) | 1);
            this.zze.write(zzm(8).putLong(j).array());
        }
        return this;
    }

    final zzbk zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
