...
public abstract class zzlx {
    static zzlp zzb(Class cls) {
        ...
        try {
            try {
                try {
                    return (zzlp) cls.cast(((zzlx) Class.forName(str, true, classLoader).getConstructor(null).newInstance(null)).zza());
            ...
            Iterator it2 = ServiceLoader.load(zzlx.class, classLoader).iterator();
