...
final class zzlh extends zzlk {
    ...
    public final void zzq(String str) throws IOException {
        ...
        try {
            ...
            int i3 = i + iZzz2;
            this.zze = i3;
            int iZzb = zzoo.zzb(str, this.zzc, i3, this.zzd - i3);
            this.zze = i;
            zzt((iZzb - i) - iZzz2);
            this.zze = iZzb;
        } catch (zzon e) {
    ...
    public final void zzv(long j) throws IOException {
        ...
        if (!zzlk.zzd || this.zzd - i2 < 10) {
            while ((j & (-128)) != 0) {
                try {
                    ...
                    try {
                        ...
                        i2 = i3;
                        indexOutOfBoundsException = e;
                        throw new zzli(i2, this.zzd, 1, indexOutOfBoundsException);
                    }
                } catch (IndexOutOfBoundsException e2) {
                    e = e2;
                }
            ...
            while ((j & (-128)) != 0) {
                zzol.zzn(this.zzc, i2, (byte) (((int) j) | 128));
                j >>>= 7;
                i2++;
            }
            i = i2 + 1;
            zzol.zzn(this.zzc, i2, (byte) j);
        }
        this.zze = i;
    }
}
