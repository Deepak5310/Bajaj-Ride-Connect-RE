...
public final class zzpd implements zzpc {
    ...
    static {
        ...
        zzb = zzkfVarZza.zzd("measurement.app_uninstalled_additional_ad_id_cache_time", DateUtils.MILLIS_PER_HOUR);
        ...
        zze = zzkfVarZza.zzd("measurement.config.cache_time", DateUtils.MILLIS_PER_DAY);
        zzkfVarZza.zze("measurement.log_tag", "FA");
        zzf = zzkfVarZza.zze("measurement.config.url_authority", "app-measurement.com");
        zzg = zzkfVarZza.zze("measurement.config.url_scheme", UriUtil.HTTPS_SCHEME);
        zzh = zzkfVarZza.zzd("measurement.upload.debug_upload_interval", 1000L);
        zzi = zzkfVarZza.zzd("measurement.session.engagement_interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzy = zzkfVarZza.zzd("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        ...
        zzkfVarZza.zzd("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        ...
        zzS = zzkfVarZza.zzd("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzZ = zzkfVarZza.zze("measurement.rb.attribution.uri_scheme", UriUtil.HTTPS_SCHEME);
        ...
        zzae = zzkfVarZza.zzd("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        zzaf = zzkfVarZza.zzd("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzao = zzkfVarZza.zzd("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzas = zzkfVarZza.zzd("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
