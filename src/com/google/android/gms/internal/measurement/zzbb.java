...
public final class zzbb {
    ...
    /* JADX WARN: Code duplicated, block: B:63:0x0103 A[PHI: r4
      0x0103: PHI (r4v3 java.lang.String) = (r4v2 java.lang.String), (r4v4 java.lang.String) binds: [B:61:0x00fd, B:58:0x00ef] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        switch (b) {
            case 0:
                ...
                if (!list.isEmpty()) {
                    ...
                    while (it2.hasNext()) {
                        zzap zzapVarZzb = zzgVar.zzb((zzap) it2.next());
            ...
            case 19:
                if (!list.isEmpty()) {
                    ...
                    while (it5.hasNext()) {
                        zzap zzapVarZzb13 = zzgVar.zzb((zzap) it5.next());
