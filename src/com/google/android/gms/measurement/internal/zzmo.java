...
public final class zzmo extends zzg {
    ...
    public final void zzB(zzmh zzmhVar, zzmh zzmhVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z2) {
            ...
            String str3 = true != z4 ? "auto" : SdkRemoteClientConnector.CATEGORY;
    ...
    public final void zzx(com.google.android.gms.internal.measurement.zzdj zzdjVar, String str, String str2) {
        ...
        zzioVar.zzaW().zzj().zzc("Setting current screen to name, class", str == null ? BuildConfig.TRAVIS : str, str2);
    ...
    public final void zzy(Bundle bundle, long j) {
        synchronized (this.zzj) {
            ...
            zzio zzioVar = this.zzu;
            zzioVar.zzaW().zzj().zzc("Logging screen view with name, class", string == null ? BuildConfig.TRAVIS : string, string2 == null ? BuildConfig.TRAVIS : string2);
