...
final class zzaw extends zzpg {
    ...
    private final zzpz zzaB(String str, long j, byte[] bArr, String str2, String str3, int i, int i2, long j2, long j3, long j4) {
        ...
        try {
            ...
            if (zzmfVarZzb != zzmf.GOOGLE_SIGNAL && zzmfVarZzb != zzmf.GOOGLE_SIGNAL_PENDING && i2 > 0) {
                ...
                Iterator it2 = zzhtVar.zzj().iterator();
                while (it2.hasNext()) {
                    com.google.android.gms.internal.measurement.zzhw zzhwVar = (com.google.android.gms.internal.measurement.zzhw) ((com.google.android.gms.internal.measurement.zzhx) it2.next()).zzch();
                    zzhwVar.zzat(i2);
                ...
                try {
                    ...
                    if (TextUtils.isEmpty(str2)) {
                        ...
                        try {
                            ...
                            e = e;
                            this.zzu.zzaW().zze().zzd("(2)Error querying user properties", zzhe.zzn(str), string, e);
                            arrayList = Collections.emptyList();
                        }
                    }
                    if (!TextUtils.isEmpty(str3)) {
                    ...
                    zzio zzioVar = this.zzu;
                    zzioVar.zzf();
                    cursorQuery = zzj().query("user_attributes", new String[]{"name", "set_timestamp", "value", "origin"}, string2, strArr, null, null, "rowid", "1001");
                    if (cursorQuery.moveToFirst()) {
                        do {
                            int size = arrayList.size();
                            zzioVar.zzf();
                            ...
                            if (objZzz == null) {
                                zzioVar.zzaW().zze().zzd("(2)Read invalid user property value, ignoring it", zzhe.zzn(str), string, str3);
                            } else {
                                arrayList.add(new zzqd(str, string, string3, j, objZzz));
                            }
                        } while (cursorQuery.moveToNext());
                    }
                } catch (SQLiteException e2) {
    ...
    /* JADX WARN: Code duplicated, block: B:31:0x00c6 A[PHI: r2 r3
      0x00c6: PHI (r2v17 android.database.Cursor) = (r2v16 android.database.Cursor), (r2v23 android.database.Cursor) binds: [B:45:0x00fe, B:30:0x00c4] A[DONT_GENERATE, DONT_INLINE]
      0x00c6: PHI (r3v6 java.lang.Object) = (r3v19 java.lang.Object), (r3v20 java.lang.Object) binds: [B:45:0x00fe, B:30:0x00c4] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Multi-variable type inference failed */
        ...
        while (!listZza.isEmpty()) {
            for (zzat zzatVar : listZza) {
                try {
                    if (!TextUtils.isEmpty(str2)) {
                        try {
                            cursorQuery = zzj().query("raw_events_metadata", new String[]{"metadata"}, "app_id = ? and metadata_fingerprint = ?", new String[]{str4, Long.toString(zzatVar.zzb)}, null, null, "rowid", ExifInterface.GPS_MEASUREMENT_2D);
                            try {
                                try {
                                    if (cursorQuery.moveToFirst()) {
                                        try {
                                        ...
                                        zzioVar2.zzaW().zze().zzb("Raw event metadata record is missing. appId", zzhe.zzn(str));
                                        if (cursorQuery != null) {
                                            cursorQuery.close();
                                        }
                                        zzhxVar = cursor;
                        ...
                        if (zzhxVar != 0) {
                            Iterator it2 = zzhxVar.zzY().iterator();
                            while (true) {
                                if (it2.hasNext()) {
                                    if (((com.google.android.gms.internal.measurement.zzio) it2.next()).zzg().equals(str2)) {
                                    }
                                }
                            }
                        }
                ...
                zzbcVar = new zzbc(this.zzu, zzhfVar.zzb, str, zzhmVar.zzh(), zzhmVar.zzd(), zzhmVar.zzc(), bundle3);
                j = zzatVar.zza;
                long j2 = zzatVar.zzb;
        ...
        try {
            ...
            while (it3.hasNext()) {
                ...
                if (zzfhVar.zzk()) {
                    ...
                    while (true) {
                        if (it4.hasNext()) {
                            if (!((com.google.android.gms.internal.measurement.zzfj) it4.next()).zzp()) {
                            ...
                            Iterator it5 = zzfhVar.zzh().iterator();
                            while (true) {
                                if (!it5.hasNext()) {
                                    Iterator it6 = zzfhVar.zzg().iterator();
                                    while (true) {
                                        if (!it6.hasNext()) {
                                            it2 = it3;
                                            Iterator it7 = zzfhVar.zzh().iterator();
                                            while (it7.hasNext()) {
                                        ...
                                        com.google.android.gms.internal.measurement.zzfj zzfjVar = (com.google.android.gms.internal.measurement.zzfj) it6.next();
                                        zzav();
                                        zzg();
                                        Preconditions.checkNotEmpty(str);
                                        ...
                                        if (!zzfjVar.zzg().isEmpty()) {
                                            ...
                                            try {
                                                ...
                                                String str7 = str6;
                                                sQLiteDatabaseZzj3.delete("property_filters", str7, new String[]{str, String.valueOf(iZza)});
                                                sQLiteDatabaseZzj3.delete("event_filters", str7, new String[]{str, String.valueOf(iZza)});
                                                str6 = str7;
                                                it3 = it2;
                                                break;
                                            }
                                        ...
                                        String str8 = str6;
                                        sQLiteDatabaseZzj4.delete("property_filters", str8, new String[]{str, String.valueOf(iZza)});
                                        sQLiteDatabaseZzj4.delete("event_filters", str8, new String[]{str, String.valueOf(iZza)});
                                        str6 = str8;
                                        break;
                                    }
                                    it3 = it2;
                                ...
                                if (!((com.google.android.gms.internal.measurement.zzfr) it5.next()).zzj()) {
            ...
            while (it9.hasNext()) {
                com.google.android.gms.internal.measurement.zzfh zzfhVar2 = (com.google.android.gms.internal.measurement.zzfh) it9.next();
            ...
            try {
                ...
                int i5 = 0;
                int iMax = Math.max(0, Math.min(Constants.MAX_URL_LENGTH, this.zzu.zzf().zzh(str, zzgi.zzT)));
                if (jZzay > iMax) {
    ...
    public final void zzT(zzh zzhVar, boolean z, boolean z2) {
        ...
        contentValues.put(WeatherCriteria.UNIT_TYPE_DAY, Long.valueOf(zzhVar.zzm()));
    ...
    public final boolean zzah(zzai zzaiVar) {
        ...
        contentValues.put("active", Boolean.valueOf(zzaiVar.zze));
    ...
    /* JADX WARN: Code duplicated, block: B:40:0x00d3 A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:41:0x00e8 A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TRY_LEAVE, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:45:0x0102 A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:48:0x0121 A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:49:0x012c A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:52:0x0152 A[Catch: SQLiteException -> 0x0068, all -> 0x006b, LOOP:0: B:52:0x0152->B:91:?, LOOP_START, TRY_LEAVE, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:60:0x0197 A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:63:0x019e A[Catch: SQLiteException -> 0x0068, all -> 0x006b, TryCatch #0 {SQLiteException -> 0x0068, blocks: (B:17:0x0060, B:38:0x00b1, B:40:0x00d3, B:41:0x00e8, B:42:0x00ec, B:43:0x00fc, B:45:0x0102, B:46:0x0115, B:48:0x0121, B:50:0x0132, B:52:0x0152, B:53:0x015b, B:55:0x0166, B:60:0x0197, B:59:0x0183, B:63:0x019e, B:49:0x012c, B:65:0x01b3), top: B:79:0x0060 }] */
    /* JADX WARN: Code duplicated, block: B:89:0x0181 A[SYNTHETIC] */
                    ...
                    try {
                        if (cursorRawQuery.moveToFirst()) {
                            ...
                            try {
                                ...
                                cursorRawQuery.close();
                                cursorRawQuery = sQLiteDatabaseZzj.query("raw_events_metadata", new String[]{"metadata"}, "app_id = ? and metadata_fingerprint = ?", new String[]{string, string2}, null, null, "rowid", ExifInterface.GPS_MEASUREMENT_2D);
                                if (cursorRawQuery.moveToFirst()) {
                                    try {
    ...
    public final zzh zzl(String str) {
        ...
        Cursor cursor = null;
        try {
            cursorQuery = zzj().query("apps", new String[]{"app_instance_id", "gmp_app_id", "resettable_device_id_hash", "last_bundle_index", "last_bundle_start_timestamp", "last_bundle_end_timestamp", "app_version", "app_store", "gmp_version", "dev_cert_hash", "measurement_enabled", WeatherCriteria.UNIT_TYPE_DAY, "daily_public_events_count", "daily_events_count", "daily_conversions_count", "config_fetched_time", "failed_config_fetch_time", "app_version_int", "firebase_instance_id", "daily_error_events_count", "daily_realtime_events_count", "health_monitor_sample", "android_id", "adid_reporting_enabled", "admob_app_id", "dynamite_version", "safelisted_events", "ga_app_id", "session_stitching_token", "sgtm_upload_enabled", "target_os_version", "session_stitching_token_hash", "ad_services_version", "unmatched_first_open_without_ad_id", "npa_metadata_value", "attribution_eligibility_status", "sgtm_preview_key", "dma_consent_state", "daily_realtime_dcu_count", "bundle_delivery_index", "serialized_npa_metadata", "unmatched_pfo", "unmatched_uwa", "ad_campaign_info", "client_upload_eligibility"}, "app_id=?", new String[]{str}, null, null, null);
            try {
                try {
                    if (cursorQuery.moveToFirst()) {
                        zzpv zzpvVar = this.zzg;
        ...
        try {
            try {
                ...
                try {
                    ...
                    e = e;
                    zzio zzioVar2 = this.zzu;
                    zzioVar2.zzaW().zze().zzd("Error querying conditional property", zzhe.zzn(str), zzioVar2.zzj().zzf(str2), e);
                }
            } catch (Throwable th) {
                th = th;
                cursor2 = cursor;
    ...
    public final zzas zzp(long j, String str, long j2, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7) {
        ...
        try {
            try {
                SQLiteDatabase sQLiteDatabaseZzj = zzj();
                cursorQuery = sQLiteDatabaseZzj.query("apps", new String[]{WeatherCriteria.UNIT_TYPE_DAY, "daily_events_count", "daily_public_events_count", "daily_conversions_count", "daily_error_events_count", "daily_realtime_events_count", "daily_realtime_dcu_count", "daily_registered_triggers_count"}, "app_id=?", new String[]{str}, null, null, null);
                if (cursorQuery.moveToFirst()) {
                    ...
                    ContentValues contentValues = new ContentValues();
                    contentValues.put(WeatherCriteria.UNIT_TYPE_DAY, Long.valueOf(j));
            ...
            try {
                ...
                try {
                    if (cursorQuery.moveToFirst()) {
                        ...
                        Object objZzz = zzz(cursorQuery, 1);
                        if (objZzz != null) {
                            zzqd zzqdVar = new zzqd(str, cursorQuery.getString(2), str2, j, objZzz);
                            if (cursorQuery.moveToNext()) {
