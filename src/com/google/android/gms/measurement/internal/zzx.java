        ...
        if (zzd()) {
            if (zze()) {
                ...
                if (TextUtils.isEmpty(strZza)) {
                    ...
                    long jZza = zzioVar.zzm().zzs.zza() / DateUtils.MILLIS_PER_HOUR;
                    ...
                    zzioVar.zzq().zzR(pair.first == null ? SdkRemoteClientConnector.CATEGORY : (String) pair.first, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, (Bundle) pair.second);
                }
                zzioVar.zzm().zzr.zzb(null);
            }
