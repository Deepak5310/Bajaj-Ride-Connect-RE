...
public final class zzif extends zzpg implements zzal {
    ...
    private final void zzH(String str, com.google.android.gms.internal.measurement.zzgn zzgnVar) {
        ...
        Iterator it2 = zzgnVar.zzh().iterator();
        while (it2.hasNext()) {
            hashSet.add(((com.google.android.gms.internal.measurement.zzgk) it2.next()).zzb());
        }
    ...
    private final void zzJ(final String str, com.google.android.gms.internal.measurement.zzgo zzgoVar) {
        ...
        try {
            ...
            Iterator it2 = zzivVar.zza().zzd().iterator();
            while (it2.hasNext()) {
                zzioVar.zzaW().zzj().zzb("EES program activity", ((com.google.android.gms.internal.measurement.zzit) it2.next()).zzb());
            }
    ...
    final zzju zzf(String str, zzjw zzjwVar) throws Throwable {
        ...
        for (com.google.android.gms.internal.measurement.zzfz zzfzVar : zzgiVarZzi.zzf()) {
            if (zzL(zzfzVar.zzc()) == zzjwVar) {
                ...
                if (iZzb != 1) {
                    return iZzb != 2 ? zzju.UNINITIALIZED : zzju.DENIED;
                }
                return zzju.GRANTED;
            }
        }
    ...
    final SortedSet zzp(String str) {
        ...
        com.google.android.gms.internal.measurement.zzgi zzgiVarZzi = zzi(str);
        if (zzgiVarZzi != null) {
            Iterator it2 = zzgiVarZzi.zzc().iterator();
            while (it2.hasNext()) {
                treeSet.add(((com.google.android.gms.internal.measurement.zzgh) it2.next()).zzb());
            }
        }
        return treeSet;
    }
