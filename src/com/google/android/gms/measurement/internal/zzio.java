...
public final class zzio implements zzjs {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    ...
                    if (listQueryIntentActivities != null && !listQueryIntentActivities.isEmpty()) {
                        ...
                        zzioVar.zzr.zzR("auto", Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, bundle);
                        zzR(zzqfVar);
                        if (TextUtils.isEmpty(strOptString)) {
                            return;
                        }
    ...
    protected final void zzH(com.google.android.gms.internal.measurement.zzdh zzdhVar) {
        ...
        if (this.zzi.zzx(null, zzgi.zzaW)) {
            ...
            zzR(zzqfVar9);
            if (zzqfVar9.zzan()) {
                long jMax = Math.max(500L, ((((long) ((Integer) zzgi.zzaw.zza(null)).intValue()) * 1000) + ((long) new Random().nextInt(NavigationConstants.UI_HANDLER_LOCATION_SERVICE))) - this.zzp.elapsedRealtime());
                if (jMax > 500) {
    ...
    public final boolean zzO() {
        ...
        zzht zzhtVar2 = this.zzj;
        zzR(zzhtVar2);
        URL urlZzH = zzqfVar2.zzH(119002L, strZzm, str2, (-1) + zzhtVar2.zzp.zza(), sb.toString());
        if (urlZzH != null) {
