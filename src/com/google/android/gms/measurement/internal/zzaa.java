...
final class zzaa extends zzab {
    ...
    final boolean zzd(Long l, Long l2, com.google.android.gms.internal.measurement.zzhm zzhmVar, long j, zzbd zzbdVar, boolean z) {
        ...
        if (!zzfjVar.zzo()) {
            hashSet = new HashSet();
            it2 = zzfjVar.zzh().iterator();
            while (true) {
                if (it2.hasNext()) {
                    arrayMap = new ArrayMap();
                    it3 = zzhmVar.zzi().iterator();
                    while (true) {
                        if (it3.hasNext()) {
                            it4 = zzfjVar.zzh().iterator();
                            while (true) {
                                if (it4.hasNext()) {
                                    bool = true;
                                    break;
                                }
                                zzflVar = (com.google.android.gms.internal.measurement.zzfl) it4.next();
                            ...
                            zzhqVar = (com.google.android.gms.internal.measurement.zzhq) it3.next();
                    ...
                    zzflVar2 = (com.google.android.gms.internal.measurement.zzfl) it2.next();
        ...
        zzioVar.zzaW().zzj().zzb("Event filter result", bool == null ? BuildConfig.TRAVIS : bool);
        if (bool == null) {
            return false;
        }
        this.zzd = true;
