...
import com.google.android.libraries.navigation.internal.lh.ad;
        ...
        synchronized (this.zzp) {
            ...
            if (i == 1) {
                ...
                if (zzeVar != null) {
                    ...
                    String str = strZzb;
                    gmsClientSupervisor.zzc(strZzb, this.zza.zza(), ad.a, zzeVar, zze(), this.zza.zzc());
                    this.zzu = null;
                }
            } else if (i == 2 || i == 3) {
                ...
                if (zzeVar2 != null && (zzvVar = this.zza) != null) {
                    ...
                    String str2 = strZzb2;
                    gmsClientSupervisor2.zzc(strZzb2, this.zza.zza(), ad.a, zzeVar2, zze(), this.zza.zzc());
                    this.zzd.incrementAndGet();
                }
                zze zzeVar3 = new zze(this, this.zzd.get());
                this.zzu = zzeVar3;
                zzv zzvVar2 = (this.zzv != 3 || getLocalStartServiceAction() == null) ? new zzv(getStartServicePackage(), getStartServiceAction(), false, ad.a, getUseDynamicLookup()) : new zzv(getContext().getPackageName(), getLocalStartServiceAction(), true, ad.a, false);
                this.zza = zzvVar2;
                ...
                String str3 = strZzb3;
                ConnectionResult connectionResultZza = gmsClientSupervisor3.zza(new zzo(strZzb3, this.zza.zza(), ad.a, this.zza.zzc()), zzeVar3, zze(), getBindServiceExecutor());
