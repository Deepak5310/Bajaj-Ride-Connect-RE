...
final class bb extends com.google.android.libraries.navigation.internal.lo.i {
    ...
    public final void n() {
        ...
        try {
            ...
            this.e.a(new ba(this.f, cr.a(this.g).b(new com.google.android.libraries.navigation.internal.lo.n(this.g))));
            Iterator it2 = this.d.iterator();
            while (it2.hasNext()) {
                ((ba) this.a).l((OnMapReadyCallback) it2.next());
            }
            this.d.clear();
