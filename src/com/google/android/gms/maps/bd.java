...
public final class bd implements com.google.android.libraries.navigation.internal.lo.m {
    private final Fragment a;
    private final cl b;

    public bd(Fragment fragment, cl clVar) {
        this.b = clVar;
    ...
    public final void l(OnStreetViewPanoramaReadyCallback onStreetViewPanoramaReadyCallback) {
        try {
            this.b.a(new bc(onStreetViewPanoramaReadyCallback));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
