...
public class AutocompleteSupportFragment extends Fragment {
    ...
    public AutocompleteSupportFragment() {
        ...
        this.zzc = zziu.zzn(AutocompleteActivityMode.OVERLAY, zzlx.zzl(), zzis.FRAGMENT);
    }
    ...
    private final void zze() {
        Intent intentBuild = new Autocomplete.IntentBuilder(this.zzc.zzm()).build(requireContext());
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            try {
                zziu zziuVar = (zziu) bundle.getParcelable("options");
                if (zziuVar == null) {
                    return;
                }
                if (this.zza.getValue() == 0) {
                    this.zza.postValue(zziuVar.zzm());
                }
                if (this.zzb.getValue() == 0) {
                    this.zzb.postValue(zziuVar.zzl());
                }
                this.zzc = zziuVar.zzg();
            } catch (Error | RuntimeException e) {
                zzif.zzb(e);
                throw e;
            }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        editText.setHint(zzix.zzc(requireContext(), R.string.places_autocomplete_search_hint));
