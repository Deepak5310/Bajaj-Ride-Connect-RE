...
final class zzans extends zzaly implements RandomAccess, zzanw, zzaph {
    private static final zzans zza = new zzans(new int[0], 0, false);
    private int[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzaoa.zzd;
        collection.getClass();
        if (!(collection instanceof zzans)) {
            return super.addAll(collection);
        }
        zzans zzansVar = (zzans) collection;
        int i = zzansVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzansVar.zzb, 0, this.zzb, this.zzc, zzansVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzansVar.zzc) {
            return false;
        }
        int[] iArr = zzansVar.zzb;
    ...
    public final zzanw zzd(int i) {
        if (i >= this.zzc) {
            return new zzans(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzans(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }
