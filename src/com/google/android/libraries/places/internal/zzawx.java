...
final class zzawx {
    ...
    public static List zza(Class cls, Iterable iterable, ClassLoader classLoader, zzaww zzawwVar) {
        ?? Load;
        if (zzb(classLoader)) {
            Load = new ArrayList();
        ...
        Collections.sort(arrayList, Collections.reverseOrder(new zzawv(zzawwVar)));
