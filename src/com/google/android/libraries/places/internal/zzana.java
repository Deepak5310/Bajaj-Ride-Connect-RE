...
final class zzana extends zzaly implements RandomAccess, zzanz, zzaph {
    private static final zzana zza = new zzana(new double[0], 0, false);
    private double[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzaoa.zzd;
        collection.getClass();
        if (!(collection instanceof zzana)) {
            return super.addAll(collection);
        }
        zzana zzanaVar = (zzana) collection;
        int i = zzanaVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzanaVar.zzb, 0, this.zzb, this.zzc, zzanaVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        zzana zzanaVar = (zzana) obj;
        if (this.zzc != zzanaVar.zzc) {
            return false;
        }
        double[] dArr = zzanaVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzanz zzd(int i) {
        if (i >= this.zzc) {
            return new zzana(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzana(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
