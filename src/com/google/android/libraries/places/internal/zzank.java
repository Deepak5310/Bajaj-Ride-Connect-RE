...
final class zzank extends zzaly implements RandomAccess, zzanz, zzaph {
    private static final zzank zza = new zzank(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzaoa.zzd;
        collection.getClass();
        if (!(collection instanceof zzank)) {
            return super.addAll(collection);
        }
        zzank zzankVar = (zzank) collection;
        int i = zzankVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzankVar.zzb, 0, this.zzb, this.zzc, zzankVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzankVar.zzc) {
            return false;
        }
        float[] fArr = zzankVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzanz zzd(int i) {
        if (i >= this.zzc) {
            return new zzank(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzank(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
