...
final class zzamp extends zzamr {
    ...
    /* synthetic */ zzamp(InputStream inputStream, int i, zzamo zzamoVar) {
        super(null);
    ...
    @Override // com.google.android.libraries.places.internal.zzamr
    ...
    @Override // com.google.android.libraries.places.internal.zzamr
    public final int zze(int i) throws zzaoc {
        if (i < 0) {
            throw zzaoc.zzf();
        }
    ...
    @Override // com.google.android.libraries.places.internal.zzamr
    public final zzaml zzw() throws IOException {
        int iZzj = zzj();
        int i = this.zzh;
        int i2 = this.zzj;
        if (iZzj <= i - i2 && iZzj > 0) {
            zzaml zzamlVarZzl = zzaml.zzl(this.zzg, i2, iZzj);
            this.zzj += iZzj;
            return zzamlVarZzl;
        }
        if (iZzj == 0) {
        ...
        if (bArrZzQ != null) {
            return zzaml.zzl(bArrZzQ, 0, bArrZzQ.length);
        }
        int i3 = this.zzj;
        int i4 = this.zzh;
        int i5 = i4 - i3;
    ...
    public final String zzx() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzj;
            if (iZzj <= i - i2) {
                String str = new String(this.zzg, i2, iZzj, zzaoa.zzb);
                this.zzj += iZzj;
                return str;
            }
        }
        ...
        if (iZzj > this.zzh) {
            return new String(zzP(iZzj, false), zzaoa.zzb);
        }
        zzN(iZzj);
        String str2 = new String(this.zzg, this.zzj, iZzj, zzaoa.zzb);
        this.zzj += iZzj;
        return str2;
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzaqv.zzd(bArrZzP, i, iZzj);
    }

    @Override // com.google.android.libraries.places.internal.zzamr
    public final void zzz(int i) throws zzaoc {
        if (this.zzk != i) {
            throw zzaoc.zzb();
        }
    }
