...
final class zzpn extends AbstractMap {
    private static final Comparator zza = new zzpk();
    private final Object[] zzb;
    private final int[] zzc;
    private final Set zzd = new zzpm(this, -1);
