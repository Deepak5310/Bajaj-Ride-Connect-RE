...
public final class zzjr implements Parcelable {
    public static final Parcelable.Creator<zzjr> CREATOR = new zzjp();
    ...
    /* synthetic */ zzjr(Parcel parcel, zzjq zzjqVar) {
        this.zza = (zzis) parcel.readParcelable(zzis.class.getClassLoader());
        ...
        this.zzl = zzlb.zzc(parcel.readString());
    ...
    public zzjr(zzis zzisVar, AutocompleteActivityMode autocompleteActivityMode, String str, zzdh zzdhVar) {
        this.zza = zzisVar;
        this.zzb = autocompleteActivityMode;
        this.zzc = AutocompleteSessionToken.newInstance();
        this.zzl = zzlb.zzc(str);
        this.zzi = -1;
        this.zzq = -1L;
        this.zzr = zzdhVar;
    }
