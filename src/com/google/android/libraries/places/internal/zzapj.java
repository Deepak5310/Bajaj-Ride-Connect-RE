...
final class zzapj extends zzaly implements RandomAccess {
    private static final zzapj zza = new zzapj(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzanz zzd(int i) {
        if (i >= this.zzc) {
            return new zzapj(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzapj(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }
