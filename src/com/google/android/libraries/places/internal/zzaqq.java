...
final class zzaqq {
    ...
    private static final zzaqp zzf;
    ...
    static {
        ...
        if (unsafeZzg != null) {
            if (zZzv) {
                zzaqnVar = new zzaqo(unsafeZzg);
            } else if (zZzv2) {
                zzaqnVar = new zzaqn(unsafeZzg);
            }
        }
        zzf = zzaqnVar;
        if (zzaqnVar == null) {
            ...
            try {
                Class<?> cls = zzaqnVar.zza.getClass();
        ...
        if (zzaqpVar2 == null) {
            ...
            try {
                Class<?> cls2 = zzaqpVar2.zza.getClass();
        ...
        zzA(Object[].class);
        Field fieldZzB = zzB();
        if (fieldZzB != null && (zzaqpVar = zzf) != null) {
            zzaqpVar.zza.objectFieldOffset(fieldZzB);
        }
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzaqp zzaqpVar = zzf;
        long j2 = (-4) & j;
        int i = zzaqpVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzaqpVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzaqpVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzaqpVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzaqm());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzaqq.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
