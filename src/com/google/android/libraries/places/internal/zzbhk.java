...
final class zzbhk {
    ...
    zzbhk(Runnable runnable, Executor executor, ScheduledExecutorService scheduledExecutorService, zzla zzlaVar) {
        this.zzc = runnable;
        this.zzb = executor;
    ...
    final void zzi(long j, TimeUnit timeUnit) {
        ...
        if (jZzk - this.zze < 0 || this.zzg == null) {
            ...
            this.zzg = this.zza.schedule(new zzbhj(this, null), nanos, TimeUnit.NANOSECONDS);
        }
        this.zze = jZzk;
    }
}
