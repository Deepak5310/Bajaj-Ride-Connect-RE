...
final class zzaqv {
    ...
    static String zzd(byte[] bArr, int i, int i2) throws zzaoc {
        int i3;
        ...
        while (i < i4) {
            ...
            if (zzaqr.zzd(b2)) {
                ...
                if (b2 < -32) {
                    ...
                    int i8 = i + 2;
                    i += 3;
                    zzaqr.zzb(b2, bArr[i7], bArr[i8], cArr, i6);
                } else {
                    if (i7 >= i4 - 2) {
                        throw zzaoc.zzd();
                    }
                    ...
                    byte b5 = bArr[i + 2];
                    i += 4;
                    zzaqr.zza(b2, b4, b5, bArr[i9], cArr, i6);
                    i6 += 2;
                }
                i6 = i3;
            }
