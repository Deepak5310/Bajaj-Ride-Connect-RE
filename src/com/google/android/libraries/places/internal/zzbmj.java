...
public final class zzbmj implements HostnameVerifier {
    public static final zzbmj zza = new zzbmj();
    ...
    public final boolean verify(String str, SSLSession sSLSession) {
        ...
        try {
            ...
            if (z || (strZza = new zzbmf(x509Certificate.getSubjectX500Principal()).zza("cn")) == null) {
                return false;
            }
