...
final class zzama extends zzaly implements RandomAccess, zzanz, zzaph {
    private static final zzama zza = new zzama(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzaoa.zzd;
        collection.getClass();
        if (!(collection instanceof zzama)) {
            return super.addAll(collection);
        }
        zzama zzamaVar = (zzama) collection;
        int i = zzamaVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzamaVar.zzb, 0, this.zzb, this.zzc, zzamaVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzamaVar.zzc) {
            return false;
        }
        boolean[] zArr = zzamaVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzaoa.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzanz zzd(int i) {
        if (i >= this.zzc) {
            return new zzama(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzama(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
