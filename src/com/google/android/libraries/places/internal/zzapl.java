...
interface zzapl {
    ...
    @Deprecated
    void zzC(List list, zzapm zzapmVar, zzand zzandVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzapm zzapmVar, zzand zzandVar) throws IOException;
    ...
    zzaml zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzapm zzapmVar, zzand zzandVar) throws IOException;

    void zzu(Object obj, zzapm zzapmVar, zzand zzandVar) throws IOException;
