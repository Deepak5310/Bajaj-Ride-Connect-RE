...
public abstract class AutocompletePrediction implements Parcelable {
    ...
    public static abstract class Builder {
        public AutocompletePrediction build() {
            ...
            setPlaceTypes(zzlx.zzj(autocompletePredictionZze.getPlaceTypes()));
            setTypes(zzlx.zzj(autocompletePredictionZze.getTypes()));
            zza(zzlx.zzj(autocompletePredictionZze.zzd()));
            zzc(zzlx.zzj(autocompletePredictionZze.zze()));
            zzd(zzlx.zzj(autocompletePredictionZze.zzf()));
            return zze();
        }
