...
public final class zzce {
    ...
    static {
        ...
        zzlzVar.zza(1, DayOfWeek.SUNDAY);
        zzlzVar.zza(2, DayOfWeek.MONDAY);
        zzlzVar.zza(3, DayOfWeek.TUESDAY);
        zzlzVar.zza(4, DayOfWeek.WEDNESDAY);
        zzlzVar.zza(5, DayOfWeek.THURSDAY);
        zzlzVar.zza(6, DayOfWeek.FRIDAY);
        zzlzVar.zza(7, DayOfWeek.SATURDAY);
        zzb = zzlzVar.zzc();
        ...
        if (utcOffsetMinutes != null) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    try {
                        ...
                        if (date == null || date2 == null) {
                            ...
                            if (!zzmk.zzb(Long.valueOf(timeInMillis), Long.valueOf(calendar.getTimeInMillis())).zzd(Long.valueOf(j))) {
                                currentOpeningHours = place.getOpeningHours();
                            }
                        }
            ...
            if (currentOpeningHours != null) {
                ...
                if (timeZoneZze2 != null) {
                    ...
                    while (it2.hasNext()) {
                        if (((zzmk) it2.next()).zzd(localTimeNewInstance)) {
                            return true;
                        }
                    }
                    return false;
            ...
            while (periodBuild != null) {
                ...
                if (open == null || close == null) {
                    ...
                    if (open.getDay() != close.getDay()) {
                        ...
                        list2.add(zzmk.zzb(time, localTime));
