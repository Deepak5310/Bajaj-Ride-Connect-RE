...
abstract class zzx extends Place {
    ...
    public final int hashCode() {
        ...
        Double d = this.zzx;
        int iHashCode21 = (((iHashCode20 ^ (d == null ? 0 : d.hashCode())) * 1000003) ^ this.zzy.hashCode()) * 1000003;
        List list5 = this.zzz;
        int iHashCode22 = (((((((((((((((((iHashCode21 ^ (list5 == null ? 0 : list5.hashCode())) * 1000003) ^ this.zzA.hashCode()) * 1000003) ^ this.zzB.hashCode()) * 1000003) ^ this.zzC.hashCode()) * 1000003) ^ this.zzD.hashCode()) * 1000003) ^ this.zzE.hashCode()) * 1000003) ^ this.zzF.hashCode()) * 1000003) ^ this.zzG.hashCode()) * 1000003) ^ this.zzH.hashCode()) * 1000003;
        List list6 = this.zzI;
        int iHashCode23 = (iHashCode22 ^ (list6 == null ? 0 : list6.hashCode())) * 1000003;
        Integer num3 = this.zzJ;
        int iHashCode24 = (iHashCode23 ^ (num3 == null ? 0 : num3.hashCode())) * 1000003;
        Integer num4 = this.zzK;
        int iHashCode25 = (iHashCode24 ^ (num4 == null ? 0 : num4.hashCode())) * 1000003;
        LatLngBounds latLngBounds = this.zzL;
        int iHashCode26 = (iHashCode25 ^ (latLngBounds == null ? 0 : latLngBounds.hashCode())) * 1000003;
        Uri uri = this.zzM;
        return ((iHashCode26 ^ (uri != null ? uri.hashCode() : 0)) * 1000003) ^ this.zzN.hashCode();
    }
}
