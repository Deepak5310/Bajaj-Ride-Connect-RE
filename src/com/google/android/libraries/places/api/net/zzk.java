...
final class zzk extends FindAutocompletePredictionsRequest {
    ...
    /* synthetic */ zzk(String str, LocationBias locationBias, LocationRestriction locationRestriction, LatLng latLng, List list, AutocompleteSessionToken autocompleteSessionToken, TypeFilter typeFilter, List list2, CancellationToken cancellationToken, zzj zzjVar) {
        this.zza = str;
    ...
    @Override // com.google.android.libraries.places.api.net.FindAutocompletePredictionsRequest, com.google.android.libraries.places.internal.zzhx
    ...
    public final int hashCode() {
        ...
        CancellationToken cancellationToken = this.zzi;
        return iHashCode6 ^ (cancellationToken != null ? cancellationToken.hashCode() : 0);
    }
}
