...
final class zzu extends SearchByTextRequest.Builder {
    ...
    public final SearchByTextRequest.RankPreference getRankPreference() {
        ...
        throw new IllegalStateException("Property \"rankPreference\" has not been set");
    }
    ...
    public final SearchByTextRequest.Builder setRankPreference(SearchByTextRequest.RankPreference rankPreference) {
        if (rankPreference == null) {
            throw new NullPointerException("Null rankPreference");
        }
    ...
    final SearchByTextRequest zza() {
        ...
        String str;
        if (this.zzn == 3 && (list = this.zzh) != null && (list2 = this.zzi) != null && (rankPreference = this.zzj) != null && (str = this.zzm) != null) {
            return new zzw(this.zza, this.zzb, this.zzc, this.zzd, this.zze, this.zzf, this.zzg, list, list2, rankPreference, this.zzk, this.zzl, str, null);
        }
