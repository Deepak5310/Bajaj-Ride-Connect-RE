...
final class zzw extends SearchByTextRequest {
    ...
    /* synthetic */ zzw(CancellationToken cancellationToken, String str, LocationBias locationBias, LocationRestriction locationRestriction, Integer num, Double d, boolean z, List list, List list2, SearchByTextRequest.RankPreference rankPreference, String str2, boolean z2, String str3, zzv zzvVar) {
    ...
    public final int hashCode() {
        ...
        Double d = this.zzf;
        int iHashCode6 = (((((((((iHashCode5 ^ (d == null ? 0 : d.hashCode())) * 1000003) ^ (true != this.zzg ? 1237 : 1231)) * 1000003) ^ this.zzh.hashCode()) * 1000003) ^ this.zzi.hashCode()) * 1000003) ^ this.zzj.hashCode()) * 1000003;
        String str2 = this.zzk;
        return ((((iHashCode6 ^ (str2 != null ? str2.hashCode() : 0)) * 1000003) ^ (true == this.zzl ? 1231 : 1237)) * 1000003) ^ this.zzm.hashCode();
    }
}
