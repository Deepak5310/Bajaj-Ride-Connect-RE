...
public final class n extends bi implements cz {
    ...
    private int c;
    private com.google.android.libraries.navigation.internal.adp.d d;
    private com.google.android.libraries.navigation.internal.adq.n e;
    private n f;
    private byte g = 2;
    ...
    public final Object aH(int i, Object obj) {
        ...
        if (i2 == 2) {
            return new dk(a, "\u0001\u0003\u0000\u0001\u0001\f\u0003\u0000\u0000\u0003\u0001ᐉ\u000e\bᐉ\u0004\fᐉ\u0003", new Object[]{"c", "f", "e", "d"});
        }
        if (i2 == 3) {
            return new n();
        }
