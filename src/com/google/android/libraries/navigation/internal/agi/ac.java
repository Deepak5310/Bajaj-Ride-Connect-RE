...
public abstract class ac extends ab implements Serializable, ju {
    ...
    public final /* synthetic */ void forEach(final BiConsumer biConsumer) {
        hd hdVarD = d();
        Consumer consumer = new Consumer() { // from class: com.google.android.libraries.navigation.internal.agi.js
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ke keVar = (ke) obj;
                biConsumer.accept(keVar.getKey(), keVar.getValue());
            }
        };
        if (hdVarD instanceof kf) {
            ((kf) hdVarD).d(consumer);
        } else {
    ...
    public int hashCode() {
        ...
        for (int size = size(); size != 0; size--) {
            iHashCode += ((ke) giVarA.next()).hashCode();
        }
        return iHashCode;
    }
    ...
    public final String toString() {
        ...
        while (size != 0) {
            ...
            ke keVar = (ke) giVarA.next();
            if (this == keVar.getKey()) {
                sb.append("(this map)");
            } else {
                sb.append(String.valueOf(keVar.getKey()));
            }
            size--;
            sb.append("=>");
            if (this == keVar.getValue()) {
                sb.append("(this map)");
            } else {
                sb.append(String.valueOf(keVar.getValue()));
            }
            z = false;
        }
        sb.append("}");
