...
final class ci extends cg implements com.google.android.libraries.navigation.internal.agg.fh {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ci(cj cjVar, int i, int i2, boolean z) {
        super(cjVar, i, i2, z);
        this.a = cjVar;
    }
