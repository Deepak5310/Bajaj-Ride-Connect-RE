...
public enum e implements cw {
    ...
    GRAVITY,
    HANDWRITING_DELEGATOR_CALLBACK,
    ...
    public final boolean a() {
        ...
        return iOrdinal == 25 || iOrdinal == 30 || iOrdinal == 40 || iOrdinal == 64 || iOrdinal == 76 || iOrdinal == 92 || iOrdinal == 159 || iOrdinal == 166;
    }

    public final boolean b() {
        int iOrdinal = ordinal();
        return iOrdinal == 77 || iOrdinal == 185;
    }
}
