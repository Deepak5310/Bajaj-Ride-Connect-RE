...
final class ef extends en implements com.google.android.libraries.navigation.internal.agi.hj {
    ...
    public final /* bridge */ /* synthetic */ void c(Object obj, int i) {
        ((Consumer) obj).accept(new ek(this.a, i));
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ef(eq eqVar, int i, int i2, boolean z) {
        super(eqVar, i, i2, z);
        this.a = eqVar;
    }
}
