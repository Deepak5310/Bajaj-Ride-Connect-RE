...
final class bj extends br implements com.google.android.libraries.navigation.internal.agi.hj {
    ...
    public final /* bridge */ /* synthetic */ void c(Object obj, int i) {
        ((Consumer) obj).accept(new bo(this.a, i));
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public bj(bu buVar, int i, int i2, boolean z) {
        super(buVar, i, i2, z);
        this.a = buVar;
    }
}
