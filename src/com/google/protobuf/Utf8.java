        ...
        final void encodeUtf8Default(CharSequence in, ByteBuffer out) {
            ...
            while (i < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    int i2 = iPosition + 1;
                    try {
                        out.put(iPosition, (byte) ((cCharAt2 >>> 6) | JfifUtil.MARKER_SOFn));
                    ...
                    int i3 = iPosition + 1;
                    out.put(iPosition, (byte) ((cCharAt2 >>> '\f') | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY));
                    iPosition += 2;
        ...
        int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            while (i4 < length2) {
                ...
                if (cCharAt2 < 128 && i5 < i3) {
                    ...
                    out[i5] = (byte) ((cCharAt2 >>> '\f') | StreamingImageHandler.TFT_HEIGHT);
                    int i9 = i5 + 2;
            ...
            while (i2 < length2) {
                ...
                if (cCharAt2 >= 128 || j3 >= j4) {
                    if (cCharAt2 >= 2048 || j3 > j4 - 2) {
                        ...
                        UnsafeUtil.putByte(out, j3, (byte) ((cCharAt2 >>> '\f') | StreamingImageHandler.TFT_HEIGHT));
                        long j6 = j3 + 2;
            ...
            while (i3 < length) {
                ...
                if (cCharAt2 >= c || jPosition >= jLimit) {
                    if (cCharAt2 >= 2048 || jPosition > jLimit - 2) {
                        ...
                        long j4 = jPosition + j;
                        UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> '\f') | StreamingImageHandler.TFT_HEIGHT));
                        long j5 = jPosition + 2;
