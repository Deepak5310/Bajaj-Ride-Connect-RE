        ...
        final void encodeUtf8Default(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (i < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    int i3 = iPosition + 1;
                    byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> '\f') | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY));
                    iPosition += 2;
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= 128 || j3 >= j4) {
                    if (cCharAt2 >= 2048 || j3 > j4 - 2) {
                        ...
                        UnsafeUtil.putByte(bArr, j3, (byte) ((cCharAt2 >>> '\f') | StreamingImageHandler.TFT_HEIGHT));
                        long j6 = j3 + 2;
