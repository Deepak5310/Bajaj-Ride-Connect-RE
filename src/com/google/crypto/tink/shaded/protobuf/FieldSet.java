...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z) {
        ...
        Iterator it2 = smallSortedMap.getOverflowEntries().iterator();
        while (it2.hasNext()) {
            cloneFieldEntry(smallSortedMapNewFieldMap, (Map.Entry) it2.next(), z);
        }
    ...
    public void setField(T t, Object obj) {
        if (t.isRepeated()) {
            ...
            while (it2.hasNext()) {
                verifyType(t.getLiteType(), it2.next());
            }
            obj = arrayList;
        } else {
    ...
    public void writeMessageSetTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        Iterator it2 = this.fields.getOverflowEntries().iterator();
        while (it2.hasNext()) {
            writeMessageSetTo((Map.Entry) it2.next(), codedOutputStream);
        }
    }
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap) {
            ...
            Iterator it2 = smallSortedMap.getOverflowEntries().iterator();
            while (it2.hasNext()) {
                replaceBuilders((Map.Entry) it2.next());
            }
        }
        ...
        private void mergeFromField(Map.Entry<T, Object> entry) {
            ...
            if (key.isRepeated()) {
                ...
                Iterator it2 = ((List) value).iterator();
                while (it2.hasNext()) {
                    ((List) field).add(FieldSet.cloneIfMutable(it2.next()));
                }
                this.fields.put(key, field);
                return;
            }
