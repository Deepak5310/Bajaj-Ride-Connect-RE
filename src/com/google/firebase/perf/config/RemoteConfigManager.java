...
public class RemoteConfigManager {
    ...
    private RemoteConfigManager() {
        this(DeviceCacheManager.getInstance(), new ThreadPoolExecutor(0, 1, 0L, TimeUnit.SECONDS, new LinkedBlockingQueue()), null, MIN_APP_START_CONFIG_FETCH_DELAY_MS + ((long) new Random().nextInt(RANDOM_APP_START_CONFIG_FETCH_DELAY_MS)), getInitialStartupMillis());
    }
    ...
    private void triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch() {
        ...
        this.firebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(this.executor, new OnSuccessListener() { // from class: com.google.firebase.perf.config.RemoteConfigManager$$ExternalSyntheticLambda0
            ...
            public final void onSuccess(Object obj) {
                this.f$0.m1745xa8c2d88f((Boolean) obj);
            }
    ...
    /* synthetic */ void m1745xa8c2d88f(Boolean bool) {
    ...
    /* synthetic */ void m1746x35fd8a10(Exception exc) {
