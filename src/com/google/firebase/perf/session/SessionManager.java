...
public class SessionManager extends AppStateUpdateHandler {
    ...
    public void setApplicationContext(final Context context) {
        ...
        this.syncInitFuture = Executors.newSingleThreadExecutor().submit(new Runnable() { // from class: com.google.firebase.perf.session.SessionManager$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m1748xa16819e0(context, perfSession);
            }
        });
    }
    ...
    /* synthetic */ void m1748xa16819e0(Context context, PerfSession perfSession) {
    ...
    public void updatePerfSession(PerfSession perfSession) {
        ...
        synchronized (this.clients) {
            Iterator<WeakReference<SessionAwareObject>> it2 = this.clients.iterator();
            while (it2.hasNext()) {
                SessionAwareObject sessionAwareObject = it2.next().get();
