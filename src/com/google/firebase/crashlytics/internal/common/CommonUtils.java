...
public class CommonUtils {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture, still in use, count: 1, list:
      ...
      (wrap java.lang.String:SGET  A[WRAPPED] com.facebook.soloader.MinElf.ISA.X86 java.lang.String)
    ...
    static final class Architecture {
        ...
        static {
            ...
            matcher = map;
            map.put(MinElf.ISA.ARM, new Architecture());
            map.put("armeabi", new Architecture());
            map.put(MinElf.ISA.AARCH64, new Architecture());
            map.put(MinElf.ISA.X86, new Architecture());
        }
    ...
    public static String getResourcePackageName(Context context) {
        ...
        if (i > 0) {
            try {
                ...
                return SystemMediaRouteProvider.PACKAGE_NAME.equals(resourcePackageName) ? context.getPackageName() : resourcePackageName;
