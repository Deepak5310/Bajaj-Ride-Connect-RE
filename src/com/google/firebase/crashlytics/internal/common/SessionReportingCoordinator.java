...
public class SessionReportingCoordinator {
    ...
    public void finalizeSessionWithNativeEvent(String str, List<NativeSessionFile> list, CrashlyticsReport.ApplicationExitInfo applicationExitInfo) {
        ...
        while (it2.hasNext()) {
            CrashlyticsReport.FilesPayload.File fileAsFilePayload = it2.next().asFilePayload();
    ...
    public Task<Void> sendReports(Executor executor, String str) {
        ...
        for (CrashlyticsReportWithSessionId crashlyticsReportWithSessionId : listLoadFinalizedReports) {
            if (str == null || str.equals(crashlyticsReportWithSessionId.getSessionId())) {
                arrayList.add(this.reportsSender.enqueueReport(ensureHasFid(crashlyticsReportWithSessionId), str != null).continueWith(executor, new Continuation() { // from class: com.google.firebase.crashlytics.internal.common.SessionReportingCoordinator$$ExternalSyntheticLambda9
        ...
        if (!z) {
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.SessionReportingCoordinator$$ExternalSyntheticLambda7
                ...
                public final void run() {
                    this.f$0.m1507x631b9fbf(eventAddMetaDataToEvent, eventMetadata, zEquals);
                }
            });
        } else {
    ...
    /* synthetic */ void m1507x631b9fbf(CrashlyticsReport.Session.Event event, EventMetadata eventMetadata, boolean z) {
    ...
    private ApplicationExitInfo findRelevantApplicationExitInfo(String str, List<ApplicationExitInfo> list) {
        ...
        while (it2.hasNext()) {
            ApplicationExitInfo applicationExitInfoM = a$$ExternalSyntheticApiModelOutline0.m((Object) it2.next());
