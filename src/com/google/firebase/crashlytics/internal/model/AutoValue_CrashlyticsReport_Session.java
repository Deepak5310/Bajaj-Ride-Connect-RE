...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    private final CrashlyticsReport.Session.Application f686app;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", appQualitySessionId=" + this.appQualitySessionId + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.f686app + ", user=" + this.user + ", os=" + this.os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public int hashCode() {
        ...
        Long l = this.endedAt;
        int iHashCode3 = (((((i ^ (l == null ? 0 : l.hashCode())) * 1000003) ^ (this.crashed ? 1231 : 1237)) * 1000003) ^ this.f686app.hashCode()) * 1000003;
    ...
    static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* JADX INFO: renamed from: app, reason: collision with root package name */
        private CrashlyticsReport.Session.Application f687app;
        ...
        public CrashlyticsReport.Session build() {
            ...
            if (this.set$0 != 7 || (str = this.generator) == null || (str2 = this.identifier) == null || (application = this.f687app) == null) {
