...
final class AutoValue_CrashlyticsReport_Session_Event extends CrashlyticsReport.Session.Event {
    ...
    private final CrashlyticsReport.Session.Event.Application f688app;
    ...
    public String toString() {
        return "Event{timestamp=" + this.timestamp + ", type=" + this.type + ", app=" + this.f688app + ", device=" + this.device + ", log=" + this.log + ", rollouts=" + this.rollouts + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.timestamp == event.getTimestamp() && this.type.equals(event.getType()) && this.f688app.equals(event.getApp()) && this.device.equals(event.getDevice()) && ((log = this.log) != null ? log.equals(event.getLog()) : event.getLog() == null)) {
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((((int) (j ^ (j >>> 32))) ^ 1000003) * 1000003) ^ this.type.hashCode()) * 1000003) ^ this.f688app.hashCode()) * 1000003) ^ this.device.hashCode()) * 1000003;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Builder {
        ...
        /* JADX INFO: renamed from: app, reason: collision with root package name */
        private CrashlyticsReport.Session.Event.Application f689app;
        ...
        public CrashlyticsReport.Session.Event build() {
            ...
            if (this.set$0 != 1 || (str = this.type) == null || (application = this.f689app) == null || (device = this.device) == null) {
