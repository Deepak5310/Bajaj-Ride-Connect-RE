...
class GmsRpc {
    ...
    private final FirebaseApp f694app;
    ...
    Task<String> getToken() {
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f694app), SCOPE_ALL, new Bundle()));
    }

    Task<?> deleteToken() {
        Bundle bundle = new Bundle();
        bundle.putString(EXTRA_DELETE, "1");
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f694app), SCOPE_ALL, bundle));
    }
    ...
    private String getHashedFirebaseAppName() {
        try {
            return base64UrlSafe(MessageDigest.getInstance("SHA-1").digest(this.f694app.getName().getBytes()));
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        bundle.putString(PARAM_GMP_APP_ID, this.f694app.getOptions().getApplicationId());
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task2) {
                return this.f$0.m1739xb80eb67f(task2);
            }
        });
    }
    ...
    /* synthetic */ String m1739xb80eb67f(Task task) throws Exception {
