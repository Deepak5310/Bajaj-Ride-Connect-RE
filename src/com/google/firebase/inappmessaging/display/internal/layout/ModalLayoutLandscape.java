...
public class ModalLayoutLandscape extends BaseModalLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (it3.hasNext()) {
            this.rightContentHeight += getDesiredHeight((View) it3.next());
        }
        ...
        while (it4.hasNext()) {
            iMax = Math.max(getDesiredWidth((View) it4.next()), iMax);
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int desiredHeight = getDesiredHeight(this.titleChild) + i11;
        ...
        int desiredHeight2 = getDesiredHeight(this.scrollChild) + i12;
