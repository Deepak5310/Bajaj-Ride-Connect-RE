...
public class ModalLayoutPortrait extends BaseModalLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float f = (float) iCalculateBaseWidth;
        Logging.logdPair("Base dimens", f, iCalculateBaseHeight);
