...
public class ConfigRealtimeHttpClient {
    ...
    public Task<HttpURLConnection> createRealtimeConnection() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{token, id}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return this.f$0.m1775xad28ecdf(token, id, task);
            }
        });
    }
    ...
    /* synthetic */ Task m1775xad28ecdf(Task task, Task task2, Task task3) throws Exception {
        ...
        if (canMakeHttpStreamConnection()) {
            if (new Date(this.clock.currentTimeMillis()).before(this.sharedPrefsClient.getRealtimeBackoffMetadata().getBackoffEndTime())) {
                ...
                Tasks.whenAllComplete((Task<?>[]) new Task[]{taskCreateRealtimeConnection}).continueWith(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient$$ExternalSyntheticLambda1
                    @Override // com.google.android.gms.tasks.Continuation
                    public final Object then(Task task) {
                        return this.f$0.m1774x5fb1dc1(taskCreateRealtimeConnection, task);
                    }
                });
            }
        }
    ...
    /* synthetic */ Task m1774x5fb1dc1(Task task, Task task2) throws Exception {
        Integer numValueOf;
        Throwable th;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!z) {
                            ...
                            if (responseCode != 200) {
                                ...
                                numValueOf.getClass();
                                firebaseRemoteConfigServerException = new FirebaseRemoteConfigServerException(responseCode, forbiddenErrorResponseMessage, FirebaseRemoteConfigException.Code.CONFIG_UPDATE_STREAM_ERROR);
                    ...
                    if (!z || numValueOf.intValue() == 200) {
                        ...
                        propagateErrors(new FirebaseRemoteConfigServerException(numValueOf.intValue(), forbiddenErrorResponseMessage3, FirebaseRemoteConfigException.Code.CONFIG_UPDATE_STREAM_ERROR));
                    }
                    throw th;
                }
