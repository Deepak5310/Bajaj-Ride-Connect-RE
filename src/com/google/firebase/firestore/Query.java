...
public class Query {
    ...
    private FieldFilter parseFieldFilter(Filter.UnaryFilter unaryFilter) {
        ...
        if (field.getInternalPath().isKeyField()) {
            ...
            if (operator == FieldFilter.Operator.IN || operator == FieldFilter.Operator.NOT_IN) {
                ...
                while (it2.hasNext()) {
                    builderNewBuilder.addValues(parseDocumentIdValue(it2.next()));
                }
    ...
    private com.google.firebase.firestore.core.Filter parseCompositeFilter(Filter.CompositeFilter compositeFilter) {
        ...
        while (it2.hasNext()) {
            com.google.firebase.firestore.core.Filter filter = parseFilter(it2.next());
    ...
    private List<FieldFilter.Operator> conflictingOps(FieldFilter.Operator operator) {
        ...
        return i != 4 ? new ArrayList() : Arrays.asList(FieldFilter.Operator.ARRAY_CONTAINS_ANY, FieldFilter.Operator.IN, FieldFilter.Operator.NOT_IN, FieldFilter.Operator.NOT_EQUAL);
    }
        ...
        if (source == Source.CACHE) {
            return ((Task) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.Query$$ExternalSyntheticLambda3
                ...
                public final Object apply(Object obj) {
                    return this.f$0.m1536lambda$get$0$comgooglefirebasefirestoreQuery((FirestoreClient) obj);
                }
                ...
                public final Object then(Task task) {
                    return this.f$0.m1537lambda$get$1$comgooglefirebasefirestoreQuery(task);
                }
            });
        }
    ...
    /* synthetic */ Task m1536lambda$get$0$comgooglefirebasefirestoreQuery(FirestoreClient firestoreClient) {
    ...
    /* synthetic */ QuerySnapshot m1537lambda$get$1$comgooglefirebasefirestoreQuery(Task task) throws Exception {
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor executor, final EventManager.ListenOptions listenOptions, final Activity activity, final EventListener<QuerySnapshot> eventListener) {
        ...
        final AsyncEventListener asyncEventListener = new AsyncEventListener(executor, new EventListener() { // from class: com.google.firebase.firestore.Query$$ExternalSyntheticLambda0
            @Override // com.google.firebase.firestore.EventListener
            public final void onEvent(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
                this.f$0.m1534xc56a5d4c(eventListener, (ViewSnapshot) obj, firebaseFirestoreException);
            }
        });
        return (ListenerRegistration) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.Query$$ExternalSyntheticLambda1
            @Override // com.google.firebase.firestore.util.Function
            public final Object apply(Object obj) {
                return this.f$0.m1535xecba044e(listenOptions, asyncEventListener, activity, (FirestoreClient) obj);
            }
        });
    }
    ...
    /* synthetic */ void m1534xc56a5d4c(EventListener eventListener, ViewSnapshot viewSnapshot, FirebaseFirestoreException firebaseFirestoreException) {
        if (firebaseFirestoreException != null) {
    ...
    /* synthetic */ ListenerRegistration m1535xecba044e(EventManager.ListenOptions listenOptions, final AsyncEventListener asyncEventListener, Activity activity, final FirestoreClient firestoreClient) {
        final QueryListener queryListenerListen = firestoreClient.listen(this.query, listenOptions, asyncEventListener);
    ...
    private void validateHasExplicitOrderByForLimitToLast() {
        if (this.query.getLimitType().equals(com.google.firebase.firestore.core.Query.LimitType.LIMIT_TO_LAST) && this.query.getExplicitOrderBy().isEmpty()) {
