...
final class SQLiteRemoteDocumentCache implements RemoteDocumentCache {
        ...
        while (longQuery.hasMoreSubqueries()) {
            longQuery.performNextSubquery().forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda2
                ...
                public final void accept(Object obj) {
                    this.f$0.m1615xca14d1c3(backgroundQueue, map, (Cursor) obj);
                }
            });
        }
    ...
    /* synthetic */ void m1615xca14d1c3(BackgroundQueue backgroundQueue, Map map, Cursor cursor) {
    ...
    public Map<DocumentKey, MutableDocument> getAll(String str, FieldIndex.IndexOffset indexOffset, int i) {
        ...
        Iterator<ResourcePath> it2 = collectionParents.iterator();
        while (it2.hasNext()) {
    ...
    private Map<DocumentKey, MutableDocument> getAll(List<ResourcePath> list, FieldIndex.IndexOffset indexOffset, int i, @Nullable final Function<MutableDocument, Boolean> function, @Nullable final QueryContext queryContext) {
        ...
        this.db.query(sbRepeatSequence.toString()).binding(objArr).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda1
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                this.f$0.m1616xbda45604(backgroundQueue, map, function, queryContext, (Cursor) obj);
            }
        });
        backgroundQueue.drain();
        return map;
    ...
    /* synthetic */ void m1616xbda45604(BackgroundQueue backgroundQueue, Map map, Function function, QueryContext queryContext, Cursor cursor) {
    ...
    private void processRowInBackground(BackgroundQueue backgroundQueue, final Map<DocumentKey, MutableDocument> map, Cursor cursor, @Nullable final Function<MutableDocument, Boolean> function) {
        ...
        executor.execute(new Runnable() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m1617x16ef698(blob, i, i2, function, map);
            }
        });
    }
    ...
    /* synthetic */ void m1617x16ef698(byte[] bArr, int i, int i2, Function function, Map map) {
