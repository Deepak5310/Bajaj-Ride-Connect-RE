...
public final class LocalStore implements BundleCallback {
    ...
    public ImmutableSortedMap<DocumentKey, Document> handleUserChange(User user) {
        ...
        while (it2.hasNext()) {
            ...
            while (it3.hasNext()) {
                ...
                while (it4.hasNext()) {
                    immutableSortedSetEmptyKeySet = immutableSortedSetEmptyKeySet.insert(it4.next().getKey());
                }
            }
        }
    ...
    public LocalDocumentsResult writeLocally(final List<Mutation> list) {
        ...
        return (LocalDocumentsResult) this.persistence.runTransaction("Locally write mutations", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda12
            ...
            public final Object get() {
                return this.f$0.m1593x4f0ff958(hashSet, list, timestampNow);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$writeLocally$2$com-google-firebase-firestore-local-LocalStore, reason: not valid java name */
    /* synthetic */ LocalDocumentsResult m1593x4f0ff958(Set set, List list, Timestamp timestamp) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> acknowledgeBatch(final MutationBatchResult mutationBatchResult) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Acknowledge batch", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda5
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return this.f$0.m1575xd0c8f3b2(mutationBatchResult);
            }
        });
    }
    ...
    /* synthetic */ ImmutableSortedMap m1575xd0c8f3b2(MutationBatchResult mutationBatchResult) {
    ...
    public void setLastStreamToken(final ByteString byteString) {
        this.persistence.runTransaction("Set stream token", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1590x6c1835ed(byteString);
            }
        });
    }
    ...
    /* synthetic */ void m1590x6c1835ed(ByteString byteString) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyRemoteEvent(final RemoteEvent remoteEvent) {
        ...
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply remote event", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda14
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return this.f$0.m1578xfb616aa7(remoteEvent, snapshotVersion);
            }
        });
    }
    ...
    /* synthetic */ ImmutableSortedMap m1578xfb616aa7(RemoteEvent remoteEvent, SnapshotVersion snapshotVersion) {
    ...
    /* synthetic */ void m1585x6c8bed50(List list) {
        Iterator it2 = list.iterator();
        while (it2.hasNext()) {
            ...
            while (it3.hasNext()) {
                this.persistence.getReferenceDelegate().removeReference(it3.next());
            }
    ...
    public TargetData allocateTarget(final Target target) {
        ...
        if (targetData != null) {
            ...
            this.persistence.runTransaction("Allocate target", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m1576x5de91a9d(allocateQueryHolder, target);
                }
            });
    ...
    /* synthetic */ void m1576x5de91a9d(AllocateQueryHolder allocateQueryHolder, Target target) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyBundledDocuments(final ImmutableSortedMap<DocumentKey, MutableDocument> immutableSortedMap, String str) {
        ...
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply bundle documents", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda15
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return this.f$0.m1577xda7cc59f(immutableSortedMap, targetDataAllocateTarget);
            }
        });
    }
    ...
    /* synthetic */ ImmutableSortedMap m1577xda7cc59f(ImmutableSortedMap immutableSortedMap, TargetData targetData) {
        ImmutableSortedSet<DocumentKey> immutableSortedSetEmptyKeySet = DocumentKey.emptyKeySet();
    ...
    public void saveNamedQuery(final NamedQuery namedQuery, final ImmutableSortedSet<DocumentKey> immutableSortedSet) {
        ...
        this.persistence.runTransaction("Saved named query", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1589x3730c4c0(namedQuery, targetDataAllocateTarget, targetId, immutableSortedSet);
            }
        });
    }
    ...
    /* synthetic */ void m1589x3730c4c0(NamedQuery namedQuery, TargetData targetData, int i, ImmutableSortedSet immutableSortedSet) {
    ...
    Collection<FieldIndex> getFieldIndexes() {
        return (Collection) this.persistence.runTransaction("Get indexes", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda20
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return this.f$0.m1582x64aa3c54();
            }
        });
    }
    ...
    /* synthetic */ Collection m1582x64aa3c54() {
    ...
    /* synthetic */ void m1580x4fad3f83(List list) {
    ...
    /* synthetic */ void m1587x57c7cf0d(int i) {
        ...
        Iterator<DocumentKey> it2 = this.localViewReferences.removeReferencesForId(i).iterator();
        while (it2.hasNext()) {
    ...
    public LruGarbageCollector.Results collectGarbage(final LruGarbageCollector lruGarbageCollector) {
        return (LruGarbageCollector.Results) this.persistence.runTransaction("Collect garbage", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda13
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return this.f$0.m1579x577feb79(lruGarbageCollector);
            }
        });
    }
    ...
    /* synthetic */ LruGarbageCollector.Results m1579x577feb79(LruGarbageCollector lruGarbageCollector) {
