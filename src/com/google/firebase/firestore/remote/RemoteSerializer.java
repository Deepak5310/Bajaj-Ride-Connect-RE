...
public final class RemoteSerializer {
    ...
    public Write encodeMutation(Mutation mutation) {
        ...
        Iterator<FieldTransform> it2 = mutation.getFieldTransforms().iterator();
        while (it2.hasNext()) {
            builderNewBuilder.addUpdateTransforms(encodeFieldTransform(it2.next()));
        }
    ...
    public Mutation decodeMutation(Write write) {
        ...
        Iterator<DocumentTransform.FieldTransform> it2 = write.getUpdateTransformsList().iterator();
        while (it2.hasNext()) {
            arrayList.add(decodeFieldTransform(it2.next()));
        }
    ...
    private com.google.firestore.v1.Precondition encodePrecondition(Precondition precondition) {
        ...
        com.google.firestore.v1.Precondition.Builder builderNewBuilder = com.google.firestore.v1.Precondition.newBuilder();
    ...
    private DocumentMask encodeDocumentMask(FieldMask fieldMask) {
        ...
        while (it2.hasNext()) {
            builderNewBuilder.addFieldPaths(it2.next().canonicalString());
        }
        return builderNewBuilder.build();
    }
    ...
    public Target.QueryTarget encodeQueryTarget(com.google.firebase.firestore.core.Target target) {
        ...
        Iterator<OrderBy> it2 = target.getOrderBy().iterator();
        while (it2.hasNext()) {
            builderNewBuilder2.addOrderBy(encodeOrderBy(it2.next()));
        }
        if (target.hasLimit()) {
    ...
    StructuredAggregationQuery encodeStructuredAggregationQuery(Target.QueryTarget queryTarget, List<AggregateField> list, HashMap<String, String> map) {
        ...
        for (AggregateField aggregateField : list) {
            if (!hashSet.contains(aggregateField.getAlias())) {
                ...
                builderNewBuilder2.setAlias(string);
    ...
    CompositeFilter decodeCompositeFilter(StructuredQuery.CompositeFilter compositeFilter) {
        ...
        while (it2.hasNext()) {
            arrayList.add(decodeFilter(it2.next()));
        }
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            int[] iArr2 = new int[com.google.firestore.v1.TargetChange.TargetChangeType.values().length];
            $SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType = iArr2;
            try {
                iArr2[com.google.firestore.v1.TargetChange.TargetChangeType.NO_CHANGE.ordinal()] = 1;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType[com.google.firestore.v1.TargetChange.TargetChangeType.ADD.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType[com.google.firestore.v1.TargetChange.TargetChangeType.REMOVE.ordinal()] = 3;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType[com.google.firestore.v1.TargetChange.TargetChangeType.CURRENT.ordinal()] = 4;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType[com.google.firestore.v1.TargetChange.TargetChangeType.RESET.ordinal()] = 5;
            ...
            int[] iArr12 = new int[com.google.firestore.v1.Precondition.ConditionTypeCase.values().length];
            $SwitchMap$com$google$firestore$v1$Precondition$ConditionTypeCase = iArr12;
            try {
                iArr12[com.google.firestore.v1.Precondition.ConditionTypeCase.UPDATE_TIME.ordinal()] = 1;
