...
public final class RemoteStore implements WatchChangeAggregator.TargetMetadataProvider {
    ...
    public RemoteStore(DatabaseId databaseId, final RemoteStoreCallback remoteStoreCallback, LocalStore localStore, Datastore datastore, final AsyncQueue asyncQueue, ConnectivityMonitor connectivityMonitor) {
        ...
        connectivityMonitor.addCallback(new Consumer() { // from class: com.google.firebase.firestore.remote.RemoteStore$$ExternalSyntheticLambda2
            ...
            public final void accept(Object obj) {
                this.f$0.m1658lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(asyncQueue, (ConnectivityMonitor.NetworkStatus) obj);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-firebase-firestore-remote-RemoteStore, reason: not valid java name */
    /* synthetic */ void m1658lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(AsyncQueue asyncQueue, final ConnectivityMonitor.NetworkStatus networkStatus) {
        asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.remote.RemoteStore$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m1657lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(networkStatus);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-firebase-firestore-remote-RemoteStore, reason: not valid java name */
    /* synthetic */ void m1657lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(ConnectivityMonitor.NetworkStatus networkStatus) {
    ...
    public void handleWatchStreamOpen() {
        Iterator<TargetData> it2 = this.listenTargets.values().iterator();
        while (it2.hasNext()) {
            sendWatchRequest(it2.next());
        }
    }
    ...
    public void handleWriteStreamHandshakeComplete() {
        ...
        Iterator<MutationBatch> it2 = this.writePipeline.iterator();
        while (it2.hasNext()) {
            this.writeStream.writeMutations(it2.next().getMutations());
        }
    }
