...
final class AndroidConnectivityMonitor implements ConnectivityMonitor {
        ...
        if (this.connectivityManager != null) {
            ...
            this.unregisterRunnable = new Runnable() { // from class: com.google.firebase.firestore.remote.AndroidConnectivityMonitor$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m1642xddc22e50(defaultNetworkCallback);
                }
            };
        } else {
            ...
            this.unregisterRunnable = new Runnable() { // from class: com.google.firebase.firestore.remote.AndroidConnectivityMonitor$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m1643x2b81a651(networkReceiver);
                }
            };
        }
    }
    ...
    /* synthetic */ void m1642xddc22e50(DefaultNetworkCallback defaultNetworkCallback) {
    ...
    /* synthetic */ void m1643x2b81a651(NetworkReceiver networkReceiver) {
    ...
    public void raiseCallbacks(boolean z) {
        synchronized (this.callbacks) {
            Iterator<Consumer<ConnectivityMonitor.NetworkStatus>> it2 = this.callbacks.iterator();
            while (it2.hasNext()) {
                it2.next().accept(z ? ConnectivityMonitor.NetworkStatus.REACHABLE : ConnectivityMonitor.NetworkStatus.UNREACHABLE);
            }
        }
    }
