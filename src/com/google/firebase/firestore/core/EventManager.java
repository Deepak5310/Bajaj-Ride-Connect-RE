...
public final class EventManager implements SyncEngine.SyncEngineCallback {
    ...
    private static class QueryListenersInfo {
        ...
        boolean hasRemoteListeners() {
            Iterator<QueryListener> it2 = this.listeners.iterator();
            while (it2.hasNext()) {
                if (it2.next().listensToRemoteStore()) {
                    return true;
                }
            }
            return false;
    ...
    private void raiseSnapshotsInSyncEvent() {
        Iterator<EventListener<Void>> it2 = this.snapshotsInSyncListeners.iterator();
        while (it2.hasNext()) {
    ...
    public void handleOnlineStateChange(OnlineState onlineState) {
        ...
        Iterator<QueryListenersInfo> it2 = this.queries.values().iterator();
        boolean z = false;
        while (it2.hasNext()) {
            Iterator it3 = it2.next().listeners.iterator();
            while (it3.hasNext()) {
