...
public class AsyncQueue {
    ...
    class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            threadNewThread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1
                ...
                public final void uncaughtException(Thread thread, Throwable th) {
                    this.f$0.m1661x23fada6e(thread, th);
                }
            });
        ...
        /* synthetic */ void m1661x23fada6e(Thread thread, Throwable th) {
            AsyncQueue.this.panic(th);
        }
    ...
    public boolean containsDelayedTask(TimerId timerId) {
        Iterator<DelayedTask> it2 = this.delayedTasks.iterator();
        while (it2.hasNext()) {
            if (it2.next().timerId == timerId) {
                return true;
            }
        }
        return false;
    ...
    public void runDelayedTasksUntil(final TimerId timerId) throws InterruptedException {
        runSync(new Runnable() { // from class: com.google.firebase.firestore.util.AsyncQueue$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1660xc3727432(timerId);
            }
        });
    }
    ...
    /* synthetic */ void m1660xc3727432(TimerId timerId) {
