...
public class Util {
    ...
    public static int compareUtf8Strings(String str, String str2) {
        ...
        while (iCharCount < str.length() && iCharCount < str2.length()) {
            ...
            if (iCodePointAt != iCodePointAt2) {
                ...
                int iCompareByteStrings = compareByteStrings(ByteString.copyFromUtf8(getUtf8SafeBytes(str, iCharCount)), ByteString.copyFromUtf8(getUtf8SafeBytes(str2, iCharCount)));
    ...
    public static String typeName(Object obj) {
        return obj == null ? BuildConfig.TRAVIS : obj.getClass().getName();
    }
    ...
    private static <T> void diffCollections(Iterator<T> it2, Iterator<T> it3, Comparator<? super T> comparator, Consumer<T> consumer, Consumer<T> consumer2) {
        T t = (Object) advanceIterator(it2);
        T t2 = (Object) advanceIterator(it3);
        while (true) {
            if (t == null && t2 == null) {
                return;
            }
            ...
            if (z) {
                consumer.accept(t2);
                t2 = (Object) advanceIterator(it3);
            } else if (z2) {
                consumer2.accept(t);
                t = (Object) advanceIterator(it2);
            } else {
                t = (Object) advanceIterator(it2);
                t2 = (Object) advanceIterator(it3);
            }
    ...
    private static <T> T advanceIterator(Iterator<T> it2) {
        if (it2.hasNext()) {
            return it2.next();
        }
        return null;
