...
public final class Target extends GeneratedMessageLite<Target, Builder> implements TargetOrBuilder {
    ...
    public void mergeQuery(com.google.firestore.v1.Target.QueryTarget queryTarget) {
        ...
        if (this.targetTypeCase_ == 5 && this.targetType_ != com.google.firestore.v1.Target.QueryTarget.getDefaultInstance()) {
            this.targetType_ = com.google.firestore.v1.Target.QueryTarget.newBuilder((com.google.firestore.v1.Target.QueryTarget) this.targetType_).mergeFrom(queryTarget).buildPartial();
        } else {
            this.targetType_ = queryTarget;
        }
        this.targetTypeCase_ = 5;
    ...
    public com.google.firestore.v1.Target.DocumentsTarget getDocuments() {
        if (this.targetTypeCase_ == 6) {
            return (com.google.firestore.v1.Target.DocumentsTarget) this.targetType_;
        }
    ...
    public void mergeDocuments(com.google.firestore.v1.Target.DocumentsTarget documentsTarget) {
        ...
        if (this.targetTypeCase_ == 6 && this.targetType_ != com.google.firestore.v1.Target.DocumentsTarget.getDefaultInstance()) {
            this.targetType_ = com.google.firestore.v1.Target.DocumentsTarget.newBuilder((com.google.firestore.v1.Target.DocumentsTarget) this.targetType_).mergeFrom(documentsTarget).buildPartial();
        } else {
            this.targetType_ = documentsTarget;
        }
        this.targetTypeCase_ = 6;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Target, Builder> implements TargetOrBuilder {
        ...
        public Builder setQuery(com.google.firestore.v1.Target.QueryTarget queryTarget) {
            copyOnWrite();
        ...
        public Builder mergeQuery(com.google.firestore.v1.Target.QueryTarget queryTarget) {
            copyOnWrite();
        ...
        public Builder setDocuments(com.google.firestore.v1.Target.DocumentsTarget documentsTarget) {
            copyOnWrite();
        ...
        public Builder mergeDocuments(com.google.firestore.v1.Target.DocumentsTarget documentsTarget) {
            copyOnWrite();
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 3:
                return newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0007\u0001\u0001\u0001\u0007\u0007\u0000\u0000\u0000\u0001\u0004\u0002ဉ\u0000\u0003\n\u0004\u0002\u0005<\u0000\u0006<\u0000\u0007ဉ\u0001", new Object[]{"targetType_", "targetTypeCase_", "bitField0_", "targetId_", "snapshotVersion_", "resumeToken_", "lastListenSequenceNumber_", com.google.firestore.v1.Target.QueryTarget.class, com.google.firestore.v1.Target.DocumentsTarget.class, "lastLimboFreeSnapshotVersion_"});
            case 4:
