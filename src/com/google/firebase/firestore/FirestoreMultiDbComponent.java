...
class FirestoreMultiDbComponent implements FirebaseAppLifecycleListener, FirebaseFirestore.InstanceRegistry {
    ...
    private final FirebaseApp f692app;
    ...
    synchronized FirebaseFirestore get(String str) {
        ...
        if (firebaseFirestoreNewInstance == null) {
            firebaseFirestoreNewInstance = FirebaseFirestore.newInstance(this.context, this.f692app, this.authProvider, this.appCheckProvider, str, this, this.metadataProvider);
