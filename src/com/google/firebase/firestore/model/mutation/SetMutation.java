...
public final class SetMutation extends Mutation {
    ...
    public void applyToRemoteDocument(MutableDocument mutableDocument, MutationResult mutationResult) {
        ...
        ObjectValue objectValueM1635clone = this.value.m1635clone();
        objectValueM1635clone.setAll(serverTransformResults(mutableDocument, mutationResult.getTransformResults()));
        mutableDocument.convertToFoundDocument(mutationResult.getVersion(), objectValueM1635clone).setHasCommittedMutations();
    }
    ...
    public FieldMask applyToLocalView(MutableDocument mutableDocument, FieldMask fieldMask, Timestamp timestamp) {
        ...
        ObjectValue objectValueM1635clone = this.value.m1635clone();
        objectValueM1635clone.setAll(mapLocalTransformResults);
        mutableDocument.convertToFoundDocument(mutableDocument.getVersion(), objectValueM1635clone).setHasLocalMutations();
        return null;
    }
