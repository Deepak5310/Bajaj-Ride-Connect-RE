...
public final class SetOptions {
    ...
    public static SetOptions mergeFields(List<String> list) {
        ...
        while (it2.hasNext()) {
            hashSet.add(FieldPath.fromDotSeparatedPath(it2.next()).getInternalPath());
        }
    ...
    public static SetOptions mergeFieldPaths(List<FieldPath> list) {
        HashSet hashSet = new HashSet();
        Iterator<FieldPath> it2 = list.iterator();
        while (it2.hasNext()) {
            hashSet.add(it2.next().getInternalPath());
        }
        return new SetOptions(true, FieldMask.fromSet(hashSet));
    }
