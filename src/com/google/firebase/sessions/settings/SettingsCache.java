...
public final class SettingsCache {
    ...
    @DebugMetadata(c = "com.google.firebase.sessions.settings.SettingsCache", f = "SettingsCache.kt", i = {}, l = {PanasonicMakernoteDirectory.TAG_BURST_SPEED}, m = "updateConfigValue", n = {}, s = {})
    static final class C02201<T> extends ContinuationImpl {
        int label;
    ...
    public final <T> Object updateConfigValue(Preferences.Key<T> key, T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                c02201.label = 1;
                if (PreferencesKt.edit(dataStore, anonymousClass2, c02201) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
