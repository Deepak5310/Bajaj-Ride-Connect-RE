...
public final class SessionsSettings {
    ...
    @DebugMetadata(c = "com.google.firebase.sessions.settings.SessionsSettings", f = "SessionsSettings.kt", i = {0}, l = {145, 146}, m = "updateSettings", n = {"this"}, s = {"L$0"})
    ...
    @Inject
    public SessionsSettings(FirebaseApp firebaseApp, @Blocking CoroutineContext blockingDispatcher, @Background CoroutineContext backgroundDispatcher, FirebaseInstallationsApi firebaseInstallationsApi) {
    ...
    public final long m1781getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo1779getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo1779getSessionRestartTimeoutFghU774();
        if (durationMo1779getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo1779getSessionRestartTimeoutFghU774.getRawValue();
            if (m1780isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo1779getSessionRestartTimeoutFghU775 = this.remoteSettings.mo1779getSessionRestartTimeoutFghU774();
        if (durationMo1779getSessionRestartTimeoutFghU775 != null) {
            long rawValue2 = durationMo1779getSessionRestartTimeoutFghU775.getRawValue();
            if (m1780isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m1780isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m3735isPositiveimpl(sessionRestartTimeout) && Duration.m3730isFiniteimpl(sessionRestartTimeout);
    }
