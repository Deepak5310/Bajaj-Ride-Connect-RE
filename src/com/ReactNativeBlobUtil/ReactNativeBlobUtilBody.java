...
class ReactNativeBlobUtilBody extends RequestBody {
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x013f A[PHI: r10
      0x013f: PHI (r10v5 java.io.InputStream) = (r10v3 java.io.InputStream), (r10v6 java.io.InputStream) binds: [B:33:0x0164, B:27:0x013d] A[DONT_GENERATE, DONT_INLINE]] */
    private File createMultipartBodyCache() throws IOException {
        ...
        Iterator<FormField> it2 = arrayListCountFormDataLength.iterator();
        while (it2.hasNext()) {
    ...
    /* JADX WARN: Code duplicated, block: B:25:0x00ae A[PHI: r2 r7
      0x00ae: PHI (r2v3 long) = (r2v1 long), (r2v4 long) binds: [B:30:0x00d5, B:24:0x00ac] A[DONT_GENERATE, DONT_INLINE]
      0x00ae: PHI (r7v12 java.io.InputStream) = (r7v10 java.io.InputStream), (r7v13 java.io.InputStream) binds: [B:30:0x00d5, B:24:0x00ac] A[DONT_GENERATE, DONT_INLINE]] */
