...
class ReactNativeBlobUtilImpl {
    ...
    public void addCompleteDownload(ReadableMap readableMap, Promise promise) {
        ...
        if (strNormalizePath == null) {
            ...
            try {
                downloadManager.addCompletedDownload(readableMap.hasKey("title") ? readableMap.getString("title") : "", readableMap.hasKey(SavingTrackHelper.POINT_COL_DESCRIPTION) ? readableMap.getString(SavingTrackHelper.POINT_COL_DESCRIPTION) : "", true, readableMap.hasKey("mime") ? readableMap.getString("mime") : null, strNormalizePath, Long.valueOf(ReactNativeBlobUtilFS.statFile(strNormalizePath).getString("size")).longValue(), readableMap.hasKey("showNotification") && readableMap.getBoolean("showNotification"));
                promise.resolve(null);
            } catch (Exception e) {
                promise.reject("EUNSPECIFIED", e.getLocalizedMessage());
            }
