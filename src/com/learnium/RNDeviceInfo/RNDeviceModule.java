...
public class RNDeviceModule extends ReactContextBaseJavaModule {
        ...
        this.receiver = new BroadcastReceiver() { // from class: com.learnium.RNDeviceInfo.RNDeviceModule.1
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (RNDeviceModule.this.mLastBatteryState.equalsIgnoreCase(string)) {
                    ...
                    rNDeviceModule3.sendEvent(rNDeviceModule3.getReactApplicationContext(), "RNDeviceInfo_powerStateDidChange", string);
                    RNDeviceModule.this.mLastBatteryState = string;
                    RNDeviceModule rNDeviceModule4 = RNDeviceModule.this;
                    boolValueOf.getClass();
                    rNDeviceModule4.mLastPowerSaveState = z;
                }
                double d2 = RNDeviceModule.this.mLastBatteryLevel;
                dValueOf.getClass();
                if (d2 != d) {
                    RNDeviceModule rNDeviceModule5 = RNDeviceModule.this;
                    rNDeviceModule5.sendEvent(rNDeviceModule5.getReactApplicationContext(), "RNDeviceInfo_batteryLevelDidChange", dValueOf);
                    dValueOf.getClass();
                    if (d <= 0.15d) {
                        RNDeviceModule rNDeviceModule6 = RNDeviceModule.this;
                        rNDeviceModule6.sendEvent(rNDeviceModule6.getReactApplicationContext(), "RNDeviceInfo_batteryLevelIsLow", dValueOf);
                    }
                    RNDeviceModule rNDeviceModule7 = RNDeviceModule.this;
                    dValueOf.getClass();
                    rNDeviceModule7.mLastBatteryLevel = d;
                }
            }
        };
    ...
    private void initializeHeadphoneConnectionReceivers() {
        ...
        getReactApplicationContext().registerReceiver(this.headphoneWiredConnectionReceiver, intentFilter2);
        ...
        getReactApplicationContext().registerReceiver(this.headphoneBluetoothConnectionReceiver, intentFilter3);
    }
    ...
    public Map<String, Object> getConstants() {
        ...
        map.put(RemoteConfigConstants.RequestFieldKey.APP_VERSION, str);
    ...
    public boolean isEmulatorSync() {
        return Build.FINGERPRINT.startsWith("generic") || Build.FINGERPRINT.startsWith(EnvironmentCompat.MEDIA_UNKNOWN) || Build.MODEL.contains("google_sdk") || Build.MODEL.toLowerCase(Locale.ROOT).contains("droid4x") || Build.MODEL.contains("Emulator") || Build.MODEL.contains("Android SDK built for x86") || Build.MANUFACTURER.contains("Genymotion") || Build.HARDWARE.contains("goldfish") || Build.HARDWARE.contains("ranchu") || Build.HARDWARE.contains("vbox86") || Build.PRODUCT.contains("sdk") || Build.PRODUCT.contains("google_sdk") || Build.PRODUCT.contains("sdk_google") || Build.PRODUCT.contains("sdk_x86") || Build.PRODUCT.contains("vbox86p") || Build.PRODUCT.contains(com.google.firebase.firestore.BuildConfig.TARGET_BACKEND) || Build.PRODUCT.contains("simulator") || Build.BOARD.toLowerCase(Locale.ROOT).contains("nox") || Build.BOOTLOADER.toLowerCase(Locale.ROOT).contains("nox") || Build.HARDWARE.toLowerCase(Locale.ROOT).contains("nox") || Build.PRODUCT.toLowerCase(Locale.ROOT).contains("nox") || Build.SERIAL.toLowerCase(Locale.ROOT).contains("nox") || (Build.BRAND.startsWith("generic") && Build.DEVICE.startsWith("generic"));
    }
    ...
    public boolean isBatteryChargingSync() {
        ...
        return (intentRegisterReceiver != null ? intentRegisterReceiver.getIntExtra(NotificationCompat.CATEGORY_STATUS, -1) : 0) == 2;
    }
    ...
    public boolean hasGmsSync() {
        try {
            Object objInvoke = Class.forName("com.google.android.gms.common.GoogleApiAvailability").getMethod("getInstance", null).invoke(null, null);
    ...
    public String getDeviceNameSync() {
        ...
        try {
            if (Build.VERSION.SDK_INT > 31 || (string2 = Settings.Secure.getString(getReactApplicationContext().getContentResolver(), "bluetooth_name")) == null) {
                return (Build.VERSION.SDK_INT < 25 || (string = Settings.Global.getString(getReactApplicationContext().getContentResolver(), "device_name")) == null) ? EnvironmentCompat.MEDIA_UNKNOWN : string;
            }
            return string2;
        } catch (Exception unused) {
            return EnvironmentCompat.MEDIA_UNKNOWN;
