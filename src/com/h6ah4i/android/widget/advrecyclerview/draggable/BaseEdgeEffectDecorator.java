...
abstract class BaseEdgeEffectDecorator extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        boolean zDrawGlow = edgeEffect != null ? drawGlow(canvas, recyclerView, this.mGlow1Dir, edgeEffect) : false;
        EdgeEffect edgeEffect2 = this.mGlow2;
        if (edgeEffect2 != null) {
            zDrawGlow |= drawGlow(canvas, recyclerView, this.mGlow2Dir, edgeEffect2);
        }
        if (zDrawGlow) {
    ...
    public void releaseBothGlows() {
        ...
        if (edgeEffect != null) {
            ...
            zIsFinished = this.mGlow1.isFinished();
        } else {
            zIsFinished = false;
        }
        EdgeEffect edgeEffect2 = this.mGlow2;
        if (edgeEffect2 != null) {
            ...
            zIsFinished |= this.mGlow2.isFinished();
        }
        if (zIsFinished) {
            ViewCompat.postInvalidateOnAnimation(this.mRecyclerView);
        }
