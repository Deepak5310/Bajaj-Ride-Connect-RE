...
public class CustomRecyclerViewUtils {
    ...
    public static RecyclerView.ViewHolder findChildViewHolderUnderWithoutTranslation(RecyclerView recyclerView, float f, float f2) {
        View viewFindChildViewUnderWithoutTranslation = findChildViewUnderWithoutTranslation(recyclerView, f, f2);
        if (viewFindChildViewUnderWithoutTranslation != null) {
            return recyclerView.getChildViewHolder(viewFindChildViewUnderWithoutTranslation);
        }
        return null;
    }
    ...
    private static int findFirstVisibleItemPositionIncludesPadding(LinearLayoutManager linearLayoutManager) {
        View viewFindOneVisibleChildIncludesPadding = findOneVisibleChildIncludesPadding(linearLayoutManager, 0, linearLayoutManager.getChildCount(), false, true);
        if (viewFindOneVisibleChildIncludesPadding == null) {
            return -1;
        }
        return linearLayoutManager.getPosition(viewFindOneVisibleChildIncludesPadding);
    }

    private static int findLastVisibleItemPositionIncludesPadding(LinearLayoutManager linearLayoutManager) {
        View viewFindOneVisibleChildIncludesPadding = findOneVisibleChildIncludesPadding(linearLayoutManager, linearLayoutManager.getChildCount() - 1, -1, false, true);
        if (viewFindOneVisibleChildIncludesPadding == null) {
            return -1;
        }
        return linearLayoutManager.getPosition(viewFindOneVisibleChildIncludesPadding);
