...
public class DatePickerManager extends SimpleViewManager<PickerView> {
    ...
    @ReactPropGroup(names = {"date", ModeProp.name, "locale", MaximumDateProp.name, MinimumDateProp.name, FadeToColorProp.name, TextColorProp.name, TimezoneOffsetInMinutesProp.name, MinuteIntervalProp.name, VariantProp.name, DividerHeightProp.name, Is24hourSourceProp.name})
