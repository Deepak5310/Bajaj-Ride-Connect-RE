...
public final class CustomTabsSupportChecker {
    ...
    static String getPackageSupportingCustomTabs(Context context, AuthorizationRequest authorizationRequest) {
        ...
        return (redirectUri.startsWith(UriUtil.HTTP_SCHEME) || redirectUri.startsWith(UriUtil.HTTPS_SCHEME) || !hasBrowserSupportForCustomTabs(packageNameSupportingCustomTabs) || !hasRedirectUriActivity(context.getPackageManager(), redirectUri)) ? "" : packageNameSupportingCustomTabs;
    }
