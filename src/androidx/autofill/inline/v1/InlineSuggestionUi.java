...
public final class InlineSuggestionUi {
    ...
    public static final class Content extends SlicedContent {
        ...
        Content(Slice slice) {
            ...
            while (it2.hasNext()) {
                SliceItem sliceItemM19m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m19m(it2.next());
                String strItemType = itemType(sliceItemM19m);
                if (strItemType != null) {
                    strItemType.hashCode();
                    switch (strItemType) {
                        case "inline_subtitle":
                            this.mSubtitle = sliceItemM19m.getText().toString();
                            break;
                        case "inline_content_description":
                            this.mContentDescription = sliceItemM19m.getText();
                            break;
                        case "inline_start_icon":
                            this.mStartIcon = sliceItemM19m.getIcon();
                            break;
                        case "inline_title":
                            this.mTitle = sliceItemM19m.getText().toString();
                            break;
                        case "inline_attribution":
                            this.mAttributionIntent = sliceItemM19m.getAction();
                            break;
                        case "inline_end_icon":
                            this.mEndIcon = sliceItemM19m.getIcon();
                            break;
                    }
                }
            }
        ...
        public static final class Builder extends SlicedContent.Builder<Content> {
            ...
            public Content build() {
                ...
                if (this.mAttributionIntent != null) {
                    ...
                    builder.addAction(pendingIntent, ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mSliceBuilder).addHints(Collections.singletonList(Content.HINT_INLINE_ATTRIBUTION_INTENT)).build(), null);
                }
