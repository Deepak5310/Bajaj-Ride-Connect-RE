...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it2.hasNext()) {
                NotificationChannel notificationChannelM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) it2.next());
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it2.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM16m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m16m((Object) it2.next());
                if (Api26Impl.getId(notificationChannelGroupM16m).equals(str)) {
                    return notificationChannelGroupM16m;
                }
            }
        }
        return null;
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) it2.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM16m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m16m((Object) it2.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM16m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM16m, notificationChannels));
                    }
                }
                return arrayList;
            }
