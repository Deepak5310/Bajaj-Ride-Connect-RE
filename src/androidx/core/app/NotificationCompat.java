...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it3.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(it3.next())));
                }
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            while (it2.hasNext()) {
                Api24Impl.addMessage(messagingStyleCreateMessagingStyle, it2.next().toAndroidMessage());
            }
            if (Build.VERSION.SDK_INT >= 26) {
                Iterator<Message> it3 = this.mHistoricMessages.iterator();
                while (it3.hasNext()) {
                    Api26Impl.addHistoricMessage(messagingStyleCreateMessagingStyle, it3.next().toAndroidMessage());
                }
            }
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m250clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m251clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(it2.next())));
                }
            }
        } else {
