...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        if (Build.VERSION.SDK_INT >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).getShortcuts(i));
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM = HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m()));
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static boolean isRateLimitingActive(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).isRateLimitingActive();
        }
    ...
    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).getIconMaxWidth();
        }
    ...
    public static int getIconMaxHeight(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).getIconMaxHeight();
        }
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List dynamicShortcuts = HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it2 = dynamicShortcuts.iterator();
            while (it2.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m(it2.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it3 = getShortcutInfoListeners(context).iterator();
        while (it3.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
            it2.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m289m())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
