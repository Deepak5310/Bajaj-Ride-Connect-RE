...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m39m$1();
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it2.hasNext()) {
            arrayList.add(new Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m((Object) it2.next())).build());
        }
        return arrayList;
    }
