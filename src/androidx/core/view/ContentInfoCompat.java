...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ClipData clipData, int i) {
            this.mPlatformBuilder = ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m(clipData, i);
        }

        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m330m();
            this.mPlatformBuilder = ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m319m(contentInfoCompat.toContentInfo());
        }
