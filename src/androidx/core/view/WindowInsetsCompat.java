...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m321m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM321m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM321m = ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m322m(windowInsets);
            } else {
                builderM321m = ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m321m();
            }
            this.mPlatBuilder = builderM321m;
        }
