            ...
            public boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
                if (Build.VERSION.SDK_INT >= 25 && (i & 1) != 0) {
                    try {
                        ...
                        InputContentInfo inputContentInfoM26m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m26m(inputContentInfoCompat.unwrap());
                        bundle = bundle == null ? new Bundle() : new Bundle(bundle);
                        bundle.putParcelable(AppCompatReceiveContentHelper.EXTRA_INPUT_CONTENT_INFO, inputContentInfoM26m);
                    } catch (Exception e) {
