...
public abstract class CameraController {
    ...
    CameraController(Context context) {
        ...
        this.mInitializationFuture = Futures.transform(ProcessCameraProvider.getInstance(applicationContext), new Function() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return this.f$0.m200lambda$new$0$androidxcameraviewCameraController((ProcessCameraProvider) obj);
            }
        ...
        this.mDeviceRotationListener = new RotationProvider.Listener() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda1
            ...
            public final void onRotationChanged(int i) {
                this.f$0.m201lambda$new$1$androidxcameraviewCameraController(i);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-view-CameraController, reason: not valid java name */
    /* synthetic */ Void m200lambda$new$0$androidxcameraviewCameraController(ProcessCameraProvider processCameraProvider) {
    ...
    /* synthetic */ void m201lambda$new$1$androidxcameraviewCameraController(int i) {
    ...
    public void takePicture(ImageCapture.OutputFileOptions outputFileOptions, Executor executor, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
        ...
        this.mImageCapture.m161lambda$takePicture$4$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
    }
    ...
    public void takePicture(Executor executor, ImageCapture.OnImageCapturedCallback onImageCapturedCallback) {
        ...
        Preconditions.checkState(isCameraInitialized(), CAMERA_NOT_INITIALIZED);
        Preconditions.checkState(isImageCaptureEnabled(), IMAGE_CAPTURE_DISABLED);
        this.mImageCapture.m160lambda$takePicture$3$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
    }
    ...
    public void startRecording(OutputFileOptions outputFileOptions, Executor executor, final OnVideoSavedCallback onVideoSavedCallback) {
        ...
        this.mVideoCapture.m180lambda$startRecording$0$androidxcameracoreVideoCapture(outputFileOptions.toVideoCaptureOutputFileOptions(), executor, new VideoCapture.OnVideoSavedCallback() { // from class: androidx.camera.view.CameraController.1
    ...
    public void stopRecording() {
        ...
        if (this.mVideoIsRecording.get()) {
            this.mVideoCapture.m184lambda$stopRecording$5$androidxcameracoreVideoCapture();
        }
    }
    ...
    public void setCameraSelector(CameraSelector cameraSelector) {
        ...
        startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m202lambda$setCameraSelector$3$androidxcameraviewCameraController(cameraSelector2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setCameraSelector$3$androidx-camera-view-CameraController, reason: not valid java name */
    /* synthetic */ void m202lambda$setCameraSelector$3$androidxcameraviewCameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
