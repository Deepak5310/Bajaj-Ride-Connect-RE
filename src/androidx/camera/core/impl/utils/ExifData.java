...
public class ExifData {
    ...
    public static final class Builder {
        ...
        private void setAttributeIfMissing(String str, String str2, List<Map<String, ExifAttribute>> list) {
            Iterator<Map<String, ExifAttribute>> it2 = list.iterator();
            while (it2.hasNext()) {
