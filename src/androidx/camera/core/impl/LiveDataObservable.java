...
public final class LiveDataObservable<T> implements Observable<T> {
    ...
    public ListenableFuture<T> fetchData() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda3
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m194lambda$fetchData$1$androidxcameracoreimplLiveDataObservable(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$fetchData$1$androidx-camera-core-impl-LiveDataObservable, reason: not valid java name */
    /* synthetic */ Object m194lambda$fetchData$1$androidxcameracoreimplLiveDataObservable(final CallbackToFutureAdapter.Completer completer) throws Exception {
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m193lambda$fetchData$0$androidxcameracoreimplLiveDataObservable(completer);
            }
        });
    ...
    /* synthetic */ void m193lambda$fetchData$0$androidxcameracoreimplLiveDataObservable(CallbackToFutureAdapter.Completer completer) {
    ...
    public void addObserver(Executor executor, Observable.Observer<? super T> observer) {
        synchronized (this.mObservers) {
            ...
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m192xb97b3ef8(liveDataObserverAdapter, liveDataObserverAdapter2);
                }
            });
        }
    }
    ...
    /* synthetic */ void m192xb97b3ef8(LiveDataObserverAdapter liveDataObserverAdapter, LiveDataObserverAdapter liveDataObserverAdapter2) {
        if (liveDataObserverAdapter != null) {
        ...
        synchronized (this.mObservers) {
            ...
            if (liveDataObserverAdapterRemove != null) {
                ...
                CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.impl.LiveDataObservable$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m195x74a0ce3a(liveDataObserverAdapterRemove);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m195x74a0ce3a(LiveDataObserverAdapter liveDataObserverAdapter) {
        this.mLiveData.removeObserver(liveDataObserverAdapter);
    }
    ...
    static final class LiveDataObserverAdapter<T> implements Observer<Result<T>> {
        ...
        /* synthetic */ void m196x31d6cb3b(Result result) {
            if (this.mActive.get()) {
