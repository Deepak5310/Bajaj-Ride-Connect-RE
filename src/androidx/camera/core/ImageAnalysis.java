...
public final class ImageAnalysis extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final ImageAnalysisConfig imageAnalysisConfig, final Size size) {
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda2
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m153lambda$createPipeline$1$androidxcameracoreImageAnalysis(str, imageAnalysisConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m153lambda$createPipeline$1$androidxcameracoreImageAnalysis(String str, ImageAnalysisConfig imageAnalysisConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
    ...
    public static final class Defaults implements ConfigProvider<ImageAnalysisConfig> {
        ...
        static {
            Size size = new Size(OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, StreamingImageHandler.TFT_HEIGHT);
