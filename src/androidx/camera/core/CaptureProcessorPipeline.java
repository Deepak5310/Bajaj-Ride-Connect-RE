...
class CaptureProcessorPipeline implements CaptureProcessor {
    ...
    public void onResolutionUpdate(Size size) {
        ...
        this.mIntermediateImageReader.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda0
            ...
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                this.f$0.m152x3f602b2(imageReaderProxy);
            }
        }, CameraXExecutors.directExecutor());
    }

    /* JADX INFO: renamed from: lambda$onResolutionUpdate$1$androidx-camera-core-CaptureProcessorPipeline, reason: not valid java name */
    /* synthetic */ void m152x3f602b2(ImageReaderProxy imageReaderProxy) {
        final ImageProxy imageProxyAcquireNextImage = imageReaderProxy.acquireNextImage();
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m151x8e7bdc71(imageProxyAcquireNextImage);
                }
            });
    ...
    /* JADX INFO: renamed from: postProcess, reason: merged with bridge method [inline-methods] */
    public void m151x8e7bdc71(ImageProxy imageProxy) {
        boolean z;
        synchronized (this.mLock) {
            z = this.mClosed;
        }
    ...
    private void closeAndCompleteFutureIfNecessary() {
        ...
        this.mUnderlyingCaptureProcessorsCloseFuture.addListener(new Runnable() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                completer.set(null);
            }
    ...
    public ListenableFuture<Void> getCloseFuture() {
        ...
        synchronized (this.mLock) {
            if (this.mClosed && !this.mProcessing) {
                listenableFutureNonCancellationPropagating = Futures.transform(this.mUnderlyingCaptureProcessorsCloseFuture, new Function() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda2
                ...
                if (this.mCloseFuture == null) {
                    this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda3
                        @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return this.f$0.m150x1c495a06(completer);
                        }
                    });
                }
    ...
    /* JADX INFO: renamed from: lambda$getCloseFuture$4$androidx-camera-core-CaptureProcessorPipeline, reason: not valid java name */
    /* synthetic */ Object m150x1c495a06(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
