...
class ProcessingImageReader implements ImageReaderProxy {
    ...
    class AnonymousClass2 implements ImageReaderProxy.OnImageAvailableListener {
                ...
                if (executor != null) {
                    executor.execute(new Runnable() { // from class: androidx.camera.core.ProcessingImageReader$2$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            this.f$0.m173x3c329d5d(onImageAvailableListener);
                        }
                    });
                } else {
        ...
        /* synthetic */ void m173x3c329d5d(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
            onImageAvailableListener.onImageAvailable(ProcessingImageReader.this);
        }
    }

    /* JADX INFO: renamed from: androidx.camera.core.ProcessingImageReader$3, reason: invalid class name */
    ...
    void closeAndCompleteFutureIfNecessary() {
        ...
        this.mUnderlyingCaptureProcessorCloseFuture.addListener(new Runnable() { // from class: androidx.camera.core.ProcessingImageReader$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m171x76c5121f(completer);
            }
        }, CameraXExecutors.directExecutor());
    }

    /* JADX INFO: renamed from: lambda$closeAndCompleteFutureIfNecessary$0$androidx-camera-core-ProcessingImageReader, reason: not valid java name */
    /* synthetic */ void m171x76c5121f(CallbackToFutureAdapter.Completer completer) {
                ...
                if (this.mCloseFuture == null) {
                    this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.ProcessingImageReader$$ExternalSyntheticLambda1
                        ...
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return this.f$0.m172xf1cfc5d5(completer);
                        }
                    });
                }
    ...
    /* JADX INFO: renamed from: lambda$getCloseFuture$2$androidx-camera-core-ProcessingImageReader, reason: not valid java name */
    /* synthetic */ Object m172xf1cfc5d5(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
