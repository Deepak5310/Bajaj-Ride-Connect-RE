...
public final class VideoCapture extends UseCase {
    ...
    public void m180lambda$startRecording$0$androidxcameracoreVideoCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnVideoSavedCallback onVideoSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m180lambda$startRecording$0$androidxcameracoreVideoCapture(outputFileOptions, executor, onVideoSavedCallback);
                }
            });
            return;
        }
        ...
        this.mRecordingFuture.addListener(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m181lambda$startRecording$2$androidxcameracoreVideoCapture();
            }
            ...
            try {
                ...
                if (this.mIsAudioEnabled.get()) {
                    this.mAudioHandler.post(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m182lambda$startRecording$3$androidxcameracoreVideoCapture(videoSavedListenerWrapper);
                        }
                    });
                }
                ...
                this.mVideoHandler.post(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m183lambda$startRecording$4$androidxcameracoreVideoCapture(videoSavedListenerWrapper, cameraId, attachedSurfaceResolution, outputFileOptions, completer);
                    }
                });
    ...
    /* synthetic */ void m181lambda$startRecording$2$androidxcameracoreVideoCapture() {
        this.mRecordingFuture = null;
        if (getCamera() != null) {
    ...
    /* synthetic */ void m183lambda$startRecording$4$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions, CallbackToFutureAdapter.Completer completer) {
    ...
    public void m184lambda$stopRecording$5$androidxcameracoreVideoCapture() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m184lambda$stopRecording$5$androidxcameracoreVideoCapture();
                }
            });
            return;
        }
    ...
    public void onDetached() {
        m184lambda$stopRecording$5$androidxcameracoreVideoCapture();
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m179lambda$onDetached$6$androidxcameracoreVideoCapture();
                }
            }, CameraXExecutors.mainThreadExecutor());
        } else {
            m179lambda$onDetached$6$androidxcameracoreVideoCapture();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: releaseResources, reason: merged with bridge method [inline-methods] */
    public void m179lambda$onDetached$6$androidxcameracoreVideoCapture() {
    ...
    public boolean m182lambda$startRecording$3$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback) {
    ...
    public static final class Defaults implements ConfigProvider<VideoCaptureConfig> {
        ...
        static {
            Size size = new Size(1920, PhotoshopDirectory.TAG_COUNT_INFORMATION);
    ...
    static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        /* synthetic */ void m186x99849d14(OutputFileResults outputFileResults) {
        ...
        public void onVideoSaved(final OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m186x99849d14(outputFileResults);
                    }
                });
        ...
        public void onError(final int i, final String str, final Throwable th) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m185xe8a64259(i, str, th);
                    }
                });
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCapture.TAG, "Unable to post to the supplied executor.");
        ...
        /* synthetic */ void m185xe8a64259(int i, String str, Throwable th) {
