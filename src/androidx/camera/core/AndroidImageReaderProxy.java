...
class AndroidImageReaderProxy implements ImageReaderProxy {
        ...
        synchronized (this.mLock) {
            this.mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda1
                ...
                public final void onImageAvailable(ImageReader imageReader) {
                    this.f$0.m144x2fd48a6(executor, onImageAvailableListener, imageReader);
                }
    ...
    /* synthetic */ void m143x4985bb07(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
    ...
    /* synthetic */ void m144x2fd48a6(Executor executor, final ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReader imageReader) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m143x4985bb07(onImageAvailableListener);
            }
        });
    }
