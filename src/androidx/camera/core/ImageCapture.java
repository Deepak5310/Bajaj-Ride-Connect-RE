...
public final class ImageCapture extends UseCase {
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x01c0  */
    ...
    SessionConfig.Builder createPipeline(final String str, final ImageCaptureConfig imageCaptureConfig, final Size size) {
        ...
        CaptureProcessor captureProcessorPipeline;
        ImageReaderProxy androidImageReaderProxy;
        ImageCaptureRequestProcessor imageCaptureRequestProcessor;
        ImageCaptureRequestProcessor.RequestProcessCallback requestProcessCallback;
        ...
        if (getCaptureMode() == 2) {
            getCameraControl().addZslConfig(size, builderCreateFrom);
        }
        if (imageCaptureConfig.getImageReaderProxyProvider() != null) {
            ...
            if (this.mIsSessionProcessorEnabled) {
                if (getImageFormat() == 256) {
                    androidImageReaderProxy = new AndroidImageReaderProxy(ImageReader.newInstance(size.getWidth(), size.getHeight(), getImageFormat(), 2));
                    ...
                    if (Build.VERSION.SDK_INT >= 26) {
                        ...
                        CaptureBundle captureBundleSingleDefaultCaptureBundle = CaptureBundles.singleDefaultCaptureBundle();
                        ProcessingImageReader processingImageReaderBuild = new ProcessingImageReader.Builder(modifiableImageReaderProxy, captureBundleSingleDefaultCaptureBundle, yuvToJpegProcessor3).setPostProcessExecutor(this.mExecutor).setOutputFormat(256).build();
                        MutableTagBundle mutableTagBundleCreate = MutableTagBundle.create();
                        mutableTagBundleCreate.putTag(processingImageReaderBuild.getTagBundleKey(), Integer.valueOf(captureBundleSingleDefaultCaptureBundle.getCaptureStages().get(0).getId()));
                        modifiableImageReaderProxy.setImageTagBundle(mutableTagBundleCreate);
                        yuvToJpegProcessor = yuvToJpegProcessor3;
                        androidImageReaderProxy = processingImageReaderBuild;
                    } else {
                ...
                this.mImageReader = new SafeCloseImageReaderProxy(androidImageReaderProxy);
            } else {
                ...
                if (captureProcessor2 != null || this.mUseSoftwareJpeg) {
                    ...
                    if (!this.mUseSoftwareJpeg) {
                        ...
                        if (this.mCaptureProcessor != null) {
                            ...
                            captureProcessorPipeline = new CaptureProcessorPipeline(this.mCaptureProcessor, this.mMaxCaptureStages, yuvToJpegProcessor2, this.mExecutor);
                        } else {
                            yuvToJpegProcessor2 = new YuvToJpegProcessor(getJpegQualityInternal(), this.mMaxCaptureStages);
                            captureProcessorPipeline = yuvToJpegProcessor2;
                        }
                        captureProcessor = captureProcessorPipeline;
                        yuvToJpegProcessor = yuvToJpegProcessor2;
                        i = 256;
                    ...
                    ProcessingImageReader processingImageReaderBuild2 = new ProcessingImageReader.Builder(size.getWidth(), size.getHeight(), imageFormat, this.mMaxCaptureStages, getCaptureBundle(CaptureBundles.singleDefaultCaptureBundle()), captureProcessor).setPostProcessExecutor(this.mExecutor).setOutputFormat(i).build();
                    this.mProcessingImageReader = processingImageReaderBuild2;
                    this.mMetadataMatchingCaptureCallback = processingImageReaderBuild2.getCameraCaptureCallback();
            ...
            ImageCaptureRequestProcessor.ImageCaptor imageCaptor = new ImageCaptureRequestProcessor.ImageCaptor() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda10
                ...
                public final ListenableFuture capture(ImageCapture.ImageCaptureRequest imageCaptureRequest) {
                    return this.f$0.m157lambda$createPipeline$1$androidxcameracoreImageCapture(imageCaptureRequest);
                }
            };
            if (yuvToJpegProcessor == null) {
                requestProcessCallback = null;
            } else {
                requestProcessCallback = new ImageCaptureRequestProcessor.RequestProcessCallback() { // from class: androidx.camera.core.ImageCapture.3
            ...
            this.mImageCaptureRequestProcessor = new ImageCaptureRequestProcessor(2, imageCaptor, requestProcessCallback);
            ...
            processingImageReader = this.mProcessingImageReader;
            if (processingImageReader != null) {
                listenableFutureImmediateFuture = processingImageReader.getCloseFuture();
            } else {
                listenableFutureImmediateFuture = Futures.immediateFuture(null);
            }
            this.mImageReaderCloseFuture = listenableFutureImmediateFuture;
            ...
            terminationFuture.addListener(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda11
            ...
            builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda12
                @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
                public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                    this.f$0.m158lambda$createPipeline$2$androidxcameracoreImageCapture(str, imageCaptureConfig, size, sessionConfig, sessionError);
                }
            });
        ...
        ImageCaptureRequestProcessor.ImageCaptor imageCaptor2 = new ImageCaptureRequestProcessor.ImageCaptor() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda10
            @Override // androidx.camera.core.ImageCapture.ImageCaptureRequestProcessor.ImageCaptor
            public final ListenableFuture capture(ImageCapture.ImageCaptureRequest imageCaptureRequest) {
                return this.f$0.m157lambda$createPipeline$1$androidxcameracoreImageCapture(imageCaptureRequest);
            }
        ...
        this.mImageCaptureRequestProcessor = new ImageCaptureRequestProcessor(2, imageCaptor2, requestProcessCallback);
        this.mImageReader.setOnImageAvailableListener(this.mClosingListener, CameraXExecutors.mainThreadExecutor());
        deferrableSurface = this.mDeferrableSurface;
        if (deferrableSurface != null) {
            deferrableSurface.close();
        ...
        final SafeCloseImageReaderProxy safeCloseImageReaderProxy2 = this.mImageReader;
        Objects.requireNonNull(safeCloseImageReaderProxy2);
        terminationFuture2.addListener(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: renamed from: lambda$createPipeline$2$androidx-camera-core-ImageCapture, reason: not valid java name */
    /* synthetic */ void m158lambda$createPipeline$2$androidxcameracoreImageCapture(String str, ImageCaptureConfig imageCaptureConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
    ...
    public void m160lambda$takePicture$3$androidxcameracoreImageCapture(final Executor executor, final OnImageCapturedCallback onImageCapturedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m160lambda$takePicture$3$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: takePicture, reason: merged with bridge method [inline-methods] */
    public void m161lambda$takePicture$4$androidxcameracoreImageCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnImageSavedCallback onImageSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m161lambda$takePicture$4$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: androidx.camera.core.ImageCapture$8, reason: invalid class name */
    ...
    private void sendImageCaptureRequest(Executor executor, final OnImageCapturedCallback onImageCapturedCallback, boolean z) {
        CameraInternal camera = getCamera();
        if (camera == null) {
            executor.execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m159x1bb57f01(onImageCapturedCallback);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: lambda$sendImageCaptureRequest$5$androidx-camera-core-ImageCapture, reason: not valid java name */
    /* synthetic */ void m159x1bb57f01(OnImageCapturedCallback onImageCapturedCallback) {
    ...
    public ListenableFuture<ImageProxy> m157lambda$createPipeline$1$androidxcameracoreImageCapture(final ImageCaptureRequest imageCaptureRequest) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m162lambda$takePictureInternal$9$androidxcameracoreImageCapture(imageCaptureRequest, completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$takePictureInternal$9$androidx-camera-core-ImageCapture, reason: not valid java name */
    /* synthetic */ Object m162lambda$takePictureInternal$9$androidxcameracoreImageCapture(ImageCaptureRequest imageCaptureRequest, final CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        Futures.addCallback(listenableFutureIssueTakePicture, new FutureCallback<Void>() { // from class: androidx.camera.core.ImageCapture.6
    ...
    public void onDetached() {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    ListenableFuture<Void> issueTakePicture(final ImageCaptureRequest imageCaptureRequest) {
        ...
        if (this.mProcessingImageReader != null) {
            ...
            this.mProcessingImageReader.setOnProcessingErrorCallback(CameraXExecutors.directExecutor(), new ProcessingImageReader.OnProcessingErrorCallback() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda8
                ...
                public final void notifyProcessingError(String str, Throwable th) {
                    ImageCapture.lambda$issueTakePicture$11(imageCaptureRequest, str, th);
                }
            });
        ...
        return Futures.transform(getCameraControl().submitStillCaptureRequests(arrayList, this.mCaptureMode, this.mFlashType), new Function() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda9
    ...
    static class ImageCaptureRequest {
        ...
        void dispatchImage(ImageProxy imageProxy) {
            ...
            try {
                this.mListenerExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$ImageCaptureRequest$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m163xf35699e1(settableImageProxy);
                    }
                });
        ...
        /* synthetic */ void m163xf35699e1(ImageProxy imageProxy) {
            ...
            if (this.mDispatched.compareAndSet(false, true)) {
                try {
                    this.mListenerExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$ImageCaptureRequest$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m164xe8eba4db(i, str, th);
                        }
                    });
                } catch (RejectedExecutionException unused) {
                    Logger.e(ImageCapture.TAG, "Unable to post to the supplied executor.");
        ...
        /* synthetic */ void m164xe8eba4db(int i, String str, Throwable th) {
