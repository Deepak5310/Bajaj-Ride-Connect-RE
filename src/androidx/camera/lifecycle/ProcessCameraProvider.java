...
public final class ProcessCameraProvider implements LifecycleCameraProvider {
        ...
        synchronized (this.mLock) {
            ...
            ListenableFuture<CameraX> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.lifecycle.ProcessCameraProvider$$ExternalSyntheticLambda0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m199x6ee14178(cameraX, completer);
                }
            });
    ...
    /* synthetic */ Object m199x6ee14178(final CameraX cameraX, final CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
            Futures.addCallback(FutureChain.from(this.mCameraXShutdownFuture).transformAsync(new AsyncFunction() { // from class: androidx.camera.lifecycle.ProcessCameraProvider$$ExternalSyntheticLambda3
    ...
    public List<CameraInfo> getAvailableCameraInfos() {
        ...
        Iterator<CameraInternal> it2 = this.mCameraX.getCameraRepository().getCameras().iterator();
        while (it2.hasNext()) {
