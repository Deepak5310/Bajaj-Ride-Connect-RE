...
public class CommandHandler implements ExecutionListener {
    ...
    public void m468lambda$runOnExecuted$1$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
    ...
    private void handleStopWork(Intent intent, SystemAlarmDispatcher dispatcher) {
        ...
        for (StartStopToken startStopToken : listRemove) {
            ...
            dispatcher.m468lambda$runOnExecuted$1$androidxworkimplProcessor(startStopToken.getId(), false);
        }
    }
    ...
    private void handleExecutionCompleted(Intent intent, int startId) {
        ...
        m468lambda$runOnExecuted$1$androidxworkimplProcessor(workGenerationalId, z);
    }
