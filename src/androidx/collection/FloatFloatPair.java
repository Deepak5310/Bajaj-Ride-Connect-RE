...
public final class FloatFloatPair {
    ...
    public static final /* synthetic */ FloatFloatPair m218boximpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m223equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m227hashCodeimpl(this.packedValue);
    }
    ...
    public String toString() {
        return m228toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m221constructorimpl(float f, float f2) {
        return m222constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getFirst-impl, reason: not valid java name */
    public static final float m225getFirstimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: getSecond-impl, reason: not valid java name */
    public static final float m226getSecondimpl(long j) {
        return Float.intBitsToFloat((int) (j & 4294967295L));
    }

    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m219component1impl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m220component2impl(long j) {
        return Float.intBitsToFloat((int) (j & 4294967295L));
    }
}
