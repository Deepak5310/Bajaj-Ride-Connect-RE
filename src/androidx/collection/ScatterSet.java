...
public abstract class ScatterSet<E> {
    ...
    public class SetWrapper implements Set<E>, KMappedMarker {
        ...
        public boolean containsAll(Collection<? extends Object> elements) {
            ...
            while (it2.hasNext()) {
                if (!scatterSet.contains((E) it2.next())) {
                    return false;
                }
            }
            return true;
