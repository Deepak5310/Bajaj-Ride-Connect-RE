...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C01861 extends ContinuationImpl {
        ...
        C01861(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C01861> continuation) {
            super(continuation);
    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C01861) {
            ...
            if ((c01861.label & Integer.MIN_VALUE) != 0) {
                ...
                c01861 = new C01861(this, continuation);
            }
        } else {
            c01861 = new C01861(this, continuation);
        }
        Object objInvoke = c01861.result;
        ...
        if (i == 0) {
            ...
            c01861.L$0 = this;
            c01861.label = 1;
            objInvoke = function2.invoke(t, c01861);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c01861.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
        ...
        if (set == null) {
            ...
            if ((set2 instanceof Collection) && set2.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    if (sharedPrefs.contains((String) it2.next())) {
                    }
                }
                z = false;
            }
