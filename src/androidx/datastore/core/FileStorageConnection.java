...
public final class FileStorageConnection<T> implements StorageConnection<T> {
    ...
    /* JADX INFO: compiled from: FileStorage.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.datastore.core.FileStorageConnection", f = "FileStorage.kt", i = {0, 0, 0, 1, 1, 1, 1}, l = {Mp4VideoDirectory.TAG_FRAME_RATE, 118}, m = "writeScope", n = {"this", "block", "$this$withLock_u24default$iv", "this", "$this$withLock_u24default$iv", "scratchFile", "$this$use$iv"}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"})
    static final class C01811 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01811(FileStorageConnection<T> fileStorageConnection, Continuation<? super C01811> continuation) {
            super(continuation);
            this.this$0 = fileStorageConnection;
        }
    ...
    public Object writeScope(Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C01811) {
            ...
            if ((c01811.label & Integer.MIN_VALUE) != 0) {
                ...
                c01811 = new C01811(this, continuation);
            }
        } else {
            c01811 = new C01811(this, continuation);
        }
                ...
                try {
                    try {
                        if (r3 == 0) {
                            ...
                            c01811.L$0 = this;
                            c01811.L$1 = function2;
                            c01811.L$2 = mutex2;
                            c01811.label = 1;
                            if (mutex2.lock(null, c01811) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            ...
                            if (r3 != 1) {
                                ...
                                closeable = (Closeable) c01811.L$3;
                                File file3 = (File) c01811.L$2;
                                mutex = (Mutex) c01811.L$1;
                                fileStorageConnection2 = (FileStorageConnection) c01811.L$0;
                                try {
                                    ResultKt.throwOnFailure(obj);
                                    file2 = file3;
                            ...
                            Mutex mutex3 = (Mutex) c01811.L$2;
                            Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function3 = (Function2) c01811.L$1;
                            fileStorageConnection = (FileStorageConnection) c01811.L$0;
                            ResultKt.throwOnFailure(obj);
                            mutex = mutex3;
                            function2 = function3;
                        }
                        c01811.L$0 = fileStorageConnection;
                        c01811.L$1 = mutex;
                        c01811.L$2 = file;
                        c01811.L$3 = fileWriteScope;
                        c01811.label = 2;
                        if (function2.invoke(fileWriteScope, c01811) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        file2 = file;
