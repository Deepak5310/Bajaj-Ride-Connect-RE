...
public final class MultiProcessCoordinator implements InterProcessCoordinator {
    ...
    @DebugMetadata(c = "androidx.datastore.core.MultiProcessCoordinator", f = "MultiProcessCoordinator.android.kt", i = {0, 0, 0, 1, 1, 2, 2}, l = {Mp4VideoDirectory.TAG_GRAPHICS_MODE, 47, 48}, m = "lock", n = {"this", "block", "$this$withLock_u24default$iv", "block", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "lock"}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$0", "L$2"})
    ...
    /* JADX WARN: Code duplicated, block: B:58:0x00e6 A[Catch: all -> 0x00ff, TRY_ENTER, TRY_LEAVE, TryCatch #8 {all -> 0x00ff, blocks: (B:58:0x00e6, B:67:0x00fb, B:70:0x0103), top: B:91:0x002a }] */
    /* JADX WARN: Code duplicated, block: B:61:0x00ee  */
    /* JADX WARN: Code duplicated, block: B:67:0x00fb A[Catch: all -> 0x00ff, TRY_ENTER, TryCatch #8 {all -> 0x00ff, blocks: (B:58:0x00e6, B:67:0x00fb, B:70:0x0103), top: B:91:0x002a }] */
    ...
    public <T> Object tryLock(Function2<? super Boolean, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C01821) {
            C01821 c01822 = (C01821) continuation;
            if ((c01822.label & Integer.MIN_VALUE) != 0) {
                c01822.label -= Integer.MIN_VALUE;
                c01821 = c01822;
            } else {
        ...
        Object objInvoke = c01821.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ?? r5 = c01821.label;
        try {
            try {
                if (r5 != 0) {
                    ...
                    z = c01821.Z$0;
                    fileLock = (FileLock) c01821.L$2;
                    java.io.Closeable closeable2 = (java.io.Closeable) c01821.L$1;
                    mutex = (Mutex) c01821.L$0;
                    try {
                        ResultKt.throwOnFailure(objInvoke);
                ...
                try {
                    if (!zTryLock) {
                        ...
                        c01821.Z$0 = zTryLock;
                        c01821.label = 1;
                        objInvoke = r2.invoke(boolBoxBoolean, c01821);
                        if (objInvoke == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        mutex2 = mutex3;
                    ...
                    try {
                        try {
                            ...
                            try {
                                ...
                                c01821.L$0 = mutex3;
                                c01821.L$1 = fileInputStream;
                                c01821.L$2 = fileLockTryLock;
                                c01821.Z$0 = zTryLock;
                                c01821.label = 2;
                                objInvoke = r2.invoke(boolBoxBoolean2, c01821);
                                if (objInvoke == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                mutex = mutex3;
