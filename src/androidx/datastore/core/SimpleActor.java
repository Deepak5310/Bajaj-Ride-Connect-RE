...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM3900getOrNullimpl = ChannelResult.m3900getOrNullimpl(((SimpleActor) this).messageQueue.mo3888tryReceivePtdJZtk());
                        if (objM3900getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM3900getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo3880trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM3899exceptionOrNullimpl = ChannelResult.m3899exceptionOrNullimpl(obj);
            if (thM3899exceptionOrNullimpl != null) {
                throw thM3899exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m3905isSuccessimpl(obj)) {
    ...
    @DebugMetadata(c = "androidx.datastore.core.SimpleActor$offer$2", f = "SimpleActor.kt", i = {}, l = {PanasonicMakernoteDirectory.TAG_INTELLIGENT_D_RANGE, PanasonicMakernoteDirectory.TAG_INTELLIGENT_D_RANGE}, m = "invokeSuspend", n = {}, s = {})
