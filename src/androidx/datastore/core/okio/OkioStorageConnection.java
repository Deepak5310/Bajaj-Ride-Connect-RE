...
public final class OkioStorageConnection<T> implements StorageConnection<T> {
    ...
    static final class C01851 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01851(OkioStorageConnection<T> okioStorageConnection, Continuation<? super C01851> continuation) {
            super(continuation);
            this.this$0 = okioStorageConnection;
        }
    ...
    /* JADX WARN: Code duplicated, block: B:37:0x00d5 A[Catch: all -> 0x00fc, IOException -> 0x00ff, TRY_ENTER, TryCatch #6 {IOException -> 0x00ff, blocks: (B:37:0x00d5, B:39:0x00dd, B:43:0x00ec, B:50:0x00fb, B:49:0x00f8), top: B:70:0x0025 }] */
    /* JADX WARN: Code duplicated, block: B:39:0x00dd A[Catch: all -> 0x00fc, IOException -> 0x00ff, TRY_LEAVE, TryCatch #6 {IOException -> 0x00ff, blocks: (B:37:0x00d5, B:39:0x00dd, B:43:0x00ec, B:50:0x00fb, B:49:0x00f8), top: B:70:0x0025 }] */
    /* JADX WARN: Code duplicated, block: B:43:0x00ec A[Catch: all -> 0x00fc, IOException -> 0x00ff, TRY_ENTER, TRY_LEAVE, TryCatch #6 {IOException -> 0x00ff, blocks: (B:37:0x00d5, B:39:0x00dd, B:43:0x00ec, B:50:0x00fb, B:49:0x00f8), top: B:70:0x0025 }] */
    /* JADX WARN: Code duplicated, block: B:7:0x0014  */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public Object writeScope(Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C01851) {
            ...
            if ((c01851.label & Integer.MIN_VALUE) != 0) {
                ...
                c01851 = new C01851(this, continuation);
            }
        } else {
            c01851 = new C01851(this, continuation);
        }
                    ...
                    try {
                        try {
                            if (r2 == 0) {
                                ...
                                c01851.L$0 = this;
                                c01851.L$1 = function2;
                                c01851.L$2 = pathParent;
                                c01851.L$3 = mutex;
                                c01851.label = 1;
                                if (mutex.lock(null, c01851) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                r7 = this;
                            } else {
                                if (r2 != 1) {
                                    ...
                                    closeable = (Closeable) c01851.L$3;
                                    Path path = (Path) c01851.L$2;
                                    mutex2 = (Mutex) c01851.L$1;
                                    OkioStorageConnection okioStorageConnection = (OkioStorageConnection) c01851.L$0;
                                    try {
                                        ResultKt.throwOnFailure(r11);
                                ...
                                Mutex mutex3 = (Mutex) c01851.L$3;
                                pathParent = (Path) c01851.L$2;
                                Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function3 = (Function2) c01851.L$1;
                                OkioStorageConnection okioStorageConnection2 = (OkioStorageConnection) c01851.L$0;
                                ResultKt.throwOnFailure(r11);
                                mutex = mutex3;
                                function2 = function3;
                            ...
                            c01851.L$1 = mutex;
                            c01851.L$2 = Resolve;
                            c01851.L$3 = okioWriteScope;
                            c01851.label = 2;
                            if (function2.invoke(okioWriteScope, c01851) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            r1 = Resolve;
