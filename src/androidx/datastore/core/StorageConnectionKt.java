...
public final class StorageConnectionKt {
    ...
    @DebugMetadata(c = "androidx.datastore.core.StorageConnectionKt$readData$2", f = "StorageConnection.kt", i = {}, l = {ReconyxHyperFireMakernoteDirectory.TAG_BRIGHTNESS}, m = "invokeSuspend", n = {}, s = {})
    ...
    @DebugMetadata(c = "androidx.datastore.core.StorageConnectionKt$writeData$2", f = "StorageConnection.kt", i = {}, l = {PanasonicMakernoteDirectory.TAG_AF_POINT_POSITION}, m = "invokeSuspend", n = {}, s = {})
    static final class C01842<T> extends SuspendLambda implements Function2<WriteScope<T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01842(T t, Continuation<? super C01842> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01842 c01842 = new C01842(this.$value, continuation);
            c01842.L$0 = obj;
            return c01842;
        }
        ...
        public final Object invoke(WriteScope<T> writeScope, Continuation<? super Unit> continuation) {
            return ((C01842) create(writeScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object writeData(StorageConnection<T> storageConnection, T t, Continuation<? super Unit> continuation) {
        Object objWriteScope = storageConnection.writeScope(new C01842(t, null), continuation);
