...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C01871 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01871(Set<String> set, Continuation<? super C01871> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01871 c01871 = new C01871(this.$keysToMigrate, continuation);
            c01871.L$0 = obj;
            return c01871;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C01871) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
