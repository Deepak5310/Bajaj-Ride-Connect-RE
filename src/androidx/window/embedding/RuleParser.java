...
public final class RuleParser {
    ...
    private final ComponentName buildClassName(String pkg, CharSequence clsSeq) {
        ...
        if (!Intrinsics.areEqual(string, "*") && StringsKt.indexOf$default((CharSequence) string, ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null) < 0) {
            return new ComponentName(pkg, pkg + ClassUtils.PACKAGE_SEPARATOR_CHAR + string);
        }
