...
public final class Version implements Comparable<Version> {
    ...
    public String toString() {
        ...
        return this.major + ClassUtils.PACKAGE_SEPARATOR_CHAR + this.minor + ClassUtils.PACKAGE_SEPARATOR_CHAR + this.patch + str;
    }
