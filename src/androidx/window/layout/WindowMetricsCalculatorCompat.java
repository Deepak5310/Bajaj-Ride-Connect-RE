...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public WindowMetrics computeCurrentWindowMetrics(Context context) {
        ...
        Context contextUnwrapUiContext$window_release = ContextUtils.INSTANCE.unwrapUiContext$window_release(context);
    ...
    private final DisplayCutout getCutoutForDisplay(Display display) {
        try {
            ...
            if (CanvasUtils$$ExternalSyntheticApiModelOutline0.m457m(obj)) {
                return CanvasUtils$$ExternalSyntheticApiModelOutline0.m452m(obj);
            }
            return null;
