...
public final class FlowExtKt {
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        @DebugMetadata(c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", f = "FlowExt.kt", i = {}, l = {KodakMakernoteDirectory.TAG_FLASH_MODE}, m = "invokeSuspend", n = {}, s = {})
        static final class C00071 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00071(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C00071> continuation) {
                super(2, continuation);
                this.$this_flowWithLifecycle = flow;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00071(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
            }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C00071(this.$this_flowWithLifecycle, producerScope2, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
