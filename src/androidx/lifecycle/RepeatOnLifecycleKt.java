...
public final class RepeatOnLifecycleKt {
    ...
    static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: compiled from: RepeatOnLifecycle.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
        @DebugMetadata(c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1", f = "RepeatOnLifecycle.kt", i = {0, 0}, l = {NikonType2MakernoteDirectory.TAG_DELETED_IMAGE_COUNT}, m = "invokeSuspend", n = {"launchedJob", "observer"}, s = {"L$0", "L$1"})
                    ...
                    objectRef4.element = new LifecycleEventObserver() { // from class: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1
                        ...
                        public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                            ...
                            if (event == Lifecycle.Event.ON_DESTROY) {
                                ...
                                cancellableContinuation.resumeWith(Result.m2319constructorimpl(Unit.INSTANCE));
                            }
                        }
