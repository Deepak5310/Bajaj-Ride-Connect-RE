...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo461clone = transition.mo461clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo461clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo461clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo461clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo461clone = transition.mo461clone();
        sceneChangeSetup(viewGroup, transitionMo461clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo461clone);
    }
