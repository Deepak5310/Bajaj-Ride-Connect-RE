...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            String strConcat = StringUtils.SPACE.concat(params.startToStart != -1 ? "SS" : "__");
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str2 + "  " + name + StringUtils.SPACE + constraintWidget + StringUtils.SPACE + string3);
            }
        ...
        /* JADX WARN: Code duplicated, block: B:42:0x013f A[SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:44:0x013f A[SYNTHETIC] */
        /* JADX WARN: Instruction removed from duplicated block: B:29:0x0111, please report this as an issue */
        public void build() {
