...
public class WidgetFrame {
    ...
    void printCustomAttributes() {
        ...
        String str = (".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + StringUtils.SPACE + (hashCode() % 1000);
        String str2 = this.widget != null ? str + RemoteSettings.FORWARD_SLASH_STRING + (this.widget.hashCode() % 1000) + StringUtils.SPACE : str + "/NULL ";
