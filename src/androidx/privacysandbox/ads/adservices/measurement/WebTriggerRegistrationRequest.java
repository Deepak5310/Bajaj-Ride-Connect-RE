...
public final class WebTriggerRegistrationRequest {
    ...
    public final android.adservices.measurement.WebTriggerRegistrationRequest convertToAdServices$ads_adservices_release() {
        ...
        android.adservices.measurement.WebTriggerRegistrationRequest webTriggerRegistrationRequestBuild = CanvasUtils$$ExternalSyntheticApiModelOutline0.m443m((List) WebTriggerParams.INSTANCE.convertWebTriggerParams$ads_adservices_release(this.webTriggerParams), this.destination).build();
