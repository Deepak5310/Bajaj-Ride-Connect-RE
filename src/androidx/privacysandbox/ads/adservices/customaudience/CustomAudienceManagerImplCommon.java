...
public class CustomAudienceManagerImplCommon extends CustomAudienceManager {
    ...
    public final android.adservices.customaudience.JoinCustomAudienceRequest convertJoinRequest(JoinCustomAudienceRequest request) {
        android.adservices.customaudience.JoinCustomAudienceRequest joinCustomAudienceRequestBuild = CanvasUtils$$ExternalSyntheticApiModelOutline0.m438m().setCustomAudience(convertCustomAudience(request.getCustomAudience())).build();
    ...
    public final android.adservices.customaudience.LeaveCustomAudienceRequest convertLeaveRequest(LeaveCustomAudienceRequest request) {
        android.adservices.customaudience.LeaveCustomAudienceRequest leaveCustomAudienceRequestBuild = PreferenceCategory$$ExternalSyntheticApiModelOutline0.m414m().setBuyer(request.getBuyer().convertToAdServices$ads_adservices_release()).setName(request.getName()).build();
    ...
    private final List<AdData> convertAds(List<androidx.privacysandbox.ads.adservices.common.AdData> input) {
        ...
        Iterator<androidx.privacysandbox.ads.adservices.common.AdData> it2 = input.iterator();
        while (it2.hasNext()) {
            arrayList.add(it2.next().convertToAdServices$ads_adservices_release());
        }
        return arrayList;
    }
    ...
    private final android.adservices.customaudience.TrustedBiddingData convertTrustedSignals(TrustedBiddingData input) {
        ...
        return CanvasUtils$$ExternalSyntheticApiModelOutline0.m439m().setTrustedBiddingKeys(input.getTrustedBiddingKeys()).setTrustedBiddingUri(input.getTrustedBiddingUri()).build();
    }
