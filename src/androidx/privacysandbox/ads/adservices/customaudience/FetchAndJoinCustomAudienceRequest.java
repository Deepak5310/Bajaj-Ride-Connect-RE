...
public final class FetchAndJoinCustomAudienceRequest {
    ...
    public final android.adservices.customaudience.FetchAndJoinCustomAudienceRequest convertToAdServices$ads_adservices_release() {
        CanvasUtils$$ExternalSyntheticApiModelOutline0.m456m();
        android.adservices.customaudience.FetchAndJoinCustomAudienceRequest.Builder expirationTime = CanvasUtils$$ExternalSyntheticApiModelOutline0.m(this.fetchUri).setName(this.name).setActivationTime(TimeConversions.convert(this.activationTime)).setExpirationTime(TimeConversions.convert(this.expirationTime));
        AdSelectionSignals adSelectionSignals = this.userBiddingSignals;
