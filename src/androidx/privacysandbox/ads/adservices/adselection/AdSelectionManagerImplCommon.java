...
public class AdSelectionManagerImplCommon extends AdSelectionManager {
    ...
    static /* synthetic */ Object selectAds$suspendImpl(AdSelectionManagerImplCommon adSelectionManagerImplCommon, AdSelectionConfig adSelectionConfig, Continuation<? super AdSelectionOutcome> continuation) throws Throwable {
        ...
        return new AdSelectionOutcome(PreferenceCategory$$ExternalSyntheticApiModelOutline0.m401m(objSelectAdsInternal));
    }
        ...
        public static final class Companion {
            ...
            public final Object getAdSelectionData(android.adservices.adselection.AdSelectionManager adSelectionManager, GetAdSelectionDataRequest getAdSelectionDataRequest, Continuation<? super GetAdSelectionDataOutcome> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    adSelectionManager.getAdSelectionData(getAdSelectionDataRequest.convertToAdServices$ads_adservices_release(), new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), OutcomeReceiverKt.asOutcomeReceiver(cancellableContinuationImpl));
                    ...
                    PreferenceCategory$$ExternalSyntheticApiModelOutline0.m400m(adSelectionManagerImplCommon$Ext10Impl$Companion$getAdSelectionData$1.L$0);
                    ResultKt.throwOnFailure(result);
                }
                return new GetAdSelectionDataOutcome(PreferenceCategory$$ExternalSyntheticApiModelOutline0.m402m(result));
            }
            ...
            public final Object persistAdSelectionResult(android.adservices.adselection.AdSelectionManager adSelectionManager, PersistAdSelectionResultRequest persistAdSelectionResultRequest, Continuation<? super AdSelectionOutcome> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    cancellableContinuationImpl.initCancellability();
                    adSelectionManager.persistAdSelectionResult(persistAdSelectionResultRequest.convertToAdServices$ads_adservices_release(), new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), OutcomeReceiverKt.asOutcomeReceiver(cancellableContinuationImpl));
                    result = cancellableContinuationImpl.getResult();
                    if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    PreferenceCategory$$ExternalSyntheticApiModelOutline0.m400m(adSelectionManagerImplCommon$Ext10Impl$Companion$persistAdSelectionResult$1.L$0);
                    ResultKt.throwOnFailure(result);
                }
                return new AdSelectionOutcome(PreferenceCategory$$ExternalSyntheticApiModelOutline0.m401m(result));
            }
            ...
            public final Object selectAds(android.adservices.adselection.AdSelectionManager adSelectionManager, AdSelectionFromOutcomesConfig adSelectionFromOutcomesConfig, Continuation<? super AdSelectionOutcome> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    cancellableContinuationImpl.initCancellability();
                    adSelectionManager.selectAds(adSelectionFromOutcomesConfig.convertToAdServices$ads_adservices_release(), new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), OutcomeReceiverKt.asOutcomeReceiver(cancellableContinuationImpl));
                    result = cancellableContinuationImpl.getResult();
                    if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    PreferenceCategory$$ExternalSyntheticApiModelOutline0.m400m(adSelectionManagerImplCommon$Ext10Impl$Companion$selectAds$1.L$0);
                    ResultKt.throwOnFailure(result);
                }
                return new AdSelectionOutcome(PreferenceCategory$$ExternalSyntheticApiModelOutline0.m401m(result));
            }
