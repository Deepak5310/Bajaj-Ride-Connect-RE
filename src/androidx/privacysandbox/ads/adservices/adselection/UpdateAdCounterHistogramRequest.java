...
public final class UpdateAdCounterHistogramRequest {
    ...
    public final android.adservices.adselection.UpdateAdCounterHistogramRequest convertToAdServices$ads_adservices_release() {
        PreferenceCategory$$ExternalSyntheticApiModelOutline0.m422m$2();
        android.adservices.adselection.UpdateAdCounterHistogramRequest updateAdCounterHistogramRequestBuild = PreferenceCategory$$ExternalSyntheticApiModelOutline0.m(this.adSelectionId, this.adEventType, this.callerAdTech.convertToAdServices$ads_adservices_release()).build();
