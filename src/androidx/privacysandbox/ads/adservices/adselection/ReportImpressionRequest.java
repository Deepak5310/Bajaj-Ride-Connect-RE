        ...
        public static final class Companion {
            ...
            public final android.adservices.adselection.ReportImpressionRequest convertReportImpressionRequest(ReportImpressionRequest request) {
                ...
                if (Intrinsics.areEqual(request.getAdSelectionConfig(), AdSelectionConfig.INSTANCE.getEMPTY())) {
                    PreferenceCategory$$ExternalSyntheticApiModelOutline0.m421m$1();
                    return PreferenceCategory$$ExternalSyntheticApiModelOutline0.m(request.getAdSelectionId());
                }
                PreferenceCategory$$ExternalSyntheticApiModelOutline0.m421m$1();
                return PreferenceCategory$$ExternalSyntheticApiModelOutline0.m(request.getAdSelectionId(), request.getAdSelectionConfig().convertToAdServices$ads_adservices_release());
            }
        }
    }
