...
final class RegisteredMediaRouteProvider extends MediaRouteProvider implements ServiceConnection {
    ...
    private void bind() {
        ...
        try {
            boolean zBindService = getContext().bindService(intent, this, Build.VERSION.SDK_INT >= 29 ? 4097 : 1);
    ...
    private final class Connection implements IBinder.DeathRecipient {
        ...
        public boolean onDynamicRouteDescriptorsChanged(int i, Bundle bundle) {
            ...
            while (it2.hasNext()) {
                arrayList.add(MediaRouteProvider.DynamicGroupRouteController.DynamicRouteDescriptor.fromBundle((Bundle) it2.next()));
            }
