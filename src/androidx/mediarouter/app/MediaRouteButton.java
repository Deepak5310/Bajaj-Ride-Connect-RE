...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, androidx.mediarouter.R.styleable.MediaRouteButton, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context2, androidx.mediarouter.R.styleable.MediaRouteButton, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        if (isInEditMode()) {
            this.mRouter = null;
            this.mCallback = null;
    ...
    private final class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouterParamsChanged(MediaRouter mediaRouter, MediaRouterParams mediaRouterParams) {
            ...
            if (MediaRouteButton.this.mIsFixedIcon != z) {
                MediaRouteButton.this.mIsFixedIcon = z;
                MediaRouteButton.this.refreshDrawableState();
            }
        }
    }
    ...
    private static final class ConnectivityReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            boolean z;
            if (!BroadcastReceiverConnectivityReceiver.CONNECTIVITY_ACTION.equals(intent.getAction()) || this.mIsConnected == (z = !intent.getBooleanExtra("noConnectivity", false))) {
                return;
            }
            this.mIsConnected = z;
            Iterator<MediaRouteButton> it2 = this.mButtons.iterator();
            while (it2.hasNext()) {
                it2.next().refreshVisibility();
            }
        }
    }
    ...
    private static class Api33 {
        ...
        static void registerReceiver(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, int i) {
