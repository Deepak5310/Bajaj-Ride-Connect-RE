    ...
    private class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        private InputStream openInputStreamByScheme(Uri uri) throws IOException {
            ...
            if (UriUtil.QUALIFIED_RESOURCE_SCHEME.equals(lowerCase) || "content".equals(lowerCase) || "file".equals(lowerCase)) {
                ...
                uRLConnection.setConnectTimeout(MediaRouteControllerDialog.CONNECTION_TIMEOUT_MILLIS);
                uRLConnection.setReadTimeout(MediaRouteControllerDialog.CONNECTION_TIMEOUT_MILLIS);
